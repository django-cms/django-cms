...
from cms.settings import CMS_TOOLBAR_URL__EDIT_ON, CMS_TOOLBAR_URL__BUILD
...
class PlaceholderToolbar(CMSToolbar):
    ...
    def add_structure_mode(self):
        ...
        switcher.add_button(_("Structure"), '?%s' % CMS_TOOLBAR_URL__BUILD, active=self.toolbar.build_mode,
                            disabled=not self.toolbar.build_mode)
        switcher.add_button(_("Content"), '?%s' % CMS_TOOLBAR_URL__EDIT_ON, active=not self.toolbar.build_mode,
...
class PageToolbar(CMSToolbar):
    ...
    def add_page_menu(self):
        ...
        current_page_menu.add_link_item(_('Edit this Page'), disabled=self.toolbar.edit_mode, url='?%s' % CMS_TOOLBAR_URL__EDIT_ON)
