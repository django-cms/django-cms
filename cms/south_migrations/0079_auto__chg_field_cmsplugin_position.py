...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CMSPlugin.position'
        db.alter_column(u'cms_cmsplugin', 'position', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'CMSPlugin.position'
        db.alter_column(u'cms_cmsplugin', 'position', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
    ...
    models = {
        ...
        'cms.usersettings': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'djangocms_usersettings'", 'unique': 'True', 'to': u"orm['auth.User']"})
        },
