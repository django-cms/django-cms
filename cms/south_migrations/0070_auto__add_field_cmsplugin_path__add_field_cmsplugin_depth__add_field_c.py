...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CMSPlugin.depth'
        db.add_column(u'cms_cmsplugin', 'depth',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CMSPlugin.numchild'
        db.add_column(u'cms_cmsplugin', 'numchild',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Page.path'
        db.add_column(u'cms_page', 'path',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'Page.depth'
        db.add_column(u'cms_page', 'depth',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Page.numchild'
        db.add_column(u'cms_page', 'numchild',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CMSPlugin.path'
        db.delete_column(u'cms_cmsplugin', 'path')

        # Deleting field 'CMSPlugin.depth'
        db.delete_column(u'cms_cmsplugin', 'depth')

        # Deleting field 'CMSPlugin.numchild'
        db.delete_column(u'cms_cmsplugin', 'numchild')

        # Deleting field 'Page.path'
        db.delete_column(u'cms_page', 'path')

        # Deleting field 'Page.depth'
        db.delete_column(u'cms_page', 'depth')

        # Deleting field 'Page.numchild'
        db.delete_column(u'cms_page', 'numchild')
