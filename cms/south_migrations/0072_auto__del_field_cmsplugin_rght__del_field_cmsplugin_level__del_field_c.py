...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CMSPlugin.rght'
        db.delete_column(u'cms_cmsplugin', 'rght')

        # Deleting field 'CMSPlugin.level'
        db.delete_column(u'cms_cmsplugin', 'level')

        # Deleting field 'CMSPlugin.tree_id'
        db.delete_column(u'cms_cmsplugin', 'tree_id')

        # Deleting field 'CMSPlugin.lft'
        db.delete_column(u'cms_cmsplugin', 'lft')

        # Deleting field 'Page.rght'
        db.delete_column(u'cms_page', 'rght')

        # Deleting field 'Page.lft'
        db.delete_column(u'cms_page', 'lft')

        # Deleting field 'Page.level'
        db.delete_column(u'cms_page', 'level')

        # Deleting field 'Page.tree_id'
        db.delete_column(u'cms_page', 'tree_id')


    def backwards(self, orm):
        # Adding field 'CMSPlugin.rght'
        db.add_column(u'cms_cmsplugin', 'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding field 'CMSPlugin.level'
        db.add_column(u'cms_cmsplugin', 'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding field 'CMSPlugin.tree_id'
        db.add_column(u'cms_cmsplugin', 'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding field 'CMSPlugin.lft'
        db.add_column(u'cms_cmsplugin', 'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding field 'Page.rght'
        db.add_column(u'cms_page', 'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding field 'Page.lft'
        db.add_column(u'cms_page', 'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding field 'Page.level'
        db.add_column(u'cms_page', 'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding field 'Page.tree_id'
        db.add_column(u'cms_page', 'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)
