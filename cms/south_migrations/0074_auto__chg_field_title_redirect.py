...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Title.redirect'
        db.alter_column(u'cms_title', 'redirect', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))

    def backwards(self, orm):

        # Changing field 'Title.redirect'
        db.alter_column(u'cms_title', 'redirect', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
