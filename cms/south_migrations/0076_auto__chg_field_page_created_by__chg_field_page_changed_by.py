...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cms_page', 'created_by', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Page.changed_by'
        db.alter_column(u'cms_page', 'changed_by', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Page.created_by'
        db.alter_column(u'cms_page', 'created_by', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'Page.changed_by'
        db.alter_column(u'cms_page', 'changed_by', self.gf('django.db.models.fields.CharField')(max_length=70))
