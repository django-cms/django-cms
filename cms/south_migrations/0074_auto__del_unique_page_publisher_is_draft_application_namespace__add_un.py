...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Page', fields ['publisher_is_draft', 'site', 'application_namespace']
        db.create_unique(u'cms_page', ['publisher_is_draft', 'site_id', 'application_namespace'])


    def backwards(self, orm):
        # Removing unique constraint on 'Page', fields ['publisher_is_draft', 'site', 'application_namespace']
        db.delete_unique(u'cms_page', ['publisher_is_draft', 'site_id', 'application_namespace'])
