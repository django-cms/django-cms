...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Title.redirect_to_page'
        db.add_column('cms_title', 'redirect_to_page', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='redirect_to_page_title_set', null=True, to=orm['cms.Page']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Title.redirect_to_page'
        db.delete_column('cms_title', 'redirect_to_page_id')
    ...
    models = {
        ...
        'cms.title': {
            ...
            'redirect_to_page': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'redirect_to_page_title_set'", 'null': 'True', 'to': "orm['cms.Page']"}),
