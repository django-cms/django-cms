...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting unique_together for [l, a, n, g, u, a, g, e] on Title.
        db.delete_unique('cms_title', ('l', 'a', 'n', 'g', 'u', 'a', 'g', 'e'))
        
        # Deleting unique_together for [p, a, g, e] on Title.
        db.delete_unique('cms_title', ('p', 'a', 'g', 'e'))
    ...
    def backwards(self, orm):
        ...
        # Deleting unique_together for [language, page] on Title.
        db.delete_unique('cms_title', ['language', 'page_id'])
        
        # Creating unique_together for [l, a, n, g, u, a, g, e] on Title.
        db.create_unique('cms_title', ('l', 'a', 'n', 'g', 'u', 'a', 'g', 'e'))
        
        # Creating unique_together for [p, a, g, e] on Title.
        db.create_unique('cms_title', ('p', 'a', 'g', 'e'))
        
    
    
    models = {
        'cms.publiccmsplugin': {
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 29, 5, 35, 0, 458096)'}),
        ...
        'cms.publictitle': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 29, 5, 35, 1, 25383)'}),
        ...
        'cms.publicpage': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 29, 5, 35, 0, 122468)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True', 'blank': 'True'}),
        ...
        'cms.cmsplugin': {
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 29, 5, 34, 58, 978377)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True', 'blank': 'True'}),
        ...
        'cms.title': {
            'Meta': {'unique_together': "(('language', 'page'),)"},
            'application_urls': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 29, 5, 34, 58, 322625)'}),
            'has_url_overwrite': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True', 'blank': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'max_length': '5', 'db_index': 'True'}),
            'menu_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'cms.page': {
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 29, 5, 34, 57, 988508)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True', 'blank': 'True'}),
            'in_navigation': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'db_index': 'True', 'blank': 'True'}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
