...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('cms_title', 'publisher_is_draft', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True, db_index=True), keep_default=False)

        # Adding field 'Title.publisher_state'
        db.add_column('cms_title', 'publisher_state', self.gf('django.db.models.fields.SmallIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'Title.publisher_public'
        db.add_column('cms_title', 'publisher_public', self.gf('django.db.models.fields.related.OneToOneField')(related_name='publisher_draft', unique=True, null=True, to=orm['cms.Title']), keep_default=False)

        # Adding unique constraint on 'Title', fields ['publisher_is_draft', 'language', 'page']
        db.create_unique('cms_title', ['publisher_is_draft', 'language', 'page_id'])

        # Removing unique constraint on 'Title', fields ['page', 'language']
        db.delete_unique('cms_title', ['page_id', 'language'])
