...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('cms_cmsplugin', 'publisher_public', self.gf('django.db.models.fields.related.OneToOneField')(related_name='publisher_draft', unique=True, null=True, to=orm['cms.CMSPlugin']), keep_default=False)

        # Adding field 'CMSPlugin.publisher_is_draft'
        db.add_column('cms_cmsplugin', 'publisher_is_draft', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True, db_index=True), keep_default=False)

        # Adding field 'CMSPlugin.publisher_state'
        db.add_column('cms_cmsplugin', 'publisher_state', self.gf('django.db.models.fields.SmallIntegerField')(default=0, db_index=True), keep_default=False)
