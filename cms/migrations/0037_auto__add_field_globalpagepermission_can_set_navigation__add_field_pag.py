...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GlobalPagePermission.can_set_navigation'
        db.add_column('cms_globalpagepermission', 'can_set_navigation',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'PagePermission.can_set_navigation'
        db.add_column('cms_pagepermission', 'can_set_navigation',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GlobalPagePermission.can_set_navigation'
        db.delete_column('cms_globalpagepermission', 'can_set_navigation')

        # Deleting field 'PagePermission.can_set_navigation'
        db.delete_column('cms_pagepermission', 'can_set_navigation')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 17, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
