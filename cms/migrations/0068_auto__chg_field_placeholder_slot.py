...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Placeholder.slot'
        db.alter_column(u'cms_placeholder', 'slot', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Placeholder.slot'
        db.alter_column(u'cms_placeholder', 'slot', self.gf('django.db.models.fields.CharField')(max_length=50))
