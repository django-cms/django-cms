    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_method', models.CharField(max_length=20, default='code', blank=True, verbose_name='creation_method', choices=[('code', 'Code'), ('template', 'Template')])),
                ('draft', cms.models.fields.PlaceholderField(null=True, to='cms.Placeholder', verbose_name='placeholder content', slotname="static_slotname", related_name='static_draft', editable=False)),
                ('public', cms.models.fields.PlaceholderField(null=True, to='cms.Placeholder', slotname="static_slotname", related_name='static_public', editable=False)),
