    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slot', models.CharField(db_index=True, max_length=50, verbose_name=_('slot'), editable=False)),
                ('default_width', models.PositiveSmallIntegerField(null=True, verbose_name=_('width'), editable=False)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, verbose_name=_('ID'), auto_created=True, serialize=False)),
                ('name', models.CharField(max_length=255, default='', help_text='Descriptive name to identify this static placeholder. Not displayed to users.', blank=True, verbose_name=_('static placeholder name'))),
                ('code', models.CharField(max_length=255, verbose_name=_('placeholder code'), help_text='To render the static placeholder in templates.', blank=True)),
                ('dirty', models.BooleanField(default=False, editable=False)),
                ('creation_method', models.CharField(max_length=20, default='code', blank=True, verbose_name=_('creation_method'), choices=cms.models.static_placeholder.StaticPlaceholder.CREATION_METHODS)),
                ('draft', cms.models.fields.PlaceholderField(null=True, to='cms.Placeholder', verbose_name=_('placeholder content'), related_name='static_draft', slotname=cms.models.static_placeholder.static_slotname, editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, verbose_name=_('ID'), auto_created=True, serialize=False)),
                ('language', models.CharField(db_index=True, max_length=15, verbose_name=_('language'))),
                ('title', models.CharField(max_length=255, verbose_name=_('title'))),
                ('page_title', models.CharField(max_length=255, null=True, help_text='overwrite the title (html title tag)', blank=True, verbose_name=_('title'))),
                ('menu_title', models.CharField(max_length=255, null=True, help_text='overwrite the title in the menu', blank=True, verbose_name=_('title'))),
                ('meta_description', models.TextField(max_length=155, null=True, help_text='The text displayed in search engines.', blank=True, verbose_name=_('description'))),
                ('slug', models.SlugField(max_length=255, verbose_name=_('slug'))),
                ('path', models.CharField(db_index=True, max_length=255, verbose_name=_('Path'))),
                ('has_url_overwrite', models.BooleanField(db_index=True, default=False, editable=False, verbose_name=_('has url overwrite'))),
                ('redirect', models.CharField(max_length=255, null=True, blank=True, verbose_name=_('redirect'))),
                ...
                ('page', models.ForeignKey(to='cms.Page', verbose_name=_('page'), related_name='title_set')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, verbose_name=_('ID'), auto_created=True, serialize=False)),
                ('language', models.CharField(max_length=10, choices=settings.LANGUAGES, help_text='The language for the admin interface and toolbar', verbose_name=_('Language'))),
