...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Title.revision_id'
        db.add_column(u'cms_title', 'revision_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Title.template'
        db.add_column(u'cms_title', 'template',
                      self.gf('django.db.models.fields.CharField')(default='INHERIT', max_length=100),
                      keep_default=False)

        # Deleting field 'Page.publication_end_date'
        db.delete_column(u'cms_page', 'publication_end_date')

        # Deleting field 'Page.publication_date'
        db.delete_column(u'cms_page', 'publication_date')
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Title.revision_id'
        db.delete_column(u'cms_title', 'revision_id')

        # Deleting field 'Title.template'
        db.delete_column(u'cms_title', 'template')

        # Adding field 'Page.publication_end_date'
        db.add_column(u'cms_page', 'publication_end_date',
                      self.gf('django.db.models.fields.DateTimeField')(blank=True, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Page.publication_date'
        db.add_column(u'cms_page', 'publication_date',
                      self.gf('django.db.models.fields.DateTimeField')(blank=True, null=True, db_index=True),
                      keep_default=False)
