...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stack.creation_method'
        db.add_column('stacks_stack', 'creation_method',
    ...
    models = {
        ...
        'stacks.stack': {
            ...
            'content': ('django.db.models.fields.related.ForeignKey', [], {
                        'related_name': "'stacks_contents'", 'null': 'True', 'to': "orm['cms.Placeholder']"}),
            'creation_method': ('django.db.models.fields.CharField', [], {'default': "'code'", 'max_length': '20'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'stacks.stacklink': {
            ...
            'stack': ('django.db.models.fields.related.ForeignKey', [], {
                      'related_name': "'linked_plugins'", 'to': "orm['stacks.Stack']"})
        }
    }
