...
class Migration:
    ...
    def backwards(self, orm):
        ...
        db.add_column('cms_page', 'url_overwrite', models.CharField(_("url overwrite"), blank=True, max_length=80, null=True, db_index=True))
    ...
    models = {
        ...
        'cms.page': {
            ...
            'level': '<< PUT FIELD DEFINITION HERE >>',
            'lft': '<< PUT FIELD DEFINITION HERE >>',
            ...
            'rght': '<< PUT FIELD DEFINITION HERE >>',
            ...
            'tree_id': '<< PUT FIELD DEFINITION HERE >>'
        },
        'auth.group': {
            '_stub': True,
            'id': ('models.AutoField', [], {'primary_key': 'True'})
