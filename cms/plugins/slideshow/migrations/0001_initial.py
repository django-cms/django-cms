...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cmsplugin_slideshow', (
        ...
        db.create_table(u'slideshow_slideshowslide', (
        ...
        db.send_create_signal(u'slideshow', ['SlideshowSlide'])


    def backwards(self, orm):
        # Deleting model 'Slideshow'
        db.delete_table(u'cmsplugin_slideshow')

        # Deleting model 'SlideshowSlide'
        db.delete_table(u'slideshow_slideshowslide')
    ...
    models = {
        ...
        u'slideshow.slideshow': {
            'Meta': {'object_name': 'Slideshow', 'db_table': "u'cmsplugin_slideshow'", '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'slideshow.slideshowslide': {
            ...
            'slideshow': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['slideshow.Slideshow']"}),
