...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Video.fullscreen'
        # (to signature: django.db.models.fields.BooleanField(default=True, blank=True))
        db.alter_column('cmsplugin_video', 'fullscreen', orm['video.video:fullscreen'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Video.height'
        # (to signature: django.db.models.fields.CharField(max_length=6))
        db.alter_column('cmsplugin_video', 'height', orm['video.video:height'])
