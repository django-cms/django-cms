...
def render_extra_menu_items(context, obj, template='cms/toolbar/dragitem_extra_menu.html'):
    ...
    if isinstance(obj, CMSPlugin):
        ...
        for plugin_class in renderer.plugins_with_extra_menu:
        ...
        for plugin_class in renderer.plugins_with_extra_placeholder_menu:
...
def render_plugin(context, plugin):
    ...
    content = renderer.render_plugin(
        instance=plugin,
        context=context,
        editable=renderer.user_is_on_edit_mode(),
    )
    return content
