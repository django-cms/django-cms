...
from cms.test_utils.project.placeholder_relation_field_app.views import detail as fancy_poll_detail_view
...
urlpatterns += i18n_patterns(
    ...
    url(r'^fancypolls/detail/([0-9]+)/$', fancy_poll_detail_view,
