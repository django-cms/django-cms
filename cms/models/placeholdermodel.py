...
class Placeholder(models.Model):
    ...
    def _move_plugin_to_placeholder(self, plugin, target_position, target_placeholder, target_plugin=None):
        ...
        if target_last_plugin:
            ...
            # On the target placeholder, the offset needs to reflect the amount of new plugins
            # being moved to it. This includes the plugin being moved and its descendants.
            target_offset = source_offset + plugin._get_descendants_count() + 1
        else:
