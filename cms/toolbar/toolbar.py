...
from cms.settings import CMS_TOOLBAR_URL__EDIT_ON, CMS_TOOLBAR_URL__EDIT_OFF
...
class CMSToolbar(ToolbarAPIMixin):
    ...
    def __init__(self, request):
        ...
        self.edit_mode_url_on = CMS_TOOLBAR_URL__EDIT_ON
        self.edit_mode_url_off = CMS_TOOLBAR_URL__EDIT_OFF
