...
class CMSToolbar(ToolbarAPIMixin):
    ...
    def get_renderer(self):
        ...
        if self.structure_mode_active:
            return self.structure_renderer
    ...
    def edit_mode_active(self):
        return self.edit_mode and self.show_toolbar

    @cached_property
    def structure_mode_active(self):
        return bool(self.edit_mode_active and 'structure' in self.request.GET)
    ...
    def content_mode_active(self):
        return not self.structure_mode_active
    ...
    def get_render_context(self):
        context = {
            'cms_toolbar': self,
            'cms_renderer': self.get_renderer(),
...
class EmptyToolbar(object):
    ...
    structure_mode_active = False
    content_mode_active = True
