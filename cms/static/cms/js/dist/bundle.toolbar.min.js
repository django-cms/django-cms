...
var CMS=window.CMS||{};!function(i){"use strict";i(function(){CMS.Modal=new CMS.Class({implement:[CMS.API.Helpers],options:{onClose:!1,minHeight:400,minWidth:800,modalDuration:200,newPlugin:!1},initialize:function(t){this.options=i.extend(!0,{},this.options,t),this.config=CMS.config,this.settings=CMS.settings,this._setupUI(),this.click="click.cms.modal",this.pointerDown="pointerdown.cms.modal contextmenu.cms.modal",this.pointerUp="pointerup.cms.modal pointercancel.cms.modal",this.pointerMove="pointermove.cms.modal",this.doubleClick="dblclick.cms.modal",this.maximized=!1,this.minimized=!1,this.triggerMaximized=!1,this.saved=!1,this.ui.modal.data("ready")||this._events(),this.ui.modal.data("ready",!0)},_setupUI:function(){var t=i(".cms-modal");this.ui={modal:t,body:i("html"),window:i(window),toolbarLeftPart:i(".cms-toolbar-left"),minimizeButton:t.find(".cms-modal-minimize"),maximizeButton:t.find(".cms-modal-maximize"),title:t.find(".cms-modal-title"),titlePrefix:t.find(".cms-modal-title-prefix"),titleSuffix:t.find(".cms-modal-title-suffix"),resize:t.find(".cms-modal-resize"),breadcrumb:t.find(".cms-modal-breadcrumb"),closeAndCancel:t.find(".cms-modal-close, .cms-modal-cancel"),modalButtons:t.find(".cms-modal-buttons"),modalBody:t.find(".cms-modal-body"),frame:t.find(".cms-modal-frame"),shim:t.find(".cms-modal-shim")}},_events:function(){var t=this;this.ui.minimizeButton.on(this.click,function(i){i.preventDefault(),t.minimize()}),this.ui.maximizeButton.on(this.click,function(i){i.preventDefault(),t.maximize()}),this.ui.title.on(this.pointerDown,function(i){i.preventDefault(),t._startMove(i)}),this.ui.title.on(this.doubleClick,function(){t.maximize()}),this.ui.resize.on(this.pointerDown,function(i){i.preventDefault(),t._startResize(i)}),this.ui.breadcrumb.on(this.click,"a",function(e){e.preventDefault(),t._changeIframe(i(this))}),this.ui.closeAndCancel.on(this.click,function(i){t.options.onClose=null,i.preventDefault(),t.close()})},open:function(i){if(!(i&&i.url||i&&i.html))throw new Error('The arguments passed to "open" were invalid.');if(CMS.API.locked)return CMS.API.locked=!1,!1;if(CMS.API.locked=!0,CMS._newPlugin&&this._deletePlugin()===!1)return!1;this.options.newPlugin&&(CMS._newPlugin=this.options.newPlugin),this.ui.body.hasClass("cms-modal-minimized")&&(this.minimized=!0,this.minimize()),this.ui.modalButtons.empty(),CMS.API.Toolbar._loader(!0),this.hideTooltip();var t=300,e=300,o=this.ui.window.width(),n=this.ui.window.height(),s=o>=this.options.minWidth+t,a=n>=this.options.minHeight+e,l=s?o-t:this.options.minWidth,d=a?n-e:this.options.minHeight;this.ui.maximizeButton.removeClass("cms-modal-maximize-active"),this.maximized=!1,d>=n&&(this.triggerMaximized=!0),i.url?this._loadIframe({url:i.url,title:i.title,breadcrumb:i.breadcrumb}):this._loadMarkup({html:i.html,title:i.title,subtitle:i.subtitle}),this._show({width:i.width||l,height:i.height||d,duration:this.options.modalDuration})},_show:function(i){var t=this,e=i.width,o=i.height,n=i.duration;this.ui.modal.css({display:"block",width:e,height:o,"margin-left":-(e/2),"margin-top":-(o/2)}),setTimeout(function(){t.ui.modal.addClass("cms-modal-open")},0),this.ui.modal.one("cmsTransitionEnd",function(){t.ui.modal.css({"margin-left":-(e/2),"margin-top":-(o/2)}),CMS.API.Toolbar._loader(!1),t.triggerMaximized&&t.maximize(),CMS.API.locked=!1}).emulateTransitionEnd(n),this.ui.body.on("keydown.cms",function(i){i.keyCode===CMS.KEYS.ESC&&t.close()}),this.ui.modal.focus()},close:function(){var i=this;CMS._newPlugin?this._deletePlugin({hideAfter:!0}):this._hide({duration:100}),this.options.onClose&&this.reloadBrowser(this.options.onClose,!1,!0),setTimeout(function(){i.minimized&&i.minimize(),i.maximized&&i.maximize()},300)},_hide:function(i){var t=this,e=this.options.modalDuration;i&&i.duration&&(e=i.duration),t.ui.modal.removeClass("cms-modal-open"),t.ui.modal.one("cmsTransitionEnd",function(){t.ui.modal.css("display","none")}).emulateTransitionEnd(e),t.ui.frame.find("iframe").remove(),t.ui.modalBody.removeClass("cms-loader")},minimize:function(){return this.maximized?!1:void(this.minimized===!1?(CMS.API.Toolbar.toggleToolbar(!0),this.ui.modal.data("css",this.ui.modal.css(["left","top","margin-left","margin-top"])),this.ui.body.addClass("cms-modal-minimized"),this.ui.modal.css({left:this.ui.toolbarLeftPart.outerWidth(!0)+50}),this.minimized=!0):(this.ui.body.removeClass("cms-modal-minimized"),this.ui.modal.css(this.ui.modal.data("css")),this.minimized=!1))},maximize:function(){var i=this.ui.modal;return this.minimized?!1:void(this.maximized===!1?(this.maximized=!0,i.data("css",this.ui.modal.css(["left","top","margin-left","margin-top","width","height"])),this.ui.body.addClass("cms-modal-maximized")):(this.maximized=!1,this.ui.body.removeClass("cms-modal-maximized"),i.css(i.data("css"))))},_startMove:function(i){if(this.maximized)return!1;if(this.minimized)return!1;var t=this,e=t.ui.modal.position();this.ui.body.on(this.pointerUp,function(i){t._stopMove(i)}),this.ui.shim.show(),this.ui.body.attr("data-touch-action","none").on(this.pointerMove,function(o){var n=e.left-(i.originalEvent.pageX-o.originalEvent.pageX),s=e.top-(i.originalEvent.pageY-o.originalEvent.pageY);t.ui.modal.css({left:n,top:s})})},_stopMove:function(){this.ui.shim.hide(),this.ui.body.off(this.pointerMove).off(this.pointerUp).removeAttr("data-touch-action")},_startResize:function(i){if(this.maximized)return!1;var t=this,e=this.ui.modal,o=e.width(),n=e.height(),s=this.ui.modal.position().left,a=this.ui.modal.position().top;this.ui.body.on(this.pointerUp,function(i){t._stopResize(i)}),this.ui.shim.show(),this.ui.body.attr("data-touch-action","none").on(this.pointerMove,function(t){var l=i.originalEvent.pageX-t.originalEvent.pageX,d=i.originalEvent.pageY-t.originalEvent.pageY,m=o-2*l,r=n-2*d,c=680,u=150;return c>=m||u>=r?!1:void e.css({width:o-2*l,height:n-2*d,left:s+l,top:a+d})})},_stopResize:function(){this.ui.shim.hide(),this.ui.body.off(this.pointerMove).off(this.pointerUp).removeAttr("data-touch-action")},_setBreadcrumb:function(t){var e=this.ui.breadcrumb,o="";return this.ui.breadcrumb.find("a").length||this.ui.modal.removeClass("cms-modal-has-breadcrumb"),!t||t.length<=1?!1:t[0].title?(this.ui.modal.addClass("cms-modal-has-breadcrumb"),i.each(t,function(i,e){var n=i>=t.length-1?"active":"";o+='<a href="'+e.url+'" class="'+n+'"><span>'+e.title+"</span></a>"}),this.ui.breadcrumb.html(o),void e.show()):!1},_setButtons:function(t){var e,o,n=t.contents().find(".suit-columns").length>0,s=this,a=i('<div class="cms-modal-item-buttons"></div>'),l=i('<div class="cms-modal-buttons-inner"></div>');e=t.contents().find(n?".save-box:eq(0)":".submit-row:eq(0)");var d=e.find("input, a, button");t.contents().find(".submit-row").hide(),d.length||(e=t.contents().find("body:not(.change-list) #content form:eq(0)"),d=e.find('input[type="submit"], button[type="submit"]'),d.addClass("deletelink").hide()),d.each(function(t,e){i(e).attr("data-rel","_"+t)}),d.each(function(t,e){if(e=i(e),"hidden"===e.attr("type"))return!1;var o=e.attr("value")||e.text(),n="cms-btn";e.hasClass("default")&&(n="cms-btn cms-btn-action"),e.hasClass("deletelink")&&(n="cms-btn cms-btn-caution");var d=i('<a href="#" class="'+n+" "+e.attr("class")+'">'+o+"</a>");d.on(s.click,function(){(e.is("input")||e.is("button"))&&e[0].click(),e.is("a")&&s._loadIframe({url:e.prop("href"),name:o}),(e.hasClass("default")||e.hasClass("deletelink"))&&(e.hasClass("deletelink")&&(s.options.onClose=null),s.ui.frame.find("iframe").hide(),s.saved=!0)}),d.wrap(a),l.append(d.parent())});var m=i('<a href="#" class="cms-btn">'+s.config.lang.cancel+"</a>");m.on(s.click,function(){s.options.onClose=!1,s.close()}),m.wrap(a),l.append(m.parent()),l.find(".cms-btn-group").unwrap(),o=l.find(".cms-btn-group").clone(!0,!0),l.find(".cms-btn-group").remove(),l.append(o.wrapAll(a.clone().addClass("cms-modal-item-buttons-left")).parent()),this.ui.modalButtons.html(l)},_prepareUrl:function(i){return i=i.replace("&","&amp;")},_loadIframe:function(t){var e=this;t.url=this._prepareUrl(t.url),t.title=t.title||"",t.breadcrumb=t.breadcrumb||"",this.ui.modal.removeClass("cms-modal-content"),this.ui.modal.addClass("cms-modal-iframe"),this._setBreadcrumb(t.breadcrumb);var o=i('<iframe src="'+t.url+'" class="" frameborder="0" />');o.css("visibility","hidden");var n=this.ui.frame,s=this.ui.titlePrefix,a=this.ui.titleSuffix;s.text(t.title||""),a.text(""),n.find("iframe").css("visibility","hidden"),e.ui.modalBody.addClass("cms-loader"),o.on("load",function(){try{o.contents()}catch(n){CMS.API.Toolbar.showError("<strong>"+n+"</strong>"),e.close()}var s=o.contents().find(".messagelist li");s.length&&CMS.API.Toolbar.openMessage(s.eq(0).text()),s.remove();var l=o.contents(),d=l.find("body");if(d.addClass("cms-admin cms-admin-modal"),s.length&&e.enforceReload&&e.reloadBrowser(),s.length&&e.enforceClose)return e.close(),!1;if(l.find(".viewsitelink").attr("target","_top"),e._setButtons(i(this)),(o.contents().find(".errornote").length||o.contents().find(".errorlist").length)&&(e.saved=!1),e.saved&&!l.find(".delete-confirmation").length)e.reloadBrowser(window.location.href,!1,!0);else{o.show();var m=o.contents().find("#content h1:eq(0)");if(void 0===t.title&&""===e.ui.titlePrefix.text()){var r=o.contents().find(".breadcrumbs").contents();e.ui.titlePrefix.text(r.eq(r.length-1).text().replace("›","").trim())}a.text(m.text()),m.remove(),o.css("visibility","visible"),o.data("ready",!0),d.on("keydown.cms",function(i){i.keyCode===CMS.KEYS.ESC&&e.close()}),l.find(".object-tools").length&&l.find("#content").css("padding-top",38)}}),n.html(o)},_changeIframe:function(i){if(i.hasClass("active"))return!1;var t=i.parent().find("a");t.removeClass("active"),i.addClass("active"),this._loadIframe({url:i.attr("href")}),this.ui.titlePrefix.text(i.text())},_loadMarkup:function(i){this.ui.modal.removeClass("cms-modal-iframe"),this.ui.modal.addClass("cms-modal-content"),this.ui.frame.html(i.html),this.ui.titlePrefix.text(i.title),this.ui.titleSuffix.text(i.subtitle||""),this.ui.modal.trigger("cms.modal.html.loaded")},_deletePlugin:function(i){var t=this,e=CMS._newPlugin,o='{ "csrfmiddlewaretoken": "'+this.config.csrf+'" }',n=this.config.lang.confirmEmpty.replace("{1}",CMS._newPlugin.breadcrumb[0].title);return CMS.API.Toolbar.openAjax(e["delete"],o,n,function(){CMS._newPlugin=!1,i&&i.hideAfter&&t._hide({duration:100})})}})})}(CMS.$);
