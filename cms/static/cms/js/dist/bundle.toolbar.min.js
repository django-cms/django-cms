...
!function(i){"use strict";i(function(){/*!
         ...
         */
CMS.Modal=new CMS.Class({implement:[CMS.API.Helpers],options:{onClose:!1,minHeight:400,minWidth:800,modalDuration:200,newPlugin:!1},initialize:function(t){this.options=i.extend(!0,{},this.options,t),this.config=CMS.config,this._setupUI(),this.click="click.cms",this.maximized=!1,this.minimized=!1,this.triggerMaximized=!1,this.saved=!1,this.ui.modal.data("ready")||this._events(),this.ui.modal.data("ready",!0)},_setupUI:function(){var t=i(".cms-modal");this.ui={modal:t,body:i("html"),window:i(window),toolbarLeftPart:i(".cms-toolbar-left"),minimizeButton:t.find(".cms-modal-minimize"),maximizeButton:t.find(".cms-modal-maximize"),title:t.find(".cms-modal-title"),titlePrefix:t.find(".cms-modal-title-prefix"),titleSuffix:t.find(".cms-modal-title-suffix"),resize:t.find(".cms-modal-resize"),breadcrumb:t.find(".cms-modal-breadcrumb"),closeAndCancel:t.find(".cms-modal-close, .cms-modal-cancel"),modalButtons:t.find(".cms-modal-buttons"),modalBody:t.find(".cms-modal-body"),frame:t.find(".cms-modal-frame"),shim:t.find(".cms-modal-shim")}},_events:function(){var t=this;this.ui.minimizeButton.on(this.click,function(i){i.preventDefault(),t._minimize()}),this.ui.title.on("pointerdown.cms contextmenu.cms",function(i){i.preventDefault(),t._startMove(i)}),this.ui.title.on("dblclick.cms",function(){t._maximize()}),this.ui.resize.on("pointerdown.cms contextmenu.cms",function(i){i.preventDefault(),t._startResize(i)}),this.ui.maximizeButton.on(this.click,function(i){i.preventDefault(),t._maximize()}),this.ui.breadcrumb.on(this.click,"a",function(e){e.preventDefault(),t._changeIframe(i(this))}),this.ui.closeAndCancel.on(this.click,function(i){t.options.onClose=null,i.preventDefault(),t.close()}),this.ui.body.on("pointerup.cms pointercancel.cms",function(i){t._endMove(i),t._endResize(i)})},open:function(i){if(!(i&&i.url||i&&i.html))throw new Error('The arguments passed to "open" were invalid.');if(i.breadcrumb=i.breadcrumb||"",i.html=i.html||"",i.title=i.title||"",i.subtitle=i.subtitle||"",i.url=i.url||"",CMS.API.locked)return CMS.API.locked=!1,!1;if(CMS.API.locked=!0,CMS._newPlugin&&this._deletePlugin()===!1)return!1;this.options.newPlugin&&(CMS._newPlugin=this.options.newPlugin),this.ui.body.hasClass("cms-modal-minimized")&&(this.minimized=!0,this._minimize()),this.ui.modalButtons.empty(),CMS.API.Toolbar._loader(!0),this.hideTooltip();var t=300,e=300,n=this.ui.window.width(),s=this.ui.window.height(),o=n>=this.options.minWidth+t?n-t:this.options.minWidth,a=s>=this.options.minHeight+e?s-e:this.options.minHeight;this.ui.maximizeButton.removeClass("cms-modal-maximize-active"),this.maximized=!1,a>=s&&(this.triggerMaximized=!0),i.url?this._loadIframe({url:i.url,title:i.title,breadcrumb:i.breadcrumb}):this._loadMarkup({html:i.html,title:i.title,subtitle:i.subtitle}),this._show({width:o,height:a,duration:this.options.modalDuration})},close:function(){var i=this;CMS._newPlugin?this._deletePlugin({hideAfter:!0}):this._hide(100),this.options.onClose&&this.reloadBrowser(this.options.onClose,!1,!0),setTimeout(function(){i.minimized&&i._minimize(),i.maximized&&i._maximize()},300)},_show:function(i){var t=this,e=i.width,n=i.height,s=i.duration;this.ui.modal.css({display:"block",width:e,height:n,"margin-left":-(e/2),"margin-top":-(n/2)}),setTimeout(function(){t.ui.modal.addClass("cms-modal-open")},0),this.ui.modal.one("cmsTransitionEnd",function(){t.ui.modal.css({"margin-left":-(e/2),"margin-top":-(n/2)}),CMS.API.Toolbar._loader(!1),t.triggerMaximized&&t._maximize(),CMS.API.locked=!1}).emulateTransitionEnd(s),this.ui.body.on("keydown.cms",function(i){i.keyCode===CMS.KEYS.ESC&&t.close()}),this.ui.modal.focus()},_hide:function(i){var t=this;t.ui.modal.removeClass("cms-modal-open"),t.ui.modal.one("cmsTransitionEnd",function(){t.ui.modal.css("display","none")}).emulateTransitionEnd(i),t.ui.frame.find("iframe").remove(),t.ui.modalBody.removeClass("cms-loader")},_minimize:function(){return this.maximized?!1:void(this.minimized===!1?(CMS.API.Toolbar.toggleToolbar(!0),this.ui.modal.data("css",this.ui.modal.css(["left","top","margin-left","margin-top"])),this.ui.body.addClass("cms-modal-minimized"),this.ui.modal.css({left:this.ui.toolbarLeftPart.outerWidth(!0)+50}),this.minimized=!0):(this.ui.body.removeClass("cms-modal-minimized"),this.ui.modal.css(this.ui.modal.data("css")),this.minimized=!1))},_maximize:function(){var i=this.ui.modal;return this.minimized?!1:void(this.maximized===!1?(this.maximized=!0,i.data("css",this.ui.modal.css(["left","top","margin-left","margin-top","width","height"])),this.ui.body.addClass("cms-modal-maximized")):(this.maximized=!1,this.ui.body.removeClass("cms-modal-maximized"),i.css(i.data("css"))))},_startMove:function(i){if(this.maximized)return!1;if(this.minimized)return!1;var t=this,e=t.ui.modal.position();this.ui.shim.show(),this.ui.body.attr("data-touch-action","none").on("pointermove.cms",function(n){var s=e.left-(i.originalEvent.pageX-n.originalEvent.pageX),o=e.top-(i.originalEvent.pageY-n.originalEvent.pageY);t.ui.modal.css({left:s,top:o})})},_endMove:function(){this.ui.shim.hide(),this.ui.body.off("pointermove.cms").removeAttr("data-touch-action")},_startResize:function(i){if(this.maximized)return!1;var t=this.ui.modal,e=t.width(),n=t.height(),s=this.ui.modal.position().left,o=this.ui.modal.position().top;this.ui.shim.show(),this.ui.body.attr("data-touch-action","none").on("pointermove.cms",function(a){var l=i.originalEvent.pageX-a.originalEvent.pageX,m=i.originalEvent.pageY-a.originalEvent.pageY,d=e-2*l,r=n-2*m,c=680,u=150;return c>=d||u>=r?!1:void t.css({width:e-2*l,height:n-2*m,left:s+l,top:o+m})})},_endResize:function(){this.ui.shim.hide(),this.ui.body.off("pointermove.cms").removeAttr("data-touch-action")},_setBreadcrumb:function(t){var e=this.ui.breadcrumb,n="";return this.ui.breadcrumb.find("a").length||this.ui.modal.removeClass("cms-modal-has-breadcrumb"),!t||t.length<=1?!1:t[0].title?(this.ui.modal.addClass("cms-modal-has-breadcrumb"),i.each(t,function(i,e){var s=i>=t.length-1?"active":"";n+='<a href="'+e.url+'" class="'+s+'"><span>'+e.title+"</span></a>"}),this.ui.breadcrumb.html(n),void e.show()):!1},_setButtons:function(t){var e,n,s=t.contents().find(".suit-columns").length>0,o=this,a=i('<div class="cms-modal-item-buttons"></div>'),l=i('<div class="cms-modal-buttons-inner"></div>');e=t.contents().find(s?".save-box:eq(0)":".submit-row:eq(0)");var m=e.find("input, a, button");t.contents().find(".submit-row").hide(),m.length||(e=t.contents().find("body:not(.change-list) #content form:eq(0)"),m=e.find('input[type="submit"], button[type="submit"]'),m.addClass("deletelink").hide()),m.each(function(t,e){i(e).attr("data-rel","_"+t)}),m.each(function(t,e){if(e=i(e),"hidden"===e.attr("type"))return!1;var n=e.attr("value")||e.text(),s="cms-btn";e.hasClass("default")&&(s="cms-btn cms-btn-action"),e.hasClass("deletelink")&&(s="cms-btn cms-btn-caution");var m=i('<a href="#" class="'+s+" "+e.attr("class")+'">'+n+"</a>");m.on(o.click,function(){(e.is("input")||e.is("button"))&&e[0].click(),e.is("a")&&o._loadIframe({url:e.prop("href"),name:n}),(e.hasClass("default")||e.hasClass("deletelink"))&&(e.hasClass("deletelink")&&(o.options.onClose=null),o.ui.frame.find("iframe").hide(),o.saved=!0)}),m.wrap(a),l.append(m.parent())});var d=i('<a href="#" class="cms-btn">'+o.config.lang.cancel+"</a>");d.on(o.click,function(){o.options.onClose=!1,o.close()}),d.wrap(a),l.append(d.parent()),l.find(".cms-btn-group").unwrap(),n=l.find(".cms-btn-group").clone(!0,!0),l.find(".cms-btn-group").remove(),l.append(n.wrapAll(a.clone().addClass("cms-modal-item-buttons-left")).parent()),this.ui.modalButtons.html(l)},_prepareUrl:function(i){return i=i.replace("&","&amp;")},_loadIframe:function(t){var e=this;t.url=this._prepareUrl(t.url),t.title=t.title||"",t.breadcrumb=t.breadcrumb||"",this.ui.modal.removeClass("cms-modal-content"),this.ui.modal.addClass("cms-modal-iframe"),this._setBreadcrumb(t.breadcrumb);var n=i('<iframe src="'+t.url+'" class="" frameborder="0" />');n.css("visibility","hidden");var s=this.ui.frame,o=this.ui.titlePrefix,a=this.ui.titleSuffix;o.text(t.title||""),a.text(""),s.find("iframe").css("visibility","hidden"),e.ui.modalBody.addClass("cms-loader"),n.on("load",function(){try{n.contents()}catch(s){CMS.API.Toolbar.showError("<strong>"+s+"</strong>"),e.close()}var o=n.contents().find(".messagelist li");o.length&&CMS.API.Toolbar.openMessage(o.eq(0).text()),o.remove();var l=n.contents(),m=l.find("body");if(m.addClass("cms-admin cms-admin-modal"),o.length&&e.enforceReload&&e.reloadBrowser(),o.length&&e.enforceClose)return e.close(),!1;if(l.find(".viewsitelink").attr("target","_top"),e._setButtons(i(this)),(n.contents().find(".errornote").length||n.contents().find(".errorlist").length)&&(e.saved=!1),e.saved&&!l.find(".delete-confirmation").length)e.reloadBrowser(window.location.href,!1,!0);else{n.show();var d=n.contents().find("#content h1:eq(0)");if(void 0===t.title&&""===e.ui.titlePrefix.text()){var r=n.contents().find(".breadcrumbs").contents();e.ui.titlePrefix.text(r.eq(r.length-1).text().replace("›","").trim())}a.text(d.text()),d.remove(),n.css("visibility","visible"),n.data("ready",!0),m.on("keydown.cms",function(i){i.keyCode===CMS.KEYS.ESC&&e.close()}),l.find(".object-tools").length&&l.find("#content").css("padding-top",38)}}),s.html(n)},_changeIframe:function(i){if(i.hasClass("active"))return!1;var t=i.parent().find("a");t.removeClass("active"),i.addClass("active"),this._loadIframe({url:i.attr("href")}),this.ui.titlePrefix.text(i.text())},_loadMarkup:function(i){this.ui.modal.removeClass("cms-modal-iframe"),this.ui.modal.addClass("cms-modal-content"),this.ui.frame.html(i.html),this.ui.titlePrefix.text(i.title),this.ui.titleSuffix.text(i.subtitle),this.ui.modal.trigger("cms.modal.html.loaded")},_deletePlugin:function(i){var t=this,e=CMS._newPlugin,n='{ "csrfmiddlewaretoken": "'+this.config.csrf+'" }',s=this.config.lang.confirmEmpty.replace("{1}",CMS._newPlugin.breadcrumb[0].title);return CMS.API.Toolbar.openAjax(e["delete"],n,s,function(){CMS._newPlugin=!1,i&&i.hideAfter&&t._hide(100)})}})})}(CMS.$);
