...
!function(e){"use strict";e(function(){var s=e(document);s.on("pointerup.cms",function(){CMS.Plugin._hideSubnav()}).on("keydown.cms",function(e){e.keyCode===CMS.KEYS.SHIFT&&s.data("expandmode",!0)}).on("keyup.cms",function(e){e.keyCode===CMS.KEYS.SHIFT&&s.data("expandmode",!1)}),/*!
         ...
         */
CMS.Plugin=new CMS.Class({implement:[CMS.API.Helpers],options:{type:"",placeholder_id:null,plugin_type:"",plugin_id:null,plugin_language:"",plugin_parent:null,plugin_order:null,plugin_breadcrumb:[],plugin_restriction:[],urls:{add_plugin:"",edit_plugin:"",move_plugin:"",copy_plugin:"",delete_plugin:""}},initialize:function(s,i){switch(this.options=e.extend(!0,{},this.options,i),this._setupUI(s),this.csrf=CMS.config.csrf,this.timer=function(){},this.timeout=250,this.click="pointerup.cms",this.ui.container.data("settings",this.options),this.options.type){case"placeholder":this._setPlaceholder(),this._collapsables();break;case"plugin":this._setPlugin(),this._collapsables();break;default:this._setGeneric()}},_setupUI:function(s){s=e("."+s),this.ui={container:s,publish:e(".cms-btn-publish"),window:e(window),revert:e(".cms-toolbar-revert"),dragbar:null,draggable:null,submenu:null,dropdown:null}},_setPlaceholder:function(){var s=this;this.ui.dragbar=e(".cms-dragbar-"+this.options.placeholder_id),this.ui.submenu=this.ui.dragbar.find(".cms-submenu-settings");var i=this.ui.dragbar.find(".cms-dragbar-title"),n=this.ui.dragbar.find(".cms-dragbar-toggler a"),t="cms-dragbar-title-expanded";this._setSettingsMenu(this.ui.submenu),this._setAddPluginMenu(this.ui.dragbar.find(".cms-submenu-add")),CMS.settings.dragbars=CMS.settings.dragbars||[],n.on("click",function(e){e.preventDefault(),i.hasClass(t)?s._collapseAll(i):s._expandAll(i)}),-1!==e.inArray(this.options.placeholder_id,CMS.settings.dragbars)&&i.addClass(t)},_setPlugin:function(){var s=this;this.ui.container.on("dblclick",function(e){e.preventDefault(),e.stopPropagation(),s.editPlugin(s.options.urls.edit_plugin,s.options.plugin_name,s.options.plugin_breadcrumb)}),this.ui.container.on("pointerover.cms pointerout.cms",function(e){e.stopPropagation();var i=s.options.plugin_name,n=s.options.plugin_id;"pointerover"===e.type?s.showTooltip(i,n):s.hideTooltip()}),this.ui.container.on("cms.plugins.update",function(e){e.stopPropagation(),s.movePlugin()}),this.ui.container.on("cms.plugin.update",function(i){i.stopPropagation();var n=e(i.delegateTarget),t=e(".cms-draggable-"+n.data("settings").plugin_id),a=s._getId(t.parents(".cms-draggables").last().prevAll(".cms-dragbar").first());if(!a)return!1;var o=n.data("settings");o.target=a,o.parent=s._getId(t.parent().closest(".cms-draggable")),s.copyPlugin(o)}),this.ui.draggable=e(".cms-draggable-"+this.options.plugin_id),this.ui.dragitem=this.ui.draggable.find("> .cms-dragitem"),this.ui.submenu=this.ui.dragitem.find(".cms-submenu"),this._setSettingsMenu(this.ui.submenu),this._setAddPluginMenu(this.ui.dragitem.find(".cms-submenu-add")),this.ui.dragitem.on("dblclick",function(e){e.preventDefault(),e.stopPropagation(),s.editPlugin(s.options.urls.edit_plugin,s.options.plugin_name,s.options.plugin_breadcrumb)})},_setGeneric:function(){var e=this;this.ui.container.on("dblclick",function(s){s.preventDefault(),s.stopPropagation(),e.editPlugin(e.options.urls.edit_plugin,e.options.plugin_name,[])}),this.ui.container.on("pointerover.cms pointerout.cms",function(s){s.stopPropagation();var i=e.options.plugin_name,n=e.options.plugin_id;"pointerover"===s.type?e.showTooltip(i,n):e.hideTooltip()})},addPlugin:function(s,i,n){if(CMS.API.locked)return!1;CMS.API.locked=!0;var t=this,a={placeholder_id:this.options.placeholder_id,plugin_type:s,plugin_parent:n||"",plugin_language:this.options.plugin_language,csrfmiddlewaretoken:this.csrf};e.ajax({type:"POST",url:this.options.urls.add_plugin,data:a,success:function(e){CMS.API.locked=!1,t.newPlugin=e,t.editPlugin(e.url,i,e.breadcrumb)},error:function(e){CMS.API.locked=!1;var s=CMS.config.lang.error;t._showError(s+e.responseText||e.status+" "+e.statusText)}})},editPlugin:function(e,s,i){var n=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});n.open(e,s,i)},copyPlugin:function(s,i){if(CMS.API.locked)return!1;CMS.API.locked=!0;var n=this,t=s||i?!0:!1;s=s||this.options,i?(s.target=s.placeholder_id,s.plugin_id="",s.parent=""):i=s.plugin_language;var a={source_placeholder_id:s.placeholder_id,source_plugin_id:s.plugin_id||"",source_language:i,target_plugin_id:s.parent||"",target_placeholder_id:s.target||CMS.config.clipboard.id,target_language:s.page_language||i,csrfmiddlewaretoken:this.csrf},o={type:"POST",url:s.urls.copy_plugin,data:a,success:function(){CMS.API.Toolbar.openMessage(CMS.config.lang.success),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var s=CMS.config.lang.error;n._showError(s+e.responseText||e.status+" "+e.statusText)}};t?e.ajax(o):CMS.API.Clipboard.clear(function(){e.ajax(o)})},cutPlugin:function(){if(CMS.API.locked)return!1;CMS.API.locked=!0;var s=this,i={placeholder_id:CMS.config.clipboard.id,plugin_id:this.options.plugin_id,plugin_parent:"",plugin_language:this.options.page_language,plugin_order:[this.options.plugin_id],csrfmiddlewaretoken:this.csrf};CMS.API.Clipboard.clear(function(){return CMS.API.locked?!1:(CMS.API.locked=!0,void e.ajax({type:"POST",url:s.options.urls.move_plugin,data:i,success:function(){CMS.API.Toolbar.openMessage(CMS.config.lang.success),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var i=CMS.config.lang.error;s._showError(i+e.responseText||e.status+" "+e.statusText)}}))})},movePlugin:function(s){if(CMS.API.locked)return!1;CMS.API.locked=!0;var i=this;s=s||this.options;var n=e(".cms-plugin-"+s.plugin_id),t=e(".cms-draggable-"+s.plugin_id);this._setPosition(s.plugin_id,n,t);var a=this._getId(t.parents(".cms-draggables").last().prevAll(".cms-dragbar").first()),o=this._getId(t.parent().closest(".cms-draggable")),r=this._getIds(t.siblings(".cms-draggable").andSelf());if(a===!1)return!1;var l={placeholder_id:a,plugin_id:s.plugin_id,plugin_parent:o||"",plugin_language:s.page_language,plugin_order:r,csrfmiddlewaretoken:this.csrf};e.ajax({type:"POST",url:s.urls.move_plugin,data:l,success:function(e){e.reload&&CMS.API.Helpers.reloadBrowser(),CMS.API.locked=!1,i._showSuccess(t)},error:function(e){CMS.API.locked=!1;var s=CMS.config.lang.error;i._showError(s+e.responseText||e.status+" "+e.statusText)}}),this.ui.publish.addClass("cms-btn-publish-active").removeClass("cms-btn-disabled").parent().show(),this.ui.revert.removeClass("cms-toolbar-item-navigation-disabled")},deletePlugin:function(e,s,i){var n=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});n.open(e,s,i)},_setPosition:function(s,i,n){var t=n.prev(".cms-draggable"),a=n.next(".cms-draggable"),o=n.parent().closest(".cms-draggable"),r=e(".cms-plugin-"+this._getId(o)),l=n.closest(".cms-dragarea");if(t.length)i.insertAfter(e(".cms-plugin-"+this._getId(t)));else if(a.length)i.insertBefore(e(".cms-plugin-"+this._getId(a)));else if(o.length){for(;r.children().length;)r=r.children();r.append(i)}else l.length?i.insertAfter(e(".cms-placeholder-"+this._getId(l))):CMS.API.Helpers.reloadBrowser()},editPluginPostAjax:function(e,s,i){return"undefined"==typeof s||"undefined"==typeof i?function(s,i){var n=e;n.editPlugin(i.url,n.options.plugin_name,i.breadcrumb)}:void this.editPlugin(i.url,this.options.plugin_name,i.breadcrumb)},_setSettingsMenu:function(s){var i=this;this.ui.dropdown=s.siblings(".cms-submenu-dropdown-settings");var n=this.ui.dropdown;s.on(this.click,function(s){s.preventDefault(),s.stopPropagation();var n=e(this);n.hasClass("cms-btn-active")?CMS.Plugin._hideSubnav(n):(CMS.Plugin._hideSubnav(),i._showSubnav(n))}),n.on("mousedown mousemove mouseup",function(e){e.stopPropagation()}).on("touchstart",function(e){e.stopPropagation()}),i._setupActions(s),s.on(this.click+" pointerup.cms pointerdown.cms click.cms dblclick.cms",function(e){e.stopPropagation()}),s.siblings(".cms-submenu-quicksearch, .cms-submenu-dropdown-settings").on(this.click+" click.cms dblclick.cms",function(e){e.stopPropagation()})},_setAddPluginMenu:function(s){var i=this,n=s.siblings(".cms-submenu-dropdown-children");s.on(this.click,function(t){t.preventDefault(),t.stopPropagation();var a=e(this);a.hasClass("cms-btn-active")?CMS.Plugin._hideSubnav(a,n):(CMS.Plugin._hideSubnav(),i._showSubnav(a,n),s.siblings(".cms-submenu-quicksearch").show(),i._setupDropdownKeyboardTraversing(s))}),s.on(this.click+" pointerup.cms pointerdown.cms click.cms dblclick.cms",function(e){e.stopPropagation()}),s.siblings(".cms-submenu-quicksearch, .cms-submenu-dropdown").on(this.click+" click.cms dblclick.cms",function(e){e.stopPropagation()}),i._setupQuickSearch(s)},_setupQuickSearch:function(s){var i=this;s.siblings(".cms-submenu-quicksearch").find("input").on("keyup.cms",function(n){clearTimeout(i.timer),i.timer=setTimeout(function(){i._searchSubnav(s,e(n.currentTarget).val())},100)})},_setupActions:function(s){var i=this;s.parent().find("a").on("click.cms",function(n){n.preventDefault(),n.stopPropagation(),CMS.API.Toolbar._loader(!0);var t=e(this);switch(CMS.Plugin._hideSubnav(s),t.attr("data-rel")){case"add":i.addPlugin(t.attr("href").replace("#",""),t.text(),i._getId(t.closest(".cms-draggable")));break;case"ajax_add":CMS.API.Toolbar.openAjax(t.attr("href"),JSON.stringify(t.data("post")),t.data("text"),i.editPluginPostAjax(i),t.data("on-success"));break;case"edit":i.editPlugin(i.options.urls.edit_plugin,i.options.plugin_name,i.options.plugin_breadcrumb);break;case"copy-lang":i.copyPlugin(this.options,t.attr("data-language"));break;case"copy":i.copyPlugin();break;case"cut":i.cutPlugin();break;case"delete":i.deletePlugin(i.options.urls.delete_plugin,i.options.plugin_name,i.options.plugin_breadcrumb);break;default:CMS.API.Toolbar._loader(!1),CMS.API.Toolbar._delegate(t)}})},_setupDropdownKeyboardTraversing:function(i){var n=e(".cms-submenu-dropdown-children:visible");s.off("keydown.cms.traverse"),s.on("keydown.cms.traverse",function(e){var s=n.find(".cms-submenu-item:visible a"),t=s.index(s.filter(":focus"));(e.keyCode===CMS.KEYS.DOWN||e.keyCode===CMS.KEYS.TAB)&&(e.preventDefault(),t>=0&&t<s.length-1?s.eq(t+1).focus():s.eq(0).focus()),(e.keyCode===CMS.KEYS.UP||e.keyCode===CMS.KEYS.TAB&&e.shiftKey)&&(e.preventDefault(),s.is(":focus")?s.eq(t-1).focus():s.eq(s.length).focus()),(e.keyCode===CMS.KEYS.ENTER||e.keyCode===CMS.KEYS.ESC)&&(i.siblings(".cms-submenu-quicksearch").find("input").blur(),CMS.Plugin._hideSubnav(i))})},_showSubnav:function(s,i){i=i||this.ui.dropdown,s.addClass("cms-btn-active");var n=e(".cms-submenu").parentsUntil(".cms-dragarea").last(),t=i.find(".cms-submenu-scroll-hint");n.addClass("cms-z-index-0");var a=s.parentsUntil(".cms-dragarea").last();a.addClass("cms-z-index-999"),i.show().on("scroll.cms",function(){t.fadeOut(100),i.off("scroll.cms")}),i[0].scrollHeight>i.height()&&t.show(),this.ui.window.height()+this.ui.window.scrollTop()-s.offset().top-i.height()<=10&&s.offset().top-i.height()>=0?i.removeClass("cms-submenu-dropdown-top").addClass("cms-submenu-dropdown-bottom"):i.removeClass("cms-submenu-dropdown-bottom").addClass("cms-submenu-dropdown-top")},_searchSubnav:function(s,i){var n=s.siblings(".cms-submenu-dropdown-children").find(".cms-submenu-item"),t=s.siblings(".cms-submenu-dropdown-children").find(".cms-submenu-item-title");return""===i?(n.add(t).show(),!1):(n.find("a, span").each(function(s,n){n=e(n);var t=n.text().toLowerCase(),a=i.toLowerCase();t.indexOf(a)>=0?n.parent().show():n.parent().hide()}),t.filter(":visible").each(function(s,i){t.hide(),e(i).nextUntil(".cms-submenu-item-title").show()}),n.filter(":visible").each(function(s,i){i=e(i),i.prev().hasClass("cms-submenu-item-title")?i.prev().show():i.prevUntil(".cms-submenu-item-title").last().prev().show()}),s.siblings(".cms-submenu-dropdown-children").show(),n.add(t).filter(":visible").length<=0&&s.siblings(".cms-submenu-dropdown-children").hide(),void s.siblings(".cms-submenu-dropdown").find(".cms-submenu-scroll-hint").hide())},_toggleCollapsable:function(i){var n,t=this,a=t._getId(i.parent()),o=this.ui.draggable,r=CMS.settings;if(r.states=r.states||[],i.hasClass("cms-dragitem-expanded")){if(r.states.splice(e.inArray(a,r.states),1),i.removeClass("cms-dragitem-expanded").parent().find("> .cms-draggables").addClass("cms-hidden"),s.data("expandmode")){if(n=o.find(".cms-draggable").find(".cms-dragitem-collapsable"),!n.length)return!1;n.each(function(){var s=e(this);s.hasClass("cms-dragitem-expanded")&&t._toggleCollapsable(s)})}}else if(r.states.push(a),i.addClass("cms-dragitem-expanded").parent().find("> .cms-draggables").removeClass("cms-hidden"),s.data("expandmode")){if(n=o.find(".cms-draggable").find(".cms-dragitem-collapsable"),!n.length)return!1;n.each(function(){var s=e(this);s.hasClass("cms-dragitem-expanded")||t._toggleCollapsable(s)})}this.ui.window.trigger("resize.sideframe"),CMS.API.Toolbar.setSettings(r)},_collapsables:function(){var s=this;if(this.ui.draggable=e(".cms-draggable-"+this.options.plugin_id),this.ui.container.each(function(s,i){var n=e(i).find(".cms-dragitem-collapsable"),t=n.filter(".cms-dragitem-expanded");n.length===t.length&&n.length+t.length!==0&&e(i).find(".cms-dragbar-title").addClass("cms-dragbar-title-expanded")}),!this.ui.draggable.length)return!1;if(this.ui.draggable.find("> .cms-dragitem").on("click.cms.plugin",function(){var i=e(this);i.hasClass("cms-dragitem-collapsable")&&s._toggleCollapsable(i)}),this.ui.draggable.on("dblclick",function(i){i.stopPropagation(),e(".cms-plugin-"+s._getId(e(this))).trigger("dblclick")}),CMS.Toolbar.ready)return!1;for(var i=CMS.settings.states.sort(),n=[],t=0;t<i.length;t++)i[t]!==i[t+1]&&n.push(i[t]);CMS.settings.states=n,e.each(CMS.settings.states,function(s,i){var n=e(".cms-draggable-"+i);n.find(".cms-draggables").length&&(n.find("> .cms-draggables").removeClass("cms-hidden"),n.find("> .cms-dragitem").addClass("cms-dragitem-expanded"))}),CMS.Toolbar.ready=!0},_expandAll:function(s){var i=this,n=s.closest(".cms-dragarea").find(".cms-dragitem-collapsable");if(!n.length)return!1;n.each(function(){var s=e(this);s.hasClass("cms-dragitem-expanded")||i._toggleCollapsable(s)}),s.addClass("cms-dragbar-title-expanded");var t=CMS.settings;t.dragbars=t.dragbars||[],t.dragbars.push(this.options.placeholder_id),CMS.API.Toolbar.setSettings(t)},_collapseAll:function(s){var i=this,n=s.closest(".cms-dragarea").find(".cms-dragitem-collapsable");n.each(function(){var s=e(this);s.hasClass("cms-dragitem-expanded")&&i._toggleCollapsable(s)}),s.removeClass("cms-dragbar-title-expanded");var t=CMS.settings;t.dragbars=t.dragbars||[],t.dragbars.splice(e.inArray(this.options.placeholder_id,t.states),1),CMS.API.Toolbar.setSettings(t)},_getId:function(e){return CMS.API.StructureBoard.getId(e)},_getIds:function(e){return CMS.API.StructureBoard.getIds(e)},_showError:function(e){return CMS.API.Toolbar.showError(e,!0)},_showSuccess:function(s){var i=e('<div class="cms-dragitem-success"></div>');s.addClass("cms-draggable-success").append(i),i.fadeOut(1e3,function(){e(this).remove(),s.removeClass("cms-draggable-success")}),this.ui.window.trigger("resize.sideframe")}}),CMS.Plugin._hideSubnav=function(s){s=s||e(".cms-submenu-btn.cms-btn-active"),s.length&&(s.removeClass("cms-btn-active"),s.closest(".cms-draggable").data("active",!1),e(".cms-z-index-0").removeClass("cms-z-index-0"),e(".cms-z-index-999").removeClass("cms-z-index-999"),s.siblings(".cms-submenu-dropdown").hide(),s.siblings(".cms-submenu-quicksearch").hide(),s.siblings(".cms-submenu-quicksearch").find("input").val("").trigger("keyup.cms").blur(),e(".cms-dragbar").css("position",""))}})}(CMS.$);
