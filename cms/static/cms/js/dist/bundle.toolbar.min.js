...
!function(i){"use strict";i(function(){/*!
         ...
         */
CMS.Modal=new CMS.Class({implement:[CMS.API.Helpers],options:{onClose:!1,minHeight:400,minWidth:800,modalDuration:200,newPlugin:!1},initialize:function(t){this.options=i.extend(!0,{},this.options,t),this.config=CMS.config,this._setupUI(),this.click="click.cms",this.maximized=!1,this.minimized=!1,this.triggerMaximized=!1,this.saved=!1,this.ui.modal.data("ready")||this._events(),this.ui.modal.data("ready",!0)},_setupUI:function(){this.ui={},this.ui.modal=i(".cms-modal"),this.ui.body=i("html"),this.ui.window=i(window),this.ui.toolbarLeftPart=i(".cms-toolbar-left"),this.ui.minimizeButton=this.ui.modal.find(".cms-modal-minimize"),this.ui.maximizeButton=this.ui.modal.find(".cms-modal-maximize"),this.ui.title=this.ui.modal.find(".cms-modal-title"),this.ui.resize=this.ui.modal.find(".cms-modal-resize"),this.ui.breadcrumb=this.ui.modal.find(".cms-modal-breadcrumb"),this.ui.breadcrumbItems=this.ui.modal.find(".cms-modal-breadcrumb-items"),this.ui.closeAndCancel=this.ui.modal.find(".cms-modal-close, .cms-modal-cancel"),this.ui.modalButtons=this.ui.modal.find(".cms-modal-buttons"),this.ui.modalBody=this.ui.modal.find(".cms-modal-body"),this.ui.iframeHolder=this.ui.modal.find(".cms-modal-frame"),this.ui.shim=this.ui.modal.find(".cms-modal-shim")},_events:function(){var t=this;this.ui.minimizeButton.on(this.click,function(i){i.preventDefault(),t._minimize()}),this.ui.title.on("pointerdown.cms",function(i){i.preventDefault(),t._startMove(i)}),this.ui.title.on("dblclick.cms",function(){t._maximize()}),this.ui.resize.on("pointerdown.cms",function(i){i.preventDefault(),t._startResize(i)}),this.ui.maximizeButton.on(this.click,function(i){i.preventDefault(),t._maximize()}),this.ui.breadcrumbItems.on(this.click,"a",function(e){e.preventDefault(),t._changeContent(i(this))}),this.ui.closeAndCancel.on(this.click,function(i){t.options.onClose=null,i.preventDefault(),t.close()}),this.ui.body.on("pointerup.cms pointercancel.cms",function(i){t._endMove(i),t._endResize(i)})},open:function(i,t,e){if(CMS.API.locked)return CMS.API.locked=!1,!1;CMS.API.locked=!0,this.ui.body.hasClass("cms-modal-minimized")&&(this.minimized=!0,this._minimize()),CMS.API.Toolbar._loader(!0),this.hideTooltip(),this._loadContent(i,t);var o=300,s=350,n=this.ui.window.width(),a=this.ui.window.height(),d=n>=this.options.minWidth+o?n-o:this.options.minWidth,m=a>=this.options.minHeight+s?a-s:this.options.minHeight;this.ui.maximizeButton.removeClass("cms-modal-maximize-active"),this.maximized=!1,m>=a&&(this.triggerMaximized=!0),this._setBreadcrumb(e),this._show({width:d,height:m,duration:this.options.modalDuration})},close:function(){var i=this;if(this.options.newPlugin){var t=this.options.newPlugin,e='{ "csrfmiddlewaretoken": "'+this.config.csrf+'" }',o=this.config.lang.confirm;CMS.API.Toolbar.openAjax(t["delete"],e,o,function(){i._hide(100)})}else this._hide(100);this.options.onClose&&this.reloadBrowser(this.options.onClose,!1,!0),setTimeout(function(){i.minimized&&i._minimize(),i.maximized&&i._maximize()},300)},_show:function(i){var t=this,e=i.width,o=i.height,s=i.duration;this.ui.modal.css({display:"block",width:e,height:o,"margin-left":-(e/2),"margin-top":-(o/2)}),setTimeout(function(){t.ui.modal.addClass("cms-modal-open")},0),this.ui.modal.one("cmsTransitionEnd",function(){t.ui.modal.css({"margin-left":-(e/2),"margin-top":-(o/2)}),CMS.API.Toolbar._loader(!1),t.triggerMaximized&&t._maximize(),CMS.API.locked=!1}).emulateTransitionEnd(s),this.ui.body.on("keydown.cms",function(i){27===i.keyCode&&t.close()}),this.ui.modal.focus()},_hide:function(i){var t=this;t.ui.modal.removeClass("cms-modal-open"),t.ui.modal.one("cmsTransitionEnd",function(){t.ui.modal.css("display","none")}).emulateTransitionEnd(i),t.ui.iframeHolder.find("iframe").remove(),t.ui.modalBody.removeClass("cms-loader")},_minimize:function(){return this.maximized?!1:void(this.minimized===!1?(CMS.API.Toolbar.toggleToolbar(!0),this.ui.modal.data("css",this.ui.modal.css(["left","top","margin-left","margin-top"])),this.ui.body.addClass("cms-modal-minimized"),this.ui.modal.css({left:this.ui.toolbarLeftPart.outerWidth(!0)+50}),this.minimized=!0):(this.ui.body.removeClass("cms-modal-minimized"),this.ui.modal.css(this.ui.modal.data("css")),this.minimized=!1))},_maximize:function(){var i=this.ui.modal;return this.minimized?!1:void(this.maximized===!1?(this.maximized=!0,i.data("css",this.ui.modal.css(["left","top","margin-left","margin-top","width","height"])),this.ui.body.addClass("cms-modal-maximized")):(this.maximized=!1,this.ui.body.removeClass("cms-modal-maximized"),i.css(i.data("css"))))},_startMove:function(i){if(this.maximized)return!1;if(this.minimized)return!1;var t=this,e=t.ui.modal.position();this.ui.shim.show(),this.ui.body.attr("touch-action","none").on("pointermove.cms",function(o){var s=e.left-(i.originalEvent.pageX-o.originalEvent.pageX),n=e.top-(i.originalEvent.pageY-o.originalEvent.pageY);t.ui.modal.css({left:s,top:n})})},_endMove:function(){this.ui.shim.hide(),this.ui.body.off("pointermove.cms").removeAttr("touch-action")},_startResize:function(i){if(this.maximized)return!1;var t=this.ui.modal,e=t.width(),o=t.height(),s=this.ui.modal.position().left,n=this.ui.modal.position().top;this.ui.shim.show(),this.ui.body.attr("touch-action","none").on("pointermove.cms",function(a){var d=i.originalEvent.pageX-a.originalEvent.pageX,m=i.originalEvent.pageY-a.originalEvent.pageY,l=e-2*d,r=o-2*m,h=680,c=100;return h>=l||c>=r?!1:void t.css({width:e-2*d,height:o-2*m,left:s+d,top:n+m})})},_endResize:function(){this.ui.shim.hide(),this.ui.body.off("pointermove.cms").removeAttr("touch-action")},_setBreadcrumb:function(t){var e=this.ui.breadcrumb,o="";return!t||t.length<=0?!1:t[0].title?(i.each(t,function(i,e){var s=i>=t.length-1?"cms-modal-breadcrumb-last":"";o+='<a href="'+e.url+'" class="'+s+'"><span>'+e.title+"</span></a>"}),this.ui.breadcrumbItems.html(o),void e.show()):!1},_setButtons:function(t){var e,o=t.contents().find(".suit-columns").length>0,s=this;e=t.contents().find(o?".save-box:eq(0)":".submit-row:eq(0)"),t.contents().find(".submit-row").hide();var n=e.find("input, a, button"),a=i("<span />");n.length||(e=t.contents().find("body:not(.change-list) #content form:eq(0)"),n=e.find('input[type="submit"], button[type="submit"]'),n.addClass("deletelink").hide()),n.each(function(t,e){i(e).attr("data-rel","_"+t)}),n.each(function(t,e){if(e=i(e),"hidden"===e.attr("type"))return!1;var o=e.attr("value")||e.text(),n="cms-btn";e.hasClass("default")&&(n="cms-btn cms-btn-action"),e.hasClass("deletelink")&&(n="cms-btn cms-btn-caution");var d=i('<div class="'+n+" "+e.attr("class")+'">'+o+"</div>");d.on(s.click,function(){(e.is("input")||e.is("button"))&&e[0].click(),e.is("a")&&s._loadContent(e.prop("href"),o),(e.hasClass("default")||e.hasClass("deletelink"))&&(s.options.newPlugin=null,e.hasClass("deletelink")&&(s.options.onClose=null),s.ui.iframeHolder.find("iframe").hide(),s.saved=!0)}),a.append(d)});var d=i('<div class="cms-btn">'+s.config.lang.cancel+"</div>");d.on(s.click,function(){s.options.onClose=!1,s.close()}),a.append(d),this.ui.modalButtons.html(a)},_prepareUrl:function(i){return i+=-1===i.indexOf("?")?"?modal=1":"&modal=1",i=i.replace("&","&amp;")},_loadContent:function(t,e){var o=this;t=this._prepareUrl(t);var s=i('<iframe src="'+t+'" class="" frameborder="0" />');s.css("visibility","hidden");var n=this.ui.iframeHolder,a=this.ui.title;a.html(e||"&nbsp;"),n.find("iframe").css("visibility","hidden"),o.ui.modalBody.addClass("cms-loader"),s.on("load",function(){try{s.contents()}catch(t){CMS.API.Toolbar.showError("<strong>"+t+"</strong>"),o.close()}var n=s.contents().find(".messagelist li");n.length&&CMS.API.Toolbar.openMessage(n.eq(0).text()),n.remove();var d=s.contents();if(n.length&&o.enforceReload&&o.reloadBrowser(),n.length&&o.enforceClose)return o.close(),!1;if(d.find(".viewsitelink").attr("target","_top"),o._setButtons(i(this)),(s.contents().find(".errornote").length||s.contents().find(".errorlist").length)&&(o.saved=!1),o.saved&&!d.find(".delete-confirmation").length)o.reloadBrowser(window.location.href,!1,!0);else{s.show();var m=s.contents().find("#content h1:eq(0)");void 0===e&&a.html(m.text()),m.remove(),s.css("visibility","visible"),s.data("ready",!0),d.find("body").on("keydown.cms",function(i){27===i.keyCode&&o.close()}),d.find("body").addClass("cms-modal-window"),d.find(".object-tools").length&&d.find("#content").css("padding-top",38)}}),n.html(s)},_changeContent:function(i){if(i.hasClass("cms-modal-breadcrumb-last"))return!1;var t=i.parent().find("a");t.removeClass("cms-modal-breadcrumb-last"),i.addClass("cms-modal-breadcrumb-last"),this._loadContent(i.attr("href")),this.ui.title.text(i.text())}})})}(CMS.$);
!function(i){"use strict";i(document).ready(function(){/*!
         * Sideframe
         * Controls a cms specific sideframe
         */
CMS.Sideframe=new CMS.Class({implement:[CMS.API.Helpers],options:{onClose:!1,sideframeDuration:300,sideframeWidth:320,urls:{css_sideframe:"cms/css/cms.toolbar.sideframe.css"}},initialize:function(e){this.options=i.extend(!0,{},this.options,e),this.config=CMS.config,this.settings=CMS.settings,this.sideframe=i(".cms-sideframe"),this.body=i("html"),this.click=null!==document.ontouchstart?"click.cms":"touchend.cms click.cms",this.enforceReload=!1,this.sideframe.data("ready")||this._events(),this.sideframe.data("ready",!0)},_events:function(){var e=this;this.sideframe.find(".cms-sideframe-close").bind(this.click,function(){e.close(!0)}),this.sideframe.find(".cms-sideframe-hide").bind(this.click,function(){i(this).hasClass("cms-sideframe-hidden")?(e.settings.sideframe.hidden=!1,e._show(e.settings.sideframe.position||e.options.sideframeWidth,!0)):(e.settings.sideframe.hidden=!0,e._hide()),e.settings=e.setSettings(e.settings)}),this.sideframe.find(".cms-sideframe-maximize").bind(this.click,function(){i(this).hasClass("cms-sideframe-minimize")?(e.settings.sideframe.maximized=!1,e._minimize()):(e.settings.sideframe.maximized=!0,e.settings.sideframe.hidden=!1,e._maximize()),e.settings=e.setSettings(e.settings)}),this.sideframe.find(".cms-sideframe-resize").bind("mousedown",function(i){i.preventDefault(),e._startResize()}),i(document).bind("mouseup.cms",function(){e._stopResize()})},open:function(e,s){function t(i){n.sideframe.find(".cms-sideframe-frame").addClass("cms-loader"),m.html(i)}var n=this,d="language="+CMS.config.request.language,a="page_id="+CMS.config.request.page_id,m=this.sideframe.find(".cms-sideframe-frame"),r=!1;if(e.indexOf(CMS.config.request.tree)>=0){var f=[];CMS.config.request.language&&f.push(d),CMS.config.request.page_id&&f.push(a),e=this._url(e,f)}var o=i('<iframe src="'+e+'" class="" frameborder="0" />');o.hide();var h=this.settings.sideframe.position||this.options.sideframeWidth;o.bind("load",function(){var e=o.contents();e.find("head").append(i('<link rel="stylesheet" type="text/css" href="'+n.config.urls["static"]+n.options.urls.css_sideframe+'" />')),n.sideframe.find(".cms-sideframe-frame").removeClass("cms-loader"),o.show(),n.config.debug&&o.contents().find("body").addClass("cms-debug"),n.settings.sideframe.url=o.get(0).contentWindow.location.href,n.settings=n.setSettings(n.settings),e.find("body").bind(n.click,function(){i(document).trigger(n.click)}),r&&n.reloadBrowser(!1,!1,!0),r=!0,e.find(".viewsitelink").attr("target","_top")}),this.sideframe.is(":visible")?(t(o),this.sideframe.outerWidth()<h&&(this.settings.sideframe.hidden=!1,this._show(h,s))):(setTimeout(function(){t(o)},this.options.sideframeDuration),this._show(h,s))},close:function(){this._hide(!0),this.settings.sideframe={url:null,hidden:!1,maximized:!1,width:this.options.sideframeWidth},this.sideframe.find(".cms-sideframe-maximize").removeClass("cms-sideframe-minimize"),this.sideframe.find(".cms-sideframe-hide").show(),this.settings=this.setSettings(this.settings),this.reloadBrowser(this.options.onClose,!1,!0)},_show:function(e,s){this.sideframe.find(".cms-sideframe-hide").removeClass("cms-sideframe-hidden"),this.sideframe.show(),this.settings.sideframe.hidden&&this._hide(),this.settings.sideframe.maximized&&this._maximize(),this.settings.sideframe.hidden||this.settings.sideframe.maximized||(s?(this.sideframe.animate({width:e},this.options.sideframeDuration),this.body.animate({"margin-left":e},this.options.sideframeDuration)):(this.sideframe.animate({width:e},0),this.body.animate({"margin-left":e},0),e>=i(window).width()&&(this.sideframe.animate({width:i(window).width()-20},0),this.body.animate({"margin-left":i(window).width()-20},0))),this.sideframe.find(".cms-sideframe-btn").css("right",-20)),setTimeout(function(){CMS.API.Toolbar._lock(!0),CMS.API.Toolbar._showToolbar(!0)},100)},_hide:function(e){this.sideframe.find(".cms-sideframe-hide").addClass("cms-sideframe-hidden");var s=this.options.sideframeDuration;e&&this.sideframe.width()<=0&&(s=0),e&&this.sideframe.find("iframe").remove(),this.sideframe.animate({width:0},s,function(){e&&i(this).hide()}),this.body.animate({"margin-left":0},s),this.sideframe.find(".cms-sideframe-frame").removeClass("cms-loader"),setTimeout(function(){CMS.API.Toolbar._lock(!1)},100)},_minimize:function(e){this.sideframe.find(".cms-sideframe-maximize").removeClass("cms-sideframe-minimize"),this.sideframe.find(".cms-sideframe-hide").show(),e||this._show(this.settings.sideframe.position||this.options.sideframeWidth,!0),i(window).unbind("resize.cms.sideframe")},_maximize:function(){var e=this;this.sideframe.find(".cms-sideframe-maximize").addClass("cms-sideframe-minimize"),this.sideframe.find(".cms-sideframe-hide").hide(),this.sideframe.find(".cms-sideframe-hide").removeClass("cms-sideframe-hidden").hide(),this.sideframe.animate({width:i(window).width()},0),this.body.animate({"margin-left":0},0),this.sideframe.find(".cms-sideframe-btn").css("right",-2),i(window).bind("resize.cms.sideframe",function(){e.sideframe.css("width",i(window).width())})},_startResize:function(){var e=this,s=20,t=function(){};this.sideframe.find(".cms-sideframe-shim").css("z-index",20),this._minimize(!0),i(document).bind("mousemove.cms",function(n){n.clientX<=320&&(n.clientX=320),n.clientX>=i(window).width()-s&&(n.clientX=i(window).width()-s),e.sideframe.css("width",n.clientX),e.body.css("margin-left",n.clientX),e.settings.sideframe.position=n.clientX,i(window).trigger("resize.sideframe"),clearTimeout(t),t=setTimeout(function(){e.settings=e.setSettings(e.settings)},500)})},_stopResize:function(){this.sideframe.find(".cms-sideframe-shim").css("z-index",1),i(document).unbind("mousemove.cms")},_url:function(e,s){var t=[],n=[],d=[],a="",m=[],r=[],f=e;return e.split("?").length<=1||void 0===window.JSON||(m=e.split("?"),r=m[1].split("&"),f=m[0]),i.each(r,function(i,e){t.push({param:e.split("=")[0],value:e.split("=")[1]})}),i.each(s,function(i,e){t.push({param:e.split("=")[0],value:e.split("=")[1]})}),i.each(t,function(e,s){var t=i.inArray(s.param,n);-1===t?(n.push(s.param),d.push(s.value)):d[t]=s.value}),i.each(n,function(i,e){a+="&"+e+"="+d[i]}),a=a.replace("&","?"),e=f+a}})})}(CMS.$);
!function(i){"use strict";i(document).ready(function(){/*!
         * Clipboard
         * Handles copy & paste
         */
...
!function(e){"use strict";e(document).ready(function(){/*!
         ...
         */
CMS.Plugin=new CMS.Class({implement:[CMS.API.Helpers],options:{type:"",placeholder_id:null,plugin_type:"",plugin_id:null,plugin_language:"",plugin_parent:null,plugin_order:null,plugin_breadcrumb:[],plugin_restriction:[],urls:{add_plugin:"",edit_plugin:"",move_plugin:"",copy_plugin:"",delete_plugin:""}},initialize:function(t,i){switch(this.container=e("."+t),this.options=e.extend(!0,{},this.options,i),this.body=e(document),this.csrf=CMS.config.csrf,this.timer=function(){},this.timeout=250,this.focused=!1,this.click="pointerup.cms",this.container.data("settings",this.options),this.options.type){case"placeholder":this._setPlaceholder(),this._collapsables();break;case"plugin":this._setPlugin(),this._collapsables();break;default:this._setGeneric()}},_setPlaceholder:function(){var t=this,i=".cms-dragbar-title",n="cms-dragbar-title-expanded",s=e(".cms-dragbar-"+this.options.placeholder_id);this._setSubnav(s.find(".cms-submenu"));var a=CMS.settings;a.dragbars=a.dragbars||[],s.find(i).bind(this.click,function(){e(this).hasClass(n)?t._collapseAll(e(this)):t._expandAll(e(this))}),-1!==e.inArray(this.options.placeholder_id,a.dragbars)&&s.find(i).addClass(n)},_setPlugin:function(){var t=this;this.container.bind("dblclick",function(e){e.preventDefault(),e.stopPropagation(),t.editPlugin(t.options.urls.edit_plugin,t.options.plugin_name,t.options.plugin_breadcrumb)}),this.container.bind("pointerover.cms pointerout.cms",function(e){e.stopPropagation();var i=t.options.plugin_name,n=t.options.plugin_id;"pointerover"===e.type?t.showTooltip(i,n):t.hideTooltip()}),this.container.bind("cms.plugins.update",function(e){e.stopPropagation(),t.movePlugin()}),this.container.bind("cms.plugin.update",function(i){i.stopPropagation();var n=e(i.delegateTarget),s=e(".cms-draggable-"+n.data("settings").plugin_id),a=t._getId(s.parents(".cms-draggables").last().prevAll(".cms-dragbar").first());if(!a)return!1;var r=n.data("settings");r.target=a,r.parent=t._getId(s.parent().closest(".cms-draggable")),t.copyPlugin(r)});var i=e(".cms-draggable-"+this.options.plugin_id),n=i.find("> .cms-dragitem"),s=i.find(".cms-submenu:eq(0)"),a=e(".cms-draggables").find(".cms-submenu");this._setSubnav(i.find("> .cms-dragitem .cms-submenu")),i.bind("pointerenter pointerleave pointerover",function(i){return i.preventDefault(),i.stopPropagation(),t.focused?!1:(("pointerenter"===i.type||"pointerover"===i.type)&&e(this).data("active",!0),"pointerleave"===i.type&&(e(this).data("active",!1),a.hide()),void setTimeout(function(){e(i.currentTarget).data("active")||e(i.currentTarget).find(".cms-submenu:eq(0)").hide()},100))}),n.bind("pointerover.cms",function(e){e.preventDefault(),e.stopPropagation(),a.hide(),s.show()}),n.bind("dblclick",function(e){e.preventDefault(),e.stopPropagation(),t.editPlugin(t.options.urls.edit_plugin,t.options.plugin_name,t.options.plugin_breadcrumb)})},_setGeneric:function(){var e=this;this.container.bind("dblclick",function(t){t.preventDefault(),t.stopPropagation(),e.editPlugin(e.options.urls.edit_plugin,e.options.plugin_name,[])}),this.container.bind("pointerover.cms pointerout.cms",function(t){t.stopPropagation();var i=e.options.plugin_name,n=e.options.plugin_id;"pointerover"===t.type?e.showTooltip(i,n):e.hideTooltip()})},addPlugin:function(t,i,n){if(CMS.API.locked)return!1;CMS.API.locked=!0;var s=this,a={placeholder_id:this.options.placeholder_id,plugin_type:t,plugin_parent:n||"",plugin_language:this.options.plugin_language,csrfmiddlewaretoken:this.csrf};e.ajax({type:"POST",url:this.options.urls.add_plugin,data:a,success:function(e){CMS.API.locked=!1,s.newPlugin=e,s.editPlugin(e.url,i,e.breadcrumb)},error:function(e){CMS.API.locked=!1;var t=CMS.config.lang.error;s._showError(t+e.responseText||e.status+" "+e.statusText)}})},editPlugin:function(e,t,i){var n=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});n.open(e,t,i)},copyPlugin:function(t,i){if(CMS.API.locked)return!1;CMS.API.locked=!0;var n=this,s=t||i?!0:!1;t=t||this.options,i?(t.target=t.placeholder_id,t.plugin_id="",t.parent=""):i=t.plugin_language;var a={source_placeholder_id:t.placeholder_id,source_plugin_id:t.plugin_id||"",source_language:i,target_plugin_id:t.parent||"",target_placeholder_id:t.target||CMS.config.clipboard.id,target_language:t.page_language||i,csrfmiddlewaretoken:this.csrf},r={type:"POST",url:t.urls.copy_plugin,data:a,success:function(){CMS.API.Toolbar.openMessage(CMS.config.lang.success),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var t=CMS.config.lang.error;n._showError(t+e.responseText||e.status+" "+e.statusText)}};s?e.ajax(r):CMS.API.Clipboard.clear(function(){e.ajax(r)})},cutPlugin:function(){if(CMS.API.locked)return!1;CMS.API.locked=!0;var t=this,i={placeholder_id:CMS.config.clipboard.id,plugin_id:this.options.plugin_id,plugin_parent:"",plugin_language:this.options.page_language,plugin_order:[this.options.plugin_id],csrfmiddlewaretoken:this.csrf};CMS.API.Clipboard.clear(function(){return CMS.API.locked?!1:(CMS.API.locked=!0,void e.ajax({type:"POST",url:t.options.urls.move_plugin,data:i,success:function(){CMS.API.Toolbar.openMessage(CMS.config.lang.success),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var i=CMS.config.lang.error;t._showError(i+e.responseText||e.status+" "+e.statusText)}}))})},movePlugin:function(t){if(CMS.API.locked)return!1;CMS.API.locked=!0;var i=this;t=t||this.options;var n=e(".cms-plugin-"+t.plugin_id),s=e(".cms-draggable-"+t.plugin_id);this._setPosition(t.plugin_id,n,s);var a=this._getId(s.parents(".cms-draggables").last().prevAll(".cms-dragbar").first()),r=this._getId(s.parent().closest(".cms-draggable")),o=this._getIds(s.siblings(".cms-draggable").andSelf());if(a===!1)return!1;var l={placeholder_id:a,plugin_id:t.plugin_id,plugin_parent:r||"",plugin_language:t.page_language,plugin_order:o,csrfmiddlewaretoken:this.csrf};e.ajax({type:"POST",url:t.urls.move_plugin,data:l,success:function(e){e.reload&&CMS.API.Helpers.reloadBrowser(),CMS.API.locked=!1,i._showSuccess(s)},error:function(e){CMS.API.locked=!1;var t=CMS.config.lang.error;i._showError(t+e.responseText||e.status+" "+e.statusText)}}),e(".cms-btn-publish").addClass("cms-btn-publish-active").parent().show(),e(".cms-toolbar-revert").removeClass("cms-toolbar-item-navigation-disabled")},deletePlugin:function(e,t,i){var n=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});n.open(e,t,i)},_setPosition:function(t,i,n){var s=n.prev(".cms-draggable"),a=n.next(".cms-draggable"),r=n.parent().closest(".cms-draggable"),o=e(".cms-plugin-"+this._getId(r)),l=n.closest(".cms-dragarea");if(s.length)i.insertAfter(e(".cms-plugin-"+this._getId(s)));else if(a.length)i.insertBefore(e(".cms-plugin-"+this._getId(a)));else if(r.length){for(;o.children().length;)o=o.children();o.append(i)}else l.length?i.append(e(".cms-plugin-"+this._getId(l))):CMS.API.Helpers.reloadBrowser()},editPluginPostAjax:function(e,t,i){return"undefined"==typeof t||"undefined"==typeof i?function(t,i){var n=e;n.editPlugin(i.url,n.options.plugin_name,i.breadcrumb)}:void this.editPlugin(i.url,this.options.plugin_name,i.breadcrumb)},_setSubnav:function(t){var i=this;t.bind("pointerenter pointerleave tap.cms",function(t){t.preventDefault(),t.stopPropagation(),"pointerenter"===t.type?i._showSubnav(e(this)):i._hideSubnav(e(this))}),t.find("a").bind(i.click,function(t){t.preventDefault(),t.stopPropagation(),CMS.API.Toolbar._loader(!0);var n=e(this);switch(n.attr("data-rel")){case"add":i.addPlugin(n.attr("href").replace("#",""),n.text(),i._getId(n.closest(".cms-draggable")));break;case"ajax_add":CMS.API.Toolbar.openAjax(n.attr("href"),JSON.stringify(n.data("post")),n.data("text"),i.editPluginPostAjax(i),n.data("on-success"));break;case"edit":i.editPlugin(i.options.urls.edit_plugin,i.options.plugin_name,i.options.plugin_breadcrumb);break;case"copy-lang":i.copyPlugin(this.options,n.attr("data-language"));break;case"copy":i.copyPlugin();break;case"cut":i.cutPlugin();break;case"delete":i.deletePlugin(i.options.urls.delete_plugin,i.options.plugin_name,i.options.plugin_breadcrumb);break;default:CMS.API.Toolbar._loader(!1),CMS.API.Toolbar._delegate(n)}}),t.find("input").bind("keyup keydown focus blur pointerup",function(n){"focus"===n.type&&(i.focused=!0),"blur"!==n.type||i.traverse||(i.focused=!1,i._hideSubnav(t)),"keyup"===n.type&&(clearTimeout(i.timer),i.timer=setTimeout(function(){i._searchSubnav(t,e(n.currentTarget).val())},100))}),t.find(".cms-submenu-dropdown").each(function(){e(this).data("top",e(this).css("top"))}),t.bind(this.click,function(e){e.stopPropagation()})},_showSubnav:function(t){var i=this,n=t.find(".cms-submenu-dropdown"),s=parseInt(n.data("top"));clearTimeout(this.timer),this.timer=setTimeout(function(){var i=e(".cms-submenu").parentsUntil(".cms-dragarea"),n=t.find(".cms-submenu-scroll-hint");i.css("z-index",0);var s=t.parentsUntil(".cms-dragarea");s.css("z-index",999),t.find(".cms-submenu-quicksearch").show(),t.find("> .cms-submenu-dropdown").show().on("scroll",function(){n.fadeOut(100),e(this).off("scroll")}),t[0].scrollHeight>245&&n.show()},100),e(document).unbind("keydown.cms"),e(document).bind("keydown.cms",function(e){var n=t.find(".cms-submenu-item:visible a"),s=n.index(n.filter(":focus"));(40===e.keyCode||9===e.keyCode)&&(i.traverse=!0,e.preventDefault(),s>=0&&s<n.length-1?n.eq(s+1).focus():n.eq(0).focus()),(38===e.keyCode||9===e.keyCode&&e.shiftKey)&&(e.preventDefault(),n.is(":focus")?n.eq(s-1).focus():n.eq(n.length).focus()),(13===e.keyCode||27===e.keyCode)&&(i.traverse=!1,t.find("input").blur(),i._hideSubnav(t))}),e(window).height()+e(window).scrollTop()-t.offset().top-n.height()<=10&&t.offset().top-n.height()>=0?(n.css("top","auto"),n.css("bottom",s),n.closest(".cms-draggable").length&&n.css("bottom",s-1)):(n.css("top",s),n.css("bottom","auto"))},_hideSubnav:function(t){clearTimeout(this.timer);var i=this;return this.focused?!1:(t.closest(".cms-draggable").data("active",!1),this.timer=setTimeout(function(){t.find("> .cms-submenu-dropdown").hide(),t.find(".cms-submenu-quicksearch").hide(),t.find("input").val(""),i._searchSubnav(t,"")},this.timeout),void e(".cms-dragbar").css("position",""))},_searchSubnav:function(t,i){var n=t.find(".cms-submenu-item"),s=t.find(".cms-submenu-item-title");return""===i?(n.add(s).show(),!1):(n.find("a, span").each(function(t,n){n=e(n);var s=n.text().toLowerCase(),a=i.toLowerCase();s.indexOf(a)>=0?n.parent().show():n.parent().hide()}),s.filter(":visible").each(function(t,i){s.hide(),e(i).nextUntil(".cms-submenu-item-title").show()}),n.filter(":visible").each(function(t,i){e(i).prev().hasClass("cms-submenu-item-title")?e(i).prev().show():e(i).prevUntil(".cms-submenu-item-title").last().prev().show()}),t.find(".cms-submenu-dropdown").show(),n.add(s).filter(":visible").length<=0&&t.find(".cms-submenu-dropdown").hide(),void t.find(".cms-submenu-scroll-hint").hide())},_collapsables:function(){var t=this,i=CMS.settings,n=e(".cms-draggable-"+this.options.plugin_id);if(this.container.each(function(t,i){var n=e(i).find(".cms-dragitem-collapsable"),s=n.filter(".cms-dragitem-expanded");n.length===s.length&&n.length+s.length!==0&&e(i).find(".cms-dragbar-title").addClass("cms-dragbar-title-expanded")}),!n.length)return!1;if(n.find("> .cms-dragitem-collapsable").bind(this.click,function(){var i,s=e(this),a=t._getId(e(this).parent()),r=CMS.settings;if(r.states=r.states||[],s.hasClass("cms-dragitem-expanded")){if(r.states.splice(e.inArray(a,r.states),1),s.removeClass("cms-dragitem-expanded").parent().find("> .cms-draggables").hide(),e(document).data("expandmode")){if(i=n.find(".cms-draggable").find(".cms-dragitem-collapsable"),!i.length)return!1;i.each(function(){e(this).hasClass("cms-dragitem-expanded")&&e(this).trigger(t.click)})}}else if(r.states.push(a),s.addClass("cms-dragitem-expanded").parent().find("> .cms-draggables").show(),e(document).data("expandmode")){if(i=n.find(".cms-draggable").find(".cms-dragitem-collapsable"),!i.length)return!1;i.each(function(){e(this).hasClass("cms-dragitem-expanded")||e(this).trigger(t.click)})}e(window).trigger("resize.sideframe"),CMS.API.Toolbar.setSettings(r)}),n.bind("dblclick",function(i){i.stopPropagation(),e(".cms-plugin-"+t._getId(e(this))).trigger("dblclick")}),CMS.Toolbar.ready)return!1;for(var s=i.states.sort(),a=[],r=0;r<s.length;r++)s[r]!==s[r+1]&&a.push(s[r]);i.states=a,e.each(CMS.settings.states,function(t,i){var n=e(".cms-draggable-"+i);n.find(".cms-draggables").length&&(n.find("> .cms-draggables").show(),n.find("> .cms-dragitem").addClass("cms-dragitem-expanded"))}),CMS.Toolbar.ready=!0},_expandAll:function(t){var i=t.closest(".cms-dragarea").find(".cms-dragitem-collapsable");if(!i.length)return!1;i.each(function(){e(this).hasClass("cms-dragitem-expanded")||e(this).trigger("click.cms")}),t.addClass("cms-dragbar-title-expanded");var n=CMS.settings;n.dragbars=n.dragbars||[],n.dragbars.push(this.options.placeholder_id),CMS.API.Toolbar.setSettings(n)},_collapseAll:function(t){var i=t.closest(".cms-dragarea").find(".cms-dragitem-collapsable");i.each(function(){e(this).hasClass("cms-dragitem-expanded")&&e(this).trigger("click.cms")}),t.removeClass("cms-dragbar-title-expanded");var n=CMS.settings;n.dragbars=n.dragbars||[],n.dragbars.splice(e.inArray(this.options.placeholder_id,n.states),1),CMS.API.Toolbar.setSettings(n)},_getId:function(e){return CMS.API.StructureBoard.getId(e)},_getIds:function(e){return CMS.API.StructureBoard.getIds(e)},_showError:function(e){return CMS.API.Toolbar.showError(e,!0)},_showSuccess:function(t){var i=e('<div class="cms-dragitem-success"></div>');t.append(i),i.fadeOut(function(){e(this).remove()}),e(window).trigger("resize.sideframe")}})})}(CMS.$);
!function(e){"use strict";e(document).ready(function(){/*!
         * StructureBoard
         * handles drag & drop, mode switching and
         */
CMS.StructureBoard=new CMS.Class({implement:[CMS.API.Helpers],options:{speed:300},initialize:function(t){this.container=e(".cms-structure"),this.options=e.extend(!0,{},this.options,t),this.config=CMS.config,this.settings=CMS.settings,this.toolbar=e("#cms-toolbar"),this.sortables=e(".cms-draggables"),this.plugins=e(".cms-plugin"),this.render_model=e(".cms-render-model"),this.placeholders=e(".cms-placeholder"),this.dragitems=e(".cms-draggable"),this.dragareas=e(".cms-dragarea"),this.dropareas=e(".cms-droppable"),this.dimmer=this.container.find(".cms-structure-dimmer"),this.clipboard=e(".cms-clipboard"),this.click=null!==document.ontouchstart?"click.cms":"tap.cms click.cms",this.timer=function(){},this.interval=function(){},this.state=!1,this.dragging=!1,this._setup(),this._events()},_setup:function(){var e=this;return this.dragareas.length&&this.toolbar.find(".cms-toolbar-item-cms-mode-switcher").length?("structure"===this.settings.mode&&setTimeout(function(){e.show(!0)},100),this.placeholders.length&&this.toolbar.find(".cms-toolbar-item-cms-mode-switcher").show(),void this._drag()):!1},_events:function(){var t=this,s=this.toolbar.find(".cms-toolbar-item-cms-mode-switcher a");s.eq(1).bind(this.click,function(e){return e.preventDefault(),"edit"===t.settings.mode?!1:void t.hide()}),s.eq(0).bind(this.click,function(e){return e.preventDefault(),"structure"===t.settings.mode?!1:void t.show()}),e(document).bind("keydown",function(s){var i=e("*:focus");if(32!==s.keyCode||"structure"!==t.settings.mode||i.length)if(32!==s.keyCode||"edit"!==t.settings.mode||i.length)16===s.keyCode&&e(this).data("expandmode",!0);else{if(!t.toolbar.find(".cms-toolbar-item-cms-mode-switcher").length)return!1;s.preventDefault(),t.show()}else{if(!t.toolbar.find(".cms-toolbar-item-cms-mode-switcher").length)return!1;s.preventDefault(),t.hide()}}),e(document).bind("keyup",function(t){16===t.keyCode&&e(this).data("expandmode",!1)})},show:function(e){if("live"===CMS.config.mode)return!1;var t=this.toolbar.find(".cms-toolbar-item-cms-mode-switcher a");t.removeClass("cms-btn-active").eq(0).addClass("cms-btn-active"),this.clipboard.css("opacity",1).fadeIn(this.options.speed),this.settings.mode="structure",e||(this.settings=this.setSettings(this.settings)),this.dragareas.show(),this._showBoard()},hide:function(e){if("live"===CMS.config.mode)return!1;var t=this.toolbar.find(".cms-toolbar-item-cms-mode-switcher a");t.removeClass("cms-btn-active").eq(1).addClass("cms-btn-active"),this.container.find(".cms-clipboard").hide(),this.clipboard.hide(),this.settings.mode="edit",e||(this.settings=this.setSettings(this.settings)),this._hideBoard()},getId:function(e){if(void 0===e||null===e||e.length<=0)return!1;var t=null,s=e.attr("class").split(" ")[1];return e.hasClass("cms-plugin")?t=s.replace("cms-plugin-",""):e.hasClass("cms-draggable")?t=s.replace("cms-draggable-",""):e.hasClass("cms-placeholder")?t=s.replace("cms-placeholder-",""):e.hasClass("cms-dragbar")?t=s.replace("cms-dragbar-",""):e.hasClass("cms-dragarea")&&(t=s.replace("cms-dragarea-","")),t},getIds:function(t){var s=this,i=[];return t.each(function(){i.push(s.getId(e(this)))}),i},setActive:function(t,s){if(this.dragitems.removeClass("cms-draggable-selected"),this.plugins.removeClass("cms-plugin-active"),t===!1)return!1;var i=e(".cms-draggable-"+t),a=e(".cms-plugin-"+t);s?(this._showBoard(),this.clipboard.show().css("opacity",.2),this.dragareas.css("opacity",.2),i.closest(".cms-dragarea").show().css("opacity",1)):this.hide();var r=i.parentsUntil(".cms-dragarea").siblings().not(".cms-dragitem-expanded");r.trigger(this.click),i.addClass("cms-draggable-selected"),a.addClass("cms-plugin-active")},preventEvents:function(t){var s=0,i=500,a=function(){};t.find("a").bind(this.click,function(t){t.preventDefault(),s++,1===s&&(a=setTimeout(function(){return s=0,0===e(t.currentTarget).attr("href").indexOf("#")?!1:void(window.location.href=e(t.currentTarget).attr("href"))},i)),2===s&&(clearTimeout(a),s=0)})},_showBoard:function(){var t=this,s=function(){};if(this.container.show(),this.dimmer.fadeIn(100),this.dragareas.css("opacity",1),this.dimmer.bind("mousedown mouseup",function(e){return 3===e.which||2===e.button?!1:(clearTimeout(s),s=setTimeout(function(){t.hide()},500),void("mouseup"===e.type&&clearTimeout(s)))}),this.plugins.not(this.render_model).hide(),this.placeholders.show(),CMS.config.simpleStructureBoard){var i=e(".cms-structure-content"),a=i.find(".cms-dragarea");i.addClass("cms-structure-content-simple"),a.addClass("cms-dragarea-simple"),a.each(function(t,s){e(s).hasClass("cms-dragarea-static")&&i.append(s)}),a.filter(".cms-dragarea-static").eq(0).css("margin-top","50px")}else e(window).bind("resize.sideframe",function(){t._resizeBoard()}).trigger("resize.sideframe")},_hideBoard:function(){this.container.hide(),this.plugins.show(),this.placeholders.hide(),this.dimmer.hide(),e(window).unbind("resize.sideframe"),clearInterval(this.interval),e(window).trigger("structureboard_hidden.sideframe")},_resizeBoard:function(){var t=null,s=null,i=null,a=null;this.placeholders.each(function(r,n){n=e(n),t=n.data("settings").placeholder_id,s=e(".cms-dragarea-"+t),n.height(s.outerHeight(!0)),i=n.width()?0:150,a=e(s).offsetParent().offset(),s.css({top:n.offset().top-a.top-5,left:n.offset().left-a.left-i,width:n.width()+i})})},_drag:function(){var t=this,s=!1,i=null,a=null,r=function(){};this.sortables.nestedSortable({items:".cms-draggable",handle:".cms-dragitem",placeholder:"cms-droppable",connectWith:this.sortables,tolerance:"pointer",toleranceElement:"> div",dropOnEmpty:!0,forcePlaceholderSize:!0,helper:"clone",appendTo:".cms-structure-content",cursor:"move",opacity:.4,zIndex:9999999,delay:100,refreshPositions:!0,listType:"div.cms-draggables",doNotClear:!0,start:function(s,i){t.dragging=!0,e(".cms-dragbar-empty-wrapper").show(),e(".cms-dragitem .cms-submenu").hide(),e(".cms-dragbar-empty").removeClass("cms-draggable-disallowed"),i.placeholder.height(i.item.height()),e(".cms-draggables").each(function(){0===e(this).children().length&&e(this).show()}),e(".cms-structure-content").css({height:e(document).height(),overflow:"hidden"})},stop:function(a,r){if(t.dragging=!1,e(".cms-dragbar-empty-wrapper").hide(),!t.state)return!1;s&&(i.prepend(r.item),s=!1);var n=t.getId(r.item),c=e(".cms-plugin-"+n);c.trigger(c.closest(".cms-clipboard").length?"cms.plugin.update":"cms.plugins.update"),e(".cms-draggables").each(function(){0===e(this).children().length&&e(this).hide()}),e(".cms-structure-content").css({height:"",overflow:""})},isAllowed:function(s,i,r){if(CMS.API.locked)return!1;var n=[],c=e(".cms-plugin-"+t.getId(r));if(0===c.length||null===c.data("settings"))return!1;var o=c.data("settings").plugin_type,d=t.getId(s.closest(".cms-dragarea")),l=e(".cms-placeholder-"+d),h=e(".cms-plugin-"+t.getId(s.closest(".cms-draggable")));return l.length&&(n=l.data("settings").plugin_restriction),h.length&&(n=h.data("settings").plugin_restriction),a&&(n=a.data("settings").plugin_restriction),s.parent().hasClass("cms-draggable-disabled")?!1:(t.state=n.length<=0||-1!==e.inArray(o,n)?!0:!1,t.state)}}),e(document).bind("keyup.cms",function(e,s){(27===e.keyCode||s)&&(t.state=!1,t.sortables.sortable("cancel"))}),this.dropareas.droppable({greedy:!0,accept:".cms-draggable",tolerance:"pointer",activeClass:"cms-draggable-allowed",hoverClass:"cms-draggable-hover-allowed",over:function(s){a=e(".cms-placeholder-"+t.getId(e(s.target).parent().prev())),r=setInterval(function(){e(".cms-dragbar-empty").removeClass("cms-draggable-disallowed"),t.state?e(s.target).removeClass("cms-draggable-disallowed"):e(s.target).addClass("cms-draggable-disallowed")},10)},out:function(t){a=null,e(t.target).removeClass("cms-draggable-disallowed"),clearInterval(r)},drop:function(t){s=!0,i=e(t.target).parent().nextAll(".cms-draggables").first(),clearInterval(r)}})}})})}(CMS.$);
!function(s){"use strict";s(document).ready(function(){/*!
         * Toolbar
         * Handles all features related to the toolbar
         */
CMS.Toolbar=new CMS.Class({implement:[CMS.API.Helpers],options:{preventSwitch:!1,preventSwitchMessage:"Switching is disabled.",messageDelay:2e3},initialize:function(t){this.container=s("#cms-toolbar"),this.options=s.extend(!0,{},this.options,t),this.config=CMS.config,this.settings=CMS.settings,this.body=s("html"),this.toolbar=this.container.find(".cms-toolbar").hide(),this.toolbarTrigger=this.container.find(".cms-toolbar-trigger"),this.navigations=this.container.find(".cms-toolbar-item-navigation"),this.buttons=this.container.find(".cms-toolbar-item-buttons"),this.switcher=this.container.find(".cms-toolbar-item-switch"),this.messages=this.container.find(".cms-messages"),this.screenBlock=this.container.find(".cms-screenblock"),this.click="pointerup.cms",this.timer=function(){},this.lockToolbar=!1,this._setup(),this._events()},_setup:function(){"expanded"===this.settings.toolbar?this._showToolbar(0,!0):this._hideToolbar(0,!0);var t=s(".cms-btn-publish").parent();if(t.hide(),s(".cms-btn-publish-active").length&&t.show(),CMS.config.debug&&this._debug(),CMS.config.messages&&this.openMessage(CMS.config.messages),CMS.config.error&&this.showError(CMS.config.error),CMS.config.auth&&CMS.config.settings.version===this.settings.version||(this.toggleToolbar(!0),this.settings=this.setSettings(CMS.config.settings)),CMS.config.publisher&&(this.openMessage(CMS.config.publisher,"right"),setInterval(function(){CMS.$(".cms-toolbar-item-switch").toggleClass("cms-toolbar-item-switch-highlight")},this.options.messageDelay)),this.settings.sideframe.url){var e=new CMS.Sideframe;e.open(this.settings.sideframe.url,!1)}this.screenBlock.length&&this._screenBlock(),this.body.addClass("cms-ready"),s(document).trigger("cms-ready")},_events:function(){var t=this;this.toolbarTrigger.on(this.click,function(s){s.preventDefault(),t.toggleToolbar()}),this.navigations.each(function(){function e(){o.removeClass(a),o.find("ul ul").hide(),i.find("> li").unbind("mouseenter"),s(document).unbind(t.click)}var i=s(this),o=i.find("li"),n="cms-toolbar-item-navigation",a="cms-toolbar-item-navigation-hover",r="cms-toolbar-item-navigation-disabled",c="cms-toolbar-item-navigation-children";i.find("a").bind(t.click,function(i){return i.preventDefault(),""===s(this).attr("href")||"#"===s(this).attr("href")||s(this).parent().hasClass(r)||s(this).parent().hasClass(r)?void 0:(t._delegate(s(this)),e(),!1)}),o.bind(t.click,function(o){o.stopPropagation();var c=s(this);return c.parent().hasClass(n)&&c.hasClass(a)||c.hasClass(r)?(e(),!1):(e(),c.addClass(a),i.find("> li").bind("mouseenter",function(){return s(this).hasClass(a)?!1:void s(this).trigger(t.click)}),void s(document).bind(t.click,e))}),o.find("li").bind("mouseenter mouseleave",function(){var t=s(this),e=t.closest(".cms-toolbar-item-navigation-children").add(t.parents(".cms-toolbar-item-navigation-children")),i=t.hasClass(c)||e.length;return t.hasClass(r)||t.hasClass(a)?!1:(o.find("li").removeClass(a),t.addClass(a),i?(t.find("> ul").show(),e.addClass(a)):o.find("ul ul").hide(),void t.siblings().find("> ul").hide())}),o.find("> ul").bind("mouseleave",function(){o.find("li").removeClass(a)})}),this.switcher.each(function(){s(this).bind(t.click,function(e){e.preventDefault(),t._setSwitcher(s(e.currentTarget))})}),this.buttons.each(function(){var e=s(this);e.find("a").attr("data-rel")&&e.on("click",function(e){e.preventDefault(),t._delegate(s(this).find("a"))}),e.find(".cms-publish-page").bind(t.click,function(s){confirm(t.config.lang.publish)||s.preventDefault()}),e.find(".cms-btn-publish").bind(t.click,function(t){t.preventDefault(),s.ajax({type:"post",url:s(this).prop("href"),data:{csrfmiddlewaretoken:CMS.config.csrf},success:function(){CMS.API.Helpers.reloadBrowser()},error:function(s){throw new Error(s)}})})})},toggleToolbar:function(s){s&&(this.settings.toolbar="collapsed"),"collapsed"===this.settings.toolbar?this._showToolbar(200):this._hideToolbar(200)},openMessage:function(s,t,e,i){this._lock(!0),this.messages.find(".cms-messages-inner").html(s),clearTimeout(this.timer);var o=this,n=320,a=this.messages.outerHeight(!0),r=this.toolbar.outerHeight(!0),c=this.messages.find(".cms-messages-close");switch(c.hide(),c.bind(this.click,function(){o.closeMessage()}),"collapsed"===this.settings.toolbar&&(r=0),this.config.debug&&(r+=5),this.messages.css("top",-a).show(),this.messages.removeClass("cms-messages-error"),i&&this.messages.addClass("cms-messages-error"),t=t||"center"){case"left":this.messages.css({top:r,left:-n,right:"auto","margin-left":0}),this.messages.animate({left:0});break;case"right":this.messages.css({top:r,right:-n,left:"auto","margin-left":0}),this.messages.animate({right:0});break;default:this.messages.css({left:"50%",right:"auto","margin-left":-(n/2)}),this.messages.animate({top:r})}return 0===e?(c.show(),!1):void(this.timer=setTimeout(function(){o.closeMessage()},e||this.options.messageDelay))},closeMessage:function(){this.messages.fadeOut(300),this._lock(!1)},openAjax:function(t,e,i,o,n){var a=this,r=i?confirm(i):!0;return r?(this._loader(!0),void s.ajax({type:"POST",url:t,data:e?JSON.parse(e):{},success:function(s){CMS.API.locked=!1,o?(o(a,s),a._loader(!1)):n?CMS.API.Helpers.reloadBrowser(n,!1,!0):CMS.API.Helpers.reloadBrowser(!1,!1,!0)},error:function(s){CMS.API.locked=!1,a.showError(s.response+" | "+s.status+" "+s.statusText)}})):!1},showError:function(s,t){this.openMessage(s,"center",0,!0),t&&CMS.API.Helpers.reloadBrowser(!1,this.options.messageDelay)},_showToolbar:function(t,e){this.toolbarTrigger.addClass("cms-toolbar-trigger-expanded"),this.toolbar.slideDown(t),this.body.animate({"margin-top":this.config.debug?35:30},e?0:t,function(){s(this).addClass("cms-toolbar-expanded")}),this.messages.css("top",31),this.settings.toolbar="expanded",e||(this.settings=this.setSettings(this.settings))},_hideToolbar:function(s,t){return this.lockToolbar?!1:(this.toolbarTrigger.removeClass("cms-toolbar-trigger-expanded"),this.toolbar.slideUp(s),this.body.removeClass("cms-toolbar-expanded").animate({"margin-top":this.config.debug?5:0},s),this.messages.css("top",0),this.settings.toolbar="collapsed",void(t||(this.settings=this.setSettings(this.settings))))},_setSwitcher:function(s){var t=s.hasClass("cms-toolbar-item-switch-active"),e=s.find("a"),i=s.find(".cms-toolbar-item-switch-knob"),o=300;return this.options.preventSwitch?(this.openMessage(this.options.preventSwitchMessage,"right"),!1):(t?(i.animate({right:e.outerWidth(!0)-(i.outerWidth(!0)+2)},o),e.css("z-index",1).animate({"padding-top":6,"padding-right":14,"padding-bottom":4,"padding-left":28},o)):(i.animate({left:e.outerWidth(!0)-(i.outerWidth(!0)+2)},o),e.css("z-index",1).animate({"padding-top":6,"padding-right":28,"padding-bottom":4,"padding-left":14},o)),void setTimeout(function(){window.location.href=e.attr("href")},o))},_delegate:function(s){var t=s.data("rel");switch(t){case"modal":var e=new CMS.Modal({onClose:s.data("on-close")});e.open(s.attr("href"),s.data("name"));break;case"message":this.openMessage(s.data("text"));break;case"sideframe":var i=new CMS.Sideframe({onClose:s.data("on-close")});i.open(s.attr("href"),!0);break;case"ajax":this.openAjax(s.attr("href"),JSON.stringify(s.data("post")),s.data("text"),null,s.data("on-success"));break;default:window.location.href=s.attr("href")}},_lock:function(s){s?(this.lockToolbar=!0,this.toolbarTrigger.css("opacity",.2)):(this.lockToolbar=!1,this.toolbarTrigger.css("opacity",1))},_loader:function(s){s?this.toolbarTrigger.addClass("cms-toolbar-loader"):this.toolbarTrigger.removeClass("cms-toolbar-loader")},_debug:function(){var s=this,t=1e3,e=function(){},i=this.container.find(".cms-debug-bar");i.bind("mouseenter mouseleave",function(i){clearTimeout(e),"mouseenter"===i.type&&(e=setTimeout(function(){s.openMessage(s.config.lang.debug)},t))})},_screenBlock:function(){var t=20,e=this.screenBlock,i=s(".cms-sideframe");s(window).on("resize.cms.screenblock",function(){var t=s(this).width()-i.width();e.css({width:t,height:s(window).height()})}).trigger("resize"),setInterval(function(){s(window).trigger("resize.cms.screenblock")},t)}})})}(CMS.$);