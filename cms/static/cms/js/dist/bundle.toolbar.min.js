...
!function(i){"use strict";i(function(){/*!
         ...
         */
CMS.Modal=new CMS.Class({implement:[CMS.API.Helpers],options:{onClose:!1,minHeight:400,minWidth:800,modalDuration:200,newPlugin:!1},initialize:function(t){this.options=i.extend(!0,{},this.options,t),this.config=CMS.config,this._setupUI(),this.click="click.cms",this.maximized=!1,this.minimized=!1,this.triggerMaximized=!1,this.saved=!1,this.ui.modal.data("ready")||this._events(),this.ui.modal.data("ready",!0)},_setupUI:function(){var t=i(".cms-modal");this.ui={modal:t,body:i("html"),window:i(window),toolbarLeftPart:i(".cms-toolbar-left"),minimizeButton:t.find(".cms-modal-minimize"),maximizeButton:t.find(".cms-modal-maximize"),title:t.find(".cms-modal-title"),titlePrefix:t.find(".cms-modal-title-prefix"),titleSuffix:t.find(".cms-modal-title-suffix"),resize:t.find(".cms-modal-resize"),breadcrumb:t.find(".cms-modal-breadcrumb"),closeAndCancel:t.find(".cms-modal-close, .cms-modal-cancel"),modalButtons:t.find(".cms-modal-buttons"),modalBody:t.find(".cms-modal-body"),iframeHolder:t.find(".cms-modal-frame"),shim:t.find(".cms-modal-shim")}},_events:function(){var t=this;this.ui.minimizeButton.on(this.click,function(i){i.preventDefault(),t._minimize()}),this.ui.title.on("pointerdown.cms contextmenu.cms",function(i){i.preventDefault(),t._startMove(i)}),this.ui.title.on("dblclick.cms",function(){t._maximize()}),this.ui.resize.on("pointerdown.cms contextmenu.cms",function(i){i.preventDefault(),t._startResize(i)}),this.ui.maximizeButton.on(this.click,function(i){i.preventDefault(),t._maximize()}),this.ui.breadcrumb.on(this.click,"a",function(e){e.preventDefault(),t._changeContent(i(this))}),this.ui.closeAndCancel.on(this.click,function(i){t.options.onClose=null,i.preventDefault(),t.close()}),this.ui.body.on("pointerup.cms pointercancel.cms",function(i){t._endMove(i),t._endResize(i)})},open:function(i,t,e){if(CMS.API.locked)return CMS.API.locked=!1,!1;if(CMS.API.locked=!0,CMS._newPlugin&&this._deletePlugin()===!1)return!1;this.options.newPlugin&&(CMS._newPlugin=this.options.newPlugin),this.ui.body.hasClass("cms-modal-minimized")&&(this.minimized=!0,this._minimize()),this.ui.modalButtons.empty(),CMS.API.Toolbar._loader(!0),this.hideTooltip(),this._loadContent(i,t);var n=300,o=300,s=this.ui.window.width(),a=this.ui.window.height(),d=s>=this.options.minWidth+n?s-n:this.options.minWidth,m=a>=this.options.minHeight+o?a-o:this.options.minHeight;this.ui.maximizeButton.removeClass("cms-modal-maximize-active"),this.maximized=!1,m>=a&&(this.triggerMaximized=!0),this._setBreadcrumb(e),this._show({width:d,height:m,duration:this.options.modalDuration})},close:function(){var i=this;CMS._newPlugin?this._deletePlugin({hideAfter:!0}):this._hide(100),this.options.onClose&&this.reloadBrowser(this.options.onClose,!1,!0),setTimeout(function(){i.minimized&&i._minimize(),i.maximized&&i._maximize()},300)},_show:function(i){var t=this,e=i.width,n=i.height,o=i.duration;this.ui.modal.css({display:"block",width:e,height:n,"margin-left":-(e/2),"margin-top":-(n/2)}),setTimeout(function(){t.ui.modal.addClass("cms-modal-open")},0),this.ui.modal.one("cmsTransitionEnd",function(){t.ui.modal.css({"margin-left":-(e/2),"margin-top":-(n/2)}),CMS.API.Toolbar._loader(!1),t.triggerMaximized&&t._maximize(),CMS.API.locked=!1}).emulateTransitionEnd(o),this.ui.body.on("keydown.cms",function(i){i.keyCode===CMS.KEYS.ESC&&t.close()}),this.ui.modal.focus()},_hide:function(i){var t=this;t.ui.modal.removeClass("cms-modal-open"),t.ui.modal.one("cmsTransitionEnd",function(){t.ui.modal.css("display","none")}).emulateTransitionEnd(i),t.ui.iframeHolder.find("iframe").remove(),t.ui.modalBody.removeClass("cms-loader")},_minimize:function(){return this.maximized?!1:void(this.minimized===!1?(CMS.API.Toolbar.toggleToolbar(!0),this.ui.modal.data("css",this.ui.modal.css(["left","top","margin-left","margin-top"])),this.ui.body.addClass("cms-modal-minimized"),this.ui.modal.css({left:this.ui.toolbarLeftPart.outerWidth(!0)+50}),this.minimized=!0):(this.ui.body.removeClass("cms-modal-minimized"),this.ui.modal.css(this.ui.modal.data("css")),this.minimized=!1))},_maximize:function(){var i=this.ui.modal;return this.minimized?!1:void(this.maximized===!1?(this.maximized=!0,i.data("css",this.ui.modal.css(["left","top","margin-left","margin-top","width","height"])),this.ui.body.addClass("cms-modal-maximized")):(this.maximized=!1,this.ui.body.removeClass("cms-modal-maximized"),i.css(i.data("css"))))},_startMove:function(i){if(this.maximized)return!1;if(this.minimized)return!1;var t=this,e=t.ui.modal.position();this.ui.shim.show(),this.ui.body.attr("data-touch-action","none").on("pointermove.cms",function(n){var o=e.left-(i.originalEvent.pageX-n.originalEvent.pageX),s=e.top-(i.originalEvent.pageY-n.originalEvent.pageY);t.ui.modal.css({left:o,top:s})})},_endMove:function(){this.ui.shim.hide(),this.ui.body.off("pointermove.cms").removeAttr("data-touch-action")},_startResize:function(i){if(this.maximized)return!1;var t=this.ui.modal,e=t.width(),n=t.height(),o=this.ui.modal.position().left,s=this.ui.modal.position().top;this.ui.shim.show(),this.ui.body.attr("data-touch-action","none").on("pointermove.cms",function(a){var d=i.originalEvent.pageX-a.originalEvent.pageX,m=i.originalEvent.pageY-a.originalEvent.pageY,l=e-2*d,r=n-2*m,c=680,u=150;return c>=l||u>=r?!1:void t.css({width:e-2*d,height:n-2*m,left:o+d,top:s+m})})},_endResize:function(){this.ui.shim.hide(),this.ui.body.off("pointermove.cms").removeAttr("data-touch-action")},_setBreadcrumb:function(t){var e=this.ui.breadcrumb,n="";return this.ui.modal.removeClass("cms-modal-has-breadcrumb"),!t||t.length<=1?!1:t[0].title?(this.ui.modal.addClass("cms-modal-has-breadcrumb"),i.each(t,function(i,e){var o=i>=t.length-1?"active":"";n+='<a href="'+e.url+'" class="'+o+'"><span>'+e.title+"</span></a>"}),this.ui.breadcrumb.html(n),void e.show()):!1},_setButtons:function(t){var e,n,o=t.contents().find(".suit-columns").length>0,s=this,a=i('<div class="cms-modal-item-buttons"></div>'),d=i('<div class="cms-modal-buttons-inner"></div>');e=t.contents().find(o?".save-box:eq(0)":".submit-row:eq(0)");var m=e.find("input, a, button");t.contents().find(".submit-row").hide(),m.length||(e=t.contents().find("body:not(.change-list) #content form:eq(0)"),m=e.find('input[type="submit"], button[type="submit"]'),m.addClass("deletelink").hide()),m.each(function(t,e){i(e).attr("data-rel","_"+t)}),m.each(function(t,e){if(e=i(e),"hidden"===e.attr("type"))return!1;var n=e.attr("value")||e.text(),o="cms-btn";e.hasClass("default")&&(o="cms-btn cms-btn-action"),e.hasClass("deletelink")&&(o="cms-btn cms-btn-caution");var m=i('<a href="#" class="'+o+" "+e.attr("class")+'">'+n+"</a>");m.on(s.click,function(){(e.is("input")||e.is("button"))&&e[0].click(),e.is("a")&&s._loadContent(e.prop("href"),n),(e.hasClass("default")||e.hasClass("deletelink"))&&(e.hasClass("deletelink")&&(s.options.onClose=null),s.ui.iframeHolder.find("iframe").hide(),s.saved=!0)}),m.wrap(a),d.append(m.parent())});var l=i('<a href="#" class="cms-btn">'+s.config.lang.cancel+"</a>");l.on(s.click,function(){s.options.onClose=!1,s.close()}),l.wrap(a),d.append(l.parent()),d.find(".cms-btn-group").unwrap(),n=d.find(".cms-btn-group").clone(!0,!0),d.find(".cms-btn-group").remove(),d.append(n.wrapAll(a.clone().addClass("cms-modal-item-buttons-left")).parent()),this.ui.modalButtons.html(d)},_prepareUrl:function(i){return i+=-1===i.indexOf("?")?"?modal=1":"&modal=1",i=i.replace("&","&amp;")},_loadContent:function(t,e){var n=this;t=this._prepareUrl(t);var o=i('<iframe src="'+t+'" class="" frameborder="0" />');o.css("visibility","hidden");var s=this.ui.iframeHolder,a=this.ui.titlePrefix,d=this.ui.titleSuffix;a.text(e||""),d.text(""),s.find("iframe").css("visibility","hidden"),n.ui.modalBody.addClass("cms-loader"),o.on("load",function(){try{o.contents()}catch(t){CMS.API.Toolbar.showError("<strong>"+t+"</strong>"),n.close()}var s=o.contents().find(".messagelist li");s.length&&CMS.API.Toolbar.openMessage(s.eq(0).text()),s.remove();var a=o.contents();if(a.find("body").addClass("cms-admin cms-admin-modal"),s.length&&n.enforceReload&&n.reloadBrowser(),s.length&&n.enforceClose)return n.close(),!1;if(a.find(".viewsitelink").attr("target","_top"),n._setButtons(i(this)),(o.contents().find(".errornote").length||o.contents().find(".errorlist").length)&&(n.saved=!1),n.saved&&!a.find(".delete-confirmation").length)n.reloadBrowser(window.location.href,!1,!0);else{o.show();var m=o.contents().find("#content h1:eq(0)");if(void 0===e&&""===n.ui.titlePrefix.text()){var l=o.contents().find(".breadcrumbs").contents();n.ui.titlePrefix.text(l.eq(l.length-1).text().replace("›","").trim())}d.text(m.text()),m.remove(),o.css("visibility","visible"),o.data("ready",!0),a.find("body").on("keydown.cms",function(i){i.keyCode===CMS.KEYS.ESC&&n.close()}),a.find("body").addClass("cms-modal-window"),a.find(".object-tools").length&&a.find("#content").css("padding-top",38)}}),s.html(o)},_changeContent:function(i){if(i.hasClass("active"))return!1;var t=i.parent().find("a");t.removeClass("active"),i.addClass("active"),this._loadContent(i.attr("href")),this.ui.titlePrefix.text(i.text())},_deletePlugin:function(i){var t=this,e=CMS._newPlugin,n='{ "csrfmiddlewaretoken": "'+this.config.csrf+'" }',o=this.config.lang.confirmEmpty.replace("{1}",CMS._newPlugin.breadcrumb[0].title);return CMS.API.Toolbar.openAjax(e["delete"],n,o,function(){CMS._newPlugin=!1,i&&i.hideAfter&&t._hide(100)})}})})}(CMS.$);
var CMS=window.CMS||{};!function(i){"use strict";i(function(){CMS.Sideframe=new CMS.Class({implement:[CMS.API.Helpers],options:{onClose:!1,sideframeDuration:300,sideframeWidth:.8},initialize:function(e){this.options=i.extend(!0,{},this.options,e),this.config=CMS.config,this.settings=CMS.settings,this._setupUI(),this.click="click.cms.sideframe",this.pointerDown="pointerdown.cms.sideframe contextmenu.cms.sideframe",this.pointerUp="pointerup.cms.sideframe pointercancel.cms.sideframe",this.pointerMove="pointermove.cms.sideframe",this.enforceReload=!1,this.settingsRefreshTimer=600,this.ui.sideframe.data("ready")||this._events(),this.ui.sideframe.data("ready",!0)},_setupUI:function(){var e=i(".cms-sideframe");this.ui={sideframe:e,body:i("html"),window:i(window),dimmer:e.find(".cms-sideframe-dimmer"),close:e.find(".cms-sideframe-close"),resize:e.find(".cms-sideframe-resize"),frame:e.find(".cms-sideframe-frame"),shim:e.find(".cms-sideframe-shim")}},_events:function(){var i=this;this.ui.close.on(this.click,function(){i.close()}),this.ui.resize.on(this.pointerDown,function(e){e.preventDefault(),i._startResize()})},open:function(i,e){var t="language="+CMS.config.request.language,s="page_id="+CMS.config.request.page_id,n=["sideframe=true"],o=this.settings.sideframe.position||window.innerWidth*this.options.sideframeWidth;console.log("params: ",n),this.ui.dimmer.show(),this.ui.frame.addClass("cms-loader"),CMS.API&&CMS.API.Toolbar&&CMS.API.Toolbar._loader(!0),console.log("url before: ",i),i.indexOf(CMS.config.request.tree)>=0&&(CMS.config.request.language&&(console.log("language: ",t),n.push(t)),CMS.config.request.page_id&&(console.log("page_id: ",s),n.push(s))),console.log("url intermediate: ",i),i=this._url(i,n),console.log("url after: ",i),this._content(i),this.ui.sideframe.is(":visible")&&this.ui.sideframe.outerWidth()<o&&(this.settings.sideframe.hidden=!1),this._show(o,e)},_content:function(e){var t,s=this,n=!1,o=i('<iframe src="'+e+'" class="" frameborder="0" />'),r=this.ui.frame;o.hide().on("load",function(){t=o.contents(),t.find("body").addClass("cms-admin cms-admin-sideframe"),s.ui.frame.removeClass("cms-loader"),o.show(),s.config.debug&&o.contents().find("body").addClass("cms-debug"),s.settings.sideframe.url=o.get(0).contentWindow.location.href,s.settings=s.setSettings(s.settings),t.find("body").on(s.click,function(){i(document).trigger(s.click)}),n&&s.reloadBrowser(!1,!1,!0),n=!0,t.find(".viewsitelink").attr("target","_top")}),r.html(o)},_show:function(e,t){this.ui.sideframe.show(),this.settings.sideframe.hidden&&this._hide(),t?this.ui.sideframe.animate({width:e,overflow:"visible"},this.options.sideframeDuration):(this.ui.sideframe.css("width",e),e>=i(window).width()&&this.ui.sideframe.css({width:i(window).width()-30,overflow:"visible"})),CMS.API&&CMS.API.Toolbar&&(CMS.API.Toolbar._lock(!0),CMS.API.Toolbar._showToolbar(!0),CMS.API.Toolbar._loader())},close:function(){this.ui.dimmer.hide(),this.settings.sideframe={url:null,hidden:!1,width:this.options.sideframeWidth},this.settings=this.setSettings(this.settings),this.reloadBrowser(this.options.onClose,!1,!0),this._hide({duration:0})},_hide:function(e){var t=e.duration||this.options.sideframeDuration;this.ui.sideframe.animate({width:0},t,function(){i(this).hide()}),this.ui.frame.removeClass("cms-loader"),CMS.API&&CMS.API.Toolbar&&CMS.API.Toolbar._lock(!1)},_startResize:function(){var e=this,t=30,s=function(){};this.ui.body.on(this.pointerUp,function(i){i.preventDefault(),e._stopResize()}),this.ui.shim.css("z-index",20),this.ui.body.attr("data-touch-action","none").on(this.pointerMove,function(n){n.originalEvent.clientX<=320&&(n.originalEvent.clientX=320),n.originalEvent.clientX>=i(window).width()-t&&(n.originalEvent.clientX=i(window).width()-t),e.ui.sideframe.css("width",n.originalEvent.clientX),e.settings.sideframe.position=n.originalEvent.clientX,clearTimeout(s),s=setTimeout(function(){e.settings=e.setSettings(e.settings)},e.settingsRefreshTimer)})},_stopResize:function(){this.ui.shim.css("z-index",1),this.ui.body.off(this.pointerUp).off(this.pointerMove).removeAttr("data-touch-action")},_url:function(e,t){var s,n=[],o=[],r=[],a="",d=[],h=[],c=e;return e.split("?").length<=1||void 0===window.JSON||(d=e.split("?"),h=d[1].split("&"),c=d[0]),i.each(h,function(i,e){n.push({param:e.split("=")[0],value:e.split("=")[1]})}),i.each(t,function(i,e){n.push({param:e.split("=")[0],value:e.split("=")[1]})}),i.each(n,function(e,t){s=i.inArray(t.param,o),-1===s?(o.push(t.param),r.push(t.value)):r[s]=t.value}),i.each(o,function(i,e){a+="&"+e+"="+r[i]}),a=a.replace("&","?"),e=c+a}})})}(CMS.$);
