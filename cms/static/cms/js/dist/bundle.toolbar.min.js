...
var CMS=window.CMS||{};!function(i){"use strict";i(function(){CMS.Sideframe=new CMS.Class({implement:[CMS.API.Helpers],options:{onClose:!1,sideframeDuration:300,sideframeWidth:.8,urls:{css_sideframe:"cms/css/cms.toolbar.sideframe.css"}},initialize:function(e){this.options=i.extend(!0,{},this.options,e),this.config=CMS.config,this.settings=CMS.settings,this._setupUI(),this.click="click.cms.sideframe",this.pointerDown="pointerdown.cms.sideframe contextmenu.cms.sideframe",this.pointerUp="pointerup.cms.sideframe pointercancel.cms.sideframe",this.pointerMove="pointermove.cms.sideframe",this.enforceReload=!1,this.settingsRefreshTimer=600,this.ui.sideframe.data("ready")||this._events(),this.ui.sideframe.data("ready",!0)},_setupUI:function(){var e=i(".cms-sideframe");this.ui={sideframe:e,body:i("html"),window:i(window),dimmer:e.find(".cms-sideframe-dimmer"),close:e.find(".cms-sideframe-close"),resize:e.find(".cms-sideframe-resize"),frame:e.find(".cms-sideframe-frame"),shim:e.find(".cms-sideframe-shim")}},_events:function(){var i=this;this.ui.close.on(this.click,function(){i.close()}),this.ui.resize.on(this.pointerDown,function(e){e.preventDefault(),i._startResize()})},open:function(i,e){var s="language="+CMS.config.request.language,t="page_id="+CMS.config.request.page_id,n=[],o=this.settings.sideframe.position||window.innerWidth*this.options.sideframeWidth;this.ui.dimmer.show(),this.ui.frame.addClass("cms-loader"),CMS.API&&CMS.API.Toolbar&&CMS.API.Toolbar._loader(!0),i.indexOf(CMS.config.request.tree)>=0&&(CMS.config.request.language&&n.push(s),CMS.config.request.page_id&&n.push(t),i=this._url(i,n)),this._content(i),this.ui.sideframe.is(":visible")&&this.ui.sideframe.outerWidth()<o&&(this.settings.sideframe.hidden=!1),this._show(o,e)},_content:function(e){var s,t=this,n=!1,o=i('<iframe src="'+e+'" class="" frameborder="0" />'),r=this.ui.frame;o.hide().on("load",function(){s=o.contents(),s.find("head").append(i('<link rel="stylesheet" type="text/css" href="'+t.config.urls["static"]+t.options.urls.css_sideframe+'" />')),t.ui.frame.removeClass("cms-loader"),o.show(),t.config.debug&&o.contents().find("body").addClass("cms-debug"),t.settings.sideframe.url=o.get(0).contentWindow.location.href,t.settings=t.setSettings(t.settings),s.find("body").on(t.click,function(){i(document).trigger(t.click)}),n&&t.reloadBrowser(!1,!1,!0),n=!0,s.find(".viewsitelink").attr("target","_top")}),r.html(o)},_show:function(e,s){this.ui.sideframe.show(),this.settings.sideframe.hidden&&this._hide(),s?this.ui.sideframe.animate({width:e,overflow:"visible"},this.options.sideframeDuration):(this.ui.sideframe.css("width",e),e>=i(window).width()&&this.ui.sideframe.css({width:i(window).width()-30,overflow:"visible"})),CMS.API&&CMS.API.Toolbar&&(CMS.API.Toolbar._lock(!0),CMS.API.Toolbar._showToolbar(!0),CMS.API.Toolbar._loader())},close:function(){this.ui.dimmer.hide(),this.settings.sideframe={url:null,hidden:!1,width:this.options.sideframeWidth},this.settings=this.setSettings(this.settings),this.reloadBrowser(this.options.onClose,!1,!0),this._hide({duration:0})},_hide:function(e){var s=e.duration||this.options.sideframeDuration;this.ui.sideframe.animate({width:0},s,function(){i(this).hide()}),this.ui.frame.removeClass("cms-loader"),CMS.API&&CMS.API.Toolbar&&CMS.API.Toolbar._lock(!1)},_startResize:function(){var e=this,s=30,t=function(){};this.ui.body.on(this.pointerUp,function(i){i.preventDefault(),e._stopResize()}),this.ui.shim.css("z-index",20),this.ui.body.attr("data-touch-action","none").on(this.pointerMove,function(n){n.originalEvent.clientX<=320&&(n.originalEvent.clientX=320),n.originalEvent.clientX>=i(window).width()-s&&(n.originalEvent.clientX=i(window).width()-s),e.ui.sideframe.css("width",n.originalEvent.clientX),e.settings.sideframe.position=n.originalEvent.clientX,clearTimeout(t),t=setTimeout(function(){e.settings=e.setSettings(e.settings)},e.settingsRefreshTimer)})},_stopResize:function(){this.ui.shim.css("z-index",1),this.ui.body.off(this.pointerUp).off(this.pointerMove).removeAttr("data-touch-action")},_url:function(e,s){var t,n=[],o=[],r=[],a="",d=[],h=[],c=e;return e.split("?").length<=1||void 0===window.JSON||(d=e.split("?"),h=d[1].split("&"),c=d[0]),i.each(h,function(i,e){n.push({param:e.split("=")[0],value:e.split("=")[1]})}),i.each(s,function(i,e){n.push({param:e.split("=")[0],value:e.split("=")[1]})}),i.each(n,function(e,s){t=i.inArray(s.param,o),-1===t?(o.push(s.param),r.push(s.value)):r[t]=s.value}),i.each(o,function(i,e){a+="&"+e+"="+r[i]}),a=a.replace("&","?"),e=c+a}})})}(CMS.$);
