 ...
 */
window.django=window.django||void 0,window.jQuery=window.django&&window.django.jQuery?window.django.jQuery:window.jQuery||void 0,window.Class=window.Class||void 0;var CMS={$:"function"==typeof window.jQuery?window.jQuery:void 0,Class:"function"==typeof window.Class?window.Class:void 0,API:{},KEYS:{SHIFT:16,TAB:9,UP:38,DOWN:40,ENTER:13,SPACE:32,ESC:27,CMD_LEFT:91,CMD_RIGHT:93}};!function(e){"use strict";e(document).ready(function(){CMS.API.Helpers={reloadBrowser:function(o,n,t){var r=this,a=window.parent?window.parent:window;return t?(a.CMS.API.locked=!0,e.ajax({async:!1,type:"GET",url:a.CMS.config.request.url,data:{model:a.CMS.config.request.model,pk:a.CMS.config.request.pk},success:function(e){return a.CMS.API.locked=!1,""!==e||o?void(a.location.pathname!==e&&""!==e?r.reloadBrowser(e):"REFRESH_PAGE"===o?r.reloadBrowser():o&&r.reloadBrowser(o)):!1}}),!1):void a.setTimeout(function(){o&&o!==a.location.href?a.location.href=o:a.location.reload()},n||0)},preventSubmit:function(){var o=e(".cms-toolbar").find("form");o.submit(function(){CMS.API.Toolbar.showLoader(),e('input[type="submit"]').bind("click",function(e){e.preventDefault()}).css("opacity",.5)})},csrf:function(o){e.ajaxSetup({beforeSend:function(e){e.setRequestHeader("X-CSRFToken",o)}})},setSettings:function(o){return o=JSON.stringify(e.extend({},CMS.config.settings,o)),CMS.API.Toolbar&&CMS.API.Toolbar.showLoader(),window.localStorage?(localStorage.setItem("cms_cookie",o),CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()):(CMS.API.locked=!0,e.ajax({async:!1,type:"POST",url:CMS.config.urls.settings,data:{csrfmiddlewaretoken:this.config.csrf,settings:o},success:function(e){CMS.API.locked=!1,o=e?JSON.parse(e):CMS.config.settings,CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()},error:function(e){CMS.API.Messages.open({message:e.response+" | "+e.status+" "+e.statusText,error:!0})}})),CMS.settings=JSON.parse(o),CMS.settings},getSettings:function(){var o;return CMS.API.Toolbar&&CMS.API.Toolbar.showLoader(),window.localStorage?(o=JSON.parse(localStorage.getItem("cms_cookie")),CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()):(CMS.API.locked=!0,e.ajax({async:!1,type:"GET",url:CMS.config.urls.settings,success:function(e){CMS.API.locked=!1,o=e?JSON.parse(e):CMS.config.settings,CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()},error:function(e){CMS.API.Messages.open({message:e.response+" | "+e.status+" "+e.statusText,error:!0})}})),o||(o=this.setSettings(CMS.config.settings)),CMS.settings=o,CMS.settings},makeURL:function(o,n){var t=[],r=[],a=[],i="",s=[],l=[],u=o;return o.split("?").length<=1||void 0===window.JSON||(s=o.split("?"),l=s[1].split("&"),u=s[0]),e.each(l,function(e,o){t.push({param:o.split("=")[0],value:o.split("=")[1]})}),n&&n.length&&e.each(n,function(e,o){t.push({param:o.split("=")[0],value:o.split("=")[1]})}),e.each(t,function(o,n){var t=e.inArray(n.param,r);-1===t?(r.push(n.param),a.push(n.value)):a[t]=n.value}),e.each(r,function(e,o){i+="&"+o+"="+a[e]}),i=i.replace("&","?"),o=u+i,o=o.replace("&","&amp;")},debounce:function(e,o,n){var t;return function(){var r=this,a=arguments,i=function(){t=null,n&&n.immediate||e.apply(r,a)},s=n&&n.immediate&&!t;clearTimeout(t),t=setTimeout(i,o),s&&e.apply(r,a)}},throttle:function(o,n,t){var r,a,i,s=null,l=0;t||(t={});var u=function(){l=t.leading===!1?0:e.now(),s=null,i=o.apply(r,a),s||(r=a=null)};return function(){var c=e.now();l||t.leading!==!1||(l=c);var d=n-(c-l);return r=this,a=arguments,0>=d||d>n?(s&&(clearTimeout(s),s=null),l=c,i=o.apply(r,a),s||(r=a=null)):s||t.trailing===!1||(s=setTimeout(u,d)),i}}},CMS.API.Helpers.preventSubmit()})}(CMS.$);
/*!========================================================================
...
var CMS=window.CMS||{};!function(s){"use strict";s(function(){CMS.Messages=new CMS.Class({options:{messageDuration:300,messageDelay:3e3},initialize:function(e){this.options=s.extend(!0,{},this.options,e),this.config=CMS.config,this.settings=CMS.settings,this._setupUI()},_setupUI:function(){var e=s(".cms");this.ui={container:e,body:s("html"),toolbar:e.find(".cms-toolbar"),messages:e.find(".cms-messages")}},open:function(s){if(!s||!s.message)throw new Error('The arguments passed to "open" were invalid.');var e=this,i=s.message,t=void 0===s.dir?"center":s.dir,a=void 0===s.delay?this.options.messageDelay:s.delay,o=void 0===s.error?!1:s.error,n=320,r=this.ui.messages.outerHeight(!0),m=this.ui.toolbar.outerHeight(!0),g=this.ui.messages.find(".cms-messages-close");switch(this.ui.messages.find(".cms-messages-inner").html(i),this.ui.messages.removeClass("cms-messages-error"),o&&this.ui.messages.addClass("cms-messages-error"),clearTimeout(this.timer),g.hide(),g.off(this.click).on(this.click,function(){e.close()}),"collapsed"===this.settings.toolbar&&(m=0),this.config.debug&&(m+=5),this.ui.messages.css("top",-r).show(),t){case"left":this.ui.messages.css({top:m,left:-n,right:"auto","margin-left":0}),this.ui.messages.animate({left:0});break;case"right":this.ui.messages.css({top:m,right:-n,left:"auto","margin-left":0}),this.ui.messages.animate({right:0});break;default:this.ui.messages.css({left:"50%",right:"auto","margin-left":-(n/2)}),this.ui.messages.animate({top:m})}0>=a?g.show():this.timer=setTimeout(function(){e.close()},a)},close:function(){this.ui.messages.fadeOut(this.options.messageDuration)}})})}(CMS.$);
var CMS=window.CMS||{};!function(i){"use strict";i(function(){CMS.Modal=new CMS.Class({implement:[CMS.API.Helpers],options:{onClose:!1,minHeight:400,minWidth:800,modalDuration:200,newPlugin:!1,resizable:!0,maximizable:!0,minimizable:!0},initialize:function(t){this.options=i.extend(!0,{},this.options,t),this.config=CMS.config,this.settings=CMS.settings,this._setupUI(),this._setupEventEmitter(),this.click="click.cms.modal",this.pointerDown="pointerdown.cms.modal contextmenu.cms.modal",this.pointerUp="pointerup.cms.modal pointercancel.cms.modal",this.pointerMove="pointermove.cms.modal",this.doubleClick="dblclick.cms.modal",this.maximized=!1,this.minimized=!1,this.triggerMaximized=!1,this.saved=!1},_setupEventEmitter:function(){function t(i){return function(){return o[i].apply(o,arguments),e}}var e=this,o=i({});this.trigger=t("trigger"),this.one=t("one"),this.on=t("on"),this.off=t("off")},_setupUI:function(){var t=i(".cms-modal");this.ui={modal:t,body:i("html"),window:i(window),toolbarLeftPart:i(".cms-toolbar-left"),minimizeButton:t.find(".cms-modal-minimize"),maximizeButton:t.find(".cms-modal-maximize"),title:t.find(".cms-modal-title"),titlePrefix:t.find(".cms-modal-title-prefix"),titleSuffix:t.find(".cms-modal-title-suffix"),resize:t.find(".cms-modal-resize"),breadcrumb:t.find(".cms-modal-breadcrumb"),closeAndCancel:t.find(".cms-modal-close, .cms-modal-cancel"),modalButtons:t.find(".cms-modal-buttons"),modalBody:t.find(".cms-modal-body"),frame:t.find(".cms-modal-frame"),shim:t.find(".cms-modal-shim")}},_events:function(){var t=this;this.ui.minimizeButton.off(this.click).on(this.click,function(i){i.preventDefault(),t.minimize()}),this.ui.maximizeButton.off(this.click).on(this.click,function(i){i.preventDefault(),t.maximize()}),this.ui.title.off(this.pointerDown).on(this.pointerDown,function(i){i.preventDefault(),t._startMove(i)}),this.ui.title.off(this.doubleClick).on(this.doubleClick,function(){t.maximize()}),this.ui.resize.off(this.pointerDown).on(this.pointerDown,function(i){i.preventDefault(),t._startResize(i)}),this.ui.closeAndCancel.off(this.click).on(this.click,function(i){t.options.onClose=null,i.preventDefault(),t.close()}),this.ui.breadcrumb.off(this.click,"a").on(this.click,"a",function(e){e.preventDefault(),t._changeIframe(i(this))})},open:function(t){if(!(t&&t.url||t&&t.html))throw new Error('The arguments passed to "open" were invalid.');if(CMS._newPlugin&&!this._deletePlugin())return!1;this._events(),this.trigger("cms.modal.load"),this.ui.modal.trigger("cms.modal.load"),this.ui.resize.toggle(this.options.resizable),this.ui.minimizeButton.toggle(this.options.minimizable),this.ui.maximizeButton.toggle(this.options.maximizable);var e=this._calculateNewPosition(t);return this.ui.maximizeButton.removeClass("cms-modal-maximize-active"),this.maximized=!1,this.options.newPlugin&&(CMS._newPlugin=this.options.newPlugin),this.ui.body.hasClass("cms-modal-minimized")&&(this.minimized=!0,this.minimize()),this.ui.modalButtons.empty(),this.ui.breadcrumb.empty(),this.ui.modal.removeClass("cms-modal-has-breadcrumb"),CMS.API.Tooltip.hide(),t.url?this._loadIframe({url:t.url,title:t.title,breadcrumbs:t.breadcrumbs}):this._loadMarkup({html:t.html,title:t.title,subtitle:t.subtitle}),this.trigger("cms.modal.loaded"),this._show(i.extend({duration:this.options.modalDuration},e)),this},_calculateNewPosition:function(i){var t,e,o=300,s=300,n=this.ui.window.width(),a=this.ui.window.height(),m=i.width||this.options.minWidth,l=i.height||this.options.minHeight,d=n>=m+o,r=a>=l+s,c=d&&!i.width?n-o:m,u=r&&!i.height?a-s:l,h=this.ui.modal.css("left"),f=this.ui.modal.css("top");return"50%"===h&&(h=n/2),"50%"===f&&(f=a/2),f=parseInt(f),h=parseInt(h),(c/2+h>n||u/2+f>a||0>h-c/2||0>f-u/2)&&(t=n/2,e=a/2),(c>=n||u>=a)&&(this.triggerMaximized=!0),{width:c,height:u,top:e,left:t}},_show:function(i){var t=this,e=i.width,o=i.height,s=i.duration,n=i.top,a=i.left;this.ui.modal.hasClass("cms-modal-open")&&this.ui.modal.addClass("cms-modal-morphing"),this.ui.modal.css({display:"block",width:e,height:o,top:n,left:a,"margin-left":-(e/2),"margin-top":-(o/2)}),setTimeout(function(){t.ui.modal.addClass("cms-modal-open")},0),this.ui.modal.one("cmsTransitionEnd",function(){t.ui.modal.removeClass("cms-modal-morphing"),t.ui.modal.css({"margin-left":-(e/2),"margin-top":-(o/2)}),t.triggerMaximized&&t.maximize(),CMS.API.locked=!1,t.trigger("cms.modal.shown")}).emulateTransitionEnd(s),this.ui.body.off("keydown.cms.close").on("keydown.cms.close",function(i){i.keyCode===CMS.KEYS.ESC&&t.close()}),this.ui.modal.focus()},close:function(){this.options.onClose&&this.reloadBrowser(this.options.onClose,!1,!0),CMS._newPlugin?this._deletePlugin({hideAfter:!0}):this._hide({duration:this.options.modalDuration/2})},_hide:function(i){var t=this,e=this.options.modalDuration;i&&i.duration&&(e=i.duration),this.ui.frame.empty(),this.ui.modalBody.removeClass("cms-loader"),this.ui.modal.removeClass("cms-modal-open"),this.ui.modal.one("cmsTransitionEnd",function(){t.ui.modal.css("display","none")}).emulateTransitionEnd(e),setTimeout(function(){t.minimized&&t.minimize(),t.maximized&&t.maximize(),t.trigger("cms.modal.closed")},this.options.duration)},minimize:function(){return this.maximized?!1:void(this.minimized===!1?(CMS.API.Toolbar.open(),this.ui.modal.data("css",this.ui.modal.css(["left","top","margin-left","margin-top"])),this.ui.body.addClass("cms-modal-minimized"),this.ui.modal.css({left:this.ui.toolbarLeftPart.outerWidth(!0)+50}),this.minimized=!0):(this.ui.body.removeClass("cms-modal-minimized"),this.ui.modal.css(this.ui.modal.data("css")),this.minimized=!1))},maximize:function(){return this.minimized?!1:void(this.maximized===!1?(this.ui.modal.data("css",this.ui.modal.css(["left","top","margin-left","margin-top","width","height"])),this.ui.body.addClass("cms-modal-maximized"),this.maximized=!0):(this.ui.body.removeClass("cms-modal-maximized"),this.ui.modal.css(this.ui.modal.data("css")),this.maximized=!1))},_startMove:function(i){if(this.maximized||this.minimized)return!1;var t,e,o=this,s=this.ui.modal.position();this.ui.shim.show(),this.ui.body.on(this.pointerUp,function(i){o._stopMove(i)}),this.ui.body.on(this.pointerMove,function(n){t=s.left-(i.originalEvent.pageX-n.originalEvent.pageX),e=s.top-(i.originalEvent.pageY-n.originalEvent.pageY),o.ui.modal.css({left:t,top:e})}).attr("data-touch-action","none")},_stopMove:function(){this.ui.shim.hide(),this.ui.body.off(this.pointerMove+" "+this.pointerUp).removeAttr("data-touch-action")},_startResize:function(i){if(this.maximized)return!1;var t=this,e=this.ui.modal.width(),o=this.ui.modal.height(),s=this.ui.modal.position().left,n=this.ui.modal.position().top;this.ui.body.on(this.pointerUp,function(i){t._stopResize(i)}),this.ui.shim.show(),this.ui.body.on(this.pointerMove,function(a){var m=i.originalEvent.pageX-a.originalEvent.pageX,l=i.originalEvent.pageY-a.originalEvent.pageY,d=e-2*m,r=o-2*l,c=t.options.minWidth,u=t.options.minHeight,h=m+s,f=l+n;c>=d&&(d=c,h=s+e/2-d/2),u>=r&&(r=u,f=n+o/2-r/2),t.ui.modal.css({width:d,height:r,left:h,top:f})}).attr("data-touch-action","none")},_stopResize:function(){this.ui.shim.hide(),this.ui.body.off(this.pointerMove+" "+this.pointerUp).removeAttr("data-touch-action")},_setBreadcrumb:function(t){var e="",o='<a href="{1}" class="{2}"><span>{3}</span></a>';return!t||t.length<=1?!1:t[0].title?(this.ui.modal.addClass("cms-modal-has-breadcrumb"),i.each(t,function(i,s){var n=i>=t.length-1?"active":"";e+=o.replace("{1}",s.url).replace("{2}",n).replace("{3}",s.title)}),void this.ui.breadcrumb.html(e)):!1},_setButtons:function(t){var e,o,s=t.contents().find(".suit-columns").length>0,n=this,a=i('<div class="cms-modal-item-buttons"></div>'),m=i('<div class="cms-modal-buttons-inner"></div>'),l=i('<a href="#" class="cms-btn">'+this.config.lang.cancel+"</a>");e=t.contents().find(s?".save-box:eq(0)":".submit-row:eq(0)");var d=t.contents().find("form");d.on("submit",function(){n.hideFrame&&(n.ui.modal.find(".cms-modal-frame iframe").hide(),n.saved=!0)});var r=e.find("input, a, button");t.contents().find(".submit-row").hide(),r.length||(e=t.contents().find("body:not(.change-list) #content form:eq(0)"),r=e.find('input[type="submit"], button[type="submit"]'),r.addClass("deletelink").hide()),r.each(function(t,e){if(e=i(e),e.attr("data-rel","_"+t),"hidden"===e.attr("type"))return!1;var o=e.attr("value")||e.text(),s="cms-btn";e.is("button")&&(o=e.text()),e.hasClass("default")&&(s="cms-btn cms-btn-action"),e.hasClass("deletelink")&&(s="cms-btn cms-btn-caution");var l=i('<a href="#" class="'+s+" "+e.attr("class")+'">'+o+"</a>");l.on(n.click,function(){e.is("a")&&n._loadIframe({url:e.prop("href"),name:o}),(e.hasClass("default")||e.hasClass("deletelink"))&&(e.hasClass("default")?n.hideFrame=!0:(n.ui.modal.find(".cms-modal-frame iframe").hide(),n.saved=!0)),(e.is("input")||e.is("button"))&&e[0].click()}),l.wrap(a),m.append(l.parent())}),l.on(n.click,function(){n.options.onClose=!1,n.close()}),l.wrap(a),m.append(l.parent()),m.find(".cms-btn-group").unwrap(),o=m.find(".cms-btn-group").clone(!0,!0),m.find(".cms-btn-group").remove(),m.append(o.wrapAll(a.clone().addClass("cms-modal-item-buttons-left")).parent()),this.ui.modalButtons.html(m)},_loadIframe:function(t){var e=this;t.url=this.makeURL(t.url),t.title=t.title||"",t.breadcrumbs=t.breadcrumbs||"",CMS.API.Toolbar.showLoader(),this.ui.modal.removeClass("cms-modal-markup"),this.ui.modal.addClass("cms-modal-iframe"),this._setBreadcrumb(t.breadcrumbs);var o=this.ui.frame,s=i('<iframe src="'+t.url+'" class="" frameborder="0" />'),n=this.ui.titlePrefix,a=this.ui.titleSuffix;s.css("visibility","hidden"),n.text(t.title||""),a.text(""),o.find("iframe").css("visibility","hidden"),e.ui.modalBody.addClass("cms-loader"),s.on("load",function(){var o,n,m,l,d;try{s.contents()}catch(r){CMS.API.Messages.open({message:"<strong>"+r+"</strong>",error:!0}),e.close()}return CMS.Modal._setupCtrlEnterSave(document),CMS.Modal._setupCtrlEnterSave(s[0].contentWindow.document),s[0].contentWindow.CMS&&s[0].contentWindow.CMS.CKEditor&&i(s[0].contentWindow.document).ready(function(){setTimeout(function(){var t=s[0].contentWindow.CMS.CKEditor.editor;t&&t.on("loaded",function(t){CMS.Modal._setupCtrlEnterSave(i(t.editor.container.$).find("iframe")[0].contentWindow.document)})},100)}),CMS.API.Toolbar.hideLoader(),o=s.contents().find(".messagelist li"),o.length&&CMS.API.Messages.open({message:o.eq(0).text()}),o.remove(),n=s.contents(),m=n.find("body"),m.addClass("cms-admin cms-admin-modal"),o.length&&e.enforceReload&&e.reloadBrowser(),o.length&&e.enforceClose?(e.close(),!1):(n.find(".viewsitelink").attr("target","_top"),e._setButtons(i(this)),(s.contents().find(".errornote").length||s.contents().find(".errorlist").length)&&(e.saved=!1),void(e.saved&&!n.find(".delete-confirmation").length?e.reloadBrowser(e.options.onClose?e.options.onClose:window.location.href,!1,!0):(s.show(),l=s.contents().find("#content h1:eq(0)"),void 0===t.title&&""===e.ui.titlePrefix.text()&&(d=s.contents().find(".breadcrumbs").contents(),e.ui.titlePrefix.text(d.eq(d.length-1).text().replace("›","").trim())),a.text(l.text()),l.remove(),s.css("visibility","visible"),s.data("ready",!0),m.on("keydown.cms",function(i){i.keyCode===CMS.KEYS.ESC&&e.close()}),n.find(".object-tools").length&&n.find("#content").css("padding-top",38))))}),o.html(s)},_changeIframe:function(i){if(i.hasClass("active"))return!1;var t=i.parent().find("a");t.removeClass("active"),i.addClass("active"),this._loadIframe({url:i.attr("href")}),this.ui.titlePrefix.text(i.text())},_loadMarkup:function(i){this.ui.modal.removeClass("cms-modal-iframe"),this.ui.modal.addClass("cms-modal-markup"),this.ui.modalBody.removeClass("cms-loader"),this.ui.frame.empty().append(i.html),this.ui.titlePrefix.text(i.title||""),this.ui.titleSuffix.text(i.subtitle||"")},_deletePlugin:function(i){var t=this,e=CMS._newPlugin,o='{ "csrfmiddlewaretoken": "'+this.config.csrf+'" }',s=this.config.lang.confirmEmpty.replace("{1}",CMS._newPlugin.breadcrumb[CMS._newPlugin.breadcrumb.length-1].title);return CMS.API.Toolbar.openAjax({url:e["delete"],post:o,text:s,callback:function(){CMS._newPlugin=!1,i&&i.hideAfter&&t._hide({duration:100})}})}}),CMS.Modal._setupCtrlEnterSave=function(t){var e=!1,o=navigator.platform.toLowerCase().indexOf("mac")+1;i(t).on("keydown.cms.submit",function(t){t.ctrlKey&&t.keyCode===CMS.KEYS.ENTER&&!o&&i(".cms-modal-buttons .cms-btn-action:first").trigger("click"),o&&((t.keyCode===CMS.KEYS.CMD_LEFT||t.keyCode===CMS.KEYS.CMD_RIGHT)&&(e=!0),t.keyCode===CMS.KEYS.ENTER&&e&&i(".cms-modal-buttons .cms-btn-action:first").trigger("click"))}).on("keyup.cms.submit",function(i){o&&(i.keyCode===CMS.KEYS.CMD_LEFT||i.keyCode===CMS.KEYS.CMD_RIGHT)&&(e=!1)})}})}(CMS.$);
var CMS=window.CMS||{};!function(i){"use strict";i(function(){CMS.Sideframe=new CMS.Class({implement:[CMS.API.Helpers],options:{onClose:!1,sideframeDuration:300,sideframeWidth:.8},initialize:function(e){this.options=i.extend(!0,{},this.options,e),this.config=CMS.config,this.settings=CMS.settings,this._setupUI(),this.click="click.cms.sideframe",this.pointerDown="pointerdown.cms.sideframe contextmenu.cms.sideframe",this.pointerUp="pointerup.cms.sideframe pointercancel.cms.sideframe",this.pointerMove="pointermove.cms.sideframe",this.enforceReload=!1,this.settingsRefreshTimer=600,this.ui.sideframe.data("ready")||this._events(),this.ui.sideframe.data("ready",!0)},_setupUI:function(){var e=i(".cms-sideframe");this.ui={sideframe:e,body:i("html"),window:i(window),dimmer:e.find(".cms-sideframe-dimmer"),close:e.find(".cms-sideframe-close"),resize:e.find(".cms-sideframe-resize"),frame:e.find(".cms-sideframe-frame"),shim:e.find(".cms-sideframe-shim")}},_events:function(){var i=this;this.ui.close.on(this.click,function(){i.close()}),this.ui.resize.on(this.pointerDown,function(e){e.preventDefault(),i._startResize()}),this.ui.dimmer.on(this.click,function(){i.close()})},open:function(i){if(!i||!i.url)throw new Error('The arguments passed to "open" were invalid.');var e=i.url,t=i.animate,s="language="+CMS.config.request.language,n="page_id="+CMS.config.request.page_id,o=[],r=this.settings.sideframe.position||window.innerWidth*this.options.sideframeWidth,a=this.ui.sideframe.outerWidth(),d=this.ui.sideframe.is(":visible");return this.ui.dimmer.show(),this.ui.frame.addClass("cms-loader"),CMS.API&&CMS.API.Toolbar&&CMS.API.Toolbar.showLoader(),e.indexOf(CMS.config.request.tree)>=0&&(CMS.config.request.language&&o.push(s),CMS.config.request.page_id&&o.push(n)),e=this.makeURL(e,o),this._content(e),d&&r>a&&(this.settings.sideframe.hidden=!1),d&&Math.round(a)===Math.round(r)&&(t=!1),this._show(r,t),this},_content:function(e){var t,s,n=this,o=!1,r=i('<iframe src="'+e+'" class="" frameborder="0" />'),a=this.ui.frame;r.hide().on("load",function(){t=r.contents(),s=t.find("body"),s.addClass("cms-admin cms-admin-sideframe"),n.ui.frame.removeClass("cms-loader"),r.show(),n.config.debug&&r.contents().find("body").addClass("cms-debug"),n.settings.sideframe.url=r.prop("src"),n.settings=n.setSettings(n.settings),s.on(n.click,function(){i(document).trigger(n.click)}),o&&n.reloadBrowser(!1,!1,!0),o=!0,t.find(".viewsitelink").attr("target","_top")}),a.html(r)},_show:function(e,t){this.ui.sideframe.show(),this.settings.sideframe.hidden&&this._hide(),t?this.ui.sideframe.animate({width:e,overflow:"visible"},this.options.sideframeDuration):(this.ui.sideframe.css("width",e),e>=i(window).width()&&this.ui.sideframe.css({width:i(window).width()-30,overflow:"visible"})),CMS.API&&CMS.API.Toolbar&&(CMS.API.Toolbar.open(),CMS.API.Toolbar.hideLoader(),CMS.API.Toolbar._lock(!0))},close:function(){this.ui.dimmer.hide(),this.settings.sideframe={url:null,hidden:!1,width:this.options.sideframeWidth},this.settings=this.setSettings(this.settings),this.reloadBrowser(this.options.onClose,!1,!0),this._hide({duration:0})},_hide:function(e){var t=this.options.sideframeDuration;e&&e.duration&&(t=e.duration),this.ui.sideframe.animate({width:0},t,function(){i(this).hide()}),this.ui.frame.removeClass("cms-loader"),CMS.API&&CMS.API.Toolbar&&CMS.API.Toolbar._lock(!1)},_startResize:function(){var e=this,t=30,s=function(){};this.ui.body.on(this.pointerUp,function(i){i.preventDefault(),e._stopResize()}),this.ui.shim.css("z-index",20),this.ui.body.attr("data-touch-action","none").on(this.pointerMove,function(n){n.originalEvent.clientX<=320&&(n.originalEvent.clientX=320),n.originalEvent.clientX>=i(window).width()-t&&(n.originalEvent.clientX=i(window).width()-t),e.ui.sideframe.css("width",n.originalEvent.clientX),e.settings.sideframe.position=n.originalEvent.clientX,clearTimeout(s),s=setTimeout(function(){e.settings=e.setSettings(e.settings)},e.settingsRefreshTimer)})},_stopResize:function(){this.ui.shim.css("z-index",1),this.ui.body.off(this.pointerUp).off(this.pointerMove).removeAttr("data-touch-action")}})})}(CMS.$);
<<<<<<< HEAD
var CMS=window.CMS||{};!function(i){"use strict";i(function(){CMS.Clipboard=new CMS.Class({implement:[CMS.API.Helpers],initialize:function(){this._setupUI(),this.config=CMS.config,this.settings=CMS.settings,this.click="click.cms.clipboard",this._events()},_setupUI:function(){var t=i(".cms-clipboard");this.ui={clipboard:t,triggers:i(".cms-clipboard-trigger a"),triggerRemove:i(".cms-clipboard-empty a"),pluginsList:t.find(".cms-clipboard-containers")}},_events:function(){var t=this,e=400,s=117;t.modal=new CMS.Modal({minWidth:e,minHeight:s,minimizable:!1,maximizable:!1,resizable:!1}),t.modal.on("cms.modal.loaded cms.modal.closed",function(){i(".cms-add-plugin-placeholder").remove()}).on("cms.modal.closed cms.modal.load",function(){t.ui.pluginsList.prependTo(t.ui.clipboard)}).ui.modal.on("cms.modal.load",function(){t.ui.pluginsList.prependTo(t.ui.clipboard)}),t.ui.triggers.on(t.click,function(a){return a.preventDefault(),i(this).parent().hasClass("cms-toolbar-item-navigation-disabled")?!1:void t.modal.open({html:t.ui.pluginsList,title:t.ui.clipboard.data("title"),width:e,height:s})}),t.ui.triggerRemove.on(t.click,function(e){return e.preventDefault(),e.stopPropagation(),i(this).parent().hasClass("cms-toolbar-item-navigation-disabled")?!1:void t.clear(function(){t.modal.close(),t.ui.triggers.parent().addClass("cms-toolbar-item-navigation-disabled"),t.ui.triggerRemove.parent().addClass("cms-toolbar-item-navigation-disabled")})})},clear:function(t){var e='{ "csrfmiddlewaretoken": "'+this.config.csrf+'" }',s=i(".cms-submenu-item [data-rel=paste]").parent().addClass("cms-submenu-item-disabled");s.find(".cms-submenu-item-paste-tooltip").css("display","none"),s.find(".cms-submenu-item-paste-tooltip-empty").css("display","block"),CMS.API.Toolbar.openAjax({url:this.config.clipboard.url,post:e,callback:t})}})})}(CMS.$);
var CMS=window.CMS||{};!function(e){"use strict";e(function(){var s=e(document),i=e(".cms-clipboard"),t=i.find(".cms-draggable:first"),n=i.find(".cms-plugin:first");s.on("pointerup.cms.plugin",function(){CMS.Plugin._hideSettingsMenu()}).on("keydown.cms.plugin",function(e){e.keyCode===CMS.KEYS.SHIFT&&s.data("expandmode",!0)}).on("keyup.cms.plugin",function(e){e.keyCode===CMS.KEYS.SHIFT&&s.data("expandmode",!1)}),CMS.Plugin=new CMS.Class({implement:[CMS.API.Helpers],options:{type:"",placeholder_id:null,plugin_type:"",plugin_id:null,plugin_language:"",plugin_parent:null,plugin_order:null,plugin_breadcrumb:[],plugin_restriction:[],urls:{add_plugin:"",edit_plugin:"",move_plugin:"",copy_plugin:"",delete_plugin:""}},initialize:function(s,i){switch(this.options=e.extend(!0,{},this.options,i),this._setupUI(s),this.csrf=CMS.config.csrf,this.click="click.cms.plugin",this.pointerUp="pointerup.cms.plugin",this.pointerDown="pointerdown.cms.plugin",this.pointerOverAndOut="pointerover.cms.plugin pointerout.cms.plugin",this.doubleClick="dblclick.cms.plugin",this.keyUp="keyup.cms.plugin",this.keyDown="keydown.cms.plugin",this.mouseEvents="mousedown.cms.plugin mousemove.cms.plugin mouseup.cms.plugin",this.touchStart="touchstart.cms.plugin",this.ui.container.data("settings",this.options),this.options.type){case"placeholder":this._setPlaceholder(),this._collapsables();break;case"plugin":this._setPlugin(),this._collapsables();break;default:this._setGeneric()}},_setupUI:function(s){s=e("."+s),this.ui={container:s,publish:e(".cms-btn-publish"),window:e(window),revert:e(".cms-toolbar-revert"),dragbar:null,draggable:null,draggables:null,submenu:null,dropdown:null}},_setPlaceholder:function(){var s=this;this.ui.dragbar=e(".cms-dragbar-"+this.options.placeholder_id),this.ui.draggables=this.ui.dragbar.closest(".cms-dragarea").find("> .cms-draggables"),this.ui.submenu=this.ui.dragbar.find(".cms-submenu-settings");var i=this.ui.dragbar.find(".cms-dragbar-title"),t=this.ui.dragbar.find(".cms-dragbar-toggler a"),n="cms-dragbar-title-expanded";this._setSettingsMenu(this.ui.submenu),this._setAddPluginModal(this.ui.dragbar.find(".cms-submenu-add")),CMS.settings.dragbars=CMS.settings.dragbars||[],t.off(this.click).on(this.click,function(e){e.preventDefault(),i.hasClass(n)?s._collapseAll(i):s._expandAll(i)}),-1!==e.inArray(this.options.placeholder_id,CMS.settings.dragbars)&&i.addClass(n),this._checkIfPasteAllowed()},_setPlugin:function(){var s=this;this.ui.container.add(this.ui.dragitem).on(this.doubleClick,function(e){e.preventDefault(),e.stopPropagation(),s.editPlugin(s.options.urls.edit_plugin,s.options.plugin_name,s.options.plugin_breadcrumb)}),this.ui.container.on(this.pointerOverAndOut,function(e){e.stopPropagation();var i=s.options.plugin_name,t=s.options.plugin_id;CMS.API.Tooltip.displayToggle("pointerover"===e.type,e,i,t)}),this.ui.container.on("cms.plugins.update",function(e){e.stopPropagation(),s.movePlugin()}),this.ui.container.on("cms.plugin.update",function(i){i.stopPropagation();var t=e(i.delegateTarget),n=e(".cms-draggable-"+t.data("settings").plugin_id),a=s._getId(n.parents(".cms-draggables").last().prevAll(".cms-dragbar").first());if(!a)return!1;var o=t.data("settings");o.target=a,o.parent=s._getId(n.parent().closest(".cms-draggable")),o.move_a_copy=!0,s.movePlugin(o)}),this.ui.draggable=e(".cms-draggable-"+this.options.plugin_id),this.ui.dragitem=this.ui.draggable.find("> .cms-dragitem"),this.ui.draggables=this.ui.draggable.find("> .cms-draggables"),this.ui.submenu=this.ui.dragitem.find(".cms-submenu"),this._setSettingsMenu(this.ui.submenu),this._setAddPluginModal(this.ui.dragitem.find(".cms-submenu-add")),this._checkIfPasteAllowed()},_setGeneric:function(){var e=this;this.ui.container.on(this.doubleClick,function(s){s.preventDefault(),s.stopPropagation(),e.editPlugin(e.options.urls.edit_plugin,e.options.plugin_name,[])}),this.ui.container.on(this.pointerOverAndOut,function(s){s.stopPropagation();var i=e.options.plugin_name,t=e.options.plugin_id;CMS.API.Tooltip.displayToggle("pointerover"===s.type,s,i,t)})},_checkIfPasteAllowed:function(){var s=this.ui.dropdown.find("[data-rel=paste]"),i=s.parent();if(!n.length)return i.addClass("cms-submenu-item-disabled"),i.find(".cms-submenu-item-paste-tooltip-empty").css("display","block"),!1;if(this.ui.draggable&&this.ui.draggable.hasClass("cms-draggable-disabled"))return i.addClass("cms-submenu-item-disabled"),i.find(".cms-submenu-item-paste-tooltip-disabled").css("display","block"),!1;var t=this.options.plugin_restriction,a=n.data("settings").plugin_type;return t.length&&-1===e.inArray(a,t)?(i.addClass("cms-submenu-item-disabled"),i.find(".cms-submenu-item-paste-tooltip-restricted").css("display","block"),!1):!0},addPlugin:function(s,i,t){if(CMS.API.locked)return!1;CMS.API.locked=!0;var n=this,a={placeholder_id:this.options.placeholder_id,plugin_type:s,plugin_parent:t||"",plugin_language:this.options.plugin_language,csrfmiddlewaretoken:this.csrf};e.ajax({type:"POST",url:this.options.urls.add_plugin,data:a,success:function(e){CMS.API.locked=!1,n.newPlugin=e,n.editPlugin(e.url,i,e.breadcrumb)},error:function(e){CMS.API.locked=!1;var s=CMS.config.lang.error;CMS.API.Messages.open({message:s+e.responseText||e.status+" "+e.statusText,error:!0})}})},editPlugin:function(s,i,t){var n=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});this.newPlugin||n.on("cms.modal.loaded",function(){e(".cms-add-plugin-placeholder").remove()}),n.on("cms.modal.closed",function(){e(".cms-add-plugin-placeholder").remove()}),n.open({url:s,title:i,breadcrumbs:t,width:850})},copyPlugin:function(s,i){if(CMS.API.locked)return!1;CMS.API.locked=!0;var t=s||i?!0:!1;s=s||this.options,i?(s.target=s.placeholder_id,s.plugin_id="",s.parent=""):i=s.plugin_language;var n={source_placeholder_id:s.placeholder_id,source_plugin_id:s.plugin_id||"",source_language:i,target_plugin_id:s.parent||"",target_placeholder_id:s.target||CMS.config.clipboard.id,target_language:s.page_language||i,csrfmiddlewaretoken:this.csrf},a={type:"POST",url:s.urls.copy_plugin,data:n,success:function(){CMS.API.Messages.open({message:CMS.config.lang.success}),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var s=CMS.config.lang.error;CMS.API.Messages.open({message:s+e.responseText||e.status+" "+e.statusText,error:!0})}};t?e.ajax(a):CMS.API.Clipboard.clear(function(){e.ajax(a)})},cutPlugin:function(){if(CMS.API.locked)return!1;CMS.API.locked=!0;var s=this,i={placeholder_id:CMS.config.clipboard.id,plugin_id:this.options.plugin_id,plugin_parent:"",plugin_language:this.options.page_language,plugin_order:[this.options.plugin_id],csrfmiddlewaretoken:this.csrf};CMS.API.Clipboard.clear(function(){return CMS.API.locked?!1:(CMS.API.locked=!0,void e.ajax({type:"POST",url:s.options.urls.move_plugin,data:i,success:function(){CMS.API.Messages.open(CMS.config.lang.success),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var s=CMS.config.lang.error;CMS.API.Messages.open({message:s+e.responseText||e.status+" "+e.statusText,error:!0})}}))})},pastePlugin:function(){t.appendTo(this.ui.draggables),this.ui.draggables.trigger("cms.update"),n.trigger("cms.plugin.update")},movePlugin:function(s){if(CMS.API.locked)return!1;CMS.API.locked=!0;var i=this;s=s||this.options;var t=e(".cms-plugin-"+s.plugin_id),n=e(".cms-draggable-"+s.plugin_id);this._setPosition(s.plugin_id,t,n);var a=this._getId(n.parents(".cms-draggables").last().prevAll(".cms-dragbar").first()),o=this._getId(n.parent().closest(".cms-draggable")),l=this._getIds(n.siblings(".cms-draggable").andSelf());if(s.move_a_copy&&(l=l.map(function(e){return e===s.plugin_id&&(e="__COPY__"),e})),a===!1)return!1;var r={placeholder_id:a,plugin_id:s.plugin_id,plugin_parent:o||"",plugin_language:s.page_language,plugin_order:l,csrfmiddlewaretoken:this.csrf,move_a_copy:s.move_a_copy};e.ajax({type:"POST",url:s.urls.move_plugin,data:r,success:function(e){e.reload&&CMS.API.Helpers.reloadBrowser(),CMS.API.locked=!1,i._showSuccess(n)},error:function(e){CMS.API.locked=!1;var s=CMS.config.lang.error;CMS.API.Messages.open({message:s+e.responseText||e.status+" "+e.statusText,error:!0})}}),this.ui.publish.addClass("cms-btn-publish-active").removeClass("cms-btn-disabled").parent().show(),this.ui.window.trigger("resize"),this.ui.revert.removeClass("cms-toolbar-item-navigation-disabled")},deletePlugin:function(s,i,t){var n=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});n.on("cms.modal.loaded",function(){e(".cms-add-plugin-placeholder").remove()}),n.open({url:s,title:i,breadcrumbs:t})},_setPosition:function(s,i,t){var n=t.prev(".cms-draggable"),a=t.next(".cms-draggable"),o=t.parent().closest(".cms-draggable"),l=e(".cms-plugin-"+this._getId(o)),r=t.closest(".cms-dragarea");if(n.length)i.insertAfter(e(".cms-plugin-"+this._getId(n)));else if(a.length)i.insertBefore(e(".cms-plugin-"+this._getId(a)));else if(o.length){for(;l.children().length;)l=l.children();l.append(i)}else r.length?i.insertAfter(e(".cms-placeholder-"+this._getId(r))):CMS.API.Helpers.reloadBrowser()},editPluginPostAjax:function(e,s){this.editPlugin(s.url,this.options.plugin_name,s.breadcrumb)},_setSettingsMenu:function(s){var i=this;this.ui.dropdown=s.siblings(".cms-submenu-dropdown-settings");var t=this.ui.dropdown;s.on(this.pointerUp,function(s){s.preventDefault(),s.stopPropagation();var t=e(this);t.hasClass("cms-btn-active")?CMS.Plugin._hideSettingsMenu(t):(CMS.Plugin._hideSettingsMenu(),i._showSettingsMenu(t))}),t.on(this.mouseEvents,function(e){e.stopPropagation()}).on(this.touchStart,function(e){e.stopPropagation()}),i._setupActions(s),s.on([this.pointerUp,this.pointerDown,this.click,this.doubleClick].join(" "),function(e){e.stopPropagation()}),s.siblings(".cms-quicksearch, .cms-submenu-dropdown-settings").on([this.pointerUp,this.click,this.doubleClick].join(" "),function(e){e.stopPropagation()})},_scrollToElement:function(s,i){var t=i&&void 0!==i.duration?i.duration:200,n=i&&void 0!==i.offset?i.offset:50,a=s.offsetParent(),o=e(window),l=o.height(),r=a.scrollTop(),d=s.position().top,c=s.height(),u=l>=d+c+n;u||a.animate({scrollTop:d+n+c+r-l},t)},_setAddPluginModal:function(s){if(s.hasClass("cms-btn-disabled"))return!1;var i,t=this,n=e('<div class="cms-add-plugin-placeholder">'+CMS.config.lang.addPluginPlaceholder+"</div>"),a=new CMS.Modal({minWidth:400,minHeight:400}),o=s.closest(".cms-dragitem"),l=!Boolean(o.length);i=l?s.closest(".cms-dragarea").find("> .cms-draggables"):s.closest(".cms-draggable").find("> .cms-draggables"),a.on("cms.modal.loaded",t._setupKeyboardTraversing),a.on("cms.modal.loaded",function(){i.hasClass("cms-hidden")&&!l&&t._toggleCollapsable(o),e(".cms-add-plugin-placeholder").remove(),n.appendTo(i),t._scrollToElement(n)}),a.on("cms.modal.closed",function(){e(".cms-add-plugin-placeholder").remove()}),a.on("cms.modal.shown",function(){var s=e(".cms-modal-markup .cms-plugin-picker");s.find("input").trigger("focus")});var r=s.siblings(".cms-plugin-picker");t._setupQuickSearch(r),s.on(this.pointerUp,function(e){e.preventDefault(),e.stopPropagation(),CMS.Plugin._hideSettingsMenu();var i=r.clone(!0,!0).data("parentId",t._getId(s.closest(".cms-draggable")));a.open({title:t.ui.container.data("settings").addPluginHelpTitle,html:i,width:530,height:400})}),s.on([this.pointerUp,this.pointerDown,this.click,this.doubleClick].join(" "),function(e){e.stopPropagation()}),s.siblings(".cms-quicksearch, .cms-submenu-dropdown").on([this.pointerUp,this.click,this.doubleClick].join(" "),function(e){e.stopPropagation()})},_setupQuickSearch:function(s){var i=this,t=s.find("> .cms-quicksearch").find("input"),n=CMS.API.Helpers.debounce(function(){var s=e(this),t=s.closest(".cms-plugin-picker");i._filterPluginsList(t,s)},100);t.on(this.keyUp,n).on(this.keyUp,CMS.API.Helpers.debounce(function(s){var i,t;s.keyCode===CMS.KEYS.ENTER&&(i=e(this),t=i.closest(".cms-plugin-picker"),t.find(".cms-submenu-item").not(".cms-submenu-item-title").filter(":visible").first().find("> a").focus().trigger("click"))},110))},_setupActions:function(s){var i=this;s.parent().find("a").on(i.click,function(t){t.preventDefault(),t.stopPropagation(),CMS.API.Toolbar.showLoader();var n=e(this);switch(CMS.Plugin._hideSettingsMenu(s),n.attr("data-rel")){case"add":i.addPlugin(n.attr("href").replace("#",""),n.text(),n.closest(".cms-plugin-picker").data("parentId"));break;case"ajax_add":CMS.API.Toolbar.openAjax({url:n.attr("href"),post:JSON.stringify(n.data("post")),text:n.data("text"),callback:e.proxy(i.editPluginPostAjax,i),onSuccess:n.data("on-success")});break;case"edit":i.editPlugin(i.options.urls.edit_plugin,i.options.plugin_name,i.options.plugin_breadcrumb);break;case"copy-lang":i.copyPlugin(this.options,n.attr("data-language"));break;case"copy":i.copyPlugin();break;case"cut":i.cutPlugin();break;case"paste":n.parent().hasClass("cms-submenu-item-disabled")?CMS.API.Toolbar.hideLoader():i.pastePlugin();break;case"delete":i.deletePlugin(i.options.urls.delete_plugin,i.options.plugin_name,i.options.plugin_breadcrumb);break;default:CMS.API.Toolbar.hideLoader(),CMS.API.Toolbar._delegate(n)}})},_setupKeyboardTraversing:function(){var i=e(".cms-modal-markup .cms-plugin-picker");i.length&&(s.off(this.keyDown+".traverse"),s.on(this.keyDown+".traverse",function(e){var s=i.find(".cms-submenu-item:visible a"),t=s.index(s.filter(":focus"));(e.keyCode===CMS.KEYS.DOWN||e.keyCode===CMS.KEYS.TAB)&&(e.preventDefault(),t>=0&&t<s.length-1?s.eq(t+1).focus():s.eq(0).focus()),(e.keyCode===CMS.KEYS.UP||e.keyCode===CMS.KEYS.TAB&&e.shiftKey)&&(e.preventDefault(),s.is(":focus")?s.eq(t-1).focus():s.eq(s.length).focus())}))},_showSettingsMenu:function(e){var s=this.ui.dropdown,i=e.parentsUntil(".cms-dragarea").last();e.addClass("cms-btn-active"),i.addClass("cms-z-index-9999"),s.show(),this.ui.window.height()+this.ui.window.scrollTop()-e.offset().top-s.height()<=10&&e.offset().top-s.height()>=0?s.removeClass("cms-submenu-dropdown-top").addClass("cms-submenu-dropdown-bottom"):s.removeClass("cms-submenu-dropdown-bottom").addClass("cms-submenu-dropdown-top")},_filterPluginsList:function(s,i){var t=s.find(".cms-submenu-item"),n=s.find(".cms-submenu-item-title"),a=i.val();return""===a?(t.add(n).show(),!1):(t.find("a, span").each(function(s,i){i=e(i);var t=i.text().toLowerCase(),n=a.toLowerCase();t.indexOf(n)>=0?i.parent().show():i.parent().hide()}),n.filter(":visible").each(function(s,i){n.hide(),e(i).nextUntil(".cms-submenu-item-title").show()}),t.filter(":visible").each(function(s,i){i=e(i),i.prev().hasClass("cms-submenu-item-title")?i.prev().show():i.prevUntil(".cms-submenu-item-title").last().prev().show()}),s.siblings(".cms-submenu-dropdown-children").show(),void(t.add(n).filter(":visible").length<=0&&s.siblings(".cms-submenu-dropdown-children").hide()))},_toggleCollapsable:function(i){var t,n=this,a=n._getId(i.parent()),o=this.ui.draggable,l=CMS.settings;if(l.states=l.states||[],i.hasClass("cms-dragitem-expanded")){if(l.states.splice(e.inArray(a,l.states),1),i.removeClass("cms-dragitem-expanded").parent().find("> .cms-draggables").addClass("cms-hidden"),s.data("expandmode")){if(t=o.find(".cms-draggable").find(".cms-dragitem-collapsable"),!t.length)return!1;t.each(function(){var s=e(this);s.hasClass("cms-dragitem-expanded")&&n._toggleCollapsable(s)})}}else if(l.states.push(a),i.addClass("cms-dragitem-expanded").parent().find("> .cms-draggables").removeClass("cms-hidden"),s.data("expandmode")){if(t=o.find(".cms-draggable").find(".cms-dragitem-collapsable"),!t.length)return!1;t.each(function(){var s=e(this);s.hasClass("cms-dragitem-expanded")||n._toggleCollapsable(s)})}this.ui.window.trigger("resize.sideframe"),CMS.API.Toolbar.setSettings(l)},_collapsables:function(){var s=this;this.ui.draggable=e(".cms-draggable-"+this.options.plugin_id);var i=this.ui.draggable.find("> .cms-dragitem");if(this.ui.container.each(function(s,i){var t=e(i).find(".cms-dragitem-collapsable"),n=t.filter(".cms-dragitem-expanded");t.length===n.length&&t.length+n.length!==0&&e(i).find(".cms-dragbar-title").addClass("cms-dragbar-title-expanded")}),!this.ui.draggable.length)return!1;if(i.find("> .cms-dragitem-text").on(this.click,function(){i.hasClass("cms-dragitem-collapsable")&&s._toggleCollapsable(i)}),this.ui.draggable.on(this.doubleClick,function(i){i.stopPropagation(),e(".cms-plugin-"+s._getId(e(this))).trigger("dblclick.cms")}),CMS.Toolbar.ready)return!1;for(var t=CMS.settings.states.sort(),n=[],a=0;a<t.length;a++)t[a]!==t[a+1]&&n.push(t[a]);CMS.settings.states=n,e.each(CMS.settings.states,function(s,i){var t=e(".cms-draggable-"+i);t.find(".cms-draggables").length&&(t.find("> .cms-draggables").removeClass("cms-hidden"),t.find("> .cms-dragitem").addClass("cms-dragitem-expanded"))}),CMS.Toolbar.ready=!0},_expandAll:function(s){var i=this,t=s.closest(".cms-dragarea").find(".cms-dragitem-collapsable");if(!t.length)return!1;t.each(function(){var s=e(this);s.hasClass("cms-dragitem-expanded")||i._toggleCollapsable(s)}),s.addClass("cms-dragbar-title-expanded");var n=CMS.settings;n.dragbars=n.dragbars||[],n.dragbars.push(this.options.placeholder_id),CMS.API.Toolbar.setSettings(n)},_collapseAll:function(s){var i=this,t=s.closest(".cms-dragarea").find(".cms-dragitem-collapsable");t.each(function(){var s=e(this);s.hasClass("cms-dragitem-expanded")&&i._toggleCollapsable(s)}),s.removeClass("cms-dragbar-title-expanded");var n=CMS.settings;n.dragbars=n.dragbars||[],n.dragbars.splice(e.inArray(this.options.placeholder_id,n.states),1),CMS.API.Toolbar.setSettings(n)},_getId:function(e){return CMS.API.StructureBoard.getId(e)},_getIds:function(e){return CMS.API.StructureBoard.getIds(e)},_showSuccess:function(s){var i=e('<div class="cms-dragitem-success"></div>');s.addClass("cms-draggable-success").append(i),i.fadeOut(1e3,function(){e(this).remove(),s.removeClass("cms-draggable-success")}),this.ui.window.trigger("resize.sideframe")}}),CMS.Plugin._hideSettingsMenu=function(s){s=s||e(".cms-submenu-btn.cms-btn-active"),s.length&&(s.removeClass("cms-btn-active"),s.closest(".cms-draggable").data("active",!1),e(".cms-z-index-9999").removeClass("cms-z-index-9999"),s.siblings(".cms-submenu-dropdown").hide(),s.siblings(".cms-quicksearch").hide(),s.siblings(".cms-quicksearch").find("input").val("").trigger(this.keyUp).blur(),e(".cms-dragbar").css("position",""))}})}(CMS.$);
!function(e){"use strict";e(function(){function t(){i.each(function(){var t=e(this);t.find("> .cms-draggables").children(".cms-draggable:not(.cms-draggable-is-dragging)").length?t.removeClass("cms-dragarea-empty"):t.addClass("cms-dragarea-empty")})}function s(t){t.each(function(){var t=e(this),s=t.closest(".cms-draggable").find("> .cms-dragitem");t.children().length?s.addClass("cms-dragitem-collapsable cms-dragitem-expanded"):s.removeClass("cms-dragitem-collapsable")})}var i=e(".cms-dragarea:not(.cms-clipboard-containers)");CMS.StructureBoard=new CMS.Class({implement:[CMS.API.Helpers],options:{speed:300},initialize:function(s){this.options=e.extend(!0,{},this.options,s),this.config=CMS.config,this.settings=CMS.settings,this._setupUI(),this.click="click.cms",this.state=!1,this.dragging=!1,this._setup(),this._events(),t()},_setupUI:function(){var t=e(".cms-structure"),s=e(".cms-toolbar");this.ui={container:t,content:e(".cms-structure-content"),doc:e(document),window:e(window),toolbar:s,sortables:e(".cms-draggables"),plugins:e(".cms-plugin"),render_model:e(".cms-render-model"),placeholders:e(".cms-placeholder"),dragitems:e(".cms-draggable"),dragareas:e(".cms-dragarea"),clipboard:e(".cms-clipboard"),toolbarModeSwitcher:s.find(".cms-toolbar-item-cms-mode-switcher"),toolbarModeLinks:s.find(".cms-toolbar-item-cms-mode-switcher a")}},_setup:function(){var e=this;return this.ui.dragareas.length&&this.ui.toolbarModeSwitcher.length?(setTimeout(function(){"structure"===e.settings.mode?e.show(!0):e.hide(!0)},0),this.ui.placeholders.length&&this.ui.toolbarModeSwitcher.show(),void this._drag()):!1},_events:function(){var e=this,t=e.ui.toolbarModeLinks;t.eq(1).on(e.click,function(t){return t.preventDefault(),"edit"===e.settings.mode?!1:void e.hide()}),t.eq(0).on(e.click,function(t){return t.preventDefault(),"structure"===e.settings.mode?!1:void e.show()}),e.ui.toolbarModeSwitcher.length&&e.ui.doc.on("keydown",function(t){var s=document.activeElement!==document.body;t.keyCode!==CMS.KEYS.SPACE||s||(t.preventDefault(),"structure"===e.settings.mode?e.hide():"edit"===e.settings.mode&&e.show())})},show:function(e){if("live"===CMS.config.mode)return!1;var t=this.ui.toolbarModeLinks;t.removeClass("cms-btn-active").eq(0).addClass("cms-btn-active"),this.ui.clipboard.fadeIn(this.options.speed),this.settings.mode="structure",e||(this.settings=this.setSettings(this.settings)),this.ui.dragareas.show(),this._showBoard()},hide:function(e){if("live"===CMS.config.mode)return!1;var t=this.ui.toolbarModeLinks;t.removeClass("cms-btn-active").eq(1).addClass("cms-btn-active"),this.ui.container.find(".cms-clipboard").hide(),this.ui.clipboard.hide(),this.settings.mode="edit",e||(this.settings=this.setSettings(this.settings)),this._hideBoard()},getId:function(e){if(void 0===e||null===e||e.length<=0)return!1;var t=null,s=e.attr("class").split(" ")[1];return e.hasClass("cms-plugin")?t=s.replace("cms-plugin-",""):e.hasClass("cms-draggable")?t=s.replace("cms-draggable-",""):e.hasClass("cms-placeholder")?t=s.replace("cms-placeholder-",""):e.hasClass("cms-dragbar")?t=s.replace("cms-dragbar-",""):e.hasClass("cms-dragarea")&&(t=s.replace("cms-dragarea-","")),t},getIds:function(t){var s=this,i=[];return t.each(function(){i.push(s.getId(e(this)))}),i},_showBoard:function(){var t=this;if(this.ui.container.show(),this.ui.dragareas.css("opacity",1),this.ui.plugins.not(this.ui.render_model).hide(),this.ui.placeholders.show(),CMS.config.simpleStructureBoard){var s=this.ui.content,i=s.find(".cms-dragarea");s.addClass("cms-structure-content-simple"),i.addClass("cms-dragarea-simple"),i.each(function(t,i){e(i).hasClass("cms-dragarea-static")&&s.append(i)}),i.filter(".cms-dragarea-static").eq(0).css("margin-top","50px")}else this.ui.container.addClass("cms-structure-dynamic"),this.ui.window.on("resize.sideframe",function(){t._resizeBoard()}).trigger("resize.sideframe")},_hideBoard:function(){this.ui.container.hide(),this.ui.plugins.show(),this.ui.placeholders.hide(),this.ui.window.off("resize.sideframe"),this.ui.window.trigger("structureboard_hidden.sideframe"),CMS.config.simpleStructureBoard||this.ui.container.height(this.ui.doc.outerHeight())},_resizeBoard:function(){var t=null,s=null,i=null,a=null,r=this;setTimeout(function(){r.ui.container.height(r.ui.doc.outerHeight())},0),this.ui.placeholders.each(function(r,n){n=e(n),t=n.data("settings").placeholder_id,s=e(".cms-dragarea-"+t),n.height(s.outerHeight(!0)),i=n.width()?0:150,a=e(s).offsetParent().offset(),s.css({top:n.offset().top-a.top-5,left:n.offset().left-a.left-i,width:n.width()+i})})},_drag:function(){var i,a=this;this.ui.sortables.nestedSortable({items:"> .cms-draggable:not(.cms-draggable-disabled .cms-draggable)",placeholder:"cms-droppable",connectWith:".cms-draggables:not(.cms-hidden)",tolerance:"intersect",toleranceElement:"> div",dropOnEmpty:!0,helper:function(e,t){var s=t.find("> .cms-dragitem").clone();return s.wrap('<div class="'+t[0].className+'"></div>'),s.parent()},appendTo:".cms-structure-content",cursor:"move",cursorAt:{left:-15,top:-15},opacity:1,zIndex:9999999,delay:100,tabSize:15,listType:"div.cms-draggables",doNotClear:!0,disableNestingClass:"cms-draggable-disabled",errorClass:"cms-draggable-disallowed",start:function(s,r){i=r.item.closest(".cms-draggables"),a.dragging=!0,t(),CMS.Plugin._hideSettingsMenu(),a.ui.sortables.each(function(){var t=e(this);0===t.children().length&&t.removeClass("cms-hidden")}),r.item.addClass("cms-is-dragging"),r.helper.addClass("cms-draggable-is-dragging"),r.item.find("> .cms-draggables").children().length&&r.helper.addClass("cms-draggable-stack"),a.ui.doc.on("keyup.cms.interrupt",function(t,s){(t.keyCode===CMS.KEYS.ESC&&a.dragging||s)&&(a.state=!1,e.ui.sortable.prototype._mouseStop(),a.ui.sortables.trigger("mouseup"))})},beforeStop:function(e,t){a.dragging=!1,t.item.removeClass("cms-is-dragging cms-draggable-stack"),a.ui.doc.off("keyup.cms.interrupt")},update:function(r,n){if(!a.state)return!1;var c=n.item.closest(".cms-draggables");if(i.is(c)){if(!c.is(this))return!1}else s(c.add(i));var d=a.getId(n.item),o=e(".cms-plugin-"+d);o.trigger(o.closest(".cms-clipboard").length?"cms.plugin.update":"cms.plugins.update"),a.ui.sortables.each(function(){var t=e(this);0===t.children().length&&t.addClass("cms-hidden")}),t()},isAllowed:function(t,s,i){if(CMS.API.locked)return!1;var r=[],n=e(".cms-plugin-"+a.getId(i));if(0===n.length||null===n.data("settings"))return!1;var c,d=n.data("settings").plugin_type,o=a.getId(t.closest(".cms-dragarea")),l=e(".cms-placeholder-"+o);return c=e(s&&s.length?".cms-plugin-"+a.getId(s.closest(".cms-draggable")):".cms-plugin-"+a.getId(t.closest(".cms-draggable"))),l.length&&(r=l.data("settings").plugin_restriction),c.length&&(r=c.data("settings").plugin_restriction),t.parent().hasClass("cms-draggable-disabled")?!1:(a.state=r.length&&-1===e.inArray(d,r)?!1:!0,a.state)}}).on("cms.update",t)}})})}(CMS.$);
=======
var CMS=window.CMS||{};!function(i){"use strict";i(function(){CMS.Clipboard=new CMS.Class({implement:[CMS.API.Helpers],initialize:function(){this._setupUI(),this.config=CMS.config,this.settings=CMS.settings,this.click="click.cms.clipboard",this._events()},_setupUI:function(){var t=i(".cms-clipboard");this.ui={clipboard:t,triggers:i(".cms-clipboard-trigger a"),triggerRemove:i(".cms-clipboard-empty a"),pluginsList:t.find(".cms-clipboard-containers")}},_events:function(){var t=this,e=400,a=117;t.modal=new CMS.Modal({minWidth:e,minHeight:a,minimizable:!1,maximizable:!1,resizable:!1}),t.modal.on("cms.modal.loaded cms.modal.closed",function(){i(".cms-add-plugin-placeholder").remove()}).on("cms.modal.closed cms.modal.load",function(){t.ui.pluginsList.prependTo(t.ui.clipboard)}).ui.modal.on("cms.modal.load",function(){t.ui.pluginsList.prependTo(t.ui.clipboard)}),t.ui.triggers.on(t.click,function(s){return s.preventDefault(),i(this).parent().hasClass("cms-toolbar-item-navigation-disabled")?!1:void t.modal.open({html:t.ui.pluginsList,title:t.ui.clipboard.data("title"),width:e,height:a})}),t.ui.triggerRemove.on(t.click,function(e){return e.preventDefault(),e.stopPropagation(),i(this).parent().hasClass("cms-toolbar-item-navigation-disabled")?!1:void t.clear(function(){t.ui.clipboard.hide(),t.ui.triggers.parent().addClass("cms-toolbar-item-navigation-disabled"),t.ui.triggerRemove.parent().addClass("cms-toolbar-item-navigation-disabled")})})},clear:function(t){var e='{ "csrfmiddlewaretoken": "'+this.config.csrf+'" }',a=i(".cms-submenu-item [data-rel=paste]").parent().addClass("cms-submenu-item-disabled");a.find(".cms-submenu-item-paste-tooltip").css("display","none"),a.find(".cms-submenu-item-paste-tooltip-empty").css("display","block"),CMS.API.Toolbar.openAjax({url:this.config.clipboard.url,post:e,callback:t})}})})}(CMS.$);
var CMS=window.CMS||{};!function(e){"use strict";e(function(){var s=e(document),i=e(".cms-clipboard"),t=i.find(".cms-draggable:first"),n=i.find(".cms-plugin:first");s.on("pointerup.cms.plugin",function(){CMS.Plugin._hideSettingsMenu()}).on("keydown.cms.plugin",function(e){e.keyCode===CMS.KEYS.SHIFT&&s.data("expandmode",!0)}).on("keyup.cms.plugin",function(e){e.keyCode===CMS.KEYS.SHIFT&&s.data("expandmode",!1)}),CMS.Plugin=new CMS.Class({implement:[CMS.API.Helpers],options:{type:"",placeholder_id:null,plugin_type:"",plugin_id:null,plugin_language:"",plugin_parent:null,plugin_order:null,plugin_breadcrumb:[],plugin_restriction:[],plugin_parent_restriction:[],urls:{add_plugin:"",edit_plugin:"",move_plugin:"",copy_plugin:"",delete_plugin:""}},initialize:function(s,i){switch(this.options=e.extend(!0,{},this.options,i),this._setupUI(s),this.csrf=CMS.config.csrf,this.click="click.cms.plugin",this.pointerUp="pointerup.cms.plugin",this.pointerDown="pointerdown.cms.plugin",this.pointerOverAndOut="pointerover.cms.plugin pointerout.cms.plugin",this.doubleClick="dblclick.cms.plugin",this.keyUp="keyup.cms.plugin",this.keyDown="keydown.cms.plugin",this.mouseEvents="mousedown.cms.plugin mousemove.cms.plugin mouseup.cms.plugin",this.touchStart="touchstart.cms.plugin",this.ui.container.data("settings",this.options),this.options.type){case"placeholder":this._setPlaceholder(),this._collapsables();break;case"plugin":this._setPlugin(),this._collapsables();break;default:this._setGeneric()}},_setupUI:function(s){s=e("."+s),this.ui={container:s,publish:e(".cms-btn-publish"),window:e(window),revert:e(".cms-toolbar-revert"),dragbar:null,draggable:null,draggables:null,submenu:null,dropdown:null}},_setPlaceholder:function(){var s=this;this.ui.dragbar=e(".cms-dragbar-"+this.options.placeholder_id),this.ui.draggables=this.ui.dragbar.closest(".cms-dragarea").find("> .cms-draggables"),this.ui.submenu=this.ui.dragbar.find(".cms-submenu-settings");var i=this.ui.dragbar.find(".cms-dragbar-title"),t=this.ui.dragbar.find(".cms-dragbar-toggler a"),n="cms-dragbar-title-expanded";this._setSettingsMenu(this.ui.submenu),this._setAddPluginModal(this.ui.dragbar.find(".cms-submenu-add")),CMS.settings.dragbars=CMS.settings.dragbars||[],t.off(this.click).on(this.click,function(e){e.preventDefault(),i.hasClass(n)?s._collapseAll(i):s._expandAll(i)}),-1!==e.inArray(this.options.placeholder_id,CMS.settings.dragbars)&&i.addClass(n),this._checkIfPasteAllowed()},_setPlugin:function(){var s=this;this.ui.container.add(this.ui.dragitem).on(this.doubleClick,function(e){e.preventDefault(),e.stopPropagation(),s.editPlugin(s.options.urls.edit_plugin,s.options.plugin_name,s.options.plugin_breadcrumb)}),this.ui.container.on(this.pointerOverAndOut,function(e){e.stopPropagation();var i=s.options.plugin_name,t=s.options.plugin_id;CMS.API.Tooltip.displayToggle("pointerover"===e.type,e,i,t)}),this.ui.container.on("cms.plugins.update",function(e){e.stopPropagation(),s.movePlugin()}),this.ui.container.on("cms.plugin.update",function(i){i.stopPropagation();var t=e(i.delegateTarget),n=e(".cms-draggable-"+t.data("settings").plugin_id),a=s._getId(n.parents(".cms-draggables").last().prevAll(".cms-dragbar").first());if(!a)return!1;var o=t.data("settings");o.target=a,o.parent=s._getId(n.parent().closest(".cms-draggable")),s.copyPlugin(o)}),this.ui.draggable=e(".cms-draggable-"+this.options.plugin_id),this.ui.dragitem=this.ui.draggable.find("> .cms-dragitem"),this.ui.draggables=this.ui.draggable.find("> .cms-draggables"),this.ui.submenu=this.ui.dragitem.find(".cms-submenu"),this._setSettingsMenu(this.ui.submenu),this._setAddPluginModal(this.ui.dragitem.find(".cms-submenu-add")),this._checkIfPasteAllowed()},_setGeneric:function(){var e=this;this.ui.container.on(this.doubleClick,function(s){s.preventDefault(),s.stopPropagation(),e.editPlugin(e.options.urls.edit_plugin,e.options.plugin_name,[])}),this.ui.container.on(this.pointerOverAndOut,function(s){s.stopPropagation();var i=e.options.plugin_name,t=e.options.plugin_id;CMS.API.Tooltip.displayToggle("pointerover"===s.type,s,i,t)})},_checkIfPasteAllowed:function(){var s=this.ui.dropdown.find("[data-rel=paste]"),i=s.parent();if(!n.length)return i.addClass("cms-submenu-item-disabled"),i.find(".cms-submenu-item-paste-tooltip-empty").css("display","block"),!1;if(this.ui.draggable&&this.ui.draggable.hasClass("cms-draggable-disabled"))return i.addClass("cms-submenu-item-disabled"),i.find(".cms-submenu-item-paste-tooltip-disabled").css("display","block"),!1;var t=this.options.plugin_restriction,a=n.data("settings").plugin_type,o=n.data("settings").plugin_parent_restriction,l=this.options.plugin_type;return t.length&&-1===e.inArray(a,t)||o.length&&-1===e.inArray(l,o)?(i.addClass("cms-submenu-item-disabled"),i.find(".cms-submenu-item-paste-tooltip-restricted").css("display","block"),!1):!0},addPlugin:function(s,i,t){if(CMS.API.locked)return!1;CMS.API.locked=!0;var n=this,a={placeholder_id:this.options.placeholder_id,plugin_type:s,plugin_parent:t||"",plugin_language:this.options.plugin_language,csrfmiddlewaretoken:this.csrf};e.ajax({type:"POST",url:this.options.urls.add_plugin,data:a,success:function(e){CMS.API.locked=!1,n.newPlugin=e,n.editPlugin(e.url,i,e.breadcrumb)},error:function(e){CMS.API.locked=!1;var s=CMS.config.lang.error;CMS.API.Messages.open({message:s+e.responseText||e.status+" "+e.statusText,error:!0})}})},editPlugin:function(s,i,t){var n=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});this.newPlugin||n.on("cms.modal.loaded",function(){e(".cms-add-plugin-placeholder").remove()}),n.on("cms.modal.closed",function(){e(".cms-add-plugin-placeholder").remove()}),n.open({url:s,title:i,breadcrumbs:t,width:850})},copyPlugin:function(s,i){if(CMS.API.locked)return!1;CMS.API.locked=!0;var t=s||i?!0:!1;s=s||this.options,i?(s.target=s.placeholder_id,s.plugin_id="",s.parent=""):i=s.plugin_language;var n={source_placeholder_id:s.placeholder_id,source_plugin_id:s.plugin_id||"",source_language:i,target_plugin_id:s.parent||"",target_placeholder_id:s.target||CMS.config.clipboard.id,target_language:s.page_language||i,csrfmiddlewaretoken:this.csrf},a={type:"POST",url:s.urls.copy_plugin,data:n,success:function(){CMS.API.Messages.open({message:CMS.config.lang.success}),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var s=CMS.config.lang.error;CMS.API.Messages.open({message:s+e.responseText||e.status+" "+e.statusText,error:!0})}};t?e.ajax(a):CMS.API.Clipboard.clear(function(){e.ajax(a)})},cutPlugin:function(){if(CMS.API.locked)return!1;CMS.API.locked=!0;var s=this,i={placeholder_id:CMS.config.clipboard.id,plugin_id:this.options.plugin_id,plugin_parent:"",plugin_language:this.options.page_language,plugin_order:[this.options.plugin_id],csrfmiddlewaretoken:this.csrf};CMS.API.Clipboard.clear(function(){return CMS.API.locked?!1:(CMS.API.locked=!0,void e.ajax({type:"POST",url:s.options.urls.move_plugin,data:i,success:function(){CMS.API.Messages.open(CMS.config.lang.success),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var s=CMS.config.lang.error;CMS.API.Messages.open({message:s+e.responseText||e.status+" "+e.statusText,error:!0})}}))})},pastePlugin:function(){t.appendTo(this.ui.draggables),n.trigger("cms.plugin.update")},movePlugin:function(s){if(CMS.API.locked)return!1;CMS.API.locked=!0;var i=this;s=s||this.options;var t=e(".cms-plugin-"+s.plugin_id),n=e(".cms-draggable-"+s.plugin_id);this._setPosition(s.plugin_id,t,n);var a=this._getId(n.parents(".cms-draggables").last().prevAll(".cms-dragbar").first()),o=this._getId(n.parent().closest(".cms-draggable")),l=this._getIds(n.siblings(".cms-draggable").andSelf());if(a===!1)return!1;var r={placeholder_id:a,plugin_id:s.plugin_id,plugin_parent:o||"",plugin_language:s.page_language,plugin_order:l,csrfmiddlewaretoken:this.csrf};e.ajax({type:"POST",url:s.urls.move_plugin,data:r,success:function(e){e.reload&&CMS.API.Helpers.reloadBrowser(),CMS.API.locked=!1,i._showSuccess(n)},error:function(e){CMS.API.locked=!1;var s=CMS.config.lang.error;CMS.API.Messages.open({message:s+e.responseText||e.status+" "+e.statusText,error:!0})}}),this.ui.publish.addClass("cms-btn-publish-active").removeClass("cms-btn-disabled").parent().show(),this.ui.window.trigger("resize"),this.ui.revert.removeClass("cms-toolbar-item-navigation-disabled")},deletePlugin:function(s,i,t){var n=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});n.on("cms.modal.loaded",function(){e(".cms-add-plugin-placeholder").remove()}),n.open({url:s,title:i,breadcrumbs:t})},_setPosition:function(s,i,t){var n=t.prev(".cms-draggable"),a=t.next(".cms-draggable"),o=t.parent().closest(".cms-draggable"),l=e(".cms-plugin-"+this._getId(o)),r=t.closest(".cms-dragarea");if(n.length)i.insertAfter(e(".cms-plugin-"+this._getId(n)));else if(a.length)i.insertBefore(e(".cms-plugin-"+this._getId(a)));else if(o.length){for(;l.children().length;)l=l.children();l.append(i)}else r.length?i.insertAfter(e(".cms-placeholder-"+this._getId(r))):CMS.API.Helpers.reloadBrowser()},editPluginPostAjax:function(e,s){this.editPlugin(s.url,this.options.plugin_name,s.breadcrumb)},_setSettingsMenu:function(s){var i=this;this.ui.dropdown=s.siblings(".cms-submenu-dropdown-settings");var t=this.ui.dropdown;s.on(this.pointerUp,function(s){s.preventDefault(),s.stopPropagation();var t=e(this);t.hasClass("cms-btn-active")?CMS.Plugin._hideSettingsMenu(t):(CMS.Plugin._hideSettingsMenu(),i._showSettingsMenu(t))}),t.on(this.mouseEvents,function(e){e.stopPropagation()}).on(this.touchStart,function(e){e.stopPropagation()}),i._setupActions(s),s.on([this.pointerUp,this.pointerDown,this.click,this.doubleClick].join(" "),function(e){e.stopPropagation()}),s.siblings(".cms-quicksearch, .cms-submenu-dropdown-settings").on([this.pointerUp,this.click,this.doubleClick].join(" "),function(e){e.stopPropagation()})},_scrollToElement:function(s,i){var t=i&&void 0!==i.duration?i.duration:200,n=i&&void 0!==i.offset?i.offset:50,a=s.offsetParent(),o=e(window),l=o.height(),r=a.scrollTop(),d=s.position().top,c=s.height(),u=l>=d+c+n;u||a.animate({scrollTop:d+n+c+r-l},t)},_setAddPluginModal:function(s){if(s.hasClass("cms-btn-disabled"))return!1;var i,t=this,n=e('<div class="cms-add-plugin-placeholder">'+CMS.config.lang.addPluginPlaceholder+"</div>"),a=new CMS.Modal({minWidth:400,minHeight:400}),o=s.closest(".cms-dragitem"),l=!Boolean(o.length);i=l?s.closest(".cms-dragarea").find("> .cms-draggables"):s.closest(".cms-draggable").find("> .cms-draggables"),a.on("cms.modal.loaded",e.proxy(t._setupKeyboardTraversing,t)),a.on("cms.modal.loaded",function(){i.hasClass("cms-hidden")&&!l&&t._toggleCollapsable(o),e(".cms-add-plugin-placeholder").remove(),n.appendTo(i),t._scrollToElement(n)}),a.on("cms.modal.closed",function(){e(".cms-add-plugin-placeholder").remove()}),a.on("cms.modal.shown",function(){var s=e(".cms-modal-markup .cms-plugin-picker");s.find("input").trigger("focus")});var r=s.siblings(".cms-plugin-picker");t._setupQuickSearch(r),s.on(this.pointerUp,function(e){e.preventDefault(),e.stopPropagation(),CMS.Plugin._hideSettingsMenu();var i=r.clone(!0,!0).data("parentId",t._getId(s.closest(".cms-draggable")));a.open({title:t.ui.container.data("settings").addPluginHelpTitle,html:i,width:530,height:400})}),s.on([this.pointerUp,this.pointerDown,this.click,this.doubleClick].join(" "),function(e){e.stopPropagation()}),s.siblings(".cms-quicksearch, .cms-submenu-dropdown").on([this.pointerUp,this.click,this.doubleClick].join(" "),function(e){e.stopPropagation()})},_setupQuickSearch:function(s){var i=this,t=s.find("> .cms-quicksearch").find("input"),n=CMS.API.Helpers.debounce(function(){var s=e(this),t=s.closest(".cms-plugin-picker");i._filterPluginsList(t,s)},100);t.on(this.keyUp,n).on(this.keyUp,CMS.API.Helpers.debounce(function(s){var i,t;s.keyCode===CMS.KEYS.ENTER&&(i=e(this),t=i.closest(".cms-plugin-picker"),t.find(".cms-submenu-item").not(".cms-submenu-item-title").filter(":visible").first().find("> a").focus().trigger("click"))},110))},_setupActions:function(s){var i=this;s.parent().find("a").on(i.click,function(t){t.preventDefault(),t.stopPropagation(),CMS.API.Toolbar.showLoader();var n=e(this);switch(CMS.Plugin._hideSettingsMenu(s),n.attr("data-rel")){case"add":i.addPlugin(n.attr("href").replace("#",""),n.text(),n.closest(".cms-plugin-picker").data("parentId"));break;case"ajax_add":CMS.API.Toolbar.openAjax({url:n.attr("href"),post:JSON.stringify(n.data("post")),text:n.data("text"),callback:e.proxy(i.editPluginPostAjax,i),onSuccess:n.data("on-success")});break;case"edit":i.editPlugin(i.options.urls.edit_plugin,i.options.plugin_name,i.options.plugin_breadcrumb);break;case"copy-lang":i.copyPlugin(this.options,n.attr("data-language"));break;case"copy":i.copyPlugin();break;case"cut":i.cutPlugin();break;case"paste":n.parent().hasClass("cms-submenu-item-disabled")?CMS.API.Toolbar.hideLoader():i.pastePlugin();break;case"delete":i.deletePlugin(i.options.urls.delete_plugin,i.options.plugin_name,i.options.plugin_breadcrumb);break;default:CMS.API.Toolbar.hideLoader(),CMS.API.Toolbar._delegate(n)}})},_setupKeyboardTraversing:function(){var i=e(".cms-modal-markup .cms-plugin-picker");i.length&&(s.off(this.keyDown+".traverse"),s.on(this.keyDown+".traverse",function(e){var s=i.find(".cms-submenu-item:visible a"),t=s.index(s.filter(":focus"));(e.keyCode===CMS.KEYS.DOWN||e.keyCode===CMS.KEYS.TAB)&&(e.preventDefault(),t>=0&&t<s.length-1?s.eq(t+1).focus():s.eq(0).focus()),(e.keyCode===CMS.KEYS.UP||e.keyCode===CMS.KEYS.TAB&&e.shiftKey)&&(e.preventDefault(),s.is(":focus")?s.eq(t-1).focus():s.eq(s.length).focus())}))},_showSettingsMenu:function(e){var s=this.ui.dropdown,i=e.parentsUntil(".cms-dragarea").last();e.addClass("cms-btn-active"),i.addClass("cms-z-index-9999"),s.show(),this.ui.window.height()+this.ui.window.scrollTop()-e.offset().top-s.height()<=10&&e.offset().top-s.height()>=0?s.removeClass("cms-submenu-dropdown-top").addClass("cms-submenu-dropdown-bottom"):s.removeClass("cms-submenu-dropdown-bottom").addClass("cms-submenu-dropdown-top")},_filterPluginsList:function(s,i){var t=s.find(".cms-submenu-item"),n=s.find(".cms-submenu-item-title"),a=i.val();return""===a?(t.add(n).show(),!1):(t.find("a, span").each(function(s,i){i=e(i);var t=i.text().toLowerCase(),n=a.toLowerCase();t.indexOf(n)>=0?i.parent().show():i.parent().hide()}),n.filter(":visible").each(function(s,i){n.hide(),e(i).nextUntil(".cms-submenu-item-title").show()}),t.filter(":visible").each(function(s,i){i=e(i),i.prev().hasClass("cms-submenu-item-title")?i.prev().show():i.prevUntil(".cms-submenu-item-title").last().prev().show()}),s.siblings(".cms-submenu-dropdown-children").show(),void(t.add(n).filter(":visible").length<=0&&s.siblings(".cms-submenu-dropdown-children").hide()))},_toggleCollapsable:function(i){var t,n=this,a=n._getId(i.parent()),o=this.ui.draggable,l=CMS.settings;if(l.states=l.states||[],i.hasClass("cms-dragitem-expanded")){if(l.states.splice(e.inArray(a,l.states),1),i.removeClass("cms-dragitem-expanded").parent().find("> .cms-draggables").addClass("cms-hidden"),s.data("expandmode")){if(t=o.find(".cms-draggable").find(".cms-dragitem-collapsable"),!t.length)return!1;t.each(function(){var s=e(this);s.hasClass("cms-dragitem-expanded")&&n._toggleCollapsable(s)})}}else if(l.states.push(a),i.addClass("cms-dragitem-expanded").parent().find("> .cms-draggables").removeClass("cms-hidden"),s.data("expandmode")){if(t=o.find(".cms-draggable").find(".cms-dragitem-collapsable"),!t.length)return!1;t.each(function(){var s=e(this);s.hasClass("cms-dragitem-expanded")||n._toggleCollapsable(s)})}this.ui.window.trigger("resize.sideframe"),CMS.API.Toolbar.setSettings(l)},_collapsables:function(){var s=this;this.ui.draggable=e(".cms-draggable-"+this.options.plugin_id);var i=this.ui.draggable.find("> .cms-dragitem");if(this.ui.container.each(function(s,i){var t=e(i).find(".cms-dragitem-collapsable"),n=t.filter(".cms-dragitem-expanded");t.length===n.length&&t.length+n.length!==0&&e(i).find(".cms-dragbar-title").addClass("cms-dragbar-title-expanded")}),!this.ui.draggable.length)return!1;if(i.find("> .cms-dragitem-text").on(this.click,function(){i.hasClass("cms-dragitem-collapsable")&&s._toggleCollapsable(i)}),this.ui.draggable.on(this.doubleClick,function(i){i.stopPropagation(),e(".cms-plugin-"+s._getId(e(this))).trigger("dblclick.cms")}),CMS.Toolbar.ready)return!1;for(var t=CMS.settings.states.sort(),n=[],a=0;a<t.length;a++)t[a]!==t[a+1]&&n.push(t[a]);CMS.settings.states=n,e.each(CMS.settings.states,function(s,i){var t=e(".cms-draggable-"+i);t.find(".cms-draggables").length&&(t.find("> .cms-draggables").removeClass("cms-hidden"),t.find("> .cms-dragitem").addClass("cms-dragitem-expanded"))}),CMS.Toolbar.ready=!0},_expandAll:function(s){var i=this,t=s.closest(".cms-dragarea").find(".cms-dragitem-collapsable");if(!t.length)return!1;t.each(function(){var s=e(this);s.hasClass("cms-dragitem-expanded")||i._toggleCollapsable(s)}),s.addClass("cms-dragbar-title-expanded");var n=CMS.settings;n.dragbars=n.dragbars||[],n.dragbars.push(this.options.placeholder_id),CMS.API.Toolbar.setSettings(n)},_collapseAll:function(s){var i=this,t=s.closest(".cms-dragarea").find(".cms-dragitem-collapsable");t.each(function(){var s=e(this);s.hasClass("cms-dragitem-expanded")&&i._toggleCollapsable(s)}),s.removeClass("cms-dragbar-title-expanded");var n=CMS.settings;n.dragbars=n.dragbars||[],n.dragbars.splice(e.inArray(this.options.placeholder_id,n.states),1),CMS.API.Toolbar.setSettings(n)},_getId:function(e){return CMS.API.StructureBoard.getId(e)},_getIds:function(e){return CMS.API.StructureBoard.getIds(e)},_showSuccess:function(s){var i=e('<div class="cms-dragitem-success"></div>');s.addClass("cms-draggable-success").append(i),i.fadeOut(1e3,function(){e(this).remove(),s.removeClass("cms-draggable-success")}),this.ui.window.trigger("resize.sideframe")}}),CMS.Plugin._hideSettingsMenu=function(s){s=s||e(".cms-submenu-btn.cms-btn-active"),s.length&&(s.removeClass("cms-btn-active"),s.closest(".cms-draggable").data("active",!1),e(".cms-z-index-9999").removeClass("cms-z-index-9999"),s.siblings(".cms-submenu-dropdown").hide(),s.siblings(".cms-quicksearch").hide(),s.siblings(".cms-quicksearch").find("input").val("").trigger(this.keyUp).blur(),e(".cms-dragbar").css("position",""))}})}(CMS.$);
!function(e){"use strict";e(function(){function t(){i.each(function(){var t=e(this);t.find("> .cms-draggables").children(".cms-draggable:not(.cms-draggable-is-dragging)").length?t.removeClass("cms-dragarea-empty"):t.addClass("cms-dragarea-empty")})}function s(t){t.each(function(){var t=e(this),s=t.closest(".cms-draggable").find("> .cms-dragitem");t.children().length?s.addClass("cms-dragitem-collapsable cms-dragitem-expanded"):s.removeClass("cms-dragitem-collapsable")})}var i=e(".cms-dragarea:not(.cms-clipboard-containers)");CMS.StructureBoard=new CMS.Class({implement:[CMS.API.Helpers],options:{speed:300},initialize:function(s){this.options=e.extend(!0,{},this.options,s),this.config=CMS.config,this.settings=CMS.settings,this._setupUI(),this.click="click.cms",this.state=!1,this.dragging=!1,this._setup(),this._events(),t()},_setupUI:function(){var t=e(".cms-structure"),s=e(".cms-toolbar");this.ui={container:t,content:e(".cms-structure-content"),doc:e(document),window:e(window),toolbar:s,sortables:e(".cms-draggables"),plugins:e(".cms-plugin"),render_model:e(".cms-render-model"),placeholders:e(".cms-placeholder"),dragitems:e(".cms-draggable"),dragareas:e(".cms-dragarea"),clipboard:e(".cms-clipboard"),toolbarModeSwitcher:s.find(".cms-toolbar-item-cms-mode-switcher"),toolbarModeLinks:s.find(".cms-toolbar-item-cms-mode-switcher a")}},_setup:function(){var e=this;return this.ui.dragareas.length&&this.ui.toolbarModeSwitcher.length?(setTimeout(function(){"structure"===e.settings.mode?e.show(!0):e.hide(!0)},0),this.ui.placeholders.length&&this.ui.toolbarModeSwitcher.show(),void this._drag()):!1},_events:function(){var e=this,t=e.ui.toolbarModeLinks;t.eq(1).on(e.click,function(t){return t.preventDefault(),"edit"===e.settings.mode?!1:void e.hide()}),t.eq(0).on(e.click,function(t){return t.preventDefault(),"structure"===e.settings.mode?!1:void e.show()}),e.ui.toolbarModeSwitcher.length&&e.ui.doc.on("keydown",function(t){var s=document.activeElement!==document.body;t.keyCode!==CMS.KEYS.SPACE||s||(t.preventDefault(),"structure"===e.settings.mode?e.hide():"edit"===e.settings.mode&&e.show())})},show:function(e){if("live"===CMS.config.mode)return!1;var t=this.ui.toolbarModeLinks;t.removeClass("cms-btn-active").eq(0).addClass("cms-btn-active"),this.ui.clipboard.fadeIn(this.options.speed),this.settings.mode="structure",e||(this.settings=this.setSettings(this.settings)),this.ui.dragareas.show(),this._showBoard()},hide:function(e){if("live"===CMS.config.mode)return!1;var t=this.ui.toolbarModeLinks;t.removeClass("cms-btn-active").eq(1).addClass("cms-btn-active"),this.ui.container.find(".cms-clipboard").hide(),this.ui.clipboard.hide(),this.settings.mode="edit",e||(this.settings=this.setSettings(this.settings)),this._hideBoard()},getId:function(e){if(void 0===e||null===e||e.length<=0)return!1;var t=null,s=e.attr("class").split(" ")[1];return e.hasClass("cms-plugin")?t=s.replace("cms-plugin-",""):e.hasClass("cms-draggable")?t=s.replace("cms-draggable-",""):e.hasClass("cms-placeholder")?t=s.replace("cms-placeholder-",""):e.hasClass("cms-dragbar")?t=s.replace("cms-dragbar-",""):e.hasClass("cms-dragarea")&&(t=s.replace("cms-dragarea-","")),t},getIds:function(t){var s=this,i=[];return t.each(function(){i.push(s.getId(e(this)))}),i},_showBoard:function(){var t=this;if(this.ui.container.show(),this.ui.dragareas.css("opacity",1),this.ui.plugins.not(this.ui.render_model).hide(),this.ui.placeholders.show(),CMS.config.simpleStructureBoard){var s=this.ui.content,i=s.find(".cms-dragarea");s.addClass("cms-structure-content-simple"),i.addClass("cms-dragarea-simple"),i.each(function(t,i){e(i).hasClass("cms-dragarea-static")&&s.append(i)}),i.filter(".cms-dragarea-static").eq(0).css("margin-top","50px")}else this.ui.container.addClass("cms-structure-dynamic"),this.ui.window.on("resize.sideframe",function(){t._resizeBoard()}).trigger("resize.sideframe")},_hideBoard:function(){this.ui.container.hide(),this.ui.plugins.show(),this.ui.placeholders.hide(),this.ui.window.off("resize.sideframe"),this.ui.window.trigger("structureboard_hidden.sideframe"),CMS.config.simpleStructureBoard||this.ui.container.height(this.ui.doc.outerHeight())},_resizeBoard:function(){var t=null,s=null,i=null,a=null,r=this;setTimeout(function(){r.ui.container.height(r.ui.doc.outerHeight())},0),this.ui.placeholders.each(function(r,n){n=e(n),t=n.data("settings").placeholder_id,s=e(".cms-dragarea-"+t),n.height(s.outerHeight(!0)),i=n.width()?0:150,a=e(s).offsetParent().offset(),s.css({top:n.offset().top-a.top-5,left:n.offset().left-a.left-i,width:n.width()+i})})},_drag:function(){var i,a=this;this.ui.sortables.nestedSortable({items:"> .cms-draggable:not(.cms-draggable-disabled .cms-draggable)",placeholder:"cms-droppable",connectWith:".cms-draggables:not(.cms-hidden)",tolerance:"intersect",toleranceElement:"> div",dropOnEmpty:!0,helper:function(e,t){var s=t.find("> .cms-dragitem").clone();return s.wrap('<div class="'+t[0].className+'"></div>'),s.parent()},appendTo:".cms-structure-content",cursor:"move",cursorAt:{left:-15,top:-15},opacity:1,zIndex:9999999,delay:100,tabSize:15,listType:"div.cms-draggables",doNotClear:!0,disableNestingClass:"cms-draggable-disabled",errorClass:"cms-draggable-disallowed",start:function(s,r){i=r.item.closest(".cms-draggables"),a.dragging=!0,t(),CMS.Plugin._hideSettingsMenu(),a.ui.sortables.each(function(){var t=e(this);0===t.children().length&&t.removeClass("cms-hidden")}),r.item.addClass("cms-is-dragging"),r.helper.addClass("cms-draggable-is-dragging"),r.item.find("> .cms-draggables").children().length&&r.helper.addClass("cms-draggable-stack"),a.ui.doc.on("keyup.cms.interrupt",function(t,s){(t.keyCode===CMS.KEYS.ESC&&a.dragging||s)&&(a.state=!1,e.ui.sortable.prototype._mouseStop(),a.ui.sortables.trigger("mouseup"))})},beforeStop:function(e,t){a.dragging=!1,t.item.removeClass("cms-is-dragging cms-draggable-stack"),a.ui.doc.off("keyup.cms.interrupt")},update:function(r,n){if(!a.state)return!1;var d=n.item.closest(".cms-draggables");if(i.is(d)){if(!d.is(this))return!1}else s(d.add(i));var c=a.getId(n.item),o=e(".cms-plugin-"+c);o.trigger(o.closest(".cms-clipboard").length?"cms.plugin.update":"cms.plugins.update"),a.ui.sortables.each(function(){var t=e(this);0===t.children().length&&t.addClass("cms-hidden")}),t()},isAllowed:function(t,s,i){if(CMS.API.locked)return!1;var r,n=[],d=e(".cms-plugin-"+a.getId(i));if(0===d.length||null===d.data("settings"))return!1;var c,o=d.data("settings").plugin_parent_restriction,l=d.data("settings").plugin_type,g=a.getId(t.closest(".cms-dragarea")),u=e(".cms-placeholder-"+g);return c=e(s&&s.length?".cms-plugin-"+a.getId(s.closest(".cms-draggable")):".cms-plugin-"+a.getId(t.closest(".cms-draggable"))),u.length&&(n=u.data("settings").plugin_restriction,r=u.data("settings").plugin_type),c.length&&(n=c.data("settings").plugin_restriction,r=c.data("settings").plugin_type),t.parent().hasClass("cms-draggable-disabled")?!1:(a.state=n.length&&-1===e.inArray(l,n)?!1:!0,o.length&&(a.state=-1!==e.inArray(r,o)?!0:!1),a.state)}})}})})}(CMS.$);
>>>>>>> develop
var CMS=window.CMS||{};!function(t){"use strict";t(function(){CMS.Navigation=new CMS.Class({implement:[CMS.API.Helpers],initialize:function(){this._setupUI(),this._getWidths(),this.rightMostItemIndex=this.items.left.length-1,this.leftMostItemIndex=0,this.resize="resize.cms.navigation",this.load="load.cms.navigation",this._events()},_setupUI:function(){var i=t(".cms"),e=i.find(".cms-toolbar-more");this.ui={window:t(window),toolbarLeftPart:i.find(".cms-toolbar-left"),toolbarRightPart:i.find(".cms-toolbar-right"),trigger:e,dropdown:e.find("> ul"),toolbarTrigger:i.find(".cms-toolbar-trigger"),logo:i.find(".cms-toolbar-item-logo")}},_events:function(){this.ui.window.on(this.resize+" "+this.load,CMS.API.Helpers.throttle(this._handleResize.bind(this),50))},_getWidths:function(){var i=this;i.items={left:[],leftTotalWidth:0,right:[],rightTotalWidth:0,moreButtonWidth:0};var e=i.ui.toolbarLeftPart.find(".cms-toolbar-item-navigation > li:not(.cms-toolbar-more)"),o=i.ui.toolbarRightPart.find("> .cms-toolbar-item"),s=function(i,e){var o=t(i),s=t(i).outerWidth(!0);e.push({element:o,width:s})},h=function(t,i){return t+i.width};e.each(function(){s(this,i.items.left)}),o.each(function(){s(this,i.items.right)}),i.items.leftTotalWidth=i.items.left.reduce(h,0),i.items.rightTotalWidth=i.items.right.reduce(h,0),i.items.moreButtonWidth=i.ui.trigger.outerWidth()},_calculateAvailableWidth:function(){var t=this.ui.window.width(),i=parseInt(this.ui.toolbarRightPart.css("padding-right"),10)+this.ui.logo.offset().left+this.ui.logo.outerWidth(!0)+15;return t-i},_showDropdown:function(){this.ui.trigger.css("display","list-item")},_hideDropdown:function(){this.ui.trigger.css("display","none")},_handleResize:function(){var t,i=this._calculateAvailableWidth();if(i>this.items.leftTotalWidth+this.items.rightTotalWidth)this._showAll();else{t=i-this.items.moreButtonWidth-this.items.rightTotalWidth;for(var e=-1;t-this.items.left[e+1].width>=0;)t-=this.items.left[e+1].width,e++;if(e<this.rightMostItemIndex?this._moveToDropdown(this.rightMostItemIndex-e):this.rightMostItemIndex<e&&this._moveOutOfDropdown(e-this.rightMostItemIndex),this._showDropdown(),0>t&&-1===this.rightMostItemIndex){t+=this.items.rightTotalWidth;var o=this.items.right.length;this._moveToDropdown(o-this.leftMostItemIndex,"right"),this.ui.dropdown.addClass("cms-more-dropdown-full")}else this._showAllRight(),this.ui.dropdown.removeClass("cms-more-dropdown-full")}},_showAll:function(){this._showAllLeft(),this._showAllRight(),this._hideDropdown()},_showAllLeft:function(){this._moveOutOfDropdown(this.items.left.length-1-this.rightMostItemIndex)},_showAllRight:function(){this._moveOutOfDropdown(this.leftMostItemIndex,"right")},_moveToDropdown:function(t,i){if(!(0>=t)){var e,o,s,h;if("right"===i){for(o=this.leftMostItemIndex,s=this.leftMostItemIndex+t-1,h=o;s>=h;h++)e=this.items.right[h].element,this.ui.dropdown.prepend(e.wrap('<li class="cms-more-buttons"></li>').parent());this.leftMostItemIndex+=t}else{for(s=this.rightMostItemIndex,o=this.rightMostItemIndex-t+1,h=s;h>=o;h--)e=this.items.left[h].element,this.ui.dropdown.prepend(e),e.find("> ul").children().length&&e.addClass("cms-toolbar-item-navigation-children");this.rightMostItemIndex-=t}}},_moveOutOfDropdown:function(t,i){if(!(0>=t)){var e,o,s,h;if("right"===i){for(h=this.leftMostItemIndex-1,s=this.leftMostItemIndex-t,e=h;e>=s;e--)o=this.items.right[e].element,o.unwrap("<li></li>"),o.prependTo(this.ui.toolbarRightPart);this.leftMostItemIndex-=t}else{for(s=this.rightMostItemIndex+1,h=this.rightMostItemIndex+t,e=s;h>=e;e++)o=this.items.left[e].element,o.insertBefore(this.ui.trigger),o.removeClass("cms-toolbar-item-navigation-children"),o.find("> ul").removeAttr("style");this.rightMostItemIndex+=t}}}})})}(CMS.$);
var CMS=window.CMS||{};!function(t){"use strict";t(function(){CMS.Toolbar=new CMS.Class({implement:[CMS.API.Helpers],options:{preventSwitch:!1,preventSwitchMessage:"Switching is disabled.",toolbarDuration:200},initialize:function(i){this.options=t.extend(!0,{},this.options,i),this.config=CMS.config,this.settings=CMS.settings,this._setupUI(),this.navigation=new CMS.Navigation,this.click="click.cms.toolbar",this.touchStart="touchstart.cms.toolbar",this.pointerUp="pointerup.cms.toolbar",this.pointerOverOut="pointerover.cms.toolbar pointerout.csm.toolbar",this.pointerLeave="pointerleave.csm.toolbar",this.mouseEnter="mouseenter.cms.toolbar",this.mouseLeave="mouseleave.cms.toolbar",this.resize="resize.cms.toolbar",this.timer=function(){},this.lockToolbar=!1,this.ui.toolbar.data("ready")||this._events();var e=this;setTimeout(function(){e._initialStates()},200),this.ui.toolbar.data("ready",!0)},_setupUI:function(){var i=t(".cms");this.ui={container:i,body:t("html"),document:t(document),window:t(window),toolbar:i.find(".cms-toolbar"),toolbarTrigger:i.find(".cms-toolbar-trigger"),navigations:i.find(".cms-toolbar-item-navigation"),buttons:i.find(".cms-toolbar-item-buttons"),switcher:i.find(".cms-toolbar-item-switch"),messages:i.find(".cms-messages"),screenBlock:i.find(".cms-screenblock"),structureBoard:i.find(".cms-structure")}},_events:function(){var i=this;this.ui.toolbarTrigger.on(this.pointerUp,function(t){t.preventDefault(),i.toggle(),i.ui.document.trigger(i.click)}),this.ui.navigations.each(function(){function e(){h=!1,o.removeClass(a),o.find("ul ul").hide(),s.find("> li").off(i.mouseEnter),i.ui.document.off(i.click),i.ui.toolbar.off(i.click,e),i.ui.structureBoard.off(i.click)}var s=t(this),o=s.find("li"),n="cms-toolbar-item-navigation",a="cms-toolbar-item-navigation-hover",r="cms-toolbar-item-navigation-disabled",c="cms-toolbar-item-navigation-children",l=!1,h=!1;s.find("a").on(i.click,function(s){return s.preventDefault(),""===t(this).attr("href")||"#"===t(this).attr("href")||t(this).parent().hasClass(r)||t(this).parent().hasClass(r)?void 0:(i._delegate(t(this)),e(),!1)}).on(i.touchStart,function(){l=!0}),o.on(i.click,function(o){o.preventDefault(),o.stopPropagation();var u=t(this);return u.parent().hasClass(n)&&h?(i.ui.body.trigger(i.click),!1):(u.hasClass(c)||e(),u.parent().hasClass(n)&&u.hasClass(a)||u.hasClass(r)?!1:(u.addClass(a),l||s.find("> li").on(i.mouseEnter,function(){return t(this).hasClass(a)?!1:(h=!1,void t(this).trigger(i.click))}),l=!1,i.ui.document.on(i.click,e),i.ui.structureBoard.on(i.click,e),i.ui.toolbar.on(i.click,e),i.ui.window.on("resize",CMS.API.Helpers.throttle(e,1e3)),void(h=!0)))}),o.on(i.pointerOverOut,"li",function(){var i=t(this),e=i.closest(".cms-toolbar-item-navigation-children").add(i.parents(".cms-toolbar-item-navigation-children")),s=i.hasClass(c)||e.length;return i.hasClass(r)?!1:i.hasClass(a)?!0:(o.find("li").removeClass(a),i.addClass(a),s?(i.find("> ul").show(),e.addClass(a)):o.find("ul ul").hide(),void i.siblings().find("> ul").hide())}).on(i.click,function(t){t.preventDefault(),t.stopPropagation()}),o.on(i.pointerLeave,"> ul",function(){o.find("li").removeClass(a)})}),this.ui.switcher.each(function(){t(this).on(i.click,function(e){e.preventDefault(),i._setSwitcher(t(e.currentTarget))})}),this.ui.buttons.each(function(){var e=t(this);e.find("a").attr("data-rel")?e.on(i.click,function(e){e.preventDefault(),i._delegate(t(this).find("a"))}):e.find("a").on(i.click,function(t){t.stopPropagation()}),e.find(".cms-publish-page").on(i.click,function(t){confirm(i.config.lang.publish)||t.preventDefault()}),e.find(".cms-btn-publish").on(i.click,function(i){i.preventDefault(),t.ajax({type:"post",url:t(this).prop("href"),data:{csrfmiddlewaretoken:CMS.config.csrf},success:function(){CMS.API.Helpers.reloadBrowser()},error:function(t){throw new Error(t)}})})})},_initialStates:function(){var i=t(".cms-btn-publish").parent(),e=new CMS.Sideframe;"expanded"===this.settings.toolbar?this.open({duration:0}):this.close(),i.hide(),t(".cms-btn-publish-active").length&&(i.show(),this.ui.window.trigger("resize")),CMS.config.debug&&this._debug(),CMS.config.messages&&CMS.API.Messages.open({message:CMS.config.messages}),CMS.config.error&&CMS.API.Messages.open({message:CMS.config.error,error:!0}),CMS.config.auth&&CMS.config.settings.version===this.settings.version||(this.open({duration:0}),this.settings=this.setSettings(CMS.config.settings)),CMS.config.publisher&&(CMS.API.Messages.open({message:CMS.config.publisher,dir:"right"}),setInterval(function(){CMS.$(".cms-toolbar-item-switch").toggleClass("cms-toolbar-item-switch-highlight")},CMS.API.Messages.messageDelay)),this.settings.sideframe.url&&e.open({url:this.settings.sideframe.url,animate:!1}),this.ui.screenBlock.length&&this._screenBlock(),this.ui.body.addClass("cms-ready"),this.ui.document.trigger("cms-ready")},toggle:function(){"collapsed"===this.settings.toolbar?this.open():this.close()},open:function(t){this._show(t),this.settings.toolbar="expanded",this.settings=this.setSettings(this.settings)},_show:function(i){var e=i&&void 0!==i.duration?i.duration:this.options.toolbarDuration,s=t(".cms-debug-bar").height()||0,o=t(".cms-toolbar").height()+10;this.ui.toolbar.css({transition:"margin-top "+e+"ms","margin-top":0}),this.ui.toolbarTrigger.addClass("cms-toolbar-trigger-expanded"),this.ui.body.addClass("cms-toolbar-expanded"),this.ui.body.animate({"margin-top":o+s},e,"linear"),this.ui.messages.css("top",o+1)},close:function(){this._hide(),this.settings.toolbar="collapsed",this.settings=this.setSettings(this.settings)},_hide:function(){var i=this.options.toolbarDuration,e=t(".cms-toolbar").height()+10;return this.ui.toolbar.css("transition","margin-top "+i+"ms"),this.lockToolbar?!1:(this.ui.toolbarTrigger.removeClass("cms-toolbar-trigger-expanded"),this.ui.toolbar.css("margin-top",-e),this.ui.body.removeClass("cms-toolbar-expanded"),this.ui.body.animate({"margin-top":this.config.debug?5:0},i),void this.ui.messages.css("top",0))},openAjax:function(i){var e=this,s=i.url,o=i.post||"{}",n=i.text||"",a=i.callback,r=i.onSuccess,c=n?confirm(n):!0;return c?(this.showLoader(),t.ajax({type:"POST",url:s,data:o?JSON.parse(o):{}}).done(function(t){CMS.API.locked=!1,a?(a(e,t),e.hideLoader()):r?CMS.API.Helpers.reloadBrowser(r,!1,!0):CMS.API.Helpers.reloadBrowser(!1,!1,!0)}).fail(function(t){CMS.API.locked=!1,CMS.API.Messages.open({message:t.response+" | "+t.status+" "+t.statusText,error:!0})})):!1},showLoader:function(){this.ui.toolbarTrigger.addClass("cms-toolbar-loader")},hideLoader:function(){this.ui.toolbarTrigger.removeClass("cms-toolbar-loader")},_delegate:function(t){var i=t.data("rel");switch(i){case"modal":var e=new CMS.Modal({onClose:t.data("on-close")});e.open({url:t.attr("href"),title:t.data("name")});break;case"message":CMS.API.Messages.open({message:t.data("text")});break;case"cms_frame":var s=window.open(t.attr("href"),"cms_frame");s.focus();break;case"sideframe":var o=new CMS.Sideframe({onClose:t.data("on-close")});o.open({url:t.attr("href"),animate:!0});break;case"ajax":this.openAjax({url:t.attr("href"),post:JSON.stringify(t.data("post")),text:t.data("text"),onSuccess:t.data("on-success")});break;default:window.location.href=t.attr("href")}},_setSwitcher:function(t){var i=t.hasClass("cms-toolbar-item-switch-active"),e=t.find("a"),s=t.find(".cms-toolbar-item-switch-knob"),o=300;return this.options.preventSwitch?(CMS.API.Messages.open({message:this.options.preventSwitchMessage,dir:"right"}),!1):(i?(s.animate({right:e.outerWidth(!0)-(s.outerWidth(!0)+2)},o),e.css("z-index",1).animate({"padding-top":6,"padding-right":14,"padding-bottom":4,"padding-left":28},o)):(s.animate({left:e.outerWidth(!0)-(s.outerWidth(!0)+2)},o),e.css("z-index",1).animate({"padding-top":6,"padding-right":28,"padding-bottom":4,"padding-left":14},o)),void setTimeout(function(){window.location.href=e.attr("href")},o))},_lock:function(t){t?(this.lockToolbar=!0,this.ui.toolbarTrigger.css("opacity",.2)):(this.lockToolbar=!1,this.ui.toolbarTrigger.css("opacity",1))},_debug:function(){var t=this,i=1e3,e=function(){},s=this.ui.container.find(".cms-debug-bar");s.on(this.mouseEnter+" "+this.mouseLeave,function(s){clearTimeout(e),s.type===t.mouseEnter&&(e=setTimeout(function(){CMS.API.Messages.open({message:t.config.lang.debug})},i))})},_screenBlock:function(){var i=this,e=20,s=this.ui.screenBlock,o=t(".cms-sideframe");t(window).on(this.resize,function(){s.css({width:t(this).width()-o.width(),height:t(window).height()})}).trigger("resize"),setInterval(function(){t(window).trigger(i.resize)},e)}})})}(CMS.$);
var CMS=window.CMS||{};!function(i){"use strict";i(function(){CMS.Tooltip=new CMS.Class({initialize:function(){this.body=i("body"),this.isTouch=!1,this.domElem=this.pick(),this.checkTouch()},checkTouch:function(){var t=this;this.body.one("touchstart.cms",function(){t.isTouch=!0,t.domElem=t.pick(),t.domElem.on("touchstart.cms",function(){i(".cms-plugin-"+i(this).data("plugin_id")).trigger("dblclick")})})},displayToggle:function(i,t,o,s){i?this.show(t,o,s):this.hide()},show:function(i,t,o){var s=this.domElem,n=this;s.css("visibility","visible").data("plugin_id",o||null).show().find("span").html(t),this.isTouch?this.position(i,s):this.body.on("mousemove.cms",function(i){n.position(i,s)})},hide:function(){this.domElem.css("visibility","hidden").hide(),this.isTouch||this.body.off("mousemove.cms")},pick:function(){return i(this.isTouch?".cms-tooltip-touch":".cms-tooltip")},position:function(t,o){var s=20,n=t.pageX-i(o).offsetParent().offset().left,c=t.pageY-i(o).offsetParent().offset().top,h=i(o).offsetParent().width(),e=n+o.outerWidth(!0)+s;o.css({left:e>=h?n-o.outerWidth(!0)-s:n+s,top:c-12})}})})}(CMS.$);