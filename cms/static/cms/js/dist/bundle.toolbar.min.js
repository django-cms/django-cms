...
!function(i){"use strict";i(function(){/*!
         ...
         */
CMS.Modal=new CMS.Class({implement:[CMS.API.Helpers],options:{onClose:!1,minHeight:400,minWidth:800,modalDuration:200,newPlugin:!1},initialize:function(t){this.options=i.extend(!0,{},this.options,t),this.config=CMS.config,this._setupUI(),this.click=null!==document.ontouchstart?"click.cms":"touchend.cms click.cms",this.maximized=!1,this.minimized=!1,this.triggerMaximized=!1,this.saved=!1,this.ui.modal.data("ready")||this._events(),this.ui.modal.data("ready",!0)},_setupUI:function(){this.ui={},this.ui.modal=i(".cms-modal"),this.ui.body=i("html"),this.ui.window=i(window),this.ui.toolbarLeftPart=i(".cms-toolbar-left"),this.ui.minimizeButton=this.ui.modal.find(".cms-modal-minimize"),this.ui.maximizeButton=this.ui.modal.find(".cms-modal-maximize"),this.ui.title=this.ui.modal.find(".cms-modal-title"),this.ui.resize=this.ui.modal.find(".cms-modal-resize"),this.ui.breadcrumb=this.ui.modal.find(".cms-modal-breadcrumb"),this.ui.breadcrumbItems=this.ui.modal.find(".cms-modal-breadcrumb-items"),this.ui.closeAndCancel=this.ui.modal.find(".cms-modal-close, .cms-modal-cancel"),this.ui.modalButtons=this.ui.modal.find(".cms-modal-buttons"),this.ui.modalBody=this.ui.modal.find(".cms-modal-body"),this.ui.iframeHolder=this.ui.modal.find(".cms-modal-frame"),this.ui.shim=this.ui.modal.find(".cms-modal-shim")},_events:function(){var t=this;this.ui.minimizeButton.on(this.click,function(i){i.preventDefault(),t._minimize()}),this.ui.title.on("mousedown.cms",function(i){i.preventDefault(),t._startMove(i)}),this.ui.title.on("dblclick.cms",function(){t._maximize()}),this.ui.resize.on("mousedown.cms",function(i){i.preventDefault(),t._startResize(i)}),this.ui.maximizeButton.on(this.click,function(i){i.preventDefault(),t._maximize()}),this.ui.breadcrumbItems.on(this.click,"a",function(s){s.preventDefault(),t._changeContent(i(this))}),this.ui.closeAndCancel.on(this.click,function(i){t.options.onClose=null,i.preventDefault(),t.close()}),this.ui.body.on("mouseup.cms",function(i){t._endMove(i),t._endResize(i)})},open:function(i,t,s){if(CMS.API.locked)return CMS.API.locked=!1,!1;CMS.API.locked=!0,this.ui.body.hasClass("cms-modal-minimized")&&(this.minimized=!0,this._minimize()),CMS.API.Toolbar._loader(!0),this.hideTooltip(),this._loadContent(i,t);var e=300,o=350,n=this.ui.window.width(),a=this.ui.window.height(),m=n>=this.options.minWidth+e?n-e:this.options.minWidth,d=a>=this.options.minHeight+o?a-o:this.options.minHeight;this.ui.maximizeButton.removeClass("cms-modal-maximize-active"),this.maximized=!1,d>=a&&(this.triggerMaximized=!0),this._setBreadcrumb(s),this._show({width:m,height:d,duration:this.options.modalDuration})},close:function(){var i=this;if(this.options.newPlugin){var t=this.options.newPlugin,s='{ "csrfmiddlewaretoken": "'+this.config.csrf+'" }',e=this.config.lang.confirm;CMS.API.Toolbar.openAjax(t["delete"],s,e,function(){i._hide(100)})}else this._hide(100);this.options.onClose&&this.reloadBrowser(this.options.onClose,!1,!0),setTimeout(function(){i.minimized&&i._minimize(),i.maximized&&i._maximize()},300)},_show:function(i){var t=this,s=i.width,e=i.height,o=i.duration;this.ui.modal.css({display:"block",width:s,height:e,"margin-left":-(s/2),"margin-top":-(e/2)}),setTimeout(function(){t.ui.modal.addClass("cms-modal-open")},0),this.ui.modal.one("cmsTransitionEnd",function(){t.ui.modal.css({"margin-left":-(s/2),"margin-top":-(e/2)}),CMS.API.Toolbar._loader(!1),t.triggerMaximized&&t._maximize(),CMS.API.locked=!1}).emulateTransitionEnd(o),this.ui.body.on("keydown.cms",function(i){27===i.keyCode&&t.close()}),this.ui.modal.focus()},_hide:function(i){var t=this;t.ui.modal.removeClass("cms-modal-open"),t.ui.modal.one("cmsTransitionEnd",function(){t.ui.modal.css("display","none")}).emulateTransitionEnd(i),t.ui.iframeHolder.find("iframe").remove(),t.ui.modalBody.removeClass("cms-loader")},_minimize:function(){return this.maximized?!1:void(this.minimized===!1?(CMS.API.Toolbar.toggleToolbar(!0),this.ui.modal.data("css",this.ui.modal.css(["left","top","margin-left","margin-top"])),this.ui.body.addClass("cms-modal-minimized"),this.ui.modal.css({left:this.ui.toolbarLeftPart.outerWidth(!0)+50}),this.minimized=!0):(this.ui.body.removeClass("cms-modal-minimized"),this.ui.modal.css(this.ui.modal.data("css")),this.minimized=!1))},_maximize:function(){var i=this.ui.modal;return this.minimized?!1:void(this.maximized===!1?(this.maximized=!0,i.data("css",this.ui.modal.css(["left","top","margin-left","margin-top","width","height"])),this.ui.body.addClass("cms-modal-maximized")):(this.maximized=!1,this.ui.body.removeClass("cms-modal-maximized"),i.css(i.data("css"))))},_startMove:function(i){if(this.maximized)return!1;if(this.minimized)return!1;var t=this,s=t.ui.modal.position();this.ui.shim.show(),this.ui.body.on("mousemove.cms",function(e){var o=s.left-(i.pageX-e.pageX),n=s.top-(i.pageY-e.pageY);t.ui.modal.css({left:o,top:n})})},_endMove:function(){this.ui.shim.hide(),this.ui.body.off("mousemove.cms")},_startResize:function(i){if(this.maximized)return!1;var t=this.ui.modal,s=t.width(),e=t.height(),o=this.ui.modal.position().left,n=this.ui.modal.position().top;this.ui.shim.show(),this.ui.body.on("mousemove.cms",function(a){var m=i.pageX-a.pageX,d=i.pageY-a.pageY,l=s-2*m,h=e-2*d,u=680;return u>=l||100>=h?!1:void t.css({width:s-2*m,height:e-2*d,left:o+m,top:n+d})})},_endResize:function(){this.ui.shim.hide(),this.ui.body.off("mousemove.cms")},_setBreadcrumb:function(t){var s=this.ui.breadcrumb,e="";return!t||t.length<=0?!1:t[0].title?(i.each(t,function(i,s){var o=i>=t.length-1?"cms-modal-breadcrumb-last":"";e+='<a href="'+s.url+'" class="'+o+'"><span>'+s.title+"</span></a>"}),this.ui.breadcrumbItems.html(e),void s.show()):!1},_setButtons:function(t){var s,e=t.contents().find(".suit-columns").length>0,o=this;s=t.contents().find(e?".save-box:eq(0)":".submit-row:eq(0)"),t.contents().find(".submit-row").hide();var n=s.find("input, a, button"),a=i("<span />");n.length||(s=t.contents().find("body:not(.change-list) #content form:eq(0)"),n=s.find('input[type="submit"], button[type="submit"]'),n.addClass("deletelink").hide()),n.each(function(t,s){i(s).attr("data-rel","_"+t)}),n.each(function(t,s){if(s=i(s),"hidden"===s.attr("type"))return!1;var e=s.attr("value")||s.text(),n="cms-btn";s.hasClass("default")&&(n="cms-btn cms-btn-action"),s.hasClass("deletelink")&&(n="cms-btn cms-btn-caution");var m=i('<div class="'+n+" "+s.attr("class")+'">'+e+"</div>");m.on(o.click,function(){(s.is("input")||s.is("button"))&&s[0].click(),s.is("a")&&o._loadContent(s.prop("href"),e),(s.hasClass("default")||s.hasClass("deletelink"))&&(o.options.newPlugin=null,s.hasClass("deletelink")&&(o.options.onClose=null),o.ui.iframeHolder.find("iframe").hide(),o.saved=!0)}),a.append(m)});var m=i('<div class="cms-btn">'+o.config.lang.cancel+"</div>");m.on(o.click,function(){o.options.onClose=!1,o.close()}),a.append(m),this.ui.modalButtons.html(a)},_prepareUrl:function(i){return i+=-1===i.indexOf("?")?"?modal=1":"&modal=1",i=i.replace("&","&amp;")},_loadContent:function(t,s){var e=this;t=this._prepareUrl(t);var o=i('<iframe src="'+t+'" class="" frameborder="0" />');o.css("visibility","hidden");var n=this.ui.iframeHolder,a=this.ui.title;a.html(s||"&nbsp;"),n.find("iframe").css("visibility","hidden"),e.ui.modalBody.addClass("cms-loader"),o.on("load",function(){try{o.contents()}catch(t){CMS.API.Toolbar.showError("<strong>"+t+"</strong>"),e.close()}var n=o.contents().find(".messagelist li");n.length&&CMS.API.Toolbar.openMessage(n.eq(0).text()),n.remove();var m=o.contents();if(n.length&&e.enforceReload&&e.reloadBrowser(),n.length&&e.enforceClose)return e.close(),!1;if(m.find(".viewsitelink").attr("target","_top"),e._setButtons(i(this)),(o.contents().find(".errornote").length||o.contents().find(".errorlist").length)&&(e.saved=!1),e.saved&&!m.find(".delete-confirmation").length)e.reloadBrowser(window.location.href,!1,!0);else{o.show();var d=o.contents().find("#content h1:eq(0)");void 0===s&&a.html(d.text()),d.remove(),o.css("visibility","visible"),o.data("ready",!0),m.find("body").on("keydown.cms",function(i){27===i.keyCode&&e.close()}),m.find("body").addClass("cms-modal-window"),m.find(".object-tools").length&&m.find("#content").css("padding-top",38)}}),n.html(o)},_changeContent:function(i){if(i.hasClass("cms-modal-breadcrumb-last"))return!1;var t=i.parent().find("a");t.removeClass("cms-modal-breadcrumb-last"),i.addClass("cms-modal-breadcrumb-last"),this._loadContent(i.attr("href")),this.ui.title.text(i.text())}})})}(CMS.$);
