...
!function(e){"use strict";e(document).ready(function(){/*!
         ...
         */
CMS.Plugin=new CMS.Class({implement:[CMS.API.Helpers],options:{type:"",placeholder_id:null,plugin_type:"",plugin_id:null,plugin_language:"",plugin_parent:null,plugin_order:null,plugin_breadcrumb:[],plugin_restriction:[],urls:{add_plugin:"",edit_plugin:"",move_plugin:"",copy_plugin:"",delete_plugin:""}},initialize:function(t,i){switch(this.container=e("."+t),this.options=e.extend(!0,{},this.options,i),this.body=e(document),this.csrf=CMS.config.csrf,this.timer=function(){},this.timeout=250,this.focused=!1,this.click=null!==document.ontouchstart?"click.cms":"tap.cms click.cms",this.container.data("settings",this.options),this.options.type){case"placeholder":this._setPlaceholder(),this._collapsables();break;case"plugin":this._setPlugin(),this._collapsables();break;default:this._setGeneric()}},_setPlaceholder:function(){var t=this,i=".cms-dragbar-title",n="cms-dragbar-title-expanded",s=e(".cms-dragbar-"+this.options.placeholder_id);this._setSubnav(s.find(".cms-submenu")),s.find(i).bind(this.click,function(){e(this).hasClass(n)?t._collapseAll(e(this)):t._expandAll(e(this))})},_setPlugin:function(){var t=this,i=function(){};this.container.bind("dblclick",function(e){e.preventDefault(),e.stopPropagation(),t.editPlugin(t.options.urls.edit_plugin,t.options.plugin_name,t.options.plugin_breadcrumb)}),this.container.bind("mouseover.cms mouseout.cms",function(e){e.stopPropagation();var i=t.options.plugin_name,n=t.options.plugin_id;"mouseover"===e.type?t.showTooltip(i,n):t.hideTooltip()}),this.container.bind("cms.plugins.update",function(e){e.stopPropagation(),t.movePlugin()}),this.container.bind("cms.plugin.update",function(i){i.stopPropagation();var n=e(i.delegateTarget),s=e(".cms-draggable-"+n.data("settings").plugin_id),o=t._getId(s.parents(".cms-draggables").last().prevAll(".cms-dragbar").first());if(!o)return!1;var a=n.data("settings");a.target=o,a.parent=t._getId(s.parent().closest(".cms-draggable")),t.copyPlugin(a)}),this.container.bind("mousedown mouseup mousemove",function(e){"mousemove"!==e.type&&e.stopPropagation(),"mousedown"!==e.type||3===e.which&&2===e.button?clearTimeout(i):i=setTimeout(function(){CMS.API.StructureBoard.setActive(t.options.plugin_id,!0)},500)});var n=e(".cms-draggable-"+this.options.plugin_id),s=n.find("> .cms-dragitem"),o=n.find(".cms-submenu:eq(0)"),a=e(".cms-draggables").find(".cms-submenu");this._setSubnav(n.find("> .cms-dragitem .cms-submenu")),n.bind("mouseenter mouseleave mouseover",function(i){return i.preventDefault(),i.stopPropagation(),t.focused?!1:(("mouseenter"===i.type||"mouseover"===i.type)&&e(this).data("active",!0),"mouseleave"===i.type&&(e(this).data("active",!1),a.hide()),void setTimeout(function(){e(i.currentTarget).data("active")||e(i.currentTarget).find(".cms-submenu:eq(0)").hide()},100))}),s.bind("mouseenter",function(e){e.preventDefault(),e.stopPropagation(),a.hide(),o.show()}),s.bind("dblclick",function(e){e.preventDefault(),e.stopPropagation(),t.editPlugin(t.options.urls.edit_plugin,t.options.plugin_name,t.options.plugin_breadcrumb)}),s.bind("mousedown mouseup mousemove",function(n){"mousedown"===n.type?i=setTimeout(function(){CMS.API.StructureBoard.setActive(t.options.plugin_id,!1),e(document).bind("mousemove.keypress",function(){e(document).trigger("keyup.cms",[!0]),setTimeout(function(){e(document).unbind("mousemove.keypress")},1e3)})},500):clearTimeout(i)})},_setGeneric:function(){var e=this;this.container.bind("dblclick",function(t){t.preventDefault(),t.stopPropagation(),e.editPlugin(e.options.urls.edit_plugin,e.options.plugin_name,[])}),this.container.bind("mouseover.cms mouseout.cms",function(t){t.stopPropagation();var i=e.options.plugin_name,n=e.options.plugin_id;"mouseover"===t.type?e.showTooltip(i,n):e.hideTooltip()})},addPlugin:function(e,t,i){var n={placeholder_id:this.options.placeholder_id,plugin_type:e,plugin_language:this.options.plugin_language};i&&(n.plugin_parent=i);var s=this.options.urls.add_plugin+"?"+CMS.$.param(n),o=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});o.open(s,t)},editPlugin:function(e,t,i){var n=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});n.open(e,t,i)},copyPlugin:function(t,i){if(CMS.API.locked)return!1;CMS.API.locked=!0;var n=this,s=t||i?!0:!1;t=t||this.options,i?(t.target=t.placeholder_id,t.plugin_id="",t.parent=""):i=t.plugin_language;var o={source_placeholder_id:t.placeholder_id,source_plugin_id:t.plugin_id||"",source_language:i,target_plugin_id:t.parent||"",target_placeholder_id:t.target||CMS.config.clipboard.id,target_language:t.page_language||i,csrfmiddlewaretoken:this.csrf},a={type:"POST",url:t.urls.copy_plugin,data:o,success:function(){CMS.API.Toolbar.openMessage(CMS.config.lang.success),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var t=CMS.config.lang.error;n._showError(t+e.responseText||e.status+" "+e.statusText)}};s?e.ajax(a):CMS.API.Clipboard.clear(function(){e.ajax(a)})},cutPlugin:function(){if(CMS.API.locked)return!1;CMS.API.locked=!0;var t=this,i={placeholder_id:CMS.config.clipboard.id,plugin_id:this.options.plugin_id,plugin_parent:"",plugin_language:this.options.page_language,plugin_order:[this.options.plugin_id],csrfmiddlewaretoken:this.csrf};CMS.API.Clipboard.clear(function(){return CMS.API.locked?!1:(CMS.API.locked=!0,void e.ajax({type:"POST",url:t.options.urls.move_plugin,data:i,success:function(){CMS.API.Toolbar.openMessage(CMS.config.lang.success),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var i=CMS.config.lang.error;t._showError(i+e.responseText||e.status+" "+e.statusText)}}))})},movePlugin:function(t){if(CMS.API.locked)return!1;CMS.API.locked=!0;var i=this;t=t||this.options;var n=e(".cms-plugin-"+t.plugin_id),s=e(".cms-draggable-"+t.plugin_id);this._setPosition(t.plugin_id,n,s);var o=this._getId(s.parents(".cms-draggables").last().prevAll(".cms-dragbar").first()),a=this._getId(s.parent().closest(".cms-draggable")),r=this._getIds(s.siblings(".cms-draggable").andSelf());if(o===!1)return!1;var l={placeholder_id:o,plugin_id:t.plugin_id,plugin_parent:a||"",plugin_language:t.page_language,plugin_order:r,csrfmiddlewaretoken:this.csrf};e.ajax({type:"POST",url:t.urls.move_plugin,data:l,success:function(e){e.reload&&CMS.API.Helpers.reloadBrowser(),CMS.API.locked=!1,i._showSuccess(s)},error:function(e){CMS.API.locked=!1;var t=CMS.config.lang.error;i._showError(t+e.responseText||e.status+" "+e.statusText)}}),e(".cms-btn-publish").addClass("cms-btn-publish-active").parent().show()},deletePlugin:function(e,t,i){var n=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});n.open(e,t,i)},_setPosition:function(t,i,n){var s=n.prev(".cms-draggable"),o=n.next(".cms-draggable"),a=n.parent().closest(".cms-draggable"),r=e(".cms-plugin-"+this._getId(a)),l=n.closest(".cms-dragarea");if(s.length)i.insertAfter(e(".cms-plugin-"+this._getId(s)));else if(o.length)i.insertBefore(e(".cms-plugin-"+this._getId(o)));else if(a.length){for(;r.children().length;)r=r.children();r.append(i)}else l.length?i.append(e(".cms-plugin-"+this._getId(l))):CMS.API.Helpers.reloadBrowser()},_setSubnav:function(t){var i=this;t.bind("mousedown",function(e){e.stopPropagation()}),t.bind("mouseenter mouseleave tap.cms",function(t){t.preventDefault(),t.stopPropagation(),"mouseenter"===t.type?i._showSubnav(e(this)):i._hideSubnav(e(this))}),t.find("a").bind(this.click,function(t){t.preventDefault(),t.stopPropagation(),CMS.API.Toolbar._loader(!0);var n=e(this);switch(n.attr("data-rel")){case"add":i.addPlugin(n.attr("href").replace("#",""),n.text(),i._getId(n.closest(".cms-draggable")));break;case"edit":i.editPlugin(i.options.urls.edit_plugin,i.options.plugin_name,i.options.plugin_breadcrumb);break;case"copy-lang":i.copyPlugin(this.options,n.attr("data-language"));break;case"copy":i.copyPlugin();break;case"cut":i.cutPlugin();break;case"delete":i.deletePlugin(i.options.urls.delete_plugin,i.options.plugin_name,i.options.plugin_breadcrumb);break;default:CMS.API.Toolbar._loader(!1),CMS.API.Toolbar._delegate(n)}}),t.find("input").bind("keyup keydown focus blur click",function(n){"focus"===n.type&&(i.focused=!0),"blur"!==n.type||i.traverse||(i.focused=!1,i._hideSubnav(t)),"keyup"===n.type&&(clearTimeout(i.timer),i.timer=setTimeout(function(){i._searchSubnav(t,e(n.currentTarget).val())},100))}),t.find(".cms-submenu-dropdown").each(function(){e(this).data("top",e(this).css("top"))}),t.bind(this.click,function(e){e.stopPropagation()})},_showSubnav:function(t){var i=this,n=t.find(".cms-submenu-dropdown"),s=parseInt(n.data("top"));clearTimeout(this.timer),this.timer=setTimeout(function(){var i=e(".cms-submenu").parentsUntil(".cms-dragarea"),n=t.find(".cms-submenu-scroll-hint");i.css("z-index",0);var s=t.parentsUntil(".cms-dragarea");s.css("z-index",999),t.find(".cms-submenu-quicksearch").show(),t.find("> .cms-submenu-dropdown").show().on("scroll",function(){n.fadeOut(100),e(this).off("scroll")}),t[0].scrollHeight>230&&n.show()},100),e(document).unbind("keydown.cms"),e(document).bind("keydown.cms",function(e){var n=t.find(".cms-submenu-item:visible a"),s=n.index(n.filter(":focus"));(40===e.keyCode||9===e.keyCode)&&(i.traverse=!0,e.preventDefault(),s>=0&&s<n.length-1?n.eq(s+1).focus():n.eq(0).focus()),38===e.keyCode&&(e.preventDefault(),n.is(":focus")?n.eq(s-1).focus():n.eq(n.length).focus()),(13===e.keyCode||27===e.keyCode)&&(i.traverse=!1,t.find("input").blur(),i._hideSubnav(t))});var o=n.height(),a=t.offset().top,r=e(window).height()+e(window).scrollTop();10>=r-a-o&&a-o>=0?(n.css("top","auto"),n.css("bottom",s),n.closest(".cms-draggable").length&&n.css("bottom",s-1)):(n.css("top",s),n.css("bottom","auto"))},_hideSubnav:function(t){clearTimeout(this.timer);var i=this;return this.focused?!1:(t.closest(".cms-draggable").data("active",!1),this.timer=setTimeout(function(){t.find("> .cms-submenu-dropdown").hide(),t.find(".cms-submenu-quicksearch").hide(),t.find("input").val(""),i._searchSubnav(t,"")},this.timeout),void e(".cms-dragbar").css("position",""))},_searchSubnav:function(t,i){var n=t.find(".cms-submenu-item"),s=t.find(".cms-submenu-item-title");return""===i?(n.add(s).show(),!1):(n.find("a, span").each(function(t,n){n=e(n);var s=n.text().toLowerCase(),o=i.toLowerCase();s.indexOf(o)>=0?n.parent().show():n.parent().hide()}),s.filter(":visible").each(function(t,i){s.hide(),e(i).nextUntil(".cms-submenu-item-title").show()}),n.filter(":visible").each(function(t,i){e(i).prev().hasClass("cms-submenu-item-title")?e(i).prev().show():e(i).prevUntil(".cms-submenu-item-title").last().prev().show()}),t.find(".cms-submenu-dropdown").show(),n.add(s).filter(":visible").length<=0&&t.find(".cms-submenu-dropdown").hide(),void t.find(".cms-submenu-scroll-hint").hide())},_collapsables:function(){var t=this,i=CMS.settings,n=e(".cms-draggable-"+this.options.plugin_id);if(this.container.each(function(t,i){var n=e(i).find(".cms-dragitem-collapsable"),s=n.filter(".cms-dragitem-expanded");n.length===s.length&&n.length+s.length!==0&&e(i).find(".cms-dragbar-title").addClass("cms-dragbar-title-expanded")}),!n.length)return!1;if(n.find("> .cms-dragitem-collapsable").bind(this.click,function(){var i=e(this),n=t._getId(e(this).parent()),s=CMS.settings;s.states=s.states||[],i.hasClass("cms-dragitem-expanded")?(s.states.splice(e.inArray(n,s.states),1),i.removeClass("cms-dragitem-expanded").parent().find("> .cms-draggables").hide()):(s.states.push(n),i.addClass("cms-dragitem-expanded").parent().find("> .cms-draggables").show()),CMS.API.Toolbar.setSettings(s)}),n.bind("dblclick",function(i){i.stopPropagation(),e(".cms-plugin-"+t._getId(e(this))).trigger("dblclick")}),CMS.Toolbar.ready)return!1;for(var s=i.states.sort(),o=[],a=0;a<s.length;a++)s[a]!==s[a+1]&&o.push(s[a]);i.states=o,e.each(CMS.settings.states,function(t,i){var n=e(".cms-draggable-"+i);n.find(".cms-draggables").length&&(n.find("> .cms-draggables").show(),n.find("> .cms-dragitem").addClass("cms-dragitem-expanded"))}),CMS.Toolbar.ready=!0},_expandAll:function(t){var i=t.closest(".cms-dragarea").find(".cms-dragitem-collapsable");return i.length?(i.each(function(){e(this).hasClass("cms-dragitem-expanded")||e(this).trigger("click.cms")}),void t.addClass("cms-dragbar-title-expanded")):!1},_collapseAll:function(t){var i=t.closest(".cms-dragarea").find(".cms-dragitem-collapsable");i.each(function(){e(this).hasClass("cms-dragitem-expanded")&&e(this).trigger("click.cms")}),t.removeClass("cms-dragbar-title-expanded")},_getId:function(e){return CMS.API.StructureBoard.getId(e)},_getIds:function(e){return CMS.API.StructureBoard.getIds(e)},_showError:function(e){return CMS.API.Toolbar.showError(e,!0)},_showSuccess:function(t){var i=e('<div class="cms-dragitem-success"></div>');t.append(i),i.fadeOut(function(){e(this).remove()})}})})}(CMS.$);
!function(e){"use strict";e(document).ready(function(){/*!
         * StructureBoard
