...
!function(i){"use strict";i(function(){/*!
         * Modal
         * Controls a cms specific modal
         */
CMS.Modal=new CMS.Class({implement:[CMS.API.Helpers],options:{onClose:!1,minHeight:400,minWidth:800,modalDuration:200,newPlugin:!1},initialize:function(t){this.options=i.extend(!0,{},this.options,t),this.config=CMS.config,this._setupUI(),this.click="click.cms",this.maximized=!1,this.minimized=!1,this.triggerMaximized=!1,this.saved=!1,this.ui.modal.data("ready")||this._events(),this.ui.modal.data("ready",!0)},_setupUI:function(){var t=i(".cms-modal");this.ui={modal:t,body:i("html"),window:i(window),toolbarLeftPart:i(".cms-toolbar-left"),minimizeButton:t.find(".cms-modal-minimize"),maximizeButton:t.find(".cms-modal-maximize"),title:t.find(".cms-modal-title"),resize:t.find(".cms-modal-resize"),breadcrumb:t.find(".cms-modal-breadcrumb"),breadcrumbItems:t.find(".cms-modal-breadcrumb-items"),closeAndCancel:t.find(".cms-modal-close, .cms-modal-cancel"),modalButtons:t.find(".cms-modal-buttons"),modalBody:t.find(".cms-modal-body"),iframeHolder:t.find(".cms-modal-frame"),shim:t.find(".cms-modal-shim")}},_events:function(){var t=this;this.ui.minimizeButton.on(this.click,function(i){i.preventDefault(),t._minimize()}),this.ui.title.on("pointerdown.cms",function(i){i.preventDefault(),t._startMove(i)}),this.ui.title.on("dblclick.cms",function(){t._maximize()}),this.ui.resize.on("pointerdown.cms",function(i){i.preventDefault(),t._startResize(i)}),this.ui.maximizeButton.on(this.click,function(i){i.preventDefault(),t._maximize()}),this.ui.breadcrumbItems.on(this.click,"a",function(e){e.preventDefault(),t._changeContent(i(this))}),this.ui.closeAndCancel.on(this.click,function(i){t.options.onClose=null,i.preventDefault(),t.close()}),this.ui.body.on("pointerup.cms pointercancel.cms",function(i){t._endMove(i),t._endResize(i)})},open:function(i,t,e){if(CMS.API.locked)return CMS.API.locked=!1,!1;CMS.API.locked=!0,this.ui.body.hasClass("cms-modal-minimized")&&(this.minimized=!0,this._minimize()),CMS.API.Toolbar._loader(!0),this.hideTooltip(),this._loadContent(i,t);var n=300,o=350,s=this.ui.window.width(),a=this.ui.window.height(),d=s>=this.options.minWidth+n?s-n:this.options.minWidth,m=a>=this.options.minHeight+o?a-o:this.options.minHeight;this.ui.maximizeButton.removeClass("cms-modal-maximize-active"),this.maximized=!1,m>=a&&(this.triggerMaximized=!0),this._setBreadcrumb(e),this._show({width:d,height:m,duration:this.options.modalDuration})},close:function(){var i=this;if(this.options.newPlugin){var t=this.options.newPlugin,e='{ "csrfmiddlewaretoken": "'+this.config.csrf+'" }',n=this.config.lang.confirm;CMS.API.Toolbar.openAjax(t["delete"],e,n,function(){i._hide(100)})}else this._hide(100);this.options.onClose&&this.reloadBrowser(this.options.onClose,!1,!0),setTimeout(function(){i.minimized&&i._minimize(),i.maximized&&i._maximize()},300)},_show:function(i){var t=this,e=i.width,n=i.height,o=i.duration;this.ui.modal.css({display:"block",width:e,height:n,"margin-left":-(e/2),"margin-top":-(n/2)}),setTimeout(function(){t.ui.modal.addClass("cms-modal-open")},0),this.ui.modal.one("cmsTransitionEnd",function(){t.ui.modal.css({"margin-left":-(e/2),"margin-top":-(n/2)}),CMS.API.Toolbar._loader(!1),t.triggerMaximized&&t._maximize(),CMS.API.locked=!1}).emulateTransitionEnd(o),this.ui.body.on("keydown.cms",function(i){27===i.keyCode&&t.close()}),this.ui.modal.focus()},_hide:function(i){var t=this;t.ui.modal.removeClass("cms-modal-open"),t.ui.modal.one("cmsTransitionEnd",function(){t.ui.modal.css("display","none")}).emulateTransitionEnd(i),t.ui.iframeHolder.find("iframe").remove(),t.ui.modalBody.removeClass("cms-loader")},_minimize:function(){return this.maximized?!1:void(this.minimized===!1?(CMS.API.Toolbar.toggleToolbar(!0),this.ui.modal.data("css",this.ui.modal.css(["left","top","margin-left","margin-top"])),this.ui.body.addClass("cms-modal-minimized"),this.ui.modal.css({left:this.ui.toolbarLeftPart.outerWidth(!0)+50}),this.minimized=!0):(this.ui.body.removeClass("cms-modal-minimized"),this.ui.modal.css(this.ui.modal.data("css")),this.minimized=!1))},_maximize:function(){var i=this.ui.modal;return this.minimized?!1:void(this.maximized===!1?(this.maximized=!0,i.data("css",this.ui.modal.css(["left","top","margin-left","margin-top","width","height"])),this.ui.body.addClass("cms-modal-maximized")):(this.maximized=!1,this.ui.body.removeClass("cms-modal-maximized"),i.css(i.data("css"))))},_startMove:function(i){if(this.maximized)return!1;if(this.minimized)return!1;var t=this,e=t.ui.modal.position();this.ui.shim.show(),this.ui.body.attr("touch-action","none").on("pointermove.cms",function(n){var o=e.left-(i.originalEvent.pageX-n.originalEvent.pageX),s=e.top-(i.originalEvent.pageY-n.originalEvent.pageY);t.ui.modal.css({left:o,top:s})})},_endMove:function(){this.ui.shim.hide(),this.ui.body.off("pointermove.cms").removeAttr("touch-action")},_startResize:function(i){if(this.maximized)return!1;var t=this.ui.modal,e=t.width(),n=t.height(),o=this.ui.modal.position().left,s=this.ui.modal.position().top;this.ui.shim.show(),this.ui.body.attr("touch-action","none").on("pointermove.cms",function(a){var d=i.originalEvent.pageX-a.originalEvent.pageX,m=i.originalEvent.pageY-a.originalEvent.pageY,l=e-2*d,r=n-2*m,c=680,h=100;return c>=l||h>=r?!1:void t.css({width:e-2*d,height:n-2*m,left:o+d,top:s+m})})},_endResize:function(){this.ui.shim.hide(),this.ui.body.off("pointermove.cms").removeAttr("touch-action")},_setBreadcrumb:function(t){var e=this.ui.breadcrumb,n="";return!t||t.length<=0?!1:t[0].title?(i.each(t,function(i,e){var o=i>=t.length-1?"cms-modal-breadcrumb-last":"";n+='<a href="'+e.url+'" class="'+o+'"><span>'+e.title+"</span></a>"}),this.ui.breadcrumbItems.html(n),void e.show()):!1},_setButtons:function(t){var e,n=t.contents().find(".suit-columns").length>0,o=this;e=t.contents().find(n?".save-box:eq(0)":".submit-row:eq(0)"),t.contents().find(".submit-row").hide();var s=e.find("input, a, button"),a=i("<span />");s.length||(e=t.contents().find("body:not(.change-list) #content form:eq(0)"),s=e.find('input[type="submit"], button[type="submit"]'),s.addClass("deletelink").hide()),s.each(function(t,e){i(e).attr("data-rel","_"+t)}),s.each(function(t,e){if(e=i(e),"hidden"===e.attr("type"))return!1;var n=e.attr("value")||e.text(),s="cms-btn";e.hasClass("default")&&(s="cms-btn cms-btn-action"),e.hasClass("deletelink")&&(s="cms-btn cms-btn-caution");var d=i('<div class="'+s+" "+e.attr("class")+'">'+n+"</div>");d.on(o.click,function(){(e.is("input")||e.is("button"))&&e[0].click(),e.is("a")&&o._loadContent(e.prop("href"),n),(e.hasClass("default")||e.hasClass("deletelink"))&&(o.options.newPlugin=null,e.hasClass("deletelink")&&(o.options.onClose=null),o.ui.iframeHolder.find("iframe").hide(),o.saved=!0)}),a.append(d)});var d=i('<div class="cms-btn">'+o.config.lang.cancel+"</div>");d.on(o.click,function(){o.options.onClose=!1,o.close()}),a.append(d),this.ui.modalButtons.html(a)},_prepareUrl:function(i){return i+=-1===i.indexOf("?")?"?modal=1":"&modal=1",i=i.replace("&","&amp;")},_loadContent:function(t,e){var n=this;t=this._prepareUrl(t);var o=i('<iframe src="'+t+'" class="" frameborder="0" />');o.css("visibility","hidden");var s=this.ui.iframeHolder,a=this.ui.title;a.html(e||"&nbsp;"),s.find("iframe").css("visibility","hidden"),n.ui.modalBody.addClass("cms-loader"),o.on("load",function(){try{o.contents()}catch(t){CMS.API.Toolbar.showError("<strong>"+t+"</strong>"),n.close()}var s=o.contents().find(".messagelist li");s.length&&CMS.API.Toolbar.openMessage(s.eq(0).text()),s.remove();var d=o.contents();if(s.length&&n.enforceReload&&n.reloadBrowser(),s.length&&n.enforceClose)return n.close(),!1;if(d.find(".viewsitelink").attr("target","_top"),n._setButtons(i(this)),(o.contents().find(".errornote").length||o.contents().find(".errorlist").length)&&(n.saved=!1),n.saved&&!d.find(".delete-confirmation").length)n.reloadBrowser(window.location.href,!1,!0);else{o.show();var m=o.contents().find("#content h1:eq(0)");void 0===e&&a.html(m.text()),m.remove(),o.css("visibility","visible"),o.data("ready",!0),d.find("body").on("keydown.cms",function(i){27===i.keyCode&&n.close()}),d.find("body").addClass("cms-modal-window"),d.find(".object-tools").length&&d.find("#content").css("padding-top",38)}}),s.html(o)},_changeContent:function(i){if(i.hasClass("cms-modal-breadcrumb-last"))return!1;var t=i.parent().find("a");t.removeClass("cms-modal-breadcrumb-last"),i.addClass("cms-modal-breadcrumb-last"),this._loadContent(i.attr("href")),this.ui.title.text(i.text())}})})}(CMS.$);
!function(i){"use strict";i(document).ready(function(){/*!
         * Sideframe
         * Controls a cms specific sideframe
         */
CMS.Sideframe=new CMS.Class({implement:[CMS.API.Helpers],options:{onClose:!1,sideframeDuration:300,sideframeWidth:320,urls:{css_sideframe:"cms/css/cms.toolbar.sideframe.css"}},initialize:function(e){this.options=i.extend(!0,{},this.options,e),this.config=CMS.config,this.settings=CMS.settings,this.sideframe=i(".cms-sideframe"),this.body=i("html"),this.click="click.cms",this.enforceReload=!1,this.sideframe.data("ready")||this._events(),this.sideframe.data("ready",!0)},_events:function(){var e=this;this.sideframe.find(".cms-sideframe-close").bind(this.click,function(){e.close(!0)}),this.sideframe.find(".cms-sideframe-hide").bind(this.click,function(){i(this).hasClass("cms-sideframe-hidden")?(e.settings.sideframe.hidden=!1,e._show(e.settings.sideframe.position||e.options.sideframeWidth,!0)):(e.settings.sideframe.hidden=!0,e._hide()),e.settings=e.setSettings(e.settings)}),this.sideframe.find(".cms-sideframe-maximize").bind(this.click,function(){i(this).hasClass("cms-sideframe-minimize")?(e.settings.sideframe.maximized=!1,e._minimize()):(e.settings.sideframe.maximized=!0,e.settings.sideframe.hidden=!1,e._maximize()),e.settings=e.setSettings(e.settings)}),this.sideframe.find(".cms-sideframe-resize").bind("pointerdown.cms.sideframe",function(i){i.preventDefault(),e._startResize()}),i("html").bind("pointerup.cms.sideframe",function(){e._stopResize()})},open:function(e,s){function t(i){n.sideframe.find(".cms-sideframe-frame").addClass("cms-loader"),m.html(i)}var n=this,d="language="+CMS.config.request.language,a="page_id="+CMS.config.request.page_id,m=this.sideframe.find(".cms-sideframe-frame"),r=!1;if(e.indexOf(CMS.config.request.tree)>=0){var f=[];CMS.config.request.language&&f.push(d),CMS.config.request.page_id&&f.push(a),e=this._url(e,f)}var o=i('<iframe src="'+e+'" class="" frameborder="0" />');o.hide();var h=this.settings.sideframe.position||this.options.sideframeWidth;o.bind("load",function(){var e=o.contents();e.find("head").append(i('<link rel="stylesheet" type="text/css" href="'+n.config.urls["static"]+n.options.urls.css_sideframe+'" />')),n.sideframe.find(".cms-sideframe-frame").removeClass("cms-loader"),o.show(),n.config.debug&&o.contents().find("body").addClass("cms-debug"),n.settings.sideframe.url=o.get(0).contentWindow.location.href,n.settings=n.setSettings(n.settings),e.find("body").bind(n.click,function(){i(document).trigger(n.click)}),r&&n.reloadBrowser(!1,!1,!0),r=!0,e.find(".viewsitelink").attr("target","_top")}),this.sideframe.is(":visible")?(t(o),this.sideframe.outerWidth()<h&&(this.settings.sideframe.hidden=!1,this._show(h,s))):(setTimeout(function(){t(o)},this.options.sideframeDuration),this._show(h,s))},close:function(){this._hide(!0),this.settings.sideframe={url:null,hidden:!1,maximized:!1,width:this.options.sideframeWidth},this.sideframe.find(".cms-sideframe-maximize").removeClass("cms-sideframe-minimize"),this.sideframe.find(".cms-sideframe-hide").show(),this.settings=this.setSettings(this.settings),this.reloadBrowser(this.options.onClose,!1,!0)},_show:function(e,s){this.sideframe.find(".cms-sideframe-hide").removeClass("cms-sideframe-hidden"),this.sideframe.show(),this.settings.sideframe.hidden&&this._hide(),this.settings.sideframe.maximized&&this._maximize(),this.settings.sideframe.hidden||this.settings.sideframe.maximized||(s?(this.sideframe.animate({width:e},this.options.sideframeDuration),this.body.animate({"margin-left":e},this.options.sideframeDuration)):(this.sideframe.animate({width:e},0),this.body.animate({"margin-left":e},0),e>=i(window).width()&&(this.sideframe.animate({width:i(window).width()-30},0),this.body.animate({"margin-left":i(window).width()-30},0))),this.sideframe.find(".cms-sideframe-btn").css("right",-30)),setTimeout(function(){CMS.API.Toolbar._lock(!0),CMS.API.Toolbar._showToolbar(!0)},100)},_hide:function(e){this.sideframe.find(".cms-sideframe-hide").addClass("cms-sideframe-hidden");var s=this.options.sideframeDuration;e&&this.sideframe.width()<=0&&(s=0),e&&this.sideframe.find("iframe").remove(),this.sideframe.animate({width:0},s,function(){e&&i(this).hide()}),this.body.animate({"margin-left":0},s),this.sideframe.find(".cms-sideframe-frame").removeClass("cms-loader"),setTimeout(function(){CMS.API.Toolbar._lock(!1)},100)},_minimize:function(e){this.sideframe.find(".cms-sideframe-maximize").removeClass("cms-sideframe-minimize"),this.sideframe.find(".cms-sideframe-hide").show(),e||this._show(this.settings.sideframe.position||this.options.sideframeWidth,!0),i(window).unbind("resize.cms.sideframe")},_maximize:function(){var e=this;this.sideframe.find(".cms-sideframe-maximize").addClass("cms-sideframe-minimize"),this.sideframe.find(".cms-sideframe-hide").hide(),this.sideframe.find(".cms-sideframe-hide").removeClass("cms-sideframe-hidden").hide(),this.sideframe.animate({width:i(window).width()},0),this.body.animate({"margin-left":0},0),this.sideframe.find(".cms-sideframe-btn").css("right",-2),i(window).bind("resize.cms.sideframe",function(){e.sideframe.css("width",i(window).width())})},_startResize:function(){var e=this,s=30,t=function(){};this.sideframe.find(".cms-sideframe-shim").css("z-index",20),this._minimize(!0),i("html").attr("touch-action","none").bind("pointermove.cms.sideframe",function(n){n.originalEvent.clientX<=320&&(n.originalEvent.clientX=320),n.originalEvent.clientX>=i(window).width()-s&&(n.originalEvent.clientX=i(window).width()-s),e.sideframe.css("width",n.originalEvent.clientX),e.body.css("margin-left",n.originalEvent.clientX),e.settings.sideframe.position=n.originalEvent.clientX,i(window).trigger("resize.sideframe"),clearTimeout(t),t=setTimeout(function(){e.settings=e.setSettings(e.settings)},500)})},_stopResize:function(){this.sideframe.find(".cms-sideframe-shim").css("z-index",1),i(window).trigger("resize.sideframe"),i("html").removeAttr("touch-action").unbind("pointermove.cms.sideframe")},_url:function(e,s){var t=[],n=[],d=[],a="",m=[],r=[],f=e;return e.split("?").length<=1||void 0===window.JSON||(m=e.split("?"),r=m[1].split("&"),f=m[0]),i.each(r,function(i,e){t.push({param:e.split("=")[0],value:e.split("=")[1]})}),i.each(s,function(i,e){t.push({param:e.split("=")[0],value:e.split("=")[1]})}),i.each(t,function(e,s){var t=i.inArray(s.param,n);-1===t?(n.push(s.param),d.push(s.value)):d[t]=s.value}),i.each(n,function(i,e){a+="&"+e+"="+d[i]}),a=a.replace("&","?"),e=f+a}})})}(CMS.$);
!function(i){"use strict";i(document).ready(function(){/*!
         * Clipboard
         * Handles copy & paste
         */
...
!function(e){"use strict";e(document).ready(function(){/*!
         ...
         */
CMS.Plugin=new CMS.Class({implement:[CMS.API.Helpers],options:{type:"",placeholder_id:null,plugin_type:"",plugin_id:null,plugin_language:"",plugin_parent:null,plugin_order:null,plugin_breadcrumb:[],plugin_restriction:[],urls:{add_plugin:"",edit_plugin:"",move_plugin:"",copy_plugin:"",delete_plugin:""}},initialize:function(s,i){switch(this.container=e("."+s),this.options=e.extend(!0,{},this.options,i),this.body=e(document),this.csrf=CMS.config.csrf,this.timer=function(){},this.timeout=250,this.focused=!1,this.click="pointerup.cms",this.container.data("settings",this.options),this.options.type){case"placeholder":this._setPlaceholder(),this._collapsables();break;case"plugin":this._setPlugin(),this._collapsables();break;default:this._setGeneric()}},_setPlaceholder:function(){var s=this,i=".cms-dragbar-title",t="cms-dragbar-title-expanded",n=e(".cms-dragbar-"+this.options.placeholder_id);this._setSubnav(n.find(".cms-submenu"));var a=CMS.settings;a.dragbars=a.dragbars||[],n.find(i).bind(this.click,function(){e(this).hasClass(t)?s._collapseAll(e(this)):s._expandAll(e(this))}),-1!==e.inArray(this.options.placeholder_id,a.dragbars)&&n.find(i).addClass(t)},_setPlugin:function(){var s=this;this.container.bind("dblclick",function(e){e.preventDefault(),e.stopPropagation(),s.editPlugin(s.options.urls.edit_plugin,s.options.plugin_name,s.options.plugin_breadcrumb)}),this.container.bind("pointerover.cms pointerout.cms",function(e){e.stopPropagation();var i=s.options.plugin_name,t=s.options.plugin_id;"pointerover"===e.type?s.showTooltip(i,t):s.hideTooltip()}),this.container.bind("cms.plugins.update",function(e){e.stopPropagation(),s.movePlugin()}),this.container.bind("cms.plugin.update",function(i){i.stopPropagation();var t=e(i.delegateTarget),n=e(".cms-draggable-"+t.data("settings").plugin_id),a=s._getId(n.parents(".cms-draggables").last().prevAll(".cms-dragbar").first());if(!a)return!1;var o=t.data("settings");o.target=a,o.parent=s._getId(n.parent().closest(".cms-draggable")),s.copyPlugin(o)});var i=e(".cms-draggable-"+this.options.plugin_id),t=i.find("> .cms-dragitem");this._setSubnav(i.find("> .cms-dragitem .cms-submenu")),t.bind("dblclick",function(e){e.preventDefault(),e.stopPropagation(),s.editPlugin(s.options.urls.edit_plugin,s.options.plugin_name,s.options.plugin_breadcrumb)})},_setGeneric:function(){var e=this;this.container.bind("dblclick",function(s){s.preventDefault(),s.stopPropagation(),e.editPlugin(e.options.urls.edit_plugin,e.options.plugin_name,[])}),this.container.bind("pointerover.cms pointerout.cms",function(s){s.stopPropagation();var i=e.options.plugin_name,t=e.options.plugin_id;"pointerover"===s.type?e.showTooltip(i,t):e.hideTooltip()})},addPlugin:function(s,i,t){if(CMS.API.locked)return!1;CMS.API.locked=!0;var n=this,a={placeholder_id:this.options.placeholder_id,plugin_type:s,plugin_parent:t||"",plugin_language:this.options.plugin_language,csrfmiddlewaretoken:this.csrf};e.ajax({type:"POST",url:this.options.urls.add_plugin,data:a,success:function(e){CMS.API.locked=!1,n.newPlugin=e,n.editPlugin(e.url,i,e.breadcrumb)},error:function(e){CMS.API.locked=!1;var s=CMS.config.lang.error;n._showError(s+e.responseText||e.status+" "+e.statusText)}})},editPlugin:function(e,s,i){var t=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});t.open(e,s,i)},copyPlugin:function(s,i){if(CMS.API.locked)return!1;CMS.API.locked=!0;var t=this,n=s||i?!0:!1;s=s||this.options,i?(s.target=s.placeholder_id,s.plugin_id="",s.parent=""):i=s.plugin_language;var a={source_placeholder_id:s.placeholder_id,source_plugin_id:s.plugin_id||"",source_language:i,target_plugin_id:s.parent||"",target_placeholder_id:s.target||CMS.config.clipboard.id,target_language:s.page_language||i,csrfmiddlewaretoken:this.csrf},o={type:"POST",url:s.urls.copy_plugin,data:a,success:function(){CMS.API.Toolbar.openMessage(CMS.config.lang.success),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var s=CMS.config.lang.error;t._showError(s+e.responseText||e.status+" "+e.statusText)}};n?e.ajax(o):CMS.API.Clipboard.clear(function(){e.ajax(o)})},cutPlugin:function(){if(CMS.API.locked)return!1;CMS.API.locked=!0;var s=this,i={placeholder_id:CMS.config.clipboard.id,plugin_id:this.options.plugin_id,plugin_parent:"",plugin_language:this.options.page_language,plugin_order:[this.options.plugin_id],csrfmiddlewaretoken:this.csrf};CMS.API.Clipboard.clear(function(){return CMS.API.locked?!1:(CMS.API.locked=!0,void e.ajax({type:"POST",url:s.options.urls.move_plugin,data:i,success:function(){CMS.API.Toolbar.openMessage(CMS.config.lang.success),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var i=CMS.config.lang.error;s._showError(i+e.responseText||e.status+" "+e.statusText)}}))})},movePlugin:function(s){if(CMS.API.locked)return!1;CMS.API.locked=!0;var i=this;s=s||this.options;var t=e(".cms-plugin-"+s.plugin_id),n=e(".cms-draggable-"+s.plugin_id);this._setPosition(s.plugin_id,t,n);var a=this._getId(n.parents(".cms-draggables").last().prevAll(".cms-dragbar").first()),o=this._getId(n.parent().closest(".cms-draggable")),r=this._getIds(n.siblings(".cms-draggable").andSelf());if(a===!1)return!1;var l={placeholder_id:a,plugin_id:s.plugin_id,plugin_parent:o||"",plugin_language:s.page_language,plugin_order:r,csrfmiddlewaretoken:this.csrf};e.ajax({type:"POST",url:s.urls.move_plugin,data:l,success:function(e){e.reload&&CMS.API.Helpers.reloadBrowser(),CMS.API.locked=!1,i._showSuccess(n)},error:function(e){CMS.API.locked=!1;var s=CMS.config.lang.error;i._showError(s+e.responseText||e.status+" "+e.statusText)}}),e(".cms-btn-publish").addClass("cms-btn-publish-active").removeClass("cms-btn-disabled").parent().show(),e(".cms-toolbar-revert").removeClass("cms-toolbar-item-navigation-disabled")},deletePlugin:function(e,s,i){var t=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});t.open(e,s,i)},_setPosition:function(s,i,t){var n=t.prev(".cms-draggable"),a=t.next(".cms-draggable"),o=t.parent().closest(".cms-draggable"),r=e(".cms-plugin-"+this._getId(o)),l=t.closest(".cms-dragarea");if(n.length)i.insertAfter(e(".cms-plugin-"+this._getId(n)));else if(a.length)i.insertBefore(e(".cms-plugin-"+this._getId(a)));else if(o.length){for(;r.children().length;)r=r.children();r.append(i)}else l.length?i.insertAfter(e(".cms-placeholder-"+this._getId(l))):CMS.API.Helpers.reloadBrowser()},editPluginPostAjax:function(e,s,i){return"undefined"==typeof s||"undefined"==typeof i?function(s,i){var t=e;t.editPlugin(i.url,t.options.plugin_name,i.breadcrumb)}:void this.editPlugin(i.url,this.options.plugin_name,i.breadcrumb)},_setSubnav:function(s){var i=this;s.bind("click",function(s){s.preventDefault(),s.stopPropagation();var t=e(this);t.hasClass("cms-btn-active")?i._hideSubnav(t):i._showSubnav(t)}),s.siblings(".cms-submenu-dropdown").on("mousedown mousemove mouseup",function(e){e.stopPropagation()}).on("touchstart",function(e){e.stopPropagation()}),s.siblings(".cms-submenu-dropdown").find("a").bind("click.cms",function(t){t.preventDefault(),t.stopPropagation(),CMS.API.Toolbar._loader(!0);var n=e(this);switch(i._hideSubnav(s),n.attr("data-rel")){case"add":i.addPlugin(n.attr("href").replace("#",""),n.text(),i._getId(n.closest(".cms-draggable")));break;case"ajax_add":CMS.API.Toolbar.openAjax(n.attr("href"),JSON.stringify(n.data("post")),n.data("text"),i.editPluginPostAjax(i),n.data("on-success"));break;case"edit":i.editPlugin(i.options.urls.edit_plugin,i.options.plugin_name,i.options.plugin_breadcrumb);break;case"copy-lang":i.copyPlugin(this.options,n.attr("data-language"));break;case"copy":i.copyPlugin();break;case"cut":i.cutPlugin();break;case"delete":i.deletePlugin(i.options.urls.delete_plugin,i.options.plugin_name,i.options.plugin_breadcrumb);break;default:CMS.API.Toolbar._loader(!1),CMS.API.Toolbar._delegate(n)}}),s.siblings(".cms-submenu-quicksearch").find("input").on("keyup keydown focus pointerup",function(t){"focus"===t.type&&(i.focused=!0),"keyup"===t.type&&(clearTimeout(i.timer),i.timer=setTimeout(function(){i._searchSubnav(s,e(t.currentTarget).val())},100))}),s.siblings(".cms-submenu-dropdown").each(function(){e(this).data("top",e(this).css("top"))}),s.on(this.click+" dblclick",function(e){e.stopPropagation()}),s.siblings(".cms-submenu-quicksearch, .cms-submenu-dropdown").on(this.click,function(e){e.stopPropagation()}),e(document).add(".cms-submenu").not(s).on(this.click,function(){i._hideSubnav(s)})},_showSubnav:function(s){var i=this,t=s.siblings(".cms-submenu-dropdown"),n=parseInt(t.data("top"));s.addClass("cms-btn-active");var a=e(".cms-submenu").parentsUntil(".cms-dragarea"),o=t.find(".cms-submenu-scroll-hint");a.css("z-index",0);var r=s.parentsUntil(".cms-dragarea");r.css("z-index",999),s.siblings(".cms-submenu-quicksearch").show().find("input"),s.siblings(".cms-submenu-dropdown").show().on("scroll",function(){o.fadeOut(100),e(this).off("scroll")}),t[0].scrollHeight>t.height()&&o.show(),e(document).unbind("keydown.cms"),e(document).bind("keydown.cms",function(e){var t=s.siblings(".cms-submenu-dropdown").find(".cms-submenu-item:visible a"),n=t.index(t.filter(":focus"));(40===e.keyCode||9===e.keyCode)&&(i.traverse=!0,e.preventDefault(),n>=0&&n<t.length-1?t.eq(n+1).focus():t.eq(0).focus()),(38===e.keyCode||9===e.keyCode&&e.shiftKey)&&(e.preventDefault(),t.is(":focus")?t.eq(n-1).focus():t.eq(t.length).focus()),(13===e.keyCode||27===e.keyCode)&&(i.traverse=!1,s.siblings(".cms-submenu-quicksearch").find("input").blur(),i._hideSubnav(s))}),e(window).height()+e(window).scrollTop()-s.offset().top-t.height()<=10&&s.offset().top-t.height()>=0?(t.css("top","auto"),t.css("bottom",n),t.closest(".cms-draggable").length&&t.css("bottom",n-1)):(t.css("top",n),t.css("bottom","auto"))},_hideSubnav:function(s){s.removeClass("cms-btn-active"),s.closest(".cms-draggable").data("active",!1),s.siblings(".cms-submenu-dropdown").hide(),s.siblings(".cms-submenu-quicksearch").hide(),s.siblings(".cms-submenu-quicksearch").find("input").val("").blur(),e(".cms-dragbar").css("position","")},_searchSubnav:function(s,i){var t=s.siblings(".cms-submenu-dropdown").find(".cms-submenu-item"),n=s.siblings(".cms-submenu-dropdown").find(".cms-submenu-item-title");return""===i?(t.add(n).show(),!1):(t.find("a, span").each(function(s,t){t=e(t);var n=t.text().toLowerCase(),a=i.toLowerCase();n.indexOf(a)>=0?t.parent().show():t.parent().hide()}),n.filter(":visible").each(function(s,i){n.hide(),e(i).nextUntil(".cms-submenu-item-title").show()}),t.filter(":visible").each(function(s,i){e(i).prev().hasClass("cms-submenu-item-title")?e(i).prev().show():e(i).prevUntil(".cms-submenu-item-title").last().prev().show()}),s.siblings(".cms-submenu-dropdown").show(),t.add(n).filter(":visible").length<=0&&s.siblings(".cms-submenu-dropdown").hide(),void s.siblings(".cms-submenu-dropdown").find(".cms-submenu-scroll-hint").hide())},_collapsables:function(){var s=this,i=CMS.settings,t=e(".cms-draggable-"+this.options.plugin_id);if(this.container.each(function(s,i){var t=e(i).find(".cms-dragitem-collapsable"),n=t.filter(".cms-dragitem-expanded");t.length===n.length&&t.length+n.length!==0&&e(i).find(".cms-dragbar-title").addClass("cms-dragbar-title-expanded")}),!t.length)return!1;if(t.find("> .cms-dragitem-collapsable").bind(this.click,function(){var i,n=e(this),a=s._getId(e(this).parent()),o=CMS.settings;if(o.states=o.states||[],n.hasClass("cms-dragitem-expanded")){if(o.states.splice(e.inArray(a,o.states),1),n.removeClass("cms-dragitem-expanded").parent().find("> .cms-draggables").hide(),e(document).data("expandmode")){if(i=t.find(".cms-draggable").find(".cms-dragitem-collapsable"),!i.length)return!1;i.each(function(){e(this).hasClass("cms-dragitem-expanded")&&e(this).trigger(s.click)})}}else if(o.states.push(a),n.addClass("cms-dragitem-expanded").parent().find("> .cms-draggables").show(),e(document).data("expandmode")){if(i=t.find(".cms-draggable").find(".cms-dragitem-collapsable"),!i.length)return!1;i.each(function(){e(this).hasClass("cms-dragitem-expanded")||e(this).trigger(s.click)})}e(window).trigger("resize.sideframe"),CMS.API.Toolbar.setSettings(o)}),t.bind("dblclick",function(i){i.stopPropagation(),e(".cms-plugin-"+s._getId(e(this))).trigger("dblclick")}),CMS.Toolbar.ready)return!1;for(var n=i.states.sort(),a=[],o=0;o<n.length;o++)n[o]!==n[o+1]&&a.push(n[o]);i.states=a,e.each(CMS.settings.states,function(s,i){var t=e(".cms-draggable-"+i);t.find(".cms-draggables").length&&(t.find("> .cms-draggables").show(),t.find("> .cms-dragitem").addClass("cms-dragitem-expanded"))}),CMS.Toolbar.ready=!0},_expandAll:function(s){var i=this,t=s.closest(".cms-dragarea").find(".cms-dragitem-collapsable");if(!t.length)return!1;t.each(function(){e(this).hasClass("cms-dragitem-expanded")||e(this).trigger(i.click)}),s.addClass("cms-dragbar-title-expanded");var n=CMS.settings;n.dragbars=n.dragbars||[],n.dragbars.push(this.options.placeholder_id),CMS.API.Toolbar.setSettings(n)},_collapseAll:function(s){var i=this,t=s.closest(".cms-dragarea").find(".cms-dragitem-collapsable");t.each(function(){e(this).hasClass("cms-dragitem-expanded")&&e(this).trigger(i.click)}),s.removeClass("cms-dragbar-title-expanded");var n=CMS.settings;n.dragbars=n.dragbars||[],n.dragbars.splice(e.inArray(this.options.placeholder_id,n.states),1),CMS.API.Toolbar.setSettings(n)},_getId:function(e){return CMS.API.StructureBoard.getId(e)},_getIds:function(e){return CMS.API.StructureBoard.getIds(e)},_showError:function(e){return CMS.API.Toolbar.showError(e,!0)},_showSuccess:function(s){var i=e('<div class="cms-dragitem-success"></div>');s.append(i),i.fadeOut(function(){e(this).remove()}),e(window).trigger("resize.sideframe")}})})}(CMS.$);
!function(e){"use strict";e(document).ready(function(){function t(){s.each(function(){var t=e(this);t.next().children().not(".cms-is-dragging").length?t.hide():t.show()})}var s=e(".cms-dragbar-empty-wrapper");/*!
         * StructureBoard
         * handles drag & drop, mode switching and
         */
CMS.StructureBoard=new CMS.Class({implement:[CMS.API.Helpers],options:{speed:300},initialize:function(s){this.container=e(".cms-structure"),this.options=e.extend(!0,{},this.options,s),this.config=CMS.config,this.settings=CMS.settings,this.toolbar=e("#cms-toolbar"),this.sortables=e(".cms-draggables"),this.plugins=e(".cms-plugin"),this.render_model=e(".cms-render-model"),this.placeholders=e(".cms-placeholder"),this.dragitems=e(".cms-draggable"),this.dragareas=e(".cms-dragarea"),this.dropareas=e(".cms-droppable"),this.dimmer=this.container.find(".cms-structure-dimmer"),this.clipboard=e(".cms-clipboard"),this.click="click.cms",this.timer=function(){},this.interval=function(){},this.state=!1,this.dragging=!1,this._setup(),this._events(),t()},_setup:function(){var e=this;return this.dragareas.length&&this.toolbar.find(".cms-toolbar-item-cms-mode-switcher").length?("structure"===this.settings.mode&&setTimeout(function(){e.show(!0)},100),this.placeholders.length&&this.toolbar.find(".cms-toolbar-item-cms-mode-switcher").show(),void this._drag()):!1},_events:function(){var t=this,s=this.toolbar.find(".cms-toolbar-item-cms-mode-switcher a");s.eq(1).bind(this.click,function(e){return e.preventDefault(),"edit"===t.settings.mode?!1:void t.hide()}),s.eq(0).bind(this.click,function(e){return e.preventDefault(),"structure"===t.settings.mode?!1:void t.show()}),e(document).bind("keydown",function(s){var i=e("*:focus");if(32!==s.keyCode||"structure"!==t.settings.mode||i.length)if(32!==s.keyCode||"edit"!==t.settings.mode||i.length)16===s.keyCode&&e(this).data("expandmode",!0);else{if(!t.toolbar.find(".cms-toolbar-item-cms-mode-switcher").length)return!1;s.preventDefault(),t.show()}else{if(!t.toolbar.find(".cms-toolbar-item-cms-mode-switcher").length)return!1;s.preventDefault(),t.hide()}}),e(document).bind("keyup",function(t){16===t.keyCode&&e(this).data("expandmode",!1)})},show:function(e){if("live"===CMS.config.mode)return!1;var t=this.toolbar.find(".cms-toolbar-item-cms-mode-switcher a");t.removeClass("cms-btn-active").eq(0).addClass("cms-btn-active"),this.clipboard.css("opacity",1).fadeIn(this.options.speed),this.settings.mode="structure",e||(this.settings=this.setSettings(this.settings)),this.dragareas.show(),this._showBoard()},hide:function(e){if("live"===CMS.config.mode)return!1;var t=this.toolbar.find(".cms-toolbar-item-cms-mode-switcher a");t.removeClass("cms-btn-active").eq(1).addClass("cms-btn-active"),this.container.find(".cms-clipboard").hide(),this.clipboard.hide(),this.settings.mode="edit",e||(this.settings=this.setSettings(this.settings)),this._hideBoard()},getId:function(e){if(void 0===e||null===e||e.length<=0)return!1;var t=null,s=e.attr("class").split(" ")[1];return e.hasClass("cms-plugin")?t=s.replace("cms-plugin-",""):e.hasClass("cms-draggable")?t=s.replace("cms-draggable-",""):e.hasClass("cms-placeholder")?t=s.replace("cms-placeholder-",""):e.hasClass("cms-dragbar")?t=s.replace("cms-dragbar-",""):e.hasClass("cms-dragarea")&&(t=s.replace("cms-dragarea-","")),t},getIds:function(t){var s=this,i=[];return t.each(function(){i.push(s.getId(e(this)))}),i},setActive:function(t,s){if(this.dragitems.removeClass("cms-draggable-selected"),this.plugins.removeClass("cms-plugin-active"),t===!1)return!1;var i=e(".cms-draggable-"+t),a=e(".cms-plugin-"+t);s?(this._showBoard(),this.clipboard.show().css("opacity",.2),this.dragareas.css("opacity",.2),i.closest(".cms-dragarea").show().css("opacity",1)):this.hide();var r=i.parentsUntil(".cms-dragarea").siblings().not(".cms-dragitem-expanded");r.trigger(this.click),i.addClass("cms-draggable-selected"),a.addClass("cms-plugin-active")},preventEvents:function(t){var s=0,i=500,a=function(){};t.find("a").bind(this.click,function(t){t.preventDefault(),s++,1===s&&(a=setTimeout(function(){return s=0,0===e(t.currentTarget).attr("href").indexOf("#")?!1:void(window.location.href=e(t.currentTarget).attr("href"))},i)),2===s&&(clearTimeout(a),s=0)})},_showBoard:function(){var t=this,s=function(){};if(this.container.show(),this.dimmer.fadeIn(100),this.dragareas.css("opacity",1),this.dimmer.bind("mousedown mouseup",function(e){return 3===e.which||2===e.button?!1:(clearTimeout(s),s=setTimeout(function(){t.hide()},500),void("mouseup"===e.type&&clearTimeout(s)))}),this.plugins.not(this.render_model).hide(),this.placeholders.show(),CMS.config.simpleStructureBoard){var i=e(".cms-structure-content"),a=i.find(".cms-dragarea");i.addClass("cms-structure-content-simple"),a.addClass("cms-dragarea-simple"),a.each(function(t,s){e(s).hasClass("cms-dragarea-static")&&i.append(s)}),a.filter(".cms-dragarea-static").eq(0).css("margin-top","50px")}else e(window).bind("resize.sideframe",function(){t._resizeBoard()}).trigger("resize.sideframe")},_hideBoard:function(){this.container.hide(),this.plugins.show(),this.placeholders.hide(),this.dimmer.hide(),e(window).unbind("resize.sideframe"),clearInterval(this.interval),e(window).trigger("structureboard_hidden.sideframe")},_resizeBoard:function(){var t=null,s=null,i=null,a=null;this.placeholders.each(function(r,n){n=e(n),t=n.data("settings").placeholder_id,s=e(".cms-dragarea-"+t),n.height(s.outerHeight(!0)),i=n.width()?0:150,a=e(s).offsetParent().offset(),s.css({top:n.offset().top-a.top-5,left:n.offset().left-a.left-i,width:n.width()+i})})},_drag:function(){var s=this,i=!1,a=null,r=null,n=function(){};this.sortables.nestedSortable({items:".cms-draggable",handle:".cms-dragitem",placeholder:"cms-droppable",connectWith:this.sortables,tolerance:"pointer",toleranceElement:"> div",dropOnEmpty:!0,helper:"clone",appendTo:".cms-structure-content",cursor:"move",opacity:.4,zIndex:9999999,delay:100,refreshPositions:!0,listType:"div.cms-draggables",doNotClear:!0,disableNestingClass:"cms-draggable-disabled",errorClass:"cms-draggable-disallowed",over:function(){t()},start:function(i,a){s.dragging=!0,t(),e(".cms-submenu").removeClass("cms-btn-active"),e(".cms-submenu-quicksearch, .cms-submenu-dropdown").hide(),e(".cms-dragbar-empty").removeClass("cms-draggable-disallowed"),e(".cms-draggables").each(function(){0===e(this).children().length&&e(this).show()}),a.item.addClass("cms-is-dragging"),a.placeholder.css("height",a.helper.css("height")),e(".cms-structure-content").css({"overflow-x":"hidden"})},stop:function(r,n){if(s.dragging=!1,n.item.removeClass("cms-is-dragging"),!s.state)return!1;i&&(a.prepend(n.item),i=!1);var c=s.getId(n.item),o=e(".cms-plugin-"+c);o.trigger(o.closest(".cms-clipboard").length?"cms.plugin.update":"cms.plugins.update"),e(".cms-draggables").each(function(){0===e(this).children().length&&e(this).hide()}),e(".cms-structure-content").css({overflow:""}),t()},isAllowed:function(t,i,a){if(CMS.API.locked)return!1;var n=[],c=e(".cms-plugin-"+s.getId(a));if(0===c.length||null===c.data("settings"))return!1;var o=c.data("settings").plugin_type,d=s.getId(t.closest(".cms-dragarea")),l=e(".cms-placeholder-"+d),h=e(".cms-plugin-"+s.getId(t.closest(".cms-draggable")));return l.length&&(n=l.data("settings").plugin_restriction),h.length&&(n=h.data("settings").plugin_restriction),r&&(n=r.data("settings").plugin_restriction),t.parent().hasClass("cms-draggable-disabled")?!1:(s.state=n.length<=0||-1!==e.inArray(o,n)?!0:!1,s.state)}}),e(document).bind("keyup.cms",function(e,t){(27===e.keyCode||t)&&(s.state=!1,s.sortables.sortable("cancel"))}),this.dropareas.droppable({greedy:!0,accept:".cms-draggable",tolerance:"pointer",activeClass:"cms-draggable-allowed",hoverClass:"cms-draggable-hover-allowed",over:function(t){r=e(".cms-placeholder-"+s.getId(e(t.target).parent().prev())),n=setInterval(function(){e(".cms-dragbar-empty").removeClass("cms-draggable-disallowed"),s.state?e(t.target).removeClass("cms-draggable-disallowed"):e(t.target).addClass("cms-draggable-disallowed")},10)},out:function(t){r=null,e(t.target).removeClass("cms-draggable-disallowed"),clearInterval(n)},drop:function(t){i=!0,a=e(t.target).parent().nextAll(".cms-draggables").first(),clearInterval(n)}})}})})}(CMS.$);
!function(t){"use strict";t(document).ready(function(){/*!
         * Toolbar
         * Handles all features related to the toolbar
         */
CMS.Toolbar=new CMS.Class({implement:[CMS.API.Helpers],options:{preventSwitch:!1,preventSwitchMessage:"Switching is disabled.",messageDelay:2e3},initialize:function(s){this.container=t("#cms-toolbar"),this.options=t.extend(!0,{},this.options,s),this.config=CMS.config,this.settings=CMS.settings,this.body=t("html"),this.toolbar=this.container.find(".cms-toolbar"),this.toolbarTrigger=this.container.find(".cms-toolbar-trigger"),this.navigations=this.container.find(".cms-toolbar-item-navigation"),this.buttons=this.container.find(".cms-toolbar-item-buttons"),this.switcher=this.container.find(".cms-toolbar-item-switch"),this.messages=this.container.find(".cms-messages"),this.screenBlock=this.container.find(".cms-screenblock"),this.click="click.cms",this.timer=function(){},this.lockToolbar=!1,this._setup(),this._events()},_setup:function(){"expanded"===this.settings.toolbar?this._showToolbar(0,!0):this._hideToolbar(0,!0);var s=t(".cms-btn-publish").parent();if(s.hide(),t(".cms-btn-publish-active").length&&s.show(),CMS.config.debug&&this._debug(),CMS.config.messages&&this.openMessage(CMS.config.messages),CMS.config.error&&this.showError(CMS.config.error),CMS.config.auth&&CMS.config.settings.version===this.settings.version||(this.toggleToolbar(!0),this.settings=this.setSettings(CMS.config.settings)),CMS.config.publisher&&(this.openMessage(CMS.config.publisher,"right"),setInterval(function(){CMS.$(".cms-toolbar-item-switch").toggleClass("cms-toolbar-item-switch-highlight")},this.options.messageDelay)),this.settings.sideframe.url){var e=new CMS.Sideframe;e.open(this.settings.sideframe.url,!1)}this.screenBlock.length&&this._screenBlock(),this.body.addClass("cms-ready"),t(document).trigger("cms-ready")},_events:function(){var s=this;this.toolbarTrigger.on("pointerup.cms",function(t){t.preventDefault(),s.toggleToolbar()}),this.navigations.each(function(){function e(){o.removeClass(a),o.find("ul ul").hide(),i.find("> li").unbind("mouseenter.cms"),t(document).unbind(s.click)}var i=t(this),o=i.find("li"),n="cms-toolbar-item-navigation",a="cms-toolbar-item-navigation-hover",r="cms-toolbar-item-navigation-disabled",c="cms-toolbar-item-navigation-children",h=!1;i.find("a").on(s.click,function(i){return i.preventDefault(),""===t(this).attr("href")||"#"===t(this).attr("href")||t(this).parent().hasClass(r)||t(this).parent().hasClass(r)?void 0:(s._delegate(t(this)),e(),!1)}).on("touchstart.cms",function(){h=!0}),o.bind(s.click,function(o){o.preventDefault(),o.stopPropagation();var l=t(this);return l.hasClass(c)||e(),l.parent().hasClass(n)&&l.hasClass(a)||l.hasClass(r)?!1:(l.addClass(a),h||i.find("> li").on("mouseenter.cms",function(){return t(this).hasClass(a)?!1:void t(this).trigger(s.click)}),h=!1,void t(document).bind(s.click,e))}),o.find("li").on("pointerover pointerout",function(){var s=t(this),e=s.closest(".cms-toolbar-item-navigation-children").add(s.parents(".cms-toolbar-item-navigation-children")),i=s.hasClass(c)||e.length;return s.hasClass(r)||s.hasClass(a)?!0:(o.find("li").removeClass(a),s.addClass(a),i?(s.find("> ul").show(),e.addClass(a)):o.find("ul ul").hide(),void s.siblings().find("> ul").hide())}).on("click",function(t){t.preventDefault(),t.stopPropagation()}),o.find("> ul").bind("pointerleave",function(){o.find("li").removeClass(a)})}),this.switcher.each(function(){t(this).bind(s.click,function(e){e.preventDefault(),s._setSwitcher(t(e.currentTarget))})}),this.buttons.each(function(){var e=t(this);e.find("a").attr("data-rel")&&e.on("click",function(e){e.preventDefault(),s._delegate(t(this).find("a"))}),e.find(".cms-publish-page").bind(s.click,function(t){confirm(s.config.lang.publish)||t.preventDefault()}),e.find(".cms-btn-publish").bind(s.click,function(s){s.preventDefault(),t.ajax({type:"post",url:t(this).prop("href"),data:{csrfmiddlewaretoken:CMS.config.csrf},success:function(){CMS.API.Helpers.reloadBrowser()},error:function(t){throw new Error(t)}})})})},toggleToolbar:function(t){t&&(this.settings.toolbar="collapsed"),"collapsed"===this.settings.toolbar?this._showToolbar(200):this._hideToolbar(200)},openMessage:function(t,s,e,i){this._lock(!0),this.messages.find(".cms-messages-inner").html(t),clearTimeout(this.timer);var o=this,n=320,a=this.messages.outerHeight(!0),r=this.toolbar.outerHeight(!0),c=this.messages.find(".cms-messages-close");switch(c.hide(),c.bind(this.click,function(){o.closeMessage()}),"collapsed"===this.settings.toolbar&&(r=0),this.config.debug&&(r+=5),this.messages.css("top",-a).show(),this.messages.removeClass("cms-messages-error"),i&&this.messages.addClass("cms-messages-error"),s=s||"center"){case"left":this.messages.css({top:r,left:-n,right:"auto","margin-left":0}),this.messages.animate({left:0});break;case"right":this.messages.css({top:r,right:-n,left:"auto","margin-left":0}),this.messages.animate({right:0});break;default:this.messages.css({left:"50%",right:"auto","margin-left":-(n/2)}),this.messages.animate({top:r})}return 0===e?(c.show(),!1):void(this.timer=setTimeout(function(){o.closeMessage()},e||this.options.messageDelay))},closeMessage:function(){this.messages.fadeOut(300),this._lock(!1)},openAjax:function(s,e,i,o,n){var a=this,r=i?confirm(i):!0;return r?(this._loader(!0),void t.ajax({type:"POST",url:s,data:e?JSON.parse(e):{},success:function(t){CMS.API.locked=!1,o?(o(a,t),a._loader(!1)):n?CMS.API.Helpers.reloadBrowser(n,!1,!0):CMS.API.Helpers.reloadBrowser(!1,!1,!0)},error:function(t){CMS.API.locked=!1,a.showError(t.response+" | "+t.status+" "+t.statusText)}})):!1},showError:function(t,s){this.openMessage(t,"center",0,!0),s&&CMS.API.Helpers.reloadBrowser(!1,this.options.messageDelay)},_showToolbar:function(s,e){var i=t(".cms-debug-bar").height()||0,o=t(".cms-toolbar").height();this.toolbar.css({transition:"margin-top "+s+"ms","margin-top":0}),this.toolbarTrigger.addClass("cms-toolbar-trigger-expanded"),this.body.addClass("cms-toolbar-expanded"),this.body.animate({"margin-top":o+i},s,"linear"),this.messages.css("top",o+1),this.settings.toolbar="expanded",e||(this.settings=this.setSettings(this.settings))},_hideToolbar:function(s,e){var i=t(".cms-toolbar").height();return this.toolbar.css("transition","margin-top "+s+"ms"),this.lockToolbar?!1:(this.toolbarTrigger.removeClass("cms-toolbar-trigger-expanded"),this.toolbar.css("margin-top",-i),this.body.removeClass("cms-toolbar-expanded"),this.body.animate({"margin-top":this.config.debug?5:0},s),this.messages.css("top",0),this.settings.toolbar="collapsed",void(e||(this.settings=this.setSettings(this.settings))))},_setSwitcher:function(t){var s=t.hasClass("cms-toolbar-item-switch-active"),e=t.find("a"),i=t.find(".cms-toolbar-item-switch-knob"),o=300;return this.options.preventSwitch?(this.openMessage(this.options.preventSwitchMessage,"right"),!1):(s?(i.animate({right:e.outerWidth(!0)-(i.outerWidth(!0)+2)},o),e.css("z-index",1).animate({"padding-top":6,"padding-right":14,"padding-bottom":4,"padding-left":28},o)):(i.animate({left:e.outerWidth(!0)-(i.outerWidth(!0)+2)},o),e.css("z-index",1).animate({"padding-top":6,"padding-right":28,"padding-bottom":4,"padding-left":14},o)),void setTimeout(function(){window.location.href=e.attr("href")},o))},_delegate:function(t){var s=t.data("rel");switch(s){case"modal":var e=new CMS.Modal({onClose:t.data("on-close")});e.open(t.attr("href"),t.data("name"));break;case"message":this.openMessage(t.data("text"));break;case"sideframe":var i=new CMS.Sideframe({onClose:t.data("on-close")});i.open(t.attr("href"),!0);break;case"ajax":this.openAjax(t.attr("href"),JSON.stringify(t.data("post")),t.data("text"),null,t.data("on-success"));break;default:window.location.href=t.attr("href")}},_lock:function(t){t?(this.lockToolbar=!0,this.toolbarTrigger.css("opacity",.2)):(this.lockToolbar=!1,this.toolbarTrigger.css("opacity",1))},_loader:function(t){t?this.toolbarTrigger.addClass("cms-toolbar-loader"):this.toolbarTrigger.removeClass("cms-toolbar-loader")},_debug:function(){var t=this,s=1e3,e=function(){},i=this.container.find(".cms-debug-bar");i.bind("mouseenter mouseleave",function(i){clearTimeout(e),"mouseenter"===i.type&&(e=setTimeout(function(){t.openMessage(t.config.lang.debug)},s))})},_screenBlock:function(){var s=20,e=this.screenBlock,i=t(".cms-sideframe");t(window).on("resize.cms.screenblock",function(){var s=t(this).width()-i.width();e.css({width:s,height:t(window).height()})}).trigger("resize"),setInterval(function(){t(window).trigger("resize.cms.screenblock")},s)}})})}(CMS.$);