...
var CMS=window.CMS||{};!function(i){"use strict";i(function(){/*!
         ...
         * Handles copy & paste
         */
CMS.Clipboard=new CMS.Class({implement:[CMS.API.Helpers],options:{position:220,speed:100,id:null,url:""},initialize:function(t){this.clipboard=i(".cms-clipboard"),this.options=i.extend(!0,{},this.options,t),this.config=CMS.config,this.settings=CMS.settings,this.containers=this.clipboard.find(".cms-clipboard-containers > .cms-draggable"),this.triggers=this.clipboard.find(".cms-clipboard-triggers a"),this.triggerRemove=this.clipboard.find(".cms-clipboard-empty a"),this.click="click.cms.clipboard",this._setup(),this._events()},_setup:function(){var t=this,o=117,n=this.clipboard.find(".cms-clipboard-containers"),e=new CMS.Modal({minWidth:400,minHeight:o,minimizable:!1,maximizable:!1,resizable:!1});e.on("cms.modal.loaded cms.modal.closed",function(){i(".cms-add-plugin-placeholder").remove()}).on("cms.modal.closed cms.modal.load",function(){n.prependTo(t.clipboard)}).ui.modal.on("cms.modal.load",function(){n.prependTo(t.clipboard)}),this.triggers.on(this.click,function(i){i.preventDefault(),e.open({html:n,title:t.clipboard.data("title"),width:400,height:o})})},_events:function(){var i=this;this.triggerRemove.bind(this.click,function(t){t.preventDefault(),i.clear(function(){i.clipboard.hide()})})},clear:function(i){var t='{ "csrfmiddlewaretoken": "'+this.config.csrf+'" }';CMS.API.Toolbar.openAjax({url:this.config.clipboard.url,post:t,callback:i})}})})}(CMS.$);
...
var CMS=window.CMS||{};!function(t){"use strict";t(function(){CMS.Navigation=new CMS.Class({implement:[CMS.API.Helpers],initialize:function(){this._setupUI(),this.getWidths(),this.rightMostItemIndex=this.items.left.length-1,this.leftMostItemIndex=0,this._events()},_setupUI:function(){var i=t(".cms-toolbar-more");this.ui={window:t(window),toolbarLeftPart:t(".cms-toolbar-left"),toolbarRightPart:t(".cms-toolbar-right"),trigger:i,dropdown:i.find("> ul"),toolbarTrigger:t(".cms-toolbar-trigger"),logo:t(".cms-toolbar-item-logo")}},_events:function(){this.ui.window.on("resize.cms load.cms",CMS.API.Helpers.throttle(this._handleResize.bind(this),50))},getWidths:function(){var i=this;i.items={left:[],leftTotalWidth:0,right:[],rightTotalWidth:0,moreButtonWidth:0};var e=i.ui.toolbarLeftPart.find(".cms-toolbar-item-navigation > li:not(.cms-toolbar-more)"),o=i.ui.toolbarRightPart.find("> .cms-toolbar-item"),s=function(i,e){var o=t(i),s=t(i).outerWidth(!0);e.push({element:o,width:s})},h=function(t,i){return t+i.width};e.each(function(){s(this,i.items.left)}),o.each(function(){s(this,i.items.right)}),i.items.leftTotalWidth=i.items.left.reduce(h,0),i.items.rightTotalWidth=i.items.right.reduce(h,0),i.items.moreButtonWidth=i.ui.trigger.outerWidth()},calculateAvailableWidth:function(){var t=this.ui.window.width(),i=parseInt(this.ui.toolbarRightPart.css("padding-right"),10)+this.ui.logo.offset().left+this.ui.logo.outerWidth(!0)+15;return t-i},showDropdown:function(){this.ui.trigger.css("display","list-item")},hideDropdown:function(){this.ui.trigger.css("display","none")},_handleResize:function(){var t,i=this.calculateAvailableWidth();if(i>this.items.leftTotalWidth+this.items.rightTotalWidth)this.showAll();else{t=i-this.items.moreButtonWidth-this.items.rightTotalWidth;for(var e=-1;t-this.items.left[e+1].width>=0;)t-=this.items.left[e+1].width,e++;if(e<this.rightMostItemIndex?this.moveToDropdown(this.rightMostItemIndex-e):this.rightMostItemIndex<e&&this.moveOutOfDropdown(e-this.rightMostItemIndex),this.showDropdown(),0>t&&-1===this.rightMostItemIndex){t+=this.items.rightTotalWidth;var o=this.items.right.length;this.moveToDropdown(o-this.leftMostItemIndex,"right"),this.ui.dropdown.addClass("cms-more-dropdown-full")}else this.showAllRight(),this.ui.dropdown.removeClass("cms-more-dropdown-full")}},showAll:function(){this.showAllLeft(),this.showAllRight(),this.hideDropdown()},showAllLeft:function(){this.moveOutOfDropdown(this.items.left.length-1-this.rightMostItemIndex)},showAllRight:function(){this.moveOutOfDropdown(this.leftMostItemIndex,"right")},moveToDropdown:function(t,i){if(!(0>=t)){var e,o,s,h;if("right"===i){for(o=this.leftMostItemIndex,s=this.leftMostItemIndex+t-1,h=o;s>=h;h++)e=this.items.right[h].element,this.ui.dropdown.prepend(e.wrap('<li class="cms-more-buttons"></li>').parent());this.leftMostItemIndex+=t}else{for(s=this.rightMostItemIndex,o=this.rightMostItemIndex-t+1,h=s;h>=o;h--)e=this.items.left[h].element,this.ui.dropdown.prepend(e),e.find("> ul").children().length&&e.addClass("cms-toolbar-item-navigation-children");this.rightMostItemIndex-=t}}},moveOutOfDropdown:function(t,i){if(!(0>=t)){var e,o,s,h;if("right"===i){for(h=this.leftMostItemIndex-1,s=this.leftMostItemIndex-t,e=h;e>=s;e--)o=this.items.right[e].element,o.unwrap("<li></li>"),o.prependTo(this.ui.toolbarRightPart);this.leftMostItemIndex-=t}else{for(s=this.rightMostItemIndex+1,h=this.rightMostItemIndex+t,e=s;h>=e;e++)o=this.items.left[e].element,o.insertBefore(this.ui.trigger),o.removeClass("cms-toolbar-item-navigation-children"),o.find("> ul").removeAttr("style");this.rightMostItemIndex+=t}}}})})}(CMS.$);
var CMS=window.CMS||{};!function(t){"use strict";t(function(){CMS.Toolbar=new CMS.Class({implement:[CMS.API.Helpers],options:{preventSwitch:!1,preventSwitchMessage:"Switching is disabled.",messageDelay:3e3,toolbarDuration:200},initialize:function(s){this.options=t.extend(!0,{},this.options,s),this.config=CMS.config,this.settings=CMS.settings,this._setupUI(),this.navigation=new CMS.Navigation,this.click="click.cms.toolbar",this.touchStart="touchstart.cms.toolbar",this.pointerUp="pointerup.cms.toolbar",this.pointerOverOut="pointerover.cms.toolbar pointerout.csm.toolbar",this.pointerLeave="pointerleave.csm.toolbar",this.mouseEnter="mouseenter.cms.toolbar",this.mouseLeave="mouseleave.cms.toolbar",this.resize="resize.cms.toolbar",this.timer=function(){},this.lockToolbar=!1,this.ui.toolbar.data("ready")||this._events();var i=this;setTimeout(function(){i._initialStates()},200),this.ui.toolbar.data("ready",!0)},_setupUI:function(){var s=t("#cms-toolbar");this.ui={container:s,body:t("html"),document:t(document),window:t(window),toolbar:s.find(".cms-toolbar"),toolbarTrigger:s.find(".cms-toolbar-trigger"),navigations:s.find(".cms-toolbar-item-navigation"),buttons:s.find(".cms-toolbar-item-buttons"),switcher:s.find(".cms-toolbar-item-switch"),messages:s.find(".cms-messages"),screenBlock:s.find(".cms-screenblock"),structureBoard:s.find(".cms-structure")}},_events:function(){var s=this;this.ui.toolbarTrigger.on(this.pointerUp,function(t){t.preventDefault(),s.toggle(),s.ui.document.trigger(s.click)}),this.ui.navigations.each(function(){function i(){o.removeClass(n),o.find("ul ul").hide(),e.find("> li").off(s.mouseEnter),s.ui.document.off(s.click),s.ui.toolbar.off(s.click,i),s.ui.structureBoard.off(s.click)}var e=t(this),o=e.find("li"),a="cms-toolbar-item-navigation",n="cms-toolbar-item-navigation-hover",r="cms-toolbar-item-navigation-disabled",c="cms-toolbar-item-navigation-children",l=!1;e.find("a").on(s.click,function(e){return e.preventDefault(),""===t(this).attr("href")||"#"===t(this).attr("href")||t(this).parent().hasClass(r)||t(this).parent().hasClass(r)?void 0:(s._delegate(t(this)),i(),!1)}).on(s.touchStart,function(){l=!0}),o.on(s.click,function(o){o.preventDefault(),o.stopPropagation();var h=t(this);return h.hasClass(c)||i(),h.parent().hasClass(a)&&h.hasClass(n)||h.hasClass(r)?!1:(h.addClass(n),l||e.find("> li").on(s.mouseEnter,function(){return t(this).hasClass(n)?!1:void t(this).trigger(s.click)}),l=!1,s.ui.document.on(s.click,i),s.ui.structureBoard.on(s.click,i),s.ui.toolbar.on(s.click,i),void s.ui.window.on("resize",CMS.API.Helpers.throttle(i,1e3)))}),o.on(s.pointerOverOut,"li",function(){var s=t(this),i=s.closest(".cms-toolbar-item-navigation-children").add(s.parents(".cms-toolbar-item-navigation-children")),e=s.hasClass(c)||i.length;return s.hasClass(r)?!1:s.hasClass(n)?!0:(o.find("li").removeClass(n),s.addClass(n),e?(s.find("> ul").show(),i.addClass(n)):o.find("ul ul").hide(),void s.siblings().find("> ul").hide())}).on(s.click,function(t){t.preventDefault(),t.stopPropagation()}),o.on(s.pointerLeave,"> ul",function(){o.find("li").removeClass(n)})}),this.ui.switcher.each(function(){t(this).on(s.click,function(i){i.preventDefault(),s._setSwitcher(t(i.currentTarget))})}),this.ui.buttons.each(function(){var i=t(this);i.find("a").attr("data-rel")&&i.on(s.click,function(i){i.preventDefault(),s._delegate(t(this).find("a"))}),i.find(".cms-publish-page").on(s.click,function(t){confirm(s.config.lang.publish)||t.preventDefault()}),i.find(".cms-btn-publish").on(s.click,function(s){s.preventDefault(),t.ajax({type:"post",url:t(this).prop("href"),data:{csrfmiddlewaretoken:CMS.config.csrf},success:function(){CMS.API.Helpers.reloadBrowser()},error:function(t){throw new Error(t)}})}),i.find("a").on(s.click,function(t){t.stopPropagation()})})},_initialStates:function(){var s=t(".cms-btn-publish").parent(),i=new CMS.Sideframe;"expanded"===this.settings.toolbar?this.open({duration:0}):this.close(),s.hide(),t(".cms-btn-publish-active").length&&(s.show(),this.ui.window.trigger("resize")),CMS.config.debug&&this._debug(),CMS.config.messages&&this.openMessage({message:CMS.config.messages}),CMS.config.error&&this.openMessage({message:CMS.config.error,error:!0}),CMS.config.auth&&CMS.config.settings.version===this.settings.version||(this.open({duration:0}),this.settings=this.setSettings(CMS.config.settings)),CMS.config.publisher&&(this.openMessage({message:CMS.config.publisher,dir:"right"}),setInterval(function(){CMS.$(".cms-toolbar-item-switch").toggleClass("cms-toolbar-item-switch-highlight")},this.options.messageDelay)),this.settings.sideframe.url&&i.open({url:this.settings.sideframe.url,animate:!1}),this.ui.screenBlock.length&&this._screenBlock(),this.ui.body.addClass("cms-ready"),this.ui.document.trigger("cms-ready")},toggle:function(){"collapsed"===this.settings.toolbar?this.open():this.close()},open:function(t){this._show(t),this.settings.toolbar="expanded",this.settings=this.setSettings(this.settings)},_show:function(s){var i=s&&void 0!==s.duration?s.duration:this.options.toolbarDuration,e=t(".cms-debug-bar").height()||0,o=t(".cms-toolbar").height()+10;this.ui.toolbar.css({transition:"margin-top "+i+"ms","margin-top":0}),this.ui.toolbarTrigger.addClass("cms-toolbar-trigger-expanded"),this.ui.body.addClass("cms-toolbar-expanded"),this.ui.body.animate({"margin-top":o+e},i,"linear"),this.ui.messages.css("top",o+1)},close:function(){this._hide(),this.settings.toolbar="collapsed",this.settings=this.setSettings(this.settings)},_hide:function(){var s=this.options.toolbarDuration,i=t(".cms-toolbar").height()+10;return this.ui.toolbar.css("transition","margin-top "+s+"ms"),this.lockToolbar?!1:(this.ui.toolbarTrigger.removeClass("cms-toolbar-trigger-expanded"),this.ui.toolbar.css("margin-top",-i),this.ui.body.removeClass("cms-toolbar-expanded"),this.ui.body.animate({"margin-top":this.config.debug?5:0},s),void this.ui.messages.css("top",0))},openMessage:function(t){if(!t||!t.message)throw new Error('The arguments passed to "openMessage" were invalid.');var s=this,i=t.message,e=void 0===t.dir?"center":t.dir,o=void 0===t.delay?this.options.messageDelay:t.delay,a=void 0===t.error?!1:t.error,n=320,r=this.ui.messages.outerHeight(!0),c=this.ui.toolbar.outerHeight(!0),l=this.ui.messages.find(".cms-messages-close");switch(this.ui.messages.find(".cms-messages-inner").html(i),this.ui.messages.removeClass("cms-messages-error"),a&&this.ui.messages.addClass("cms-messages-error"),clearTimeout(this.timer),l.hide(),l.off(this.click).on(this.click,function(){s.closeMessage()}),"collapsed"===this.settings.toolbar&&(c=0),this.config.debug&&(c+=5),this.ui.messages.css("top",-r).show(),e){case"left":this.ui.messages.css({top:c,left:-n,right:"auto","margin-left":0}),this.ui.messages.animate({left:0});break;case"right":this.ui.messages.css({top:c,right:-n,left:"auto","margin-left":0}),this.ui.messages.animate({right:0});break;default:this.ui.messages.css({left:"50%",right:"auto","margin-left":-(n/2)}),this.ui.messages.animate({top:c})}0>=o?l.show():this.timer=setTimeout(function(){s.closeMessage()},o)},closeMessage:function(){this.ui.messages.fadeOut(this.options.toolbarDuration)},openAjax:function(s){var i=this,e=s.url,o=s.post||"{}",a=s.text||"",n=s.callback,r=s.onSuccess,c=a?confirm(a):!0;return c?(this.showLoader(),t.ajax({type:"POST",url:e,data:o?JSON.parse(o):{}}).done(function(t){CMS.API.locked=!1,n?(n(i,t),i.hideLoader()):r?CMS.API.Helpers.reloadBrowser(r,!1,!0):CMS.API.Helpers.reloadBrowser(!1,!1,!0)}).fail(function(t){CMS.API.locked=!1,i.openMessage({message:t.response+" | "+t.status+" "+t.statusText,error:!0})})):!1},showLoader:function(){this.ui.toolbarTrigger.addClass("cms-toolbar-loader")},hideLoader:function(){this.ui.toolbarTrigger.removeClass("cms-toolbar-loader")},_delegate:function(t){var s=t.data("rel");switch(s){case"modal":var i=new CMS.Modal({onClose:t.data("on-close")});i.open({url:t.attr("href"),title:t.data("name")});break;case"message":this.openMessage({message:t.data("text")});break;case"cms_frame":var e=window.open(t.attr("href"),"cms_frame");e.focus();break;case"sideframe":var o=new CMS.Sideframe({onClose:t.data("on-close")});o.open({url:t.attr("href"),animate:!0});break;case"ajax":this.openAjax({url:t.attr("href"),post:JSON.stringify(t.data("post")),text:t.data("text"),onSuccess:t.data("on-success")});break;default:window.location.href=t.attr("href")}},_setSwitcher:function(t){var s=t.hasClass("cms-toolbar-item-switch-active"),i=t.find("a"),e=t.find(".cms-toolbar-item-switch-knob"),o=300;return this.options.preventSwitch?(this.openMessage({message:this.options.preventSwitchMessage,dir:"right"}),!1):(s?(e.animate({right:i.outerWidth(!0)-(e.outerWidth(!0)+2)},o),i.css("z-index",1).animate({"padding-top":6,"padding-right":14,"padding-bottom":4,"padding-left":28},o)):(e.animate({left:i.outerWidth(!0)-(e.outerWidth(!0)+2)},o),i.css("z-index",1).animate({"padding-top":6,"padding-right":28,"padding-bottom":4,"padding-left":14},o)),void setTimeout(function(){window.location.href=i.attr("href")},o))},_lock:function(t){t?(this.lockToolbar=!0,this.ui.toolbarTrigger.css("opacity",.2)):(this.lockToolbar=!1,this.ui.toolbarTrigger.css("opacity",1))},_debug:function(){var t=this,s=1e3,i=function(){},e=this.ui.container.find(".cms-debug-bar");e.on(this.mouseEnter+" "+this.mouseLeave,function(e){clearTimeout(i),e.type===t.mouseEnter&&(i=setTimeout(function(){t.openMessage({message:t.config.lang.debug})},s))})},_screenBlock:function(){var s=this,i=20,e=this.ui.screenBlock,o=t(".cms-sideframe");t(window).on(this.resize,function(){e.css({width:t(this).width()-o.width(),height:t(window).height()})}).trigger("resize"),setInterval(function(){t(window).trigger(s.resize)},i)}})})}(CMS.$);