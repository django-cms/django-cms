...
!function(e){"use strict";e(document).ready(function(){/*!
         ...
         */
CMS.Plugin=new CMS.Class({implement:[CMS.API.Helpers],options:{type:"",placeholder_id:null,plugin_type:"",plugin_id:null,plugin_language:"",plugin_parent:null,plugin_order:null,plugin_breadcrumb:[],plugin_restriction:[],urls:{add_plugin:"",edit_plugin:"",move_plugin:"",copy_plugin:"",delete_plugin:""}},initialize:function(t,i){switch(this.container=e("."+t),this.options=e.extend(!0,{},this.options,i),this.body=e(document),this.csrf=CMS.config.csrf,this.timer=function(){},this.timeout=250,this.focused=!1,this.click="pointerup.cms",this.container.data("settings",this.options),this.options.type){case"placeholder":this._setPlaceholder(),this._collapsables();break;case"plugin":this._setPlugin(),this._collapsables();break;default:this._setGeneric()}},_setPlaceholder:function(){var t=this,i=".cms-dragbar-title",s="cms-dragbar-title-expanded",n=e(".cms-dragbar-"+this.options.placeholder_id);this._setSubnav(n.find(".cms-submenu"));var a=CMS.settings;a.dragbars=a.dragbars||[],n.find(i).bind(this.click,function(){e(this).hasClass(s)?t._collapseAll(e(this)):t._expandAll(e(this))}),-1!==e.inArray(this.options.placeholder_id,a.dragbars)&&n.find(i).addClass(s)},_setPlugin:function(){var t=this;this.container.bind("dblclick",function(e){e.preventDefault(),e.stopPropagation(),t.editPlugin(t.options.urls.edit_plugin,t.options.plugin_name,t.options.plugin_breadcrumb)}),this.container.bind("pointerover.cms pointerout.cms",function(e){e.stopPropagation();var i=t.options.plugin_name,s=t.options.plugin_id;"pointerover"===e.type?t.showTooltip(i,s):t.hideTooltip()}),this.container.bind("cms.plugins.update",function(e){e.stopPropagation(),t.movePlugin()}),this.container.bind("cms.plugin.update",function(i){i.stopPropagation();var s=e(i.delegateTarget),n=e(".cms-draggable-"+s.data("settings").plugin_id),a=t._getId(n.parents(".cms-draggables").last().prevAll(".cms-dragbar").first());if(!a)return!1;var r=s.data("settings");r.target=a,r.parent=t._getId(n.parent().closest(".cms-draggable")),t.copyPlugin(r)});var i=e(".cms-draggable-"+this.options.plugin_id),s=i.find("> .cms-dragitem"),n=i.find(".cms-submenu:eq(0)"),a=e(".cms-draggables").find(".cms-submenu");this._setSubnav(i.find("> .cms-dragitem .cms-submenu")),i.bind("pointerenter pointerleave pointerover",function(i){return i.preventDefault(),i.stopPropagation(),t.focused?!1:(("pointerenter"===i.type||"pointerover"===i.type)&&e(this).data("active",!0),"pointerleave"===i.type&&(e(this).data("active",!1),a.hide()),void setTimeout(function(){e(i.currentTarget).data("active")||e(i.currentTarget).find(".cms-submenu:eq(0)").hide()},100))}),s.bind("pointerover.cms",function(e){e.preventDefault(),e.stopPropagation(),a.hide(),n.show()}),s.bind("dblclick",function(e){e.preventDefault(),e.stopPropagation(),t.editPlugin(t.options.urls.edit_plugin,t.options.plugin_name,t.options.plugin_breadcrumb)})},_setGeneric:function(){var e=this;this.container.bind("dblclick",function(t){t.preventDefault(),t.stopPropagation(),e.editPlugin(e.options.urls.edit_plugin,e.options.plugin_name,[])}),this.container.bind("pointerover.cms pointerout.cms",function(t){t.stopPropagation();var i=e.options.plugin_name,s=e.options.plugin_id;"pointerover"===t.type?e.showTooltip(i,s):e.hideTooltip()})},addPlugin:function(t,i,s){if(CMS.API.locked)return!1;CMS.API.locked=!0;var n=this,a={placeholder_id:this.options.placeholder_id,plugin_type:t,plugin_parent:s||"",plugin_language:this.options.plugin_language,csrfmiddlewaretoken:this.csrf};e.ajax({type:"POST",url:this.options.urls.add_plugin,data:a,success:function(e){CMS.API.locked=!1,n.newPlugin=e,n.editPlugin(e.url,i,e.breadcrumb)},error:function(e){CMS.API.locked=!1;var t=CMS.config.lang.error;n._showError(t+e.responseText||e.status+" "+e.statusText)}})},editPlugin:function(e,t,i){var s=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});s.open(e,t,i)},copyPlugin:function(t,i){if(CMS.API.locked)return!1;CMS.API.locked=!0;var s=this,n=t||i?!0:!1;t=t||this.options,i?(t.target=t.placeholder_id,t.plugin_id="",t.parent=""):i=t.plugin_language;var a={source_placeholder_id:t.placeholder_id,source_plugin_id:t.plugin_id||"",source_language:i,target_plugin_id:t.parent||"",target_placeholder_id:t.target||CMS.config.clipboard.id,target_language:t.page_language||i,csrfmiddlewaretoken:this.csrf},r={type:"POST",url:t.urls.copy_plugin,data:a,success:function(){CMS.API.Toolbar.openMessage(CMS.config.lang.success),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var t=CMS.config.lang.error;s._showError(t+e.responseText||e.status+" "+e.statusText)}};n?e.ajax(r):CMS.API.Clipboard.clear(function(){e.ajax(r)})},cutPlugin:function(){if(CMS.API.locked)return!1;CMS.API.locked=!0;var t=this,i={placeholder_id:CMS.config.clipboard.id,plugin_id:this.options.plugin_id,plugin_parent:"",plugin_language:this.options.page_language,plugin_order:[this.options.plugin_id],csrfmiddlewaretoken:this.csrf};CMS.API.Clipboard.clear(function(){return CMS.API.locked?!1:(CMS.API.locked=!0,void e.ajax({type:"POST",url:t.options.urls.move_plugin,data:i,success:function(){CMS.API.Toolbar.openMessage(CMS.config.lang.success),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var i=CMS.config.lang.error;t._showError(i+e.responseText||e.status+" "+e.statusText)}}))})},movePlugin:function(t){if(CMS.API.locked)return!1;CMS.API.locked=!0;var i=this;t=t||this.options;var s=e(".cms-plugin-"+t.plugin_id),n=e(".cms-draggable-"+t.plugin_id);this._setPosition(t.plugin_id,s,n);var a=this._getId(n.parents(".cms-draggables").last().prevAll(".cms-dragbar").first()),r=this._getId(n.parent().closest(".cms-draggable")),o=this._getIds(n.siblings(".cms-draggable").andSelf());if(a===!1)return!1;var l={placeholder_id:a,plugin_id:t.plugin_id,plugin_parent:r||"",plugin_language:t.page_language,plugin_order:o,csrfmiddlewaretoken:this.csrf};e.ajax({type:"POST",url:t.urls.move_plugin,data:l,success:function(e){e.reload&&CMS.API.Helpers.reloadBrowser(),CMS.API.locked=!1,i._showSuccess(n)},error:function(e){CMS.API.locked=!1;var t=CMS.config.lang.error;i._showError(t+e.responseText||e.status+" "+e.statusText)}}),e(".cms-btn-publish").addClass("cms-btn-publish-active").removeClass("cms-btn-disabled").parent().show(),e(".cms-toolbar-revert").removeClass("cms-toolbar-item-navigation-disabled")},deletePlugin:function(e,t,i){var s=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});s.open(e,t,i)},_setPosition:function(t,i,s){var n=s.prev(".cms-draggable"),a=s.next(".cms-draggable"),r=s.parent().closest(".cms-draggable"),o=e(".cms-plugin-"+this._getId(r)),l=s.closest(".cms-dragarea");if(n.length)i.insertAfter(e(".cms-plugin-"+this._getId(n)));else if(a.length)i.insertBefore(e(".cms-plugin-"+this._getId(a)));else if(r.length){for(;o.children().length;)o=o.children();o.append(i)}else l.length?i.insertAfter(e(".cms-placeholder-"+this._getId(l))):CMS.API.Helpers.reloadBrowser()},editPluginPostAjax:function(e,t,i){return"undefined"==typeof t||"undefined"==typeof i?function(t,i){var s=e;s.editPlugin(i.url,s.options.plugin_name,i.breadcrumb)}:void this.editPlugin(i.url,this.options.plugin_name,i.breadcrumb)},_setSubnav:function(t){var i=this;t.bind("pointerenter pointerleave tap.cms",function(t){t.preventDefault(),t.stopPropagation(),"pointerenter"===t.type?i._showSubnav(e(this)):i._hideSubnav(e(this))}),t.find("a").bind("click.cms",function(t){t.preventDefault(),t.stopPropagation(),CMS.API.Toolbar._loader(!0);var s=e(this);switch(s.attr("data-rel")){case"add":i.addPlugin(s.attr("href").replace("#",""),s.text(),i._getId(s.closest(".cms-draggable")));break;case"ajax_add":CMS.API.Toolbar.openAjax(s.attr("href"),JSON.stringify(s.data("post")),s.data("text"),i.editPluginPostAjax(i),s.data("on-success"));break;case"edit":i.editPlugin(i.options.urls.edit_plugin,i.options.plugin_name,i.options.plugin_breadcrumb);break;case"copy-lang":i.copyPlugin(this.options,s.attr("data-language"));break;case"copy":i.copyPlugin();break;case"cut":i.cutPlugin();break;case"delete":i.deletePlugin(i.options.urls.delete_plugin,i.options.plugin_name,i.options.plugin_breadcrumb);break;default:CMS.API.Toolbar._loader(!1),CMS.API.Toolbar._delegate(s)}}),t.find("input").bind("keyup keydown focus blur pointerup",function(s){"focus"===s.type&&(i.focused=!0),"blur"!==s.type||i.traverse||(i.focused=!1,i._hideSubnav(t)),"keyup"===s.type&&(clearTimeout(i.timer),i.timer=setTimeout(function(){i._searchSubnav(t,e(s.currentTarget).val())},100))}),t.find(".cms-submenu-dropdown").each(function(){e(this).data("top",e(this).css("top"))}),t.bind(this.click,function(e){e.stopPropagation()})},_showSubnav:function(t){var i=this,s=t.find(".cms-submenu-dropdown"),n=parseInt(s.data("top"));clearTimeout(this.timer),this.timer=setTimeout(function(){var i=e(".cms-submenu").parentsUntil(".cms-dragarea"),n=t.find(".cms-submenu-scroll-hint");i.css("z-index",0);var a=t.parentsUntil(".cms-dragarea");a.css("z-index",999),t.find(".cms-submenu-quicksearch").show(),t.find("> .cms-submenu-dropdown").show().on("scroll",function(){n.fadeOut(100),e(this).off("scroll")}),s[0].scrollHeight>s.height()&&n.show()},100),e(document).unbind("keydown.cms"),e(document).bind("keydown.cms",function(e){var s=t.find(".cms-submenu-item:visible a"),n=s.index(s.filter(":focus"));(40===e.keyCode||9===e.keyCode)&&(i.traverse=!0,e.preventDefault(),n>=0&&n<s.length-1?s.eq(n+1).focus():s.eq(0).focus()),(38===e.keyCode||9===e.keyCode&&e.shiftKey)&&(e.preventDefault(),s.is(":focus")?s.eq(n-1).focus():s.eq(s.length).focus()),(13===e.keyCode||27===e.keyCode)&&(i.traverse=!1,t.find("input").blur(),i._hideSubnav(t))}),e(window).height()+e(window).scrollTop()-t.offset().top-s.height()<=10&&t.offset().top-s.height()>=0?(s.css("top","auto"),s.css("bottom",n),s.closest(".cms-draggable").length&&s.css("bottom",n-1)):(s.css("top",n),s.css("bottom","auto"))},_hideSubnav:function(t){clearTimeout(this.timer);var i=this;return this.focused?!1:(t.closest(".cms-draggable").data("active",!1),this.timer=setTimeout(function(){t.find("> .cms-submenu-dropdown").hide(),t.find(".cms-submenu-quicksearch").hide(),t.find("input").val(""),i._searchSubnav(t,"")},this.timeout),void e(".cms-dragbar").css("position",""))},_searchSubnav:function(t,i){var s=t.find(".cms-submenu-item"),n=t.find(".cms-submenu-item-title");return""===i?(s.add(n).show(),!1):(s.find("a, span").each(function(t,s){s=e(s);var n=s.text().toLowerCase(),a=i.toLowerCase();n.indexOf(a)>=0?s.parent().show():s.parent().hide()}),n.filter(":visible").each(function(t,i){n.hide(),e(i).nextUntil(".cms-submenu-item-title").show()}),s.filter(":visible").each(function(t,i){e(i).prev().hasClass("cms-submenu-item-title")?e(i).prev().show():e(i).prevUntil(".cms-submenu-item-title").last().prev().show()}),t.find(".cms-submenu-dropdown").show(),s.add(n).filter(":visible").length<=0&&t.find(".cms-submenu-dropdown").hide(),void t.find(".cms-submenu-scroll-hint").hide())},_collapsables:function(){var t=this,i=CMS.settings,s=e(".cms-draggable-"+this.options.plugin_id);if(this.container.each(function(t,i){var s=e(i).find(".cms-dragitem-collapsable"),n=s.filter(".cms-dragitem-expanded");s.length===n.length&&s.length+n.length!==0&&e(i).find(".cms-dragbar-title").addClass("cms-dragbar-title-expanded")}),!s.length)return!1;if(s.find("> .cms-dragitem-collapsable").bind(this.click,function(){var i,n=e(this),a=t._getId(e(this).parent()),r=CMS.settings;if(r.states=r.states||[],n.hasClass("cms-dragitem-expanded")){if(r.states.splice(e.inArray(a,r.states),1),n.removeClass("cms-dragitem-expanded").parent().find("> .cms-draggables").hide(),e(document).data("expandmode")){if(i=s.find(".cms-draggable").find(".cms-dragitem-collapsable"),!i.length)return!1;i.each(function(){e(this).hasClass("cms-dragitem-expanded")&&e(this).trigger(t.click)})}}else if(r.states.push(a),n.addClass("cms-dragitem-expanded").parent().find("> .cms-draggables").show(),e(document).data("expandmode")){if(i=s.find(".cms-draggable").find(".cms-dragitem-collapsable"),!i.length)return!1;i.each(function(){e(this).hasClass("cms-dragitem-expanded")||e(this).trigger(t.click)})}e(window).trigger("resize.sideframe"),CMS.API.Toolbar.setSettings(r)}),s.bind("dblclick",function(i){i.stopPropagation(),e(".cms-plugin-"+t._getId(e(this))).trigger("dblclick")}),CMS.Toolbar.ready)return!1;for(var n=i.states.sort(),a=[],r=0;r<n.length;r++)n[r]!==n[r+1]&&a.push(n[r]);i.states=a,e.each(CMS.settings.states,function(t,i){var s=e(".cms-draggable-"+i);s.find(".cms-draggables").length&&(s.find("> .cms-draggables").show(),s.find("> .cms-dragitem").addClass("cms-dragitem-expanded"))}),CMS.Toolbar.ready=!0},_expandAll:function(t){var i=this,s=t.closest(".cms-dragarea").find(".cms-dragitem-collapsable");if(!s.length)return!1;s.each(function(){e(this).hasClass("cms-dragitem-expanded")||e(this).trigger(i.click)}),t.addClass("cms-dragbar-title-expanded");var n=CMS.settings;n.dragbars=n.dragbars||[],n.dragbars.push(this.options.placeholder_id),CMS.API.Toolbar.setSettings(n)},_collapseAll:function(t){var i=this,s=t.closest(".cms-dragarea").find(".cms-dragitem-collapsable");s.each(function(){e(this).hasClass("cms-dragitem-expanded")&&e(this).trigger(i.click)}),t.removeClass("cms-dragbar-title-expanded");var n=CMS.settings;n.dragbars=n.dragbars||[],n.dragbars.splice(e.inArray(this.options.placeholder_id,n.states),1),CMS.API.Toolbar.setSettings(n)},_getId:function(e){return CMS.API.StructureBoard.getId(e)},_getIds:function(e){return CMS.API.StructureBoard.getIds(e)},_showError:function(e){return CMS.API.Toolbar.showError(e,!0)},_showSuccess:function(t){var i=e('<div class="cms-dragitem-success"></div>');t.append(i),i.fadeOut(function(){e(this).remove()}),e(window).trigger("resize.sideframe")}})})}(CMS.$);
