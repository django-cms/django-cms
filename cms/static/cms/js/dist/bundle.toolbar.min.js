...
var CMS=window.CMS||{};!function(i){"use strict";i(function(){CMS.Tooltip=new CMS.Class({initialize:function(){this.body=i("body"),this.isTouch=!1,this.domElem=this._pick(),this._checkTouch()},_checkTouch:function(){var t=this;this.body.one("touchstart.cms",function(){t.isTouch=!0,t.domElem=t._pick(),t.domElem.on("touchstart.cms",function(){var t=i(this).data("plugin_id"),s=i(".cms-plugin-"+t);if(s.length)s.trigger("dblclick.cms");else{var o=i('.cms-plugin[class*="cms-plugin-cms-"][class*="-'+t+'"]');o.eq(0).trigger("dblclick.cms")}})})},displayToggle:function(i,t,s,o){i?this.show(t,s,o):this.hide()},show:function(i,t,s){var o=this.domElem,c=this;o.css("visibility","visible").data("plugin_id",s||null).show().find("span").html(t),this.isTouch?this.position(i.originalEvent,o):(c.position(i.originalEvent,o),this.body.on("mousemove.cms",function(i){c.position(i,o)}))},hide:function(){this.domElem.css("visibility","hidden").hide(),this.isTouch||this.body.off("mousemove.cms")},_pick:function(){return i(".cms-tooltip-touch, .cms-tooltip").css("visibility","hidden").hide(),i(this.isTouch?".cms-tooltip-touch":".cms-tooltip")},position:function(t,s){var o=20,c=t.pageX-i(s).offsetParent().offset().left,n=t.pageY-i(s).offsetParent().offset().top,e=i(s).offsetParent().width(),h=c+s.outerWidth(!0)+o;s.css({left:h>=e?c-s.outerWidth(!0)-o:c+o,top:n-12})}})})}(CMS.$);