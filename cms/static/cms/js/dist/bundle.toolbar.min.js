 ...
 */
window.django=window.django||void 0,window.jQuery=window.django&&window.django.jQuery?window.django.jQuery:window.jQuery||void 0,window.Class=window.Class||void 0;var CMS={$:"function"==typeof window.jQuery?window.jQuery:void 0,Class:"function"==typeof window.Class?window.Class:void 0,API:{},KEYS:{SHIFT:16,TAB:9,UP:38,DOWN:40,ENTER:13,SPACE:32,ESC:27}};!function(o){"use strict";o(document).ready(function(){CMS.API.Helpers={reloadBrowser:function(t,e,n){var i=this,s=window.parent?window.parent:window;return n?(s.CMS.API.locked=!0,o.ajax({async:!1,type:"GET",url:s.CMS.config.request.url,data:{model:s.CMS.config.request.model,pk:s.CMS.config.request.pk},success:function(o){return s.CMS.API.locked=!1,""!==o||t?void(s.location.pathname!==o?i.reloadBrowser(o):"REFRESH_PAGE"===t?i.reloadBrowser():t&&i.reloadBrowser(t)):!1}}),!1):void s.setTimeout(function(){t&&t!==s.location.href?s.location.href=t:s.location.reload()},e||0)},preventSubmit:function(){var t=o("#cms-toolbar").find("form");t.submit(function(){CMS.API.Toolbar._loader(!0),o('input[type="submit"]').bind("click",function(o){o.preventDefault()}).css("opacity",.5)})},csrf:function(t){o.ajaxSetup({beforeSend:function(o){o.setRequestHeader("X-CSRFToken",t)}})},showTooltip:function(t,e){var n=o(".cms-tooltip");n.css("visibility","visible").data("plugin_id",e||null).show().find("span").html(t),o("body").bind("mousemove.cms",function(t){var e=20,i=t.pageX-o(n).offsetParent().offset().left,s=t.pageY-o(n).offsetParent().offset().top,r=o(n).offsetParent().width(),a=i+n.outerWidth(!0)+e;n.css({left:a>=r?i-n.outerWidth(!0)-e:i+e,top:s-12})}),n.bind("touchstart.cms",function(){o(".cms-plugin-"+o(this).data("plugin_id")).trigger("dblclick")})},hideTooltip:function(){var t=o(".cms-tooltip");t.css("visibility","hidden").hide(),o("body").unbind("mousemove.cms"),t.unbind("touchstart.cms")},setSettings:function(t){var e=this;return t=JSON.stringify(o.extend({},CMS.config.settings,t)),CMS.API.Toolbar&&CMS.API.Toolbar._loader(!0),window.localStorage?(localStorage.setItem("cms_cookie",t),CMS.API.Toolbar&&CMS.API.Toolbar._loader(!1)):(CMS.API.locked=!0,o.ajax({async:!1,type:"POST",url:CMS.config.urls.settings,data:{csrfmiddlewaretoken:this.config.csrf,settings:t},success:function(o){CMS.API.locked=!1,t=o?JSON.parse(o):CMS.config.settings,CMS.API.Toolbar&&CMS.API.Toolbar._loader(!1)},error:function(o){e.showError(o.response+" | "+o.status+" "+o.statusText)}})),CMS.settings=JSON.parse(t),CMS.settings},getSettings:function(){var t,e=this;return CMS.API.Toolbar&&CMS.API.Toolbar._loader(!0),window.localStorage?(t=JSON.parse(localStorage.getItem("cms_cookie")),CMS.API.Toolbar&&CMS.API.Toolbar._loader(!1)):(CMS.API.locked=!0,o.ajax({async:!1,type:"GET",url:CMS.config.urls.settings,success:function(o){CMS.API.locked=!1,t=o?JSON.parse(o):CMS.config.settings,CMS.API.Toolbar&&CMS.API.Toolbar._loader(!1)},error:function(o){e.showError(o.response+" | "+o.status+" "+o.statusText)}})),t||(t=this.setSettings(CMS.config.settings)),CMS.settings=t,CMS.settings}},CMS.API.Helpers.preventSubmit()})}(CMS.$);
/*!========================================================================
...
var CMS=window.CMS||{};!function(t){"use strict";t(document).ready(function(){CMS.Toolbar=new CMS.Class({implement:[CMS.API.Helpers],options:{preventSwitch:!1,preventSwitchMessage:"Switching is disabled.",messageDelay:2e3},initialize:function(s){this.options=t.extend(!0,{},this.options,s),this.config=CMS.config,this.settings=CMS.settings,this._setupUI(),this.click="click.cms.toolbar",this.timer=function(){},this.lockToolbar=!1,this.ui.toolbar.data("ready")||(this._setup(),this._events()),this.ui.toolbar.data("ready",!0)},_setupUI:function(){var s=t("#cms-toolbar");this.ui={container:s,body:t("html"),toolbar:s.find(".cms-toolbar"),toolbarTrigger:s.find(".cms-toolbar-trigger"),navigations:s.find(".cms-toolbar-item-navigation"),buttons:s.find(".cms-toolbar-item-buttons"),switcher:s.find(".cms-toolbar-item-switch"),messages:s.find(".cms-messages"),screenBlock:s.find(".cms-screenblock")}},_setup:function(){"expanded"===this.settings.toolbar?this._showToolbar(0,!0):this._hideToolbar(0,!0);var s=t(".cms-btn-publish").parent();if(s.hide(),t(".cms-btn-publish-active").length&&s.show(),CMS.config.debug&&this._debug(),CMS.config.messages&&this.openMessage(CMS.config.messages),CMS.config.error&&this.showError(CMS.config.error),CMS.config.auth&&CMS.config.settings.version===this.settings.version||(this.toggleToolbar(!0),this.settings=this.setSettings(CMS.config.settings)),CMS.config.publisher&&(this.openMessage(CMS.config.publisher,"right"),setInterval(function(){CMS.$(".cms-toolbar-item-switch").toggleClass("cms-toolbar-item-switch-highlight")},this.options.messageDelay)),this.settings.sideframe.url){var i=new CMS.Sideframe;i.open(this.settings.sideframe.url,!1)}this.ui.screenBlock.length&&this._screenBlock(),this.ui.body.addClass("cms-ready"),t(document).trigger("cms-ready")},_events:function(){var s=this;this.ui.toolbarTrigger.on("pointerup.cms",function(t){t.preventDefault(),s.toggleToolbar()}),this.ui.navigations.each(function(){function i(){o.removeClass(n),o.find("ul ul").hide(),e.find("> li").unbind("mouseenter.cms"),t(document).unbind(s.click)}var e=t(this),o=e.find("li"),a="cms-toolbar-item-navigation",n="cms-toolbar-item-navigation-hover",r="cms-toolbar-item-navigation-disabled",c="cms-toolbar-item-navigation-children",l=!1;e.find("a").on(s.click,function(e){return e.preventDefault(),""===t(this).attr("href")||"#"===t(this).attr("href")||t(this).parent().hasClass(r)||t(this).parent().hasClass(r)?void 0:(s._delegate(t(this)),i(),!1)}).on("touchstart.cms",function(){l=!0}),o.bind(s.click,function(o){o.preventDefault(),o.stopPropagation();var h=t(this);return h.hasClass(c)||i(),h.parent().hasClass(a)&&h.hasClass(n)||h.hasClass(r)?!1:(h.addClass(n),l||e.find("> li").on("mouseenter.cms",function(){return t(this).hasClass(n)?!1:void t(this).trigger(s.click)}),l=!1,void t(document).bind(s.click,i))}),o.find("li").on("pointerover pointerout",function(){var s=t(this),i=s.closest(".cms-toolbar-item-navigation-children").add(s.parents(".cms-toolbar-item-navigation-children")),e=s.hasClass(c)||i.length;return s.hasClass(r)||s.hasClass(n)?!0:(o.find("li").removeClass(n),s.addClass(n),e?(s.find("> ul").show(),i.addClass(n)):o.find("ul ul").hide(),void s.siblings().find("> ul").hide())}).on("click",function(t){t.preventDefault(),t.stopPropagation()}),o.find("> ul").bind("pointerleave",function(){o.find("li").removeClass(n)})}),this.ui.switcher.each(function(){t(this).bind(s.click,function(i){i.preventDefault(),s._setSwitcher(t(i.currentTarget))})}),this.ui.buttons.each(function(){var i=t(this);i.find("a").attr("data-rel")&&i.on("click",function(i){i.preventDefault(),s._delegate(t(this).find("a"))}),i.find(".cms-publish-page").bind(s.click,function(t){confirm(s.config.lang.publish)||t.preventDefault()}),i.find(".cms-btn-publish").bind(s.click,function(s){s.preventDefault(),t.ajax({type:"post",url:t(this).prop("href"),data:{csrfmiddlewaretoken:CMS.config.csrf},success:function(){CMS.API.Helpers.reloadBrowser()},error:function(t){throw new Error(t)}})})})},toggleToolbar:function(t){t&&(this.settings.toolbar="collapsed"),"collapsed"===this.settings.toolbar?this._showToolbar(200):this._hideToolbar(200)},openMessage:function(t,s,i,e){this._lock(!0),this.ui.messages.find(".cms-messages-inner").html(t),clearTimeout(this.timer);var o=this,a=320,n=this.ui.messages.outerHeight(!0),r=this.ui.toolbar.outerHeight(!0),c=this.ui.messages.find(".cms-messages-close");switch(c.hide(),c.bind(this.click,function(){o.closeMessage()}),"collapsed"===this.settings.toolbar&&(r=0),this.config.debug&&(r+=5),this.ui.messages.css("top",-n).show(),this.ui.messages.removeClass("cms-messages-error"),e&&this.ui.messages.addClass("cms-messages-error"),s=s||"center"){case"left":this.ui.messages.css({top:r,left:-a,right:"auto","margin-left":0}),this.ui.messages.animate({left:0});break;case"right":this.ui.messages.css({top:r,right:-a,left:"auto","margin-left":0}),this.ui.messages.animate({right:0});break;default:this.ui.messages.css({left:"50%",right:"auto","margin-left":-(a/2)}),this.ui.messages.animate({top:r})}return 0===i?(c.show(),!1):void(this.timer=setTimeout(function(){o.closeMessage()},i||this.options.messageDelay))},closeMessage:function(){this.ui.messages.fadeOut(300),this._lock(!1)},openAjax:function(s,i,e,o,a){var n=this,r=e?confirm(e):!0;return r?(this._loader(!0),void t.ajax({type:"POST",url:s,data:i?JSON.parse(i):{},success:function(t){CMS.API.locked=!1,o?(o(n,t),n._loader(!1)):a?CMS.API.Helpers.reloadBrowser(a,!1,!0):CMS.API.Helpers.reloadBrowser(!1,!1,!0)},error:function(t){CMS.API.locked=!1,n.showError(t.response+" | "+t.status+" "+t.statusText)}})):!1},showError:function(t,s){this.openMessage(t,"center",0,!0),s&&CMS.API.Helpers.reloadBrowser(!1,this.options.messageDelay)},_showToolbar:function(s,i){var e=t(".cms-debug-bar").height()||0,o=t(".cms-toolbar").height()+10;this.ui.toolbar.css({transition:"margin-top "+s+"ms","margin-top":0}),this.ui.toolbarTrigger.addClass("cms-toolbar-trigger-expanded"),this.ui.body.addClass("cms-toolbar-expanded"),this.ui.body.animate({"margin-top":o+e},s,"linear"),this.ui.messages.css("top",o+1),this.settings.toolbar="expanded",i||(this.settings=this.setSettings(this.settings))},_hideToolbar:function(s,i){var e=t(".cms-toolbar").height()+10;return this.ui.toolbar.css("transition","margin-top "+s+"ms"),this.lockToolbar?!1:(this.ui.toolbarTrigger.removeClass("cms-toolbar-trigger-expanded"),this.ui.toolbar.css("margin-top",-e),this.ui.body.removeClass("cms-toolbar-expanded"),this.ui.body.animate({"margin-top":this.config.debug?5:0},s),this.ui.messages.css("top",0),this.settings.toolbar="collapsed",void(i||(this.settings=this.setSettings(this.settings))))},_setSwitcher:function(t){var s=t.hasClass("cms-toolbar-item-switch-active"),i=t.find("a"),e=t.find(".cms-toolbar-item-switch-knob"),o=300;return this.options.preventSwitch?(this.openMessage(this.options.preventSwitchMessage,"right"),!1):(s?(e.animate({right:i.outerWidth(!0)-(e.outerWidth(!0)+2)},o),i.css("z-index",1).animate({"padding-top":6,"padding-right":14,"padding-bottom":4,"padding-left":28},o)):(e.animate({left:i.outerWidth(!0)-(e.outerWidth(!0)+2)},o),i.css("z-index",1).animate({"padding-top":6,"padding-right":28,"padding-bottom":4,"padding-left":14},o)),void setTimeout(function(){window.location.href=i.attr("href")},o))},_delegate:function(t){var s=t.data("rel");switch(s){case"modal":var i=new CMS.Modal({onClose:t.data("on-close")});i.open({url:t.attr("href"),title:t.data("name")});break;case"message":this.openMessage(t.data("text"));break;case"sideframe":var e=new CMS.Sideframe({onClose:t.data("on-close")});e.open(t.attr("href"),!0);break;case"ajax":this.openAjax(t.attr("href"),JSON.stringify(t.data("post")),t.data("text"),null,t.data("on-success"));break;default:window.location.href=t.attr("href")}},_lock:function(t){t?(this.lockToolbar=!0,this.ui.toolbarTrigger.css("opacity",.2)):(this.lockToolbar=!1,this.ui.toolbarTrigger.css("opacity",1))},_loader:function(t){t?this.ui.toolbarTrigger.addClass("cms-toolbar-loader"):this.ui.toolbarTrigger.removeClass("cms-toolbar-loader")},_debug:function(){var t=this,s=1e3,i=function(){},e=this.ui.container.find(".cms-debug-bar");e.bind("mouseenter mouseleave",function(e){clearTimeout(i),"mouseenter"===e.type&&(i=setTimeout(function(){t.openMessage(t.config.lang.debug)},s))})},_screenBlock:function(){var s=20,i=this.ui.screenBlock,e=t(".cms-sideframe");t(window).on("resize.cms.screenblock",function(){var s=t(this).width()-e.width();i.css({width:s,height:t(window).height()})}).trigger("resize"),setInterval(function(){t(window).trigger("resize.cms.screenblock")},s)}})})}(CMS.$);
=======
