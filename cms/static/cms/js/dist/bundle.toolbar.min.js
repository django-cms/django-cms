...
var CMS=window.CMS||{};!function(i){"use strict";i(function(){/*!
         ...
         * Handles copy & paste
         */
CMS.Clipboard=new CMS.Class({implement:[CMS.API.Helpers],options:{position:220,speed:100,id:null,url:""},initialize:function(t){this.clipboard=i(".cms-clipboard"),this.options=i.extend(!0,{},this.options,t),this.config=CMS.config,this.settings=CMS.settings,this.containers=this.clipboard.find(".cms-clipboard-containers > .cms-draggable"),this.triggers=this.clipboard.find(".cms-clipboard-triggers a"),this.triggerRemove=this.clipboard.find(".cms-clipboard-empty a"),this.click="click.cms",this.timer=function(){},this._setup(),this._events()},_setup:function(){var t=this,n=113,o=this.clipboard.find(".cms-clipboard-containers"),e=new CMS.Modal({minWidth:400,minHeight:n,minimizable:!1,maximizable:!1,resizable:!1});e.on("cms.modal.loaded",function(){i(".cms-add-plugin-placeholder").remove()}).on("cms.modal.closed cms.modal.load",function(){o.prependTo(t.clipboard)}).ui.modal.on("cms.modal.load",function(){o.prependTo(t.clipboard)}),this.triggers.on(this.click,function(i){i.preventDefault(),e.open({html:o,title:t.clipboard.data("title"),width:400,height:n})})},_events:function(){var i=this;this.triggerRemove.bind(this.click,function(t){t.preventDefault(),i.clear(function(){i.clipboard.hide()})})},clear:function(i){var t='{ "csrfmiddlewaretoken": "'+this.config.csrf+'" }';CMS.API.Toolbar.openAjax({url:this.config.clipboard.url,post:t,callback:i})}})})}(CMS.$);
