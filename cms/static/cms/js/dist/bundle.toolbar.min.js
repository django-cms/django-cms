...
!function(e){"use strict";e(document).ready(function(){e(document).on("pointerup.cms",function(){CMS.Plugin.prototype._hideSubnav()}),/*!
         * Plugins
         * for created plugins or generics (static content)
         */
CMS.Plugin=new CMS.Class({implement:[CMS.API.Helpers],options:{type:"",placeholder_id:null,plugin_type:"",plugin_id:null,plugin_language:"",plugin_parent:null,plugin_order:null,plugin_breadcrumb:[],plugin_restriction:[],urls:{add_plugin:"",edit_plugin:"",move_plugin:"",copy_plugin:"",delete_plugin:""}},initialize:function(s,t){switch(this.container=e("."+s),this.options=e.extend(!0,{},this.options,t),this.body=e(document),this.csrf=CMS.config.csrf,this.timer=function(){},this.timeout=250,this.focused=!1,this.click="pointerup.cms",this.container.data("settings",this.options),this.options.type){case"placeholder":this._setPlaceholder(),this._collapsables();break;case"plugin":this._setPlugin(),this._collapsables();break;default:this._setGeneric()}},_setPlaceholder:function(){var s=this,t=".cms-dragbar-title",i="cms-dragbar-title-expanded",n=e(".cms-dragbar-"+this.options.placeholder_id);this._setSubnav(n.find(".cms-submenu"));var a=CMS.settings;a.dragbars=a.dragbars||[],n.find(t).bind(this.click,function(){e(this).hasClass(i)?s._collapseAll(e(this)):s._expandAll(e(this))}),-1!==e.inArray(this.options.placeholder_id,a.dragbars)&&n.find(t).addClass(i)},_setPlugin:function(){var s=this;this.container.bind("dblclick",function(e){e.preventDefault(),e.stopPropagation(),s.editPlugin(s.options.urls.edit_plugin,s.options.plugin_name,s.options.plugin_breadcrumb)}),this.container.bind("pointerover.cms pointerout.cms",function(e){e.stopPropagation();var t=s.options.plugin_name,i=s.options.plugin_id;"pointerover"===e.type?s.showTooltip(t,i):s.hideTooltip()}),this.container.bind("cms.plugins.update",function(e){e.stopPropagation(),s.movePlugin()}),this.container.bind("cms.plugin.update",function(t){t.stopPropagation();var i=e(t.delegateTarget),n=e(".cms-draggable-"+i.data("settings").plugin_id),a=s._getId(n.parents(".cms-draggables").last().prevAll(".cms-dragbar").first());if(!a)return!1;var o=i.data("settings");o.target=a,o.parent=s._getId(n.parent().closest(".cms-draggable")),s.copyPlugin(o)});var t=e(".cms-draggable-"+this.options.plugin_id),i=t.find("> .cms-dragitem");this._setSubnav(t.find("> .cms-dragitem .cms-submenu")),i.bind("dblclick",function(e){e.preventDefault(),e.stopPropagation(),s.editPlugin(s.options.urls.edit_plugin,s.options.plugin_name,s.options.plugin_breadcrumb)})},_setGeneric:function(){var e=this;this.container.bind("dblclick",function(s){s.preventDefault(),s.stopPropagation(),e.editPlugin(e.options.urls.edit_plugin,e.options.plugin_name,[])}),this.container.bind("pointerover.cms pointerout.cms",function(s){s.stopPropagation();var t=e.options.plugin_name,i=e.options.plugin_id;"pointerover"===s.type?e.showTooltip(t,i):e.hideTooltip()})},addPlugin:function(s,t,i){if(CMS.API.locked)return!1;CMS.API.locked=!0;var n=this,a={placeholder_id:this.options.placeholder_id,plugin_type:s,plugin_parent:i||"",plugin_language:this.options.plugin_language,csrfmiddlewaretoken:this.csrf};e.ajax({type:"POST",url:this.options.urls.add_plugin,data:a,success:function(e){CMS.API.locked=!1,n.newPlugin=e,n.editPlugin(e.url,t,e.breadcrumb)},error:function(e){CMS.API.locked=!1;var s=CMS.config.lang.error;n._showError(s+e.responseText||e.status+" "+e.statusText)}})},editPlugin:function(e,s,t){var i=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});i.open(e,s,t)},copyPlugin:function(s,t){if(CMS.API.locked)return!1;CMS.API.locked=!0;var i=this,n=s||t?!0:!1;s=s||this.options,t?(s.target=s.placeholder_id,s.plugin_id="",s.parent=""):t=s.plugin_language;var a={source_placeholder_id:s.placeholder_id,source_plugin_id:s.plugin_id||"",source_language:t,target_plugin_id:s.parent||"",target_placeholder_id:s.target||CMS.config.clipboard.id,target_language:s.page_language||t,csrfmiddlewaretoken:this.csrf},o={type:"POST",url:s.urls.copy_plugin,data:a,success:function(){CMS.API.Toolbar.openMessage(CMS.config.lang.success),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var s=CMS.config.lang.error;i._showError(s+e.responseText||e.status+" "+e.statusText)}};n?e.ajax(o):CMS.API.Clipboard.clear(function(){e.ajax(o)})},cutPlugin:function(){if(CMS.API.locked)return!1;CMS.API.locked=!0;var s=this,t={placeholder_id:CMS.config.clipboard.id,plugin_id:this.options.plugin_id,plugin_parent:"",plugin_language:this.options.page_language,plugin_order:[this.options.plugin_id],csrfmiddlewaretoken:this.csrf};CMS.API.Clipboard.clear(function(){return CMS.API.locked?!1:(CMS.API.locked=!0,void e.ajax({type:"POST",url:s.options.urls.move_plugin,data:t,success:function(){CMS.API.Toolbar.openMessage(CMS.config.lang.success),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var t=CMS.config.lang.error;s._showError(t+e.responseText||e.status+" "+e.statusText)}}))})},movePlugin:function(s){if(CMS.API.locked)return!1;CMS.API.locked=!0;var t=this;s=s||this.options;var i=e(".cms-plugin-"+s.plugin_id),n=e(".cms-draggable-"+s.plugin_id);this._setPosition(s.plugin_id,i,n);var a=this._getId(n.parents(".cms-draggables").last().prevAll(".cms-dragbar").first()),o=this._getId(n.parent().closest(".cms-draggable")),r=this._getIds(n.siblings(".cms-draggable").andSelf());if(a===!1)return!1;var l={placeholder_id:a,plugin_id:s.plugin_id,plugin_parent:o||"",plugin_language:s.page_language,plugin_order:r,csrfmiddlewaretoken:this.csrf};e.ajax({type:"POST",url:s.urls.move_plugin,data:l,success:function(e){e.reload&&CMS.API.Helpers.reloadBrowser(),CMS.API.locked=!1,t._showSuccess(n)},error:function(e){CMS.API.locked=!1;var s=CMS.config.lang.error;t._showError(s+e.responseText||e.status+" "+e.statusText)}}),e(".cms-btn-publish").addClass("cms-btn-publish-active").removeClass("cms-btn-disabled").parent().show(),e(".cms-toolbar-revert").removeClass("cms-toolbar-item-navigation-disabled")},deletePlugin:function(e,s,t){var i=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});i.open(e,s,t)},_setPosition:function(s,t,i){var n=i.prev(".cms-draggable"),a=i.next(".cms-draggable"),o=i.parent().closest(".cms-draggable"),r=e(".cms-plugin-"+this._getId(o)),l=i.closest(".cms-dragarea");if(n.length)t.insertAfter(e(".cms-plugin-"+this._getId(n)));else if(a.length)t.insertBefore(e(".cms-plugin-"+this._getId(a)));else if(o.length){for(;r.children().length;)r=r.children();r.append(t)}else l.length?t.insertAfter(e(".cms-placeholder-"+this._getId(l))):CMS.API.Helpers.reloadBrowser()},editPluginPostAjax:function(e,s,t){return"undefined"==typeof s||"undefined"==typeof t?function(s,t){var i=e;i.editPlugin(t.url,i.options.plugin_name,t.breadcrumb)}:void this.editPlugin(t.url,this.options.plugin_name,t.breadcrumb)},_setSubnav:function(s){var t=this;s.bind("click",function(s){s.preventDefault(),s.stopPropagation();var i=e(this);i.hasClass("cms-btn-active")?t._hideSubnav(i):(t._hideSubnav(),t._showSubnav(i))}),s.siblings(".cms-submenu-dropdown").on("mousedown mousemove mouseup",function(e){e.stopPropagation()}).on("touchstart",function(e){e.stopPropagation()}),s.siblings(".cms-submenu-dropdown").find("a").bind("click.cms",function(i){i.preventDefault(),i.stopPropagation(),CMS.API.Toolbar._loader(!0);var n=e(this);switch(t._hideSubnav(s),n.attr("data-rel")){case"add":t.addPlugin(n.attr("href").replace("#",""),n.text(),t._getId(n.closest(".cms-draggable")));break;case"ajax_add":CMS.API.Toolbar.openAjax(n.attr("href"),JSON.stringify(n.data("post")),n.data("text"),t.editPluginPostAjax(t),n.data("on-success"));break;case"edit":t.editPlugin(t.options.urls.edit_plugin,t.options.plugin_name,t.options.plugin_breadcrumb);break;case"copy-lang":t.copyPlugin(this.options,n.attr("data-language"));break;case"copy":t.copyPlugin();break;case"cut":t.cutPlugin();break;case"delete":t.deletePlugin(t.options.urls.delete_plugin,t.options.plugin_name,t.options.plugin_breadcrumb);break;default:CMS.API.Toolbar._loader(!1),CMS.API.Toolbar._delegate(n)}}),s.siblings(".cms-submenu-quicksearch").find("input").on("keyup keydown focus pointerup",function(i){"focus"===i.type&&(t.focused=!0),"keyup"===i.type&&(clearTimeout(t.timer),t.timer=setTimeout(function(){t._searchSubnav(s,e(i.currentTarget).val())},100))}),s.siblings(".cms-submenu-dropdown").each(function(){e(this).data("top",e(this).css("top"))}),s.on(this.click+" dblclick",function(e){e.stopPropagation()}),s.siblings(".cms-submenu-quicksearch, .cms-submenu-dropdown").on(this.click,function(e){e.stopPropagation()})},_showSubnav:function(s){var t=this,i=s.siblings(".cms-submenu-dropdown"),n=parseInt(i.data("top"));s.addClass("cms-btn-active");var a=e(".cms-submenu").parentsUntil(".cms-dragarea"),o=i.find(".cms-submenu-scroll-hint");a.css("z-index",0);var r=s.parentsUntil(".cms-dragarea");r.css("z-index",999),s.siblings(".cms-submenu-quicksearch").show().find("input"),s.siblings(".cms-submenu-dropdown").show().on("scroll",function(){o.fadeOut(100),e(this).off("scroll")}),i[0].scrollHeight>i.height()&&o.show(),e(document).unbind("keydown.cms"),e(document).bind("keydown.cms",function(e){var i=s.siblings(".cms-submenu-dropdown").find(".cms-submenu-item:visible a"),n=i.index(i.filter(":focus"));(40===e.keyCode||9===e.keyCode)&&(t.traverse=!0,e.preventDefault(),n>=0&&n<i.length-1?i.eq(n+1).focus():i.eq(0).focus()),(38===e.keyCode||9===e.keyCode&&e.shiftKey)&&(e.preventDefault(),i.is(":focus")?i.eq(n-1).focus():i.eq(i.length).focus()),(13===e.keyCode||27===e.keyCode)&&(t.traverse=!1,s.siblings(".cms-submenu-quicksearch").find("input").blur(),t._hideSubnav(s))}),e(window).height()+e(window).scrollTop()-s.offset().top-i.height()<=10&&s.offset().top-i.height()>=0?(i.css("top","auto"),i.css("bottom",n),i.closest(".cms-draggable").length&&i.css("bottom",n-1)):(i.css("top",n),i.css("bottom","auto"))},_hideSubnav:function(s){s=s||e(".cms-submenu.cms-btn-active"),s.length&&(s.removeClass("cms-btn-active"),s.closest(".cms-draggable").data("active",!1),s.siblings(".cms-submenu-dropdown").hide(),s.siblings(".cms-submenu-quicksearch").hide(),s.siblings(".cms-submenu-quicksearch").find("input").val("").blur(),e(".cms-dragbar").css("position",""))},_searchSubnav:function(s,t){var i=s.siblings(".cms-submenu-dropdown").find(".cms-submenu-item"),n=s.siblings(".cms-submenu-dropdown").find(".cms-submenu-item-title");return""===t?(i.add(n).show(),!1):(i.find("a, span").each(function(s,i){i=e(i);var n=i.text().toLowerCase(),a=t.toLowerCase();n.indexOf(a)>=0?i.parent().show():i.parent().hide()}),n.filter(":visible").each(function(s,t){n.hide(),e(t).nextUntil(".cms-submenu-item-title").show()}),i.filter(":visible").each(function(s,t){e(t).prev().hasClass("cms-submenu-item-title")?e(t).prev().show():e(t).prevUntil(".cms-submenu-item-title").last().prev().show()}),s.siblings(".cms-submenu-dropdown").show(),i.add(n).filter(":visible").length<=0&&s.siblings(".cms-submenu-dropdown").hide(),void s.siblings(".cms-submenu-dropdown").find(".cms-submenu-scroll-hint").hide())},_toggleCollapsable:function(s){var t,i=this,n=i._getId(e(this).parent()),a=e(".cms-draggable-"+this.options.plugin_id),o=CMS.settings;if(o.states=o.states||[],s.hasClass("cms-dragitem-expanded")){if(o.states.splice(e.inArray(n,o.states),1),s.removeClass("cms-dragitem-expanded").parent().find("> .cms-draggables").hide(),e(document).data("expandmode")){if(t=a.find(".cms-draggable").find(".cms-dragitem-collapsable"),!t.length)return!1;t.each(function(){var s=e(this);s.hasClass("cms-dragitem-expanded")&&i._toggleCollapsable(s)})}}else if(o.states.push(n),s.addClass("cms-dragitem-expanded").parent().find("> .cms-draggables").show(),e(document).data("expandmode")){if(t=a.find(".cms-draggable").find(".cms-dragitem-collapsable"),!t.length)return!1;t.each(function(){var s=e(this);s.hasClass("cms-dragitem-expanded")||i._toggleCollapsable(s)})}e(window).trigger("resize.sideframe"),CMS.API.Toolbar.setSettings(o)},_collapsables:function(){var s=this,t=CMS.settings,i=e(".cms-draggable-"+this.options.plugin_id);if(this.container.each(function(s,t){var i=e(t).find(".cms-dragitem-collapsable"),n=i.filter(".cms-dragitem-expanded");i.length===n.length&&i.length+n.length!==0&&e(t).find(".cms-dragbar-title").addClass("cms-dragbar-title-expanded")}),!i.length)return!1;if(i.find("> .cms-dragitem-collapsable").bind(this.click,function(){var t=e(this);s._toggleCollapsable(t)}),i.bind("dblclick",function(t){t.stopPropagation(),e(".cms-plugin-"+s._getId(e(this))).trigger("dblclick")}),CMS.Toolbar.ready)return!1;for(var n=t.states.sort(),a=[],o=0;o<n.length;o++)n[o]!==n[o+1]&&a.push(n[o]);t.states=a,e.each(CMS.settings.states,function(s,t){var i=e(".cms-draggable-"+t);i.find(".cms-draggables").length&&(i.find("> .cms-draggables").show(),i.find("> .cms-dragitem").addClass("cms-dragitem-expanded"))}),CMS.Toolbar.ready=!0},_expandAll:function(s){var t=this,i=s.closest(".cms-dragarea").find(".cms-dragitem-collapsable");if(!i.length)return!1;i.each(function(){var s=e(this);s.hasClass("cms-dragitem-expanded")||t._toggleCollapsable(s)}),s.addClass("cms-dragbar-title-expanded");var n=CMS.settings;n.dragbars=n.dragbars||[],n.dragbars.push(this.options.placeholder_id),CMS.API.Toolbar.setSettings(n)},_collapseAll:function(s){var t=this,i=s.closest(".cms-dragarea").find(".cms-dragitem-collapsable");i.each(function(){var s=e(this);s.hasClass("cms-dragitem-expanded")&&t._toggleCollapsable(s)}),s.removeClass("cms-dragbar-title-expanded");var n=CMS.settings;n.dragbars=n.dragbars||[],n.dragbars.splice(e.inArray(this.options.placeholder_id,n.states),1),CMS.API.Toolbar.setSettings(n)},_getId:function(e){return CMS.API.StructureBoard.getId(e)},_getIds:function(e){return CMS.API.StructureBoard.getIds(e)},_showError:function(e){return CMS.API.Toolbar.showError(e,!0)},_showSuccess:function(s){var t=e('<div class="cms-dragitem-success"></div>');s.append(t),t.fadeOut(function(){e(this).remove()}),e(window).trigger("resize.sideframe")}})})}(CMS.$);
