 ...
 */
window.django=window.django||void 0,window.jQuery=window.django&&window.django.jQuery?window.django.jQuery:window.jQuery||void 0,window.Class=window.Class||void 0;var CMS={$:"function"==typeof window.jQuery?window.jQuery:void 0,Class:"function"==typeof window.Class?window.Class:void 0,API:{},KEYS:{SHIFT:16,TAB:9,UP:38,DOWN:40,ENTER:13,SPACE:32,ESC:27}};!function(o){"use strict";o(document).ready(function(){CMS.API.Helpers={isTouch:void 0!==window.ontouchstart,reloadBrowser:function(e,t,n){var i=this,s=window.parent?window.parent:window;return n?(s.CMS.API.locked=!0,o.ajax({async:!1,type:"GET",url:s.CMS.config.request.url,data:{model:s.CMS.config.request.model,pk:s.CMS.config.request.pk},success:function(o){return s.CMS.API.locked=!1,""!==o||e?void(s.location.pathname!==o&&""!==o?i.reloadBrowser(o):"REFRESH_PAGE"===e?i.reloadBrowser():e&&i.reloadBrowser(e)):!1}}),!1):void s.setTimeout(function(){e&&e!==s.location.href?s.location.href=e:s.location.reload()},t||0)},preventSubmit:function(){var e=o("#cms-toolbar").find("form");e.submit(function(){CMS.API.Toolbar.showLoader(),o('input[type="submit"]').bind("click",function(o){o.preventDefault()}).css("opacity",.5)})},csrf:function(e){o.ajaxSetup({beforeSend:function(o){o.setRequestHeader("X-CSRFToken",e)}})},showTooltip:function(e,t,n){var i=CMS.API.Helpers.pickTooltip();i.css("visibility","visible").data("plugin_id",n||null).show().find("span").html(t),CMS.API.Helpers.isTouch?(CMS.API.Helpers.positionTooltip(e,i),i.bind("touchstart.cms",function(){o(".cms-plugin-"+o(this).data("plugin_id")).trigger("dblclick")})):o("body").bind("mousemove.cms",function(o){CMS.API.Helpers.positionTooltip(o,i)})},hideTooltip:function(){var e=CMS.API.Helpers.pickTooltip();e.css("visibility","hidden").hide(),o("body").unbind("mousemove.cms"),CMS.API.Helpers.isTouch&&e.unbind("touchstart.cms")},pickTooltip:function(){return o(CMS.API.Helpers.isTouch?".cms-tooltip-touch":".cms-tooltip")},positionTooltip:function(e,t){var n=20,i=e.pageX-o(t).offsetParent().offset().left,s=e.pageY-o(t).offsetParent().offset().top,r=o(t).offsetParent().width(),a=i+t.outerWidth(!0)+n;t.css({left:a>=r?i-t.outerWidth(!0)-n:i+n,top:s-12})},setSettings:function(e){return e=JSON.stringify(o.extend({},CMS.config.settings,e)),CMS.API.Toolbar&&CMS.API.Toolbar.showLoader(),window.localStorage?(localStorage.setItem("cms_cookie",e),CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()):(CMS.API.locked=!0,o.ajax({async:!1,type:"POST",url:CMS.config.urls.settings,data:{csrfmiddlewaretoken:this.config.csrf,settings:e},success:function(o){CMS.API.locked=!1,e=o?JSON.parse(o):CMS.config.settings,CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()},error:function(o){CMS.API.Messages.open({message:o.response+" | "+o.status+" "+o.statusText,error:!0})}})),CMS.settings=JSON.parse(e),CMS.settings},getSettings:function(){var e;return CMS.API.Toolbar&&CMS.API.Toolbar.showLoader(),window.localStorage?(e=JSON.parse(localStorage.getItem("cms_cookie")),CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()):(CMS.API.locked=!0,o.ajax({async:!1,type:"GET",url:CMS.config.urls.settings,success:function(o){CMS.API.locked=!1,e=o?JSON.parse(o):CMS.config.settings,CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()},error:function(o){CMS.API.Messages.open({message:o.response+" | "+o.status+" "+o.statusText,error:!0})}})),e||(e=this.setSettings(CMS.config.settings)),CMS.settings=e,CMS.settings},makeURL:function(e,t){var n=[],i=[],s=[],r="",a=[],l=[],u=e;return e.split("?").length<=1||void 0===window.JSON||(a=e.split("?"),l=a[1].split("&"),u=a[0]),o.each(l,function(o,e){n.push({param:e.split("=")[0],value:e.split("=")[1]})}),t&&t.length&&o.each(t,function(o,e){n.push({param:e.split("=")[0],value:e.split("=")[1]})}),o.each(n,function(e,t){var n=o.inArray(t.param,i);-1===n?(i.push(t.param),s.push(t.value)):s[n]=t.value}),o.each(i,function(o,e){r+="&"+e+"="+s[o]}),r=r.replace("&","?"),e=u+r,e=e.replace("&","&amp;")},debounce:function(o,e,t){var n;return function(){var i=this,s=arguments,r=function(){n=null,t&&t.immediate||o.apply(i,s)},a=t&&t.immediate&&!n;clearTimeout(n),n=setTimeout(r,e),a&&o.apply(i,s)}},throttle:function(e,t,n){var i,s,r,a=null,l=0;n||(n={});var u=function(){l=n.leading===!1?0:o.now(),a=null,r=e.apply(i,s),a||(i=s=null)};return function(){var c=o.now();l||n.leading!==!1||(l=c);var d=t-(c-l);return i=this,s=arguments,0>=d||d>t?(a&&(clearTimeout(a),a=null),l=c,r=e.apply(i,s),a||(i=s=null)):a||n.trailing===!1||(a=setTimeout(u,d)),r}}},CMS.API.Helpers.preventSubmit()})}(CMS.$);
/*!========================================================================
