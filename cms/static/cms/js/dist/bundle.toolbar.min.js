...
var CMS=window.CMS||{};!function(n){"use strict";n(function(){CMS.CMSFrame=new CMS.Class({implement:[CMS.API.Helpers],options:{},initialize:function(e){this.options=n.extend(!0,{},this.options,e)},open:function(n){if(!n||!n.url)throw new Error("The CMSFrame.open method requires a url.");var e=n.url,i=window.open(e,"cms_frame");return i.focus(),this}})})}(CMS.$);
