...
!function(e){"use strict";var s={SHIFT:16,TAB:9,UP:38,DOWN:40,ENTER:13,ESC:27};e(function(){var i=e(document);i.on("pointerup.cms",function(){CMS.Plugin.prototype._hideSubnav()}).on("keydown",function(e){e.keyCode===s.SHIFT&&i.data("expandmode",!0)}).on("keyup",function(e){e.keyCode===s.SHIFT&&i.data("expandmode",!1)}),/*!
         * Plugins
         * for created plugins or generics (static content)
         */
CMS.Plugin=new CMS.Class({implement:[CMS.API.Helpers],options:{type:"",placeholder_id:null,plugin_type:"",plugin_id:null,plugin_language:"",plugin_parent:null,plugin_order:null,plugin_breadcrumb:[],plugin_restriction:[],urls:{add_plugin:"",edit_plugin:"",move_plugin:"",copy_plugin:"",delete_plugin:""}},initialize:function(s,i){switch(this.options=e.extend(!0,{},this.options,i),this._setupUI(s),this.csrf=CMS.config.csrf,this.timer=function(){},this.timeout=250,this.focused=!1,this.click="pointerup.cms",this.ui.container.data("settings",this.options),this.options.type){case"placeholder":this._setPlaceholder(),this._collapsables();break;case"plugin":this._setPlugin(),this._collapsables();break;default:this._setGeneric()}},_setupUI:function(s){this.ui={},this.ui.container=e("."+s),this.ui.publish=e(".cms-btn-publish"),this.ui.window=e(window),this.ui.revert=e(".cms-toolbar-revert")},_setPlaceholder:function(){var s=this,i=".cms-dragbar-title",t="cms-dragbar-title-expanded",n=e(".cms-dragbar-"+this.options.placeholder_id);this._setSubnav(n.find(".cms-submenu"));var a=CMS.settings;a.dragbars=a.dragbars||[],n.find(i).on(this.click,function(){e(this).hasClass(t)?s._collapseAll(e(this)):s._expandAll(e(this))}),-1!==e.inArray(this.options.placeholder_id,a.dragbars)&&n.find(i).addClass(t)},_setPlugin:function(){var s=this;this.ui.container.on("dblclick",function(e){e.preventDefault(),e.stopPropagation(),s.editPlugin(s.options.urls.edit_plugin,s.options.plugin_name,s.options.plugin_breadcrumb)}),this.ui.container.on("pointerover.cms pointerout.cms",function(e){e.stopPropagation();var i=s.options.plugin_name,t=s.options.plugin_id;"pointerover"===e.type?s.showTooltip(i,t):s.hideTooltip()}),this.ui.container.on("cms.plugins.update",function(e){e.stopPropagation(),s.movePlugin()}),this.ui.container.on("cms.plugin.update",function(i){i.stopPropagation();var t=e(i.delegateTarget),n=e(".cms-draggable-"+t.data("settings").plugin_id),a=s._getId(n.parents(".cms-draggables").last().prevAll(".cms-dragbar").first());if(!a)return!1;var o=t.data("settings");o.target=a,o.parent=s._getId(n.parent().closest(".cms-draggable")),s.copyPlugin(o)});var i=e(".cms-draggable-"+this.options.plugin_id),t=i.find("> .cms-dragitem");this._setSubnav(i.find("> .cms-dragitem .cms-submenu")),t.on("dblclick",function(e){e.preventDefault(),e.stopPropagation(),s.editPlugin(s.options.urls.edit_plugin,s.options.plugin_name,s.options.plugin_breadcrumb)})},_setGeneric:function(){var e=this;this.ui.container.on("dblclick",function(s){s.preventDefault(),s.stopPropagation(),e.editPlugin(e.options.urls.edit_plugin,e.options.plugin_name,[])}),this.ui.container.on("pointerover.cms pointerout.cms",function(s){s.stopPropagation();var i=e.options.plugin_name,t=e.options.plugin_id;"pointerover"===s.type?e.showTooltip(i,t):e.hideTooltip()})},addPlugin:function(s,i,t){if(CMS.API.locked)return!1;CMS.API.locked=!0;var n=this,a={placeholder_id:this.options.placeholder_id,plugin_type:s,plugin_parent:t||"",plugin_language:this.options.plugin_language,csrfmiddlewaretoken:this.csrf};e.ajax({type:"POST",url:this.options.urls.add_plugin,data:a,success:function(e){CMS.API.locked=!1,n.newPlugin=e,n.editPlugin(e.url,i,e.breadcrumb)},error:function(e){CMS.API.locked=!1;var s=CMS.config.lang.error;n._showError(s+e.responseText||e.status+" "+e.statusText)}})},editPlugin:function(e,s,i){var t=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});t.open(e,s,i)},copyPlugin:function(s,i){if(CMS.API.locked)return!1;CMS.API.locked=!0;var t=this,n=s||i?!0:!1;s=s||this.options,i?(s.target=s.placeholder_id,s.plugin_id="",s.parent=""):i=s.plugin_language;var a={source_placeholder_id:s.placeholder_id,source_plugin_id:s.plugin_id||"",source_language:i,target_plugin_id:s.parent||"",target_placeholder_id:s.target||CMS.config.clipboard.id,target_language:s.page_language||i,csrfmiddlewaretoken:this.csrf},o={type:"POST",url:s.urls.copy_plugin,data:a,success:function(){CMS.API.Toolbar.openMessage(CMS.config.lang.success),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var s=CMS.config.lang.error;t._showError(s+e.responseText||e.status+" "+e.statusText)}};n?e.ajax(o):CMS.API.Clipboard.clear(function(){e.ajax(o)})},cutPlugin:function(){if(CMS.API.locked)return!1;CMS.API.locked=!0;var s=this,i={placeholder_id:CMS.config.clipboard.id,plugin_id:this.options.plugin_id,plugin_parent:"",plugin_language:this.options.page_language,plugin_order:[this.options.plugin_id],csrfmiddlewaretoken:this.csrf};CMS.API.Clipboard.clear(function(){return CMS.API.locked?!1:(CMS.API.locked=!0,void e.ajax({type:"POST",url:s.options.urls.move_plugin,data:i,success:function(){CMS.API.Toolbar.openMessage(CMS.config.lang.success),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var i=CMS.config.lang.error;s._showError(i+e.responseText||e.status+" "+e.statusText)}}))})},movePlugin:function(s){if(CMS.API.locked)return!1;CMS.API.locked=!0;var i=this;s=s||this.options;var t=e(".cms-plugin-"+s.plugin_id),n=e(".cms-draggable-"+s.plugin_id);this._setPosition(s.plugin_id,t,n);var a=this._getId(n.parents(".cms-draggables").last().prevAll(".cms-dragbar").first()),o=this._getId(n.parent().closest(".cms-draggable")),r=this._getIds(n.siblings(".cms-draggable").andSelf());if(a===!1)return!1;var l={placeholder_id:a,plugin_id:s.plugin_id,plugin_parent:o||"",plugin_language:s.page_language,plugin_order:r,csrfmiddlewaretoken:this.csrf};e.ajax({type:"POST",url:s.urls.move_plugin,data:l,success:function(e){e.reload&&CMS.API.Helpers.reloadBrowser(),CMS.API.locked=!1,i._showSuccess(n)},error:function(e){CMS.API.locked=!1;var s=CMS.config.lang.error;i._showError(s+e.responseText||e.status+" "+e.statusText)}}),this.ui.publish.addClass("cms-btn-publish-active").removeClass("cms-btn-disabled").parent().show(),this.ui.revert.removeClass("cms-toolbar-item-navigation-disabled")},deletePlugin:function(e,s,i){var t=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});t.open(e,s,i)},_setPosition:function(s,i,t){var n=t.prev(".cms-draggable"),a=t.next(".cms-draggable"),o=t.parent().closest(".cms-draggable"),r=e(".cms-plugin-"+this._getId(o)),l=t.closest(".cms-dragarea");if(n.length)i.insertAfter(e(".cms-plugin-"+this._getId(n)));else if(a.length)i.insertBefore(e(".cms-plugin-"+this._getId(a)));else if(o.length){for(;r.children().length;)r=r.children();r.append(i)}else l.length?i.insertAfter(e(".cms-placeholder-"+this._getId(l))):CMS.API.Helpers.reloadBrowser()},editPluginPostAjax:function(e,s,i){return"undefined"==typeof s||"undefined"==typeof i?function(s,i){var t=e;t.editPlugin(i.url,t.options.plugin_name,i.breadcrumb)}:void this.editPlugin(i.url,this.options.plugin_name,i.breadcrumb)},_setSubnav:function(s){var i=this;s.on("click",function(s){s.preventDefault(),s.stopPropagation();var t=e(this);t.hasClass("cms-btn-active")?i._hideSubnav(t):(i._hideSubnav(),i._showSubnav(t))}),s.siblings(".cms-submenu-dropdown").on("mousedown mousemove mouseup",function(e){e.stopPropagation()}).on("touchstart",function(e){e.stopPropagation()}),s.siblings(".cms-submenu-dropdown").find("a").on("click.cms",function(t){t.preventDefault(),t.stopPropagation(),CMS.API.Toolbar._loader(!0);var n=e(this);switch(i._hideSubnav(s),n.attr("data-rel")){case"add":i.addPlugin(n.attr("href").replace("#",""),n.text(),i._getId(n.closest(".cms-draggable")));break;case"ajax_add":CMS.API.Toolbar.openAjax(n.attr("href"),JSON.stringify(n.data("post")),n.data("text"),i.editPluginPostAjax(i),n.data("on-success"));break;case"edit":i.editPlugin(i.options.urls.edit_plugin,i.options.plugin_name,i.options.plugin_breadcrumb);break;case"copy-lang":i.copyPlugin(this.options,n.attr("data-language"));break;case"copy":i.copyPlugin();break;case"cut":i.cutPlugin();break;case"delete":i.deletePlugin(i.options.urls.delete_plugin,i.options.plugin_name,i.options.plugin_breadcrumb);break;default:CMS.API.Toolbar._loader(!1),CMS.API.Toolbar._delegate(n)}}),s.siblings(".cms-submenu-quicksearch").find("input").on("keyup keydown focus pointerup",function(t){"focus"===t.type&&(i.focused=!0),"keyup"===t.type&&(clearTimeout(i.timer),i.timer=setTimeout(function(){i._searchSubnav(s,e(t.currentTarget).val())},100))}),s.siblings(".cms-submenu-dropdown").each(function(){e(this).data("top",e(this).css("top"))}),s.on(this.click+" dblclick",function(e){e.stopPropagation()}),s.siblings(".cms-submenu-quicksearch, .cms-submenu-dropdown").on(this.click,function(e){e.stopPropagation()})},_showSubnav:function(t){var n=this,a=t.siblings(".cms-submenu-dropdown"),o=parseInt(a.data("top"));t.addClass("cms-btn-active");var r=e(".cms-submenu").parentsUntil(".cms-dragarea"),l=a.find(".cms-submenu-scroll-hint");r.css("z-index",0);var d=t.parentsUntil(".cms-dragarea");d.css("z-index",999),t.siblings(".cms-submenu-quicksearch").show().find("input"),t.siblings(".cms-submenu-dropdown").show().on("scroll",function(){l.fadeOut(100),e(this).off("scroll")}),a[0].scrollHeight>a.height()&&l.show(),i.off("keydown.cms"),i.on("keydown.cms",function(e){var i=t.siblings(".cms-submenu-dropdown").find(".cms-submenu-item:visible a"),a=i.index(i.filter(":focus"));(e.keyCode===s.DOWN||e.keyCode===s.TAB)&&(n.traverse=!0,e.preventDefault(),a>=0&&a<i.length-1?i.eq(a+1).focus():i.eq(0).focus()),(e.keyCode===s.UP||e.keyCode===s.TAB&&e.shiftKey)&&(e.preventDefault(),i.is(":focus")?i.eq(a-1).focus():i.eq(i.length).focus()),(e.keyCode===s.ENTER||e.keyCode===s.ESC)&&(n.traverse=!1,t.siblings(".cms-submenu-quicksearch").find("input").blur(),n._hideSubnav(t))}),this.ui.window.height()+this.ui.window.scrollTop()-t.offset().top-a.height()<=10&&t.offset().top-a.height()>=0?(a.css("top","auto"),a.css("bottom",o),a.closest(".cms-draggable").length&&a.css("bottom",o-1)):(a.css("top",o),a.css("bottom","auto"))},_hideSubnav:function(s){s=s||e(".cms-submenu.cms-btn-active"),s.length&&(s.removeClass("cms-btn-active"),s.closest(".cms-draggable").data("active",!1),s.siblings(".cms-submenu-dropdown").hide(),s.siblings(".cms-submenu-quicksearch").hide(),s.siblings(".cms-submenu-quicksearch").find("input").val("").blur(),e(".cms-dragbar").css("position",""))},_searchSubnav:function(s,i){var t=s.siblings(".cms-submenu-dropdown").find(".cms-submenu-item"),n=s.siblings(".cms-submenu-dropdown").find(".cms-submenu-item-title");return""===i?(t.add(n).show(),!1):(t.find("a, span").each(function(s,t){t=e(t);var n=t.text().toLowerCase(),a=i.toLowerCase();n.indexOf(a)>=0?t.parent().show():t.parent().hide()}),n.filter(":visible").each(function(s,i){n.hide(),e(i).nextUntil(".cms-submenu-item-title").show()}),t.filter(":visible").each(function(s,i){e(i).prev().hasClass("cms-submenu-item-title")?e(i).prev().show():e(i).prevUntil(".cms-submenu-item-title").last().prev().show()}),s.siblings(".cms-submenu-dropdown").show(),t.add(n).filter(":visible").length<=0&&s.siblings(".cms-submenu-dropdown").hide(),void s.siblings(".cms-submenu-dropdown").find(".cms-submenu-scroll-hint").hide())},_toggleCollapsable:function(s){var t,n=this,a=n._getId(e(this).parent()),o=e(".cms-draggable-"+this.options.plugin_id),r=CMS.settings;if(r.states=r.states||[],s.hasClass("cms-dragitem-expanded")){if(r.states.splice(e.inArray(a,r.states),1),s.removeClass("cms-dragitem-expanded").parent().find("> .cms-draggables").hide(),i.data("expandmode")){if(t=o.find(".cms-draggable").find(".cms-dragitem-collapsable"),!t.length)return!1;t.each(function(){var s=e(this);s.hasClass("cms-dragitem-expanded")&&n._toggleCollapsable(s)})}}else if(r.states.push(a),s.addClass("cms-dragitem-expanded").parent().find("> .cms-draggables").show(),i.data("expandmode")){if(t=o.find(".cms-draggable").find(".cms-dragitem-collapsable"),!t.length)return!1;t.each(function(){var s=e(this);s.hasClass("cms-dragitem-expanded")||n._toggleCollapsable(s)})}this.ui.window.trigger("resize.sideframe"),CMS.API.Toolbar.setSettings(r)},_collapsables:function(){var s=this,i=CMS.settings,t=e(".cms-draggable-"+this.options.plugin_id);if(this.ui.container.each(function(s,i){var t=e(i).find(".cms-dragitem-collapsable"),n=t.filter(".cms-dragitem-expanded");t.length===n.length&&t.length+n.length!==0&&e(i).find(".cms-dragbar-title").addClass("cms-dragbar-title-expanded")}),!t.length)return!1;if(t.find("> .cms-dragitem-collapsable").on(this.click,function(){var i=e(this);s._toggleCollapsable(i)}),t.on("dblclick",function(i){i.stopPropagation(),e(".cms-plugin-"+s._getId(e(this))).trigger("dblclick")}),CMS.Toolbar.ready)return!1;for(var n=i.states.sort(),a=[],o=0;o<n.length;o++)n[o]!==n[o+1]&&a.push(n[o]);i.states=a,e.each(CMS.settings.states,function(s,i){var t=e(".cms-draggable-"+i);t.find(".cms-draggables").length&&(t.find("> .cms-draggables").show(),t.find("> .cms-dragitem").addClass("cms-dragitem-expanded"))}),CMS.Toolbar.ready=!0},_expandAll:function(s){var i=this,t=s.closest(".cms-dragarea").find(".cms-dragitem-collapsable");if(!t.length)return!1;t.each(function(){var s=e(this);s.hasClass("cms-dragitem-expanded")||i._toggleCollapsable(s)}),s.addClass("cms-dragbar-title-expanded");var n=CMS.settings;n.dragbars=n.dragbars||[],n.dragbars.push(this.options.placeholder_id),CMS.API.Toolbar.setSettings(n)},_collapseAll:function(s){var i=this,t=s.closest(".cms-dragarea").find(".cms-dragitem-collapsable");t.each(function(){var s=e(this);s.hasClass("cms-dragitem-expanded")&&i._toggleCollapsable(s)}),s.removeClass("cms-dragbar-title-expanded");var n=CMS.settings;n.dragbars=n.dragbars||[],n.dragbars.splice(e.inArray(this.options.placeholder_id,n.states),1),CMS.API.Toolbar.setSettings(n)},_getId:function(e){return CMS.API.StructureBoard.getId(e)},_getIds:function(e){return CMS.API.StructureBoard.getIds(e)},_showError:function(e){return CMS.API.Toolbar.showError(e,!0)},_showSuccess:function(s){var i=e('<div class="cms-dragitem-success"></div>');s.append(i),i.fadeOut(function(){e(this).remove()}),this.ui.window.trigger("resize.sideframe")}})})}(CMS.$);
!function(e){"use strict";var t={SPACE:32,SHIFT:16,ESC:27};e(function(){function s(){i.each(function(){var t=e(this);t.next().children().not(".cms-is-dragging").length?t.hide():t.show()})}var i=e(".cms-dragbar-empty-wrapper");/*!
         * StructureBoard
         * handles drag & drop, mode switching and
         */
CMS.StructureBoard=new CMS.Class({implement:[CMS.API.Helpers],options:{speed:300},initialize:function(t){this.options=e.extend(!0,{},this.options,t),this.config=CMS.config,this.settings=CMS.settings,this._setupUI(),this.click="click.cms",this.state=!1,this.dragging=!1,this._setup(),this._events(),s()},_setupUI:function(){var t=e(".cms-structure"),s=e("#cms-toolbar");this.ui={container:t,content:e(".cms-structure-content"),doc:e(document),window:e(window),toolbar:s,sortables:e(".cms-draggables"),plugins:e(".cms-plugin"),render_model:e(".cms-render-model"),placeholders:e(".cms-placeholder"),dragitems:e(".cms-draggable"),dragareas:e(".cms-dragarea"),dropareas:e(".cms-droppable"),dimmer:t.find(".cms-structure-dimmer"),clipboard:e(".cms-clipboard"),toolbarModeSwitcher:s.find(".cms-toolbar-item-cms-mode-switcher"),toolbarModeLinks:s.find(".cms-toolbar-item-cms-mode-switcher a")}},_setup:function(){var e=this;return this.ui.dragareas.length&&this.ui.toolbarModeSwitcher.length?(setTimeout(function(){"structure"===e.settings.mode?e.show(!0):e.hide(!0)},0),this.ui.placeholders.length&&this.ui.toolbarModeSwitcher.show(),void this._drag()):!1},_events:function(){var e=this,s=e.ui.toolbarModeLinks;s.eq(1).on(e.click,function(t){return t.preventDefault(),"edit"===e.settings.mode?!1:void e.hide()}),s.eq(0).on(e.click,function(t){return t.preventDefault(),"structure"===e.settings.mode?!1:void e.show()}),e.ui.toolbarModeSwitcher.length&&e.ui.doc.on("keydown",function(s){var i=document.activeElement!==document.body;s.keyCode!==t.SPACE||i||(s.preventDefault(),"structure"===e.settings.mode?e.hide():"edit"===e.settings.mode&&e.show())})},show:function(e){if("live"===CMS.config.mode)return!1;var t=this.ui.toolbarModeLinks;t.removeClass("cms-btn-active").eq(0).addClass("cms-btn-active"),this.ui.clipboard.fadeIn(this.options.speed),this.settings.mode="structure",e||(this.settings=this.setSettings(this.settings)),this.ui.dragareas.show(),this._showBoard()},hide:function(e){if("live"===CMS.config.mode)return!1;var t=this.ui.toolbarModeLinks;t.removeClass("cms-btn-active").eq(1).addClass("cms-btn-active"),this.ui.container.find(".cms-clipboard").hide(),this.ui.clipboard.hide(),this.settings.mode="edit",e||(this.settings=this.setSettings(this.settings)),this._hideBoard()},getId:function(e){if(void 0===e||null===e||e.length<=0)return!1;var t=null,s=e.attr("class").split(" ")[1];return e.hasClass("cms-plugin")?t=s.replace("cms-plugin-",""):e.hasClass("cms-draggable")?t=s.replace("cms-draggable-",""):e.hasClass("cms-placeholder")?t=s.replace("cms-placeholder-",""):e.hasClass("cms-dragbar")?t=s.replace("cms-dragbar-",""):e.hasClass("cms-dragarea")&&(t=s.replace("cms-dragarea-","")),t},getIds:function(t){var s=this,i=[];return t.each(function(){i.push(s.getId(e(this)))}),i},_showBoard:function(){var t=this;if(this.ui.container.show(),this.ui.dimmer.show(),this.ui.dragareas.css("opacity",1),this.ui.plugins.not(this.ui.render_model).hide(),this.ui.placeholders.show(),CMS.config.simpleStructureBoard){var s=this.ui.content,i=s.find(".cms-dragarea");s.addClass("cms-structure-content-simple"),i.addClass("cms-dragarea-simple"),i.each(function(t,i){e(i).hasClass("cms-dragarea-static")&&s.append(i)}),i.filter(".cms-dragarea-static").eq(0).css("margin-top","50px")}else this.ui.container.addClass("cms-structure-dynamic"),this.ui.window.on("resize.sideframe",function(){t._resizeBoard()}).trigger("resize.sideframe")},_hideBoard:function(){this.ui.container.hide(),this.ui.plugins.show(),this.ui.placeholders.hide(),this.ui.dimmer.hide(),this.ui.window.off("resize.sideframe"),this.ui.window.trigger("structureboard_hidden.sideframe"),CMS.config.simpleStructureBoard||this.ui.container.height(this.ui.doc.outerHeight())},_resizeBoard:function(){var t=null,s=null,i=null,a=null,r=this;setTimeout(function(){r.ui.container.height(r.ui.doc.outerHeight())},0),this.ui.placeholders.each(function(r,n){n=e(n),t=n.data("settings").placeholder_id,s=e(".cms-dragarea-"+t),n.height(s.outerHeight(!0)),i=n.width()?0:150,a=e(s).offsetParent().offset(),s.css({top:n.offset().top-a.top-5,left:n.offset().left-a.left-i,width:n.width()+i})})},_drag:function(){var i=this,a=!1,r=null,n=null;this.ui.sortables.nestedSortable({items:".cms-draggable:not(.cms-draggable-disabled .cms-draggable)",handle:".cms-dragitem",placeholder:"cms-droppable",connectWith:this.ui.sortables,tolerance:"pointer",toleranceElement:"> div",dropOnEmpty:!0,helper:"clone",appendTo:".cms-structure-content",cursor:"move",opacity:.4,zIndex:9999999,delay:100,refreshPositions:!0,listType:"div.cms-draggables",doNotClear:!0,disableNestingClass:"cms-draggable-disabled",errorClass:"cms-draggable-disallowed",over:function(){s()},start:function(t,a){i.dragging=!0,s(),e(".cms-submenu").removeClass("cms-btn-active"),e(".cms-submenu-quicksearch, .cms-submenu-dropdown").hide(),e(".cms-dragbar-empty").removeClass("cms-draggable-disallowed"),i.ui.sortables.each(function(){var t=e(this);0===t.children().length&&t.show()}),a.item.addClass("cms-is-dragging"),a.placeholder.css("height",a.helper.css("height")),i.ui.content.css({"overflow-x":"hidden"})},stop:function(t,n){if(i.dragging=!1,n.item.removeClass("cms-is-dragging"),!i.state)return!1;a&&(r.prepend(n.item),a=!1);var o=i.getId(n.item),c=e(".cms-plugin-"+o);c.trigger(c.closest(".cms-clipboard").length?"cms.plugin.update":"cms.plugins.update"),i.ui.sortables.each(function(){var t=e(this);0===t.children().length&&t.hide()}),i.ui.content.css({overflow:""}),s()},isAllowed:function(t,s,a){if(CMS.API.locked)return!1;var r=[],o=e(".cms-plugin-"+i.getId(a));if(0===o.length||null===o.data("settings"))return!1;var c=o.data("settings").plugin_type,d=i.getId(t.closest(".cms-dragarea")),l=e(".cms-placeholder-"+d),u=e(".cms-plugin-"+i.getId(t.closest(".cms-draggable")));return l.length&&(r=l.data("settings").plugin_restriction),u.length&&(r=u.data("settings").plugin_restriction),n&&(r=n.data("settings").plugin_restriction),t.parent().hasClass("cms-draggable-disabled")?!1:(i.state=r.length<=0||-1!==e.inArray(c,r)?!0:!1,i.state)}}),this.ui.doc.on("keyup.cms",function(e,s){(e.keyCode===t.ESC||s)&&(i.state=!1,i.ui.sortables.sortable("cancel"))}),this.ui.dropareas.droppable({greedy:!0,accept:".cms-draggable",tolerance:"pointer",activeClass:"cms-draggable-allowed",hoverClass:"cms-draggable-hover-allowed",over:function(t){n=e(".cms-placeholder-"+i.getId(e(t.target).parent().prev())),e(".cms-dragbar-empty").removeClass("cms-draggable-disallowed"),i.state?e(t.target).removeClass("cms-draggable-disallowed"):e(t.target).addClass("cms-draggable-disallowed")},out:function(t){n=null,e(t.target).removeClass("cms-draggable-disallowed")},drop:function(t){a=!0,r=e(t.target).parent().nextAll(".cms-draggables").first()}})}})})}(CMS.$);
