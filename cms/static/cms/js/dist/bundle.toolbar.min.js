...
var CMS=window.CMS||{};!function(t){"use strict";t(function(){CMS.Toolbar=new CMS.Class({implement:[CMS.API.Helpers],options:{preventSwitch:!1,preventSwitchMessage:"Switching is disabled.",toolbarDuration:200},initialize:function(i){this.options=t.extend(!0,{},this.options,i),this._setupUI(),this.navigation=new CMS.Navigation,this.click="click.cms.toolbar",this.touchStart="touchstart.cms.toolbar",this.pointerUp="pointerup.cms.toolbar",this.pointerOverOut="pointerover.cms.toolbar pointerout.csm.toolbar",this.pointerLeave="pointerleave.csm.toolbar",this.mouseEnter="mouseenter.cms.toolbar",this.mouseLeave="mouseleave.cms.toolbar",this.resize="resize.cms.toolbar",this.timer=function(){},this.lockToolbar=!1,this.ui.toolbar.data("ready")||this._events();var e=this;setTimeout(function(){e._initialStates()},200),this.ui.toolbar.data("ready",!0)},_setupUI:function(){var i=t(".cms");this.ui={container:i,body:t("html"),document:t(document),window:t(window),toolbar:i.find(".cms-toolbar"),toolbarTrigger:i.find(".cms-toolbar-trigger"),navigations:i.find(".cms-toolbar-item-navigation"),buttons:i.find(".cms-toolbar-item-buttons"),switcher:i.find(".cms-toolbar-item-switch"),messages:i.find(".cms-messages"),screenBlock:i.find(".cms-screenblock"),structureBoard:i.find(".cms-structure")}},_events:function(){var i=this;this.ui.toolbarTrigger.on(this.click,function(t){t.preventDefault(),i.toggle(),i.ui.document.trigger(i.click)}),this.ui.navigations.each(function(){function e(){u=!1,o.removeClass(a),o.find("ul ul").hide(),s.find("> li").off(i.mouseEnter),i.ui.document.off(i.click),i.ui.toolbar.off(i.click,e),i.ui.structureBoard.off(i.click)}var s=t(this),o=s.find("li"),n="cms-toolbar-item-navigation",a="cms-toolbar-item-navigation-hover",r="cms-toolbar-item-navigation-disabled",c="cms-toolbar-item-navigation-children",l=!1,u=!1;s.find("a").on(i.click,function(s){return s.preventDefault(),""===t(this).attr("href")||"#"===t(this).attr("href")||t(this).parent().hasClass(r)||t(this).parent().hasClass(r)?void 0:(i._delegate(t(this)),e(),!1)}).on(i.touchStart,function(){l=!0}),o.on(i.click,function(o){o.preventDefault(),o.stopPropagation();var h=t(this);return h.parent().hasClass(n)&&u?(i.ui.body.trigger(i.click),!1):(h.hasClass(c)||e(),h.parent().hasClass(n)&&h.hasClass(a)||h.hasClass(r)?!1:(h.addClass(a),l||s.find("> li").on(i.mouseEnter,function(){return t(this).hasClass(a)?!1:(u=!1,void t(this).trigger(i.click))}),l=!1,i.ui.document.on(i.click,e),i.ui.structureBoard.on(i.click,e),i.ui.toolbar.on(i.click,e),i.ui.window.on("resize",CMS.API.Helpers.throttle(e,1e3)),void(u=!0)))}),o.on(i.pointerOverOut,"li",function(){var i=t(this),e=i.closest(".cms-toolbar-item-navigation-children").add(i.parents(".cms-toolbar-item-navigation-children")),s=i.hasClass(c)||e.length;return i.hasClass(r)?!1:i.hasClass(a)?!0:(o.find("li").removeClass(a),i.addClass(a),s?(i.find("> ul").show(),e.addClass(a)):o.find("ul ul").hide(),void i.siblings().find("> ul").hide())}).on(i.click,function(t){t.preventDefault(),t.stopPropagation()}),o.on(i.pointerLeave,"> ul",function(){o.find("li").removeClass(a)})}),this.ui.switcher.each(function(){t(this).on(i.click,function(e){e.preventDefault(),i._setSwitcher(t(e.currentTarget))})}),this.ui.buttons.each(function(){var e=t(this);e.find("a").attr("data-rel")?e.on(i.click,function(e){e.preventDefault(),i._delegate(t(this).find("a"))}):e.find("a").on(i.click,function(t){t.stopPropagation()}),e.find(".cms-publish-page").on(i.click,function(t){confirm(CMS.config.lang.publish)||t.preventDefault()}),e.find(".cms-btn-publish").on(i.click,function(i){i.preventDefault(),t.ajax({type:"post",url:t(this).prop("href"),data:{csrfmiddlewaretoken:CMS.config.csrf},success:function(){CMS.API.Helpers.reloadBrowser()},error:function(t){throw new Error(t)}})})})},_initialStates:function(){var i=t(".cms-btn-publish").parent();if("expanded"===CMS.settings.toolbar?this.open({duration:0}):this.close(),i.hide(),t(".cms-btn-publish-active").length&&(i.show(),this.ui.window.trigger("resize")),CMS.config.debug&&this._debug(),CMS.config.messages&&CMS.API.Messages.open({message:CMS.config.messages}),CMS.config.error&&CMS.API.Messages.open({message:CMS.config.error,error:!0}),CMS.config.auth&&CMS.config.settings.version===CMS.settings.version||(this.open({duration:0}),CMS.settings=this.setSettings(CMS.config.settings)),CMS.config.publisher&&(CMS.API.Messages.open({message:CMS.config.publisher,dir:"right"}),setInterval(function(){CMS.$(".cms-toolbar-item-switch").toggleClass("cms-toolbar-item-switch-highlight")},CMS.API.Messages.messageDelay)),CMS.settings.sideframe.url){var e=new CMS.Sideframe;e.open({url:CMS.settings.sideframe.url,animate:!1})}this.ui.screenBlock.length&&this._screenBlock(),this.ui.body.addClass("cms-ready"),this.ui.document.trigger("cms-ready")},toggle:function(){"collapsed"===CMS.settings.toolbar?this.open():this.close()},open:function(t){this._show(t),CMS.settings.toolbar="expanded",CMS.settings=this.setSettings(CMS.settings)},_show:function(i){var e=i&&void 0!==i.duration?i.duration:this.options.toolbarDuration,s=t(".cms-debug-bar").height()||0,o=t(".cms-toolbar").height()+10;this.ui.toolbar.css({transition:"margin-top "+e+"ms","margin-top":0}),this.ui.toolbarTrigger.addClass("cms-toolbar-trigger-expanded"),this.ui.body.addClass("cms-toolbar-expanded"),this.ui.body.animate({"margin-top":o-10+s},e,"linear"),this.ui.messages.css("top",o+1)},close:function(){this._hide(),CMS.settings.toolbar="collapsed",CMS.settings=this.setSettings(CMS.settings)},_hide:function(){var i=this.options.toolbarDuration,e=t(".cms-toolbar").height()+10;return this.ui.toolbar.css("transition","margin-top "+i+"ms"),this.lockToolbar?!1:(this.ui.toolbarTrigger.removeClass("cms-toolbar-trigger-expanded"),this.ui.toolbar.css("margin-top",-e),this.ui.body.removeClass("cms-toolbar-expanded"),this.ui.body.animate({"margin-top":CMS.config.debug?5:0},i),void this.ui.messages.css("top",0))},openAjax:function(i){var e=this,s=i.url,o=i.post||"{}",n=i.text||"",a=i.callback,r=i.onSuccess,c=n?confirm(n):!0;return c?(this.showLoader(),t.ajax({type:"POST",url:s,data:o?JSON.parse(o):{}}).done(function(t){CMS.API.locked=!1,a?(a(e,t),e.hideLoader()):r?CMS.API.Helpers.reloadBrowser(r,!1,!0):CMS.API.Helpers.reloadBrowser(!1,!1,!0)}).fail(function(t){CMS.API.locked=!1,CMS.API.Messages.open({message:t.response+" | "+t.status+" "+t.statusText,error:!0})})):!1},showLoader:function(){this.ui.toolbarTrigger.addClass("cms-toolbar-loader")},hideLoader:function(){this.ui.toolbarTrigger.removeClass("cms-toolbar-loader")},_delegate:function(t){var i=t.data("rel");switch(i){case"modal":var e=new CMS.Modal({onClose:t.data("on-close")});e.open({url:t.attr("href"),title:t.data("name")});break;case"message":CMS.API.Messages.open({message:t.data("text")});break;case"cms_frame":var s=window.open(t.attr("href"),JSON.stringify({name:"cms_frame",url:window.location.href}));s.focus();break;case"sideframe":var o=new CMS.Sideframe({onClose:t.data("on-close")});o.open({url:t.attr("href"),animate:!0});break;case"ajax":this.openAjax({url:t.attr("href"),post:JSON.stringify(t.data("post")),text:t.data("text"),onSuccess:t.data("on-success")});break;default:window.location.href=t.attr("href")}},_setSwitcher:function(t){var i=t.hasClass("cms-toolbar-item-switch-active"),e=t.find("a"),s=t.find(".cms-toolbar-item-switch-knob"),o=300;return this.options.preventSwitch?(CMS.API.Messages.open({message:this.options.preventSwitchMessage,dir:"right"}),!1):(i?(s.animate({right:e.outerWidth(!0)-(s.outerWidth(!0)+2)},o),e.css("z-index",1).animate({"padding-top":6,"padding-right":14,"padding-bottom":4,"padding-left":28},o)):(s.animate({left:e.outerWidth(!0)-(s.outerWidth(!0)+2)},o),e.css("z-index",1).animate({"padding-top":6,"padding-right":28,"padding-bottom":4,"padding-left":14},o)),void setTimeout(function(){window.location.href=e.attr("href")},o))},_lock:function(t){t?(this.lockToolbar=!0,this.ui.toolbarTrigger.css("opacity",.2)):(this.lockToolbar=!1,this.ui.toolbarTrigger.css("opacity",1))},_debug:function(){var t=this,i=1e3,e=function(){},s=this.ui.container.find(".cms-debug-bar");s.on(this.mouseEnter+" "+this.mouseLeave,function(s){clearTimeout(e),s.type===t.mouseEnter&&(e=setTimeout(function(){CMS.API.Messages.open({message:CMS.config.lang.debug})},i))})},_screenBlock:function(){var i=this,e=20,s=this.ui.screenBlock,o=t(".cms-sideframe");t(window).on(this.resize,function(){s.css({width:t(this).width()-o.width(),height:t(window).height()})}).trigger("resize"),setInterval(function(){t(window).trigger(i.resize)},e)}})})}(CMS.$);
