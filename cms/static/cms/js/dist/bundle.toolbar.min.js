...
!function(e){"use strict";var s={SHIFT:16};e(document).ready(function(){e(document).on("pointerup.cms",function(){CMS.Plugin.prototype._hideSubnav()}).on("keydown",function(t){t.keyCode===s.SHIFT&&e(this).data("expandmode",!0)}).on("keyup",function(t){t.keyCode===s.SHIFT&&e(this).data("expandmode",!1)}),/*!
         * Plugins
