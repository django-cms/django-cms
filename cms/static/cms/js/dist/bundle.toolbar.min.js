 ...
 */
window.django=window.django||void 0,window.jQuery=window.django&&window.django.jQuery?window.django.jQuery:window.jQuery||void 0,window.Class=window.Class||void 0;var CMS={$:"function"==typeof window.jQuery?window.jQuery:void 0,Class:"function"==typeof window.Class?window.Class:void 0,API:{},KEYS:{SHIFT:16,TAB:9,UP:38,DOWN:40,ENTER:13,SPACE:32,ESC:27,CMD_LEFT:91,CMD_RIGHT:93,CMD_FIREFOX:224,CTRL:17},BREAKPOINTS:{mobile:420}};!function(e){"use strict";e(function(){var o=e("#cms-top"),t=function(e){return e.split(/\s+/g).map(function(e){return"cms-"+e}).join(" ")};CMS.API.Helpers={reloadBrowser:function(o,t,n){var r=this,i=window.parent?window.parent:window;return n?(i.CMS.API.locked=!0,e.ajax({async:!1,type:"GET",url:i.CMS.config.request.url,data:{model:i.CMS.config.request.model,pk:i.CMS.config.request.pk},success:function(e){return i.CMS.API.locked=!1,""!==e||o?void(i.location.pathname!==e&&""!==e?r.reloadBrowser(e):"REFRESH_PAGE"===o?r.reloadBrowser():o&&r.reloadBrowser(o)):!1}}),!1):void i.setTimeout(function(){o&&o!==i.location.href?i.location.href=o:i.location.reload()},t||0)},preventSubmit:function(){var o=e(".cms-toolbar").find("form");o.submit(function(){CMS.API.Toolbar.showLoader(),e('input[type="submit"]').on("click",function(e){e.preventDefault()}).css("opacity",.5)})},csrf:function(o){e.ajaxSetup({beforeSend:function(e){e.setRequestHeader("X-CSRFToken",o)}})},setSettings:function(o){return o=JSON.stringify(e.extend({},CMS.config.settings,o)),CMS.API.Toolbar&&CMS.API.Toolbar.showLoader(),this._isStorageSupported?(localStorage.setItem("cms_cookie",o),CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()):(CMS.API.locked=!0,e.ajax({async:!1,type:"POST",url:CMS.config.urls.settings,data:{csrfmiddlewaretoken:CMS.config.csrf,settings:o},success:function(e){CMS.API.locked=!1,o=e?JSON.parse(e):CMS.config.settings,CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()},error:function(e){CMS.API.Messages.open({message:e.response+" | "+e.status+" "+e.statusText,error:!0})}})),CMS.settings="object"==typeof o?o:JSON.parse(o),CMS.settings},getSettings:function(){var o;return CMS.API.Toolbar&&CMS.API.Toolbar.showLoader(),this._isStorageSupported?(o=JSON.parse(localStorage.getItem("cms_cookie")),CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()):(CMS.API.locked=!0,e.ajax({async:!1,type:"GET",url:CMS.config.urls.settings,success:function(e){CMS.API.locked=!1,o=e?JSON.parse(e):CMS.config.settings,CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()},error:function(e){CMS.API.Messages.open({message:e.response+" | "+e.status+" "+e.statusText,error:!0})}})),o||(o=this.setSettings(CMS.config.settings)),CMS.settings=o,CMS.settings},makeURL:function(o,t){var n=[],r=[],i=[],a="",s=[],u=[],c=o;return o.split("?").length<=1||void 0===window.JSON||(s=o.split("?"),u=s[1].split("&"),c=s[0]),e.each(u,function(e,o){n.push({param:o.split("=")[0],value:o.split("=")[1]})}),t&&t.length&&e.each(t,function(e,o){n.push({param:o.split("=")[0],value:o.split("=")[1]})}),e.each(n,function(o,t){var n=e.inArray(t.param,r);-1===n?(r.push(t.param),i.push(t.value)):i[n]=t.value}),e.each(r,function(e,o){a+="&"+o+"="+i[e]}),a=a.replace("&","?"),o=c+a,o=o.replace("&","&amp;")},debounce:function(e,o,t){var n;return function(){var r=this,i=arguments,a=function(){n=null,t&&t.immediate||e.apply(r,i)},s=t&&t.immediate&&!n;clearTimeout(n),n=setTimeout(a,o),s&&e.apply(r,i)}},throttle:function(o,t,n){var r,i,a,s=null,u=0;n||(n={});var c=function(){u=n.leading===!1?0:e.now(),s=null,a=o.apply(r,i),s||(r=i=null)};return function(){var l=e.now();u||n.leading!==!1||(u=l);var d=t-(l-u);return r=this,i=arguments,0>=d||d>t?(s&&(clearTimeout(s),s=null),u=l,a=o.apply(r,i),s||(r=i=null)):s||n.trailing===!1||(s=setTimeout(c,d)),a}},secureConfirm:function(e){var o=Number(new Date),t=confirm(e),n=Number(new Date);return o+10>n||t===!0},_isStorageSupported:function(){var e="modernizr";try{return localStorage.setItem(e,e),localStorage.removeItem(e),!0}catch(o){return!1}}(),addEventListener:function(e,n){return o.on(t(e),n)},removeEventListener:function(e,n){return o.off(t(e),n)},dispatchEvent:function(e,n){return o.trigger(t(e),[n])}},CMS.API.Helpers.preventSubmit()})}(CMS.$);
/*!========================================================================
