...
!function(e){"use strict";e(function(){var i=e(document);i.on("pointerup.cms",function(){CMS.Plugin._hideSettingsMenu()}).on("keydown.cms",function(e){e.keyCode===CMS.KEYS.SHIFT&&i.data("expandmode",!0)}).on("keyup.cms",function(e){e.keyCode===CMS.KEYS.SHIFT&&i.data("expandmode",!1)}),/*!
         * Plugins
         * for created plugins or generics (static content)
         */
CMS.Plugin=new CMS.Class({implement:[CMS.API.Helpers],options:{type:"",placeholder_id:null,plugin_type:"",plugin_id:null,plugin_language:"",plugin_parent:null,plugin_order:null,plugin_breadcrumb:[],plugin_restriction:[],urls:{add_plugin:"",edit_plugin:"",move_plugin:"",copy_plugin:"",delete_plugin:""}},initialize:function(i,s){switch(this.options=e.extend(!0,{},this.options,s),this._setupUI(i),this.csrf=CMS.config.csrf,this.timer=function(){},this.timeout=250,this.click="pointerup.cms",this.ui.container.data("settings",this.options),this.options.type){case"placeholder":this._setPlaceholder(),this._collapsables();break;case"plugin":this._setPlugin(),this._collapsables();break;default:this._setGeneric()}},_setupUI:function(i){i=e("."+i),this.ui={container:i,publish:e(".cms-btn-publish"),window:e(window),revert:e(".cms-toolbar-revert"),dragbar:null,draggable:null,submenu:null,dropdown:null}},_setPlaceholder:function(){var i=this;this.ui.dragbar=e(".cms-dragbar-"+this.options.placeholder_id),this.ui.submenu=this.ui.dragbar.find(".cms-submenu-settings");var s=this.ui.dragbar.find(".cms-dragbar-title"),t=this.ui.dragbar.find(".cms-dragbar-toggler a"),n="cms-dragbar-title-expanded";this._setSettingsMenu(this.ui.submenu),this._setAddPluginModal(this.ui.dragbar.find(".cms-submenu-add")),CMS.settings.dragbars=CMS.settings.dragbars||[],t.on("click",function(e){e.preventDefault(),s.hasClass(n)?i._collapseAll(s):i._expandAll(s)}),-1!==e.inArray(this.options.placeholder_id,CMS.settings.dragbars)&&s.addClass(n)},_setPlugin:function(){var i=this;this.ui.container.on("dblclick",function(e){e.preventDefault(),e.stopPropagation(),i.editPlugin(i.options.urls.edit_plugin,i.options.plugin_name,i.options.plugin_breadcrumb)}),this.ui.container.on("pointerover.cms pointerout.cms",function(e){e.stopPropagation();var s=i.options.plugin_name,t=i.options.plugin_id;"pointerover"===e.type?i.showTooltip(s,t):i.hideTooltip()}),this.ui.container.on("cms.plugins.update",function(e){e.stopPropagation(),i.movePlugin()}),this.ui.container.on("cms.plugin.update",function(s){s.stopPropagation();var t=e(s.delegateTarget),n=e(".cms-draggable-"+t.data("settings").plugin_id),a=i._getId(n.parents(".cms-draggables").last().prevAll(".cms-dragbar").first());if(!a)return!1;var o=t.data("settings");o.target=a,o.parent=i._getId(n.parent().closest(".cms-draggable")),i.copyPlugin(o)}),this.ui.draggable=e(".cms-draggable-"+this.options.plugin_id),this.ui.dragitem=this.ui.draggable.find("> .cms-dragitem"),this.ui.submenu=this.ui.dragitem.find(".cms-submenu"),this._setSettingsMenu(this.ui.submenu),this._setAddPluginModal(this.ui.dragitem.find(".cms-submenu-add")),this.ui.dragitem.on("dblclick",function(e){e.preventDefault(),e.stopPropagation(),i.editPlugin(i.options.urls.edit_plugin,i.options.plugin_name,i.options.plugin_breadcrumb)})},_setGeneric:function(){var e=this;this.ui.container.on("dblclick",function(i){i.preventDefault(),i.stopPropagation(),e.editPlugin(e.options.urls.edit_plugin,e.options.plugin_name,[])}),this.ui.container.on("pointerover.cms pointerout.cms",function(i){i.stopPropagation();var s=e.options.plugin_name,t=e.options.plugin_id;"pointerover"===i.type?e.showTooltip(s,t):e.hideTooltip()})},addPlugin:function(i,s,t){if(CMS.API.locked)return!1;CMS.API.locked=!0;var n=this,a={placeholder_id:this.options.placeholder_id,plugin_type:i,plugin_parent:t||"",plugin_language:this.options.plugin_language,csrfmiddlewaretoken:this.csrf};e.ajax({type:"POST",url:this.options.urls.add_plugin,data:a,success:function(e){CMS.API.locked=!1,n.newPlugin=e,n.editPlugin(e.url,s,e.breadcrumb)},error:function(e){CMS.API.locked=!1;var i=CMS.config.lang.error;n._showError(i+e.responseText||e.status+" "+e.statusText)}})},editPlugin:function(i,s,t){var n=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});this.newPlugin||n.on("cms.modal.loaded",function(){e(".cms-add-plugin-placeholder").remove()}),n.open({url:i,title:s,breadcrumbs:t})},copyPlugin:function(i,s){if(CMS.API.locked)return!1;CMS.API.locked=!0;var t=this,n=i||s?!0:!1;i=i||this.options,s?(i.target=i.placeholder_id,i.plugin_id="",i.parent=""):s=i.plugin_language;var a={source_placeholder_id:i.placeholder_id,source_plugin_id:i.plugin_id||"",source_language:s,target_plugin_id:i.parent||"",target_placeholder_id:i.target||CMS.config.clipboard.id,target_language:i.page_language||s,csrfmiddlewaretoken:this.csrf},o={type:"POST",url:i.urls.copy_plugin,data:a,success:function(){CMS.API.Toolbar.openMessage(CMS.config.lang.success),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var i=CMS.config.lang.error;t._showError(i+e.responseText||e.status+" "+e.statusText)}};n?e.ajax(o):CMS.API.Clipboard.clear(function(){e.ajax(o)})},cutPlugin:function(){if(CMS.API.locked)return!1;CMS.API.locked=!0;var i=this,s={placeholder_id:CMS.config.clipboard.id,plugin_id:this.options.plugin_id,plugin_parent:"",plugin_language:this.options.page_language,plugin_order:[this.options.plugin_id],csrfmiddlewaretoken:this.csrf};CMS.API.Clipboard.clear(function(){return CMS.API.locked?!1:(CMS.API.locked=!0,void e.ajax({type:"POST",url:i.options.urls.move_plugin,data:s,success:function(){CMS.API.Toolbar.openMessage(CMS.config.lang.success),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var s=CMS.config.lang.error;i._showError(s+e.responseText||e.status+" "+e.statusText)}}))})},movePlugin:function(i){if(CMS.API.locked)return!1;CMS.API.locked=!0;var s=this;i=i||this.options;var t=e(".cms-plugin-"+i.plugin_id),n=e(".cms-draggable-"+i.plugin_id);this._setPosition(i.plugin_id,t,n);var a=this._getId(n.parents(".cms-draggables").last().prevAll(".cms-dragbar").first()),o=this._getId(n.parent().closest(".cms-draggable")),r=this._getIds(n.siblings(".cms-draggable").andSelf());if(a===!1)return!1;var l={placeholder_id:a,plugin_id:i.plugin_id,plugin_parent:o||"",plugin_language:i.page_language,plugin_order:r,csrfmiddlewaretoken:this.csrf};e.ajax({type:"POST",url:i.urls.move_plugin,data:l,success:function(e){e.reload&&CMS.API.Helpers.reloadBrowser(),CMS.API.locked=!1,s._showSuccess(n)},error:function(e){CMS.API.locked=!1;var i=CMS.config.lang.error;s._showError(i+e.responseText||e.status+" "+e.statusText)}}),this.ui.publish.addClass("cms-btn-publish-active").removeClass("cms-btn-disabled").parent().show(),this.ui.revert.removeClass("cms-toolbar-item-navigation-disabled")},deletePlugin:function(i,s,t){var n=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});n.on("cms.modal.loaded",function(){e(".cms-add-plugin-placeholder").remove()}),n.open({url:i,title:s,breadcrumbs:t})},_setPosition:function(i,s,t){var n=t.prev(".cms-draggable"),a=t.next(".cms-draggable"),o=t.parent().closest(".cms-draggable"),r=e(".cms-plugin-"+this._getId(o)),l=t.closest(".cms-dragarea");if(n.length)s.insertAfter(e(".cms-plugin-"+this._getId(n)));else if(a.length)s.insertBefore(e(".cms-plugin-"+this._getId(a)));else if(o.length){for(;r.children().length;)r=r.children();r.append(s)}else l.length?s.insertAfter(e(".cms-placeholder-"+this._getId(l))):CMS.API.Helpers.reloadBrowser()},editPluginPostAjax:function(e,i,s){return"undefined"==typeof i||"undefined"==typeof s?function(i,s){var t=e;t.editPlugin(s.url,t.options.plugin_name,s.breadcrumb)}:void this.editPlugin(s.url,this.options.plugin_name,s.breadcrumb)},_setSettingsMenu:function(i){var s=this;this.ui.dropdown=i.siblings(".cms-submenu-dropdown-settings");var t=this.ui.dropdown;i.on(this.click,function(i){i.preventDefault(),i.stopPropagation();var t=e(this);t.hasClass("cms-btn-active")?CMS.Plugin._hideSettingsMenu(t):(CMS.Plugin._hideSettingsMenu(),s._showSettingsMenu(t))}),t.on("mousedown mousemove mouseup",function(e){e.stopPropagation()}).on("touchstart",function(e){e.stopPropagation()}),s._setupActions(i),i.on(this.click+" pointerup.cms pointerdown.cms click.cms dblclick.cms",function(e){e.stopPropagation()}),i.siblings(".cms-quicksearch, .cms-submenu-dropdown-settings").on(this.click+" click.cms dblclick.cms",function(e){e.stopPropagation()})},_scrollIntoStructureBoardIfNeeded:function(i,s){var t=s&&s.duration||200,n=s&&s.offset||50,a=i.offsetParent(),o=e(window),r=o.height(),l=a.scrollTop(),d=i.position().top,c=i.height(),u=r>=d+c+n;u||a.animate({scrollTop:d+n+c+l-r},t)},_setAddPluginModal:function(i){var s,t=this,n=e('<div class="cms-add-plugin-placeholder">'+CMS.config.lang.addPluginPlaceholder+"</div>"),a=new CMS.Modal({minWidth:400,minHeight:150}),o=i.closest(".cms-dragitem"),r=!Boolean(o.length);s=r?i.closest(".cms-dragarea").find("> .cms-draggables"):i.closest(".cms-draggable").find("> .cms-draggables"),a.on("cms.modal.loaded",t._setupPluginsPickerKeyboardTraversing),a.on("cms.modal.loaded",function(){s.hasClass("cms-hidden")&&!r&&t._toggleCollapsable(o),e(".cms-add-plugin-placeholder").remove(),n.appendTo(s),t._scrollIntoStructureBoardIfNeeded(n)}),a.on("cms.modal.closed",function(){e(".cms-add-plugin-placeholder").remove()}),a.on("cms.modal.shown",function(){var i=e(".cms-modal-markup .cms-plugin-picker");i.find("input").trigger("focus")});var l=i.siblings(".cms-plugin-picker");t._setupQuickSearch(l),i.on(this.click,function(e){e.preventDefault(),e.stopPropagation(),CMS.Plugin._hideSettingsMenu();var s=l.clone(!0,!0).data("parentId",t._getId(i.closest(".cms-draggable")));a.open({title:t.ui.container.data("settings").addPluginHelpTitle,html:s,width:530,height:280})}),i.on(this.click+" pointerup.cms pointerdown.cms click.cms dblclick.cms",function(e){e.stopPropagation()}),i.siblings(".cms-quicksearch, .cms-submenu-dropdown").on(this.click+" click.cms dblclick.cms",function(e){e.stopPropagation()})},_setupQuickSearch:function(i){var s=this;i.find("> .cms-quicksearch").find("input").on("keyup.cms",function(i){clearTimeout(s.timer);var t=e(i.currentTarget);s.timer=setTimeout(function(){s._filterPluginsList(t.closest(".cms-plugin-picker"),t.val())},100)})},_setupActions:function(i){var s=this;i.parent().find("a").on("click.cms",function(t){t.preventDefault(),t.stopPropagation(),CMS.API.Toolbar._loader(!0);var n=e(this);switch(CMS.Plugin._hideSettingsMenu(i),n.attr("data-rel")){case"add":s.addPlugin(n.attr("href").replace("#",""),n.text(),n.closest(".cms-plugin-picker").data("parentId"));break;case"ajax_add":CMS.API.Toolbar.openAjax(n.attr("href"),JSON.stringify(n.data("post")),n.data("text"),s.editPluginPostAjax(s),n.data("on-success"));break;case"edit":s.editPlugin(s.options.urls.edit_plugin,s.options.plugin_name,s.options.plugin_breadcrumb);break;case"copy-lang":s.copyPlugin(this.options,n.attr("data-language"));break;case"copy":s.copyPlugin();break;case"cut":s.cutPlugin();break;case"delete":s.deletePlugin(s.options.urls.delete_plugin,s.options.plugin_name,s.options.plugin_breadcrumb);break;default:CMS.API.Toolbar._loader(!1),CMS.API.Toolbar._delegate(n)}})},_setupPluginsPickerKeyboardTraversing:function(){var s=e(".cms-modal-markup .cms-plugin-picker");s.length&&(i.off("keydown.cms.traverse"),i.on("keydown.cms.traverse",function(e){var i=s.find(".cms-submenu-item:visible a"),t=i.index(i.filter(":focus"));(e.keyCode===CMS.KEYS.DOWN||e.keyCode===CMS.KEYS.TAB)&&(e.preventDefault(),t>=0&&t<i.length-1?i.eq(t+1).focus():i.eq(0).focus()),(e.keyCode===CMS.KEYS.UP||e.keyCode===CMS.KEYS.TAB&&e.shiftKey)&&(e.preventDefault(),i.is(":focus")?i.eq(t-1).focus():i.eq(i.length).focus())}))},_showSettingsMenu:function(e){var i=this.ui.dropdown,s=e.parentsUntil(".cms-dragarea").last();e.addClass("cms-btn-active"),s.addClass("cms-z-index-9999"),i.show(),this.ui.window.height()+this.ui.window.scrollTop()-e.offset().top-i.height()<=10&&e.offset().top-i.height()>=0?i.removeClass("cms-submenu-dropdown-top").addClass("cms-submenu-dropdown-bottom"):i.removeClass("cms-submenu-dropdown-bottom").addClass("cms-submenu-dropdown-top")},_filterPluginsList:function(i,s){var t=i.find(".cms-submenu-item"),n=i.find(".cms-submenu-item-title");return""===s?(t.add(n).show(),!1):(t.find("a, span").each(function(i,t){t=e(t);var n=t.text().toLowerCase(),a=s.toLowerCase();n.indexOf(a)>=0?t.parent().show():t.parent().hide()}),n.filter(":visible").each(function(i,s){n.hide(),e(s).nextUntil(".cms-submenu-item-title").show()}),t.filter(":visible").each(function(i,s){s=e(s),s.prev().hasClass("cms-submenu-item-title")?s.prev().show():s.prevUntil(".cms-submenu-item-title").last().prev().show()}),i.siblings(".cms-submenu-dropdown-children").show(),t.add(n).filter(":visible").length<=0&&i.siblings(".cms-submenu-dropdown-children").hide(),void i.siblings(".cms-submenu-dropdown").find(".cms-submenu-scroll-hint").hide())},_toggleCollapsable:function(s){var t,n=this,a=n._getId(s.parent()),o=this.ui.draggable,r=CMS.settings;if(r.states=r.states||[],s.hasClass("cms-dragitem-expanded")){if(r.states.splice(e.inArray(a,r.states),1),s.removeClass("cms-dragitem-expanded").parent().find("> .cms-draggables").addClass("cms-hidden"),i.data("expandmode")){if(t=o.find(".cms-draggable").find(".cms-dragitem-collapsable"),!t.length)return!1;t.each(function(){var i=e(this);i.hasClass("cms-dragitem-expanded")&&n._toggleCollapsable(i)})}}else if(r.states.push(a),s.addClass("cms-dragitem-expanded").parent().find("> .cms-draggables").removeClass("cms-hidden"),i.data("expandmode")){if(t=o.find(".cms-draggable").find(".cms-dragitem-collapsable"),!t.length)return!1;t.each(function(){var i=e(this);i.hasClass("cms-dragitem-expanded")||n._toggleCollapsable(i)})}this.ui.window.trigger("resize.sideframe"),CMS.API.Toolbar.setSettings(r)},_collapsables:function(){var i=this;this.ui.draggable=e(".cms-draggable-"+this.options.plugin_id);var s=this.ui.draggable.find("> .cms-dragitem");if(this.ui.container.each(function(i,s){var t=e(s).find(".cms-dragitem-collapsable"),n=t.filter(".cms-dragitem-expanded");t.length===n.length&&t.length+n.length!==0&&e(s).find(".cms-dragbar-title").addClass("cms-dragbar-title-expanded")}),!this.ui.draggable.length)return!1;if(s.find("> .cms-dragitem-text").on("click.cms.plugin",function(){s.hasClass("cms-dragitem-collapsable")&&i._toggleCollapsable(s)}),this.ui.draggable.on("dblclick",function(s){s.stopPropagation(),e(".cms-plugin-"+i._getId(e(this))).trigger("dblclick")}),CMS.Toolbar.ready)return!1;for(var t=CMS.settings.states.sort(),n=[],a=0;a<t.length;a++)t[a]!==t[a+1]&&n.push(t[a]);CMS.settings.states=n,e.each(CMS.settings.states,function(i,s){var t=e(".cms-draggable-"+s);t.find(".cms-draggables").length&&(t.find("> .cms-draggables").removeClass("cms-hidden"),t.find("> .cms-dragitem").addClass("cms-dragitem-expanded"))}),CMS.Toolbar.ready=!0},_expandAll:function(i){var s=this,t=i.closest(".cms-dragarea").find(".cms-dragitem-collapsable");if(!t.length)return!1;t.each(function(){var i=e(this);i.hasClass("cms-dragitem-expanded")||s._toggleCollapsable(i)}),i.addClass("cms-dragbar-title-expanded");var n=CMS.settings;n.dragbars=n.dragbars||[],n.dragbars.push(this.options.placeholder_id),CMS.API.Toolbar.setSettings(n)},_collapseAll:function(i){var s=this,t=i.closest(".cms-dragarea").find(".cms-dragitem-collapsable");t.each(function(){var i=e(this);i.hasClass("cms-dragitem-expanded")&&s._toggleCollapsable(i)}),i.removeClass("cms-dragbar-title-expanded");var n=CMS.settings;n.dragbars=n.dragbars||[],n.dragbars.splice(e.inArray(this.options.placeholder_id,n.states),1),CMS.API.Toolbar.setSettings(n)},_getId:function(e){return CMS.API.StructureBoard.getId(e)},_getIds:function(e){return CMS.API.StructureBoard.getIds(e)},_showError:function(e){return CMS.API.Toolbar.showError(e,!0)},_showSuccess:function(i){var s=e('<div class="cms-dragitem-success"></div>');i.addClass("cms-draggable-success").append(s),s.fadeOut(1e3,function(){e(this).remove(),i.removeClass("cms-draggable-success")}),this.ui.window.trigger("resize.sideframe")}}),CMS.Plugin._hideSettingsMenu=function(i){i=i||e(".cms-submenu-btn.cms-btn-active"),i.length&&(i.removeClass("cms-btn-active"),i.closest(".cms-draggable").data("active",!1),e(".cms-z-index-9999").removeClass("cms-z-index-9999"),i.siblings(".cms-submenu-dropdown").hide(),i.siblings(".cms-quicksearch").hide(),i.siblings(".cms-quicksearch").find("input").val("").trigger("keyup.cms").blur(),e(".cms-dragbar").css("position",""))}})}(CMS.$);
