...
var CMS=window.CMS||{};!function(i){"use strict";i(function(){CMS.Tooltip=new CMS.Class({initialize:function(){this.isTouch=!1,this.domElem=this.pick(),this.checkTouch()},checkTouch:function(){var t=this;i("body").one("touchstart.cms",function(){t.isTouch=!0,t.domElem=t.pick()})},displayToggle:function(i,t,o,s){i?CMS.API.Tooltip.show(t,o,s):CMS.API.Tooltip.hide()},show:function(t,o,s){var n=this.domElem,c=this;n.css("visibility","visible").data("plugin_id",s||null).show().find("span").html(o),this.isTouch?(this.position(t,n),n.bind("touchstart.cms",function(){i(".cms-plugin-"+i(this).data("plugin_id")).trigger("dblclick")})):i("body").bind("mousemove.cms",function(i){c.position(i,n)})},hide:function(){var t=this.domElem;t.css("visibility","hidden").hide(),i("body").unbind("mousemove.cms"),this.isTouch&&t.unbind("touchstart.cms")},pick:function(){return i(this.isTouch?".cms-tooltip-touch":".cms-tooltip")},position:function(t,o){var s=20,n=t.pageX-i(o).offsetParent().offset().left,c=t.pageY-i(o).offsetParent().offset().top,h=i(o).offsetParent().width(),e=n+o.outerWidth(!0)+s;o.css({left:e>=h?n-o.outerWidth(!0)-s:n+s,top:c-12})}})})}(CMS.$);