 ...
 */
window.django=window.django||void 0,window.jQuery=window.django&&window.django.jQuery?window.django.jQuery:window.jQuery||void 0,window.Class=window.Class||void 0;var CMS={$:"function"==typeof window.jQuery?window.jQuery:void 0,Class:"function"==typeof window.Class?window.Class:void 0,API:{},KEYS:{SHIFT:16,TAB:9,UP:38,DOWN:40,ENTER:13,SPACE:32,ESC:27,CMD_LEFT:91,CMD_RIGHT:93,CMD_FIREFOX:224,CTRL:17}};!function(e){"use strict";e(function(){CMS.API.Helpers={reloadBrowser:function(o,t,n){var r=this,a=window.parent?window.parent:window;return n?(a.CMS.API.locked=!0,e.ajax({async:!1,type:"GET",url:a.CMS.config.request.url,data:{model:a.CMS.config.request.model,pk:a.CMS.config.request.pk},success:function(e){return a.CMS.API.locked=!1,""!==e||o?void(a.location.pathname!==e&&""!==e?r.reloadBrowser(e):"REFRESH_PAGE"===o?r.reloadBrowser():o&&r.reloadBrowser(o)):!1}}),!1):void a.setTimeout(function(){o&&o!==a.location.href?a.location.href=o:a.location.reload()},t||0)},preventSubmit:function(){var o=e(".cms-toolbar").find("form");o.submit(function(){CMS.API.Toolbar.showLoader(),e('input[type="submit"]').on("click",function(e){e.preventDefault()}).css("opacity",.5)})},csrf:function(o){e.ajaxSetup({beforeSend:function(e){e.setRequestHeader("X-CSRFToken",o)}})},setSettings:function(o){return o=JSON.stringify(e.extend({},CMS.config.settings,o)),CMS.API.Toolbar&&CMS.API.Toolbar.showLoader(),this._isStorageSupported?(localStorage.setItem("cms_cookie",o),CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()):(CMS.API.locked=!0,e.ajax({async:!1,type:"POST",url:CMS.config.urls.settings,data:{csrfmiddlewaretoken:CMS.config.csrf,settings:o},success:function(e){CMS.API.locked=!1,o=e?JSON.parse(e):CMS.config.settings,CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()},error:function(e){CMS.API.Messages.open({message:e.response+" | "+e.status+" "+e.statusText,error:!0})}})),CMS.settings="object"==typeof o?o:JSON.parse(o),CMS.settings},getSettings:function(){var o;return CMS.API.Toolbar&&CMS.API.Toolbar.showLoader(),this._isStorageSupported?(o=JSON.parse(localStorage.getItem("cms_cookie")),CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()):(CMS.API.locked=!0,e.ajax({async:!1,type:"GET",url:CMS.config.urls.settings,success:function(e){CMS.API.locked=!1,o=e?JSON.parse(e):CMS.config.settings,CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()},error:function(e){CMS.API.Messages.open({message:e.response+" | "+e.status+" "+e.statusText,error:!0})}})),o||(o=this.setSettings(CMS.config.settings)),CMS.settings=o,CMS.settings},makeURL:function(o,t){var n=[],r=[],a=[],i="",s=[],u=[],l=o;return o.split("?").length<=1||void 0===window.JSON||(s=o.split("?"),u=s[1].split("&"),l=s[0]),e.each(u,function(e,o){n.push({param:o.split("=")[0],value:o.split("=")[1]})}),t&&t.length&&e.each(t,function(e,o){n.push({param:o.split("=")[0],value:o.split("=")[1]})}),e.each(n,function(o,t){var n=e.inArray(t.param,r);-1===n?(r.push(t.param),a.push(t.value)):a[n]=t.value}),e.each(r,function(e,o){i+="&"+o+"="+a[e]}),i=i.replace("&","?"),o=l+i,o=o.replace("&","&amp;")},debounce:function(e,o,t){var n;return function(){var r=this,a=arguments,i=function(){n=null,t&&t.immediate||e.apply(r,a)},s=t&&t.immediate&&!n;clearTimeout(n),n=setTimeout(i,o),s&&e.apply(r,a)}},throttle:function(o,t,n){var r,a,i,s=null,u=0;n||(n={});var l=function(){u=n.leading===!1?0:e.now(),s=null,i=o.apply(r,a),s||(r=a=null)};return function(){var c=e.now();u||n.leading!==!1||(u=c);var d=t-(c-u);return r=this,a=arguments,0>=d||d>t?(s&&(clearTimeout(s),s=null),u=c,i=o.apply(r,a),s||(r=a=null)):s||n.trailing===!1||(s=setTimeout(l,d)),i}},secureConfirm:function(e){var o=Number(new Date),t=confirm(e),n=Number(new Date);return o+10>n||t===!0},_isStorageSupported:function(){var e="modernizr";try{return localStorage.setItem(e,e),localStorage.removeItem(e),!0}catch(o){return!1}}()},CMS.API.Helpers.preventSubmit()})}(CMS.$);
/*!========================================================================
...
var CMS=window.CMS||{};!function(t){"use strict";t(function(){CMS.Toolbar=new CMS.Class({implement:[CMS.API.Helpers],options:{preventSwitch:!1,preventSwitchMessage:"Switching is disabled.",toolbarDuration:200},initialize:function(e){this.options=t.extend(!0,{},this.options,e),this._setupUI(),this.navigation=new CMS.Navigation,this.click="click.cms.toolbar",this.touchStart="touchstart.cms.toolbar",this.pointerUp="pointerup.cms.toolbar",this.pointerOverOut="pointerover.cms.toolbar pointerout.csm.toolbar",this.pointerLeave="pointerleave.csm.toolbar",this.mouseEnter="mouseenter.cms.toolbar",this.mouseLeave="mouseleave.cms.toolbar",this.resize="resize.cms.toolbar",this.key="keydown.cms.toolbar keyup.cms.toolbar",this.timer=function(){},this.lockToolbar=!1,this.ui.toolbar.data("ready")||this._events();var i=this;setTimeout(function(){i._initialStates()},200),this.ui.toolbar.data("ready",!0)},_setupUI:function(){var e=t(".cms");this.ui={container:e,body:t("html"),document:t(document),window:t(window),toolbar:e.find(".cms-toolbar"),toolbarTrigger:e.find(".cms-toolbar-trigger"),navigations:e.find(".cms-toolbar-item-navigation"),buttons:e.find(".cms-toolbar-item-buttons"),switcher:e.find(".cms-toolbar-item-switch"),messages:e.find(".cms-messages"),screenBlock:e.find(".cms-screenblock"),structureBoard:e.find(".cms-structure")}},_events:function(){var e=this;this.ui.toolbarTrigger.on(this.pointerUp,function(t){t.preventDefault(),e.toggle(),e.ui.document.trigger(e.click)}).on(this.click,function(t){t.preventDefault()}),this.ui.navigations.each(function(){function i(){u=!1,d=!1,o.removeClass(a),o.find("ul ul").hide(),s.find("> li").off(e.mouseEnter),e.ui.document.off(e.click),e.ui.toolbar.off(e.click,i),e.ui.structureBoard.off(e.click)}var s=t(this),o=s.find("li"),n="cms-toolbar-item-navigation",a="cms-toolbar-item-navigation-hover",r="cms-toolbar-item-navigation-disabled",c="cms-toolbar-item-navigation-children",l=!1,u=!1,d=!1;s.find("a").on(e.click+", "+e.key,function(s){var o=t(this);return(s.keyCode===CMS.KEYS.CMD_LEFT||s.keyCode===CMS.KEYS.CMD_RIGHT||s.keyCode===CMS.KEYS.CMD_FIREFOX||s.keyCode===CMS.KEYS.SHIFT||s.keyCode===CMS.KEYS.CTRL)&&(d=!0),"keyup"===s.type&&(d=!1),""===o.attr("href")||"#"===o.attr("href")||o.parent().hasClass(r)?void 0:(d?window.open(o.attr("href"),"_blank"):e._delegate(t(this)),i(),!1)}).on(e.touchStart,function(){l=!0}),o.on(e.click,function(o){o.preventDefault(),o.stopPropagation();var d=t(this);return d.parent().hasClass(n)&&u?(e.ui.body.trigger(e.click),!1):(d.hasClass(c)||i(),d.parent().hasClass(n)&&d.hasClass(a)||d.hasClass(r)?!1:(d.addClass(a),l||s.find("> li").on(e.mouseEnter,function(){return t(this).hasClass(a)?!1:(u=!1,void t(this).trigger(e.click))}),l=!1,e.ui.document.on(e.click,i),e.ui.structureBoard.on(e.click,i),e.ui.toolbar.on(e.click,i),e.ui.window.on("resize",CMS.API.Helpers.throttle(i,1e3)),void(u=!0)))}),o.on(e.pointerOverOut,"li",function(){var e=t(this),i=e.closest(".cms-toolbar-item-navigation-children").add(e.parents(".cms-toolbar-item-navigation-children")),s=e.hasClass(c)||i.length;return e.hasClass(r)?!1:e.hasClass(a)?!0:(o.find("li").removeClass(a),e.addClass(a),s?(e.find("> ul").show(),i.addClass(a)):o.find("ul ul").hide(),void e.siblings().find("> ul").hide())}).on(e.click,function(t){t.preventDefault(),t.stopPropagation()}),o.on(e.pointerLeave,"> ul",function(){o.find("li").removeClass(a)})}),this.ui.switcher.each(function(){t(this).on(e.click,function(i){i.preventDefault(),e._setSwitcher(t(i.currentTarget))})}),this.ui.buttons.each(function(){var i=t(this);i.find("a").attr("data-rel")?i.on(e.click,function(i){i.preventDefault(),e._delegate(t(this).find("a"))}):i.find("a").on(e.click,function(t){t.stopPropagation()}),i.find(".cms-publish-page").on(e.click,function(t){CMS.API.Helpers.secureConfirm(CMS.config.lang.publish)||t.preventDefault()}),i.find(".cms-btn-publish").on(e.click,function(e){e.preventDefault(),t.ajax({type:"post",url:t(this).prop("href"),data:{csrfmiddlewaretoken:CMS.config.csrf},success:function(){var t=CMS.API.Helpers.makeURL(window.location.href.split("?")[0],[CMS.settings.edit_off+"=true"]);CMS.API.Helpers.reloadBrowser(t)},error:function(t){throw new Error(t)}})})})},_initialStates:function(){var e=t(".cms-btn-publish").parent();if("expanded"===CMS.settings.toolbar?this.open({duration:0}):this.close(),e.hide(),t(".cms-btn-publish-active").length&&(e.show(),this.ui.window.trigger("resize")),CMS.config.debug&&this._debug(),CMS.config.messages&&CMS.API.Messages.open({message:CMS.config.messages}),CMS.config.error&&CMS.API.Messages.open({message:CMS.config.error,error:!0}),CMS.config.auth&&CMS.config.settings.version===CMS.settings.version||(this.open({duration:0}),CMS.settings=this.setSettings(CMS.config.settings)),CMS.config.publisher&&(CMS.API.Messages.open({message:CMS.config.publisher,dir:"right"}),setInterval(function(){CMS.$(".cms-toolbar-item-switch").toggleClass("cms-toolbar-item-switch-highlight")},CMS.API.Messages.messageDelay)),CMS.settings.sideframe.url){var i=new CMS.Sideframe;i.open({url:CMS.settings.sideframe.url,animate:!1})}this.ui.screenBlock.length&&this._screenBlock(),this.ui.body.addClass("cms-ready"),this.ui.document.trigger("cms-ready")},toggle:function(){"collapsed"===CMS.settings.toolbar?this.open():this.close()},open:function(t){this._show(t),CMS.settings.toolbar="expanded",CMS.settings=this.setSettings(CMS.settings)},_show:function(e){var i=e&&void 0!==e.duration?e.duration:this.options.toolbarDuration,s=t(".cms-debug-bar").height()||0,o=t(".cms-toolbar").height()+10;this.ui.toolbar.css({transition:"margin-top "+i+"ms","margin-top":0}),this.ui.toolbarTrigger.addClass("cms-toolbar-trigger-expanded"),this.ui.body.addClass("cms-toolbar-expanded"),this.ui.body.animate({"margin-top":o-10+s},i,"linear"),this.ui.messages.css("top",o+1)},close:function(){this._hide(),CMS.settings.toolbar="collapsed",CMS.settings=this.setSettings(CMS.settings)},_hide:function(){var e=this.options.toolbarDuration,i=t(".cms-toolbar").height()+10;return this.ui.toolbar.css("transition","margin-top "+e+"ms"),this.lockToolbar?!1:(this.ui.toolbarTrigger.removeClass("cms-toolbar-trigger-expanded"),this.ui.toolbar.css("margin-top",-i),this.ui.body.removeClass("cms-toolbar-expanded"),this.ui.body.animate({"margin-top":CMS.config.debug?5:0},e),void this.ui.messages.css("top",0))},openAjax:function(e){var i=this,s=e.url,o=e.post||"{}",n=e.text||"",a=e.callback,r=e.onSuccess,c=n?CMS.API.Helpers.secureConfirm(n):!0;return c?(this.showLoader(),t.ajax({type:"POST",url:s,data:o?JSON.parse(o):{}}).done(function(t){CMS.API.locked=!1,a?(a(i,t),i.hideLoader()):r?CMS.API.Helpers.reloadBrowser(r,!1,!0):CMS.API.Helpers.reloadBrowser(!1,!1,!0)}).fail(function(t){CMS.API.locked=!1,CMS.API.Messages.open({message:t.response+" | "+t.status+" "+t.statusText,error:!0})})):!1},showLoader:function(){this.ui.toolbarTrigger.addClass("cms-toolbar-loader")},hideLoader:function(){this.ui.toolbarTrigger.removeClass("cms-toolbar-loader")},_delegate:function(t){var e=t.data("rel");if(t.hasClass("cms-btn-disabled"))return!1;switch(e){case"modal":var i=new CMS.Modal({onClose:t.data("on-close")});i.open({url:t.attr("href"),title:t.data("name")});break;case"message":CMS.API.Messages.open({message:t.data("text")});break;case"sideframe":var s=new CMS.Sideframe({onClose:t.data("on-close")});s.open({url:t.attr("href"),animate:!0});break;case"ajax":this.openAjax({url:t.attr("href"),post:JSON.stringify(t.data("post")),text:t.data("text"),onSuccess:t.data("on-success")});break;default:window.location.href=t.attr("href")}},_setSwitcher:function(t){var e=t.hasClass("cms-toolbar-item-switch-active"),i=t.find("a"),s=t.find(".cms-toolbar-item-switch-knob"),o=300;return this.options.preventSwitch?(CMS.API.Messages.open({message:this.options.preventSwitchMessage,dir:"right"}),!1):(e?(s.animate({right:i.outerWidth(!0)-(s.outerWidth(!0)+2)},o),i.css("z-index",1).animate({"padding-top":6,"padding-right":14,"padding-bottom":4,"padding-left":28},o)):(s.animate({left:i.outerWidth(!0)-(s.outerWidth(!0)+2)},o),i.css("z-index",1).animate({"padding-top":6,"padding-right":28,"padding-bottom":4,"padding-left":14},o)),void setTimeout(function(){window.location.href=i.attr("href")},o))},_lock:function(t){t?(this.lockToolbar=!0,this.ui.toolbarTrigger.css("opacity",.2)):(this.lockToolbar=!1,this.ui.toolbarTrigger.css("opacity",1))},_debug:function(){var t=this,e=1e3,i=function(){},s=this.ui.container.find(".cms-debug-bar");s.on(this.mouseEnter+" "+this.mouseLeave,function(s){clearTimeout(i),s.type===t.mouseEnter&&(i=setTimeout(function(){CMS.API.Messages.open({message:CMS.config.lang.debug})},e))})},_screenBlock:function(){var e=this,i=20,s=this.ui.screenBlock,o=t(".cms-sideframe");t(window).on(this.resize,function(){s.css({width:t(this).width()-o.width(),height:t(window).height()})}).trigger("resize"),setInterval(function(){t(window).trigger(e.resize)},i)}})})}(CMS.$);
var CMS=window.CMS||{};!function(i){"use strict";i(function(){CMS.Tooltip=new CMS.Class({initialize:function(){this.body=i("body"),this.isTouch=!1,this.domElem=this._pick(),this._checkTouch()},_checkTouch:function(){var t=this;this.body.one("touchstart.cms",function(){t.isTouch=!0,t.domElem=t._pick(),t.domElem.on("touchstart.cms",function(){i(".cms-plugin-"+i(this).data("plugin_id")).trigger("dblclick.cms")})})},displayToggle:function(i,t,o,s){i?this.show(t,o,s):this.hide()},show:function(i,t,o){var s=this.domElem,n=this;s.css("visibility","visible").data("plugin_id",o||null).show().find("span").html(t),this.isTouch?this.position(i.originalEvent,s):(n.position(i.originalEvent,s),this.body.on("mousemove.cms",function(i){n.position(i,s)}))},hide:function(){this.domElem.css("visibility","hidden").hide(),this.isTouch||this.body.off("mousemove.cms")},_pick:function(){return i(".cms-tooltip-touch, .cms-tooltip").css("visibility","hidden").hide(),i(this.isTouch?".cms-tooltip-touch":".cms-tooltip")},position:function(t,o){var s=20,n=t.pageX-i(o).offsetParent().offset().left,c=t.pageY-i(o).offsetParent().offset().top,h=i(o).offsetParent().width(),e=n+o.outerWidth(!0)+s;o.css({left:e>=h?n-o.outerWidth(!0)-s:n+s,top:c-12})}})})}(CMS.$);