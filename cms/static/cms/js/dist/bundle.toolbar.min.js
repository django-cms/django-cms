...
var CMS=window.CMS||{};!function(e){"use strict";e(function(){CMS.CMSFrame=new CMS.Class({implement:[CMS.API.Helpers],options:{frameName:"cms_frame"},initialize:function(n){this.options=e.extend(!0,{},this.options,n)},open:function(e){var n;if(!e||!e.url)throw new Error("The CMSFrame.open method requires a url.");n=e&&e.frameName?e.frameName:this.options.frameName;var r=e.url,i=window.open(r,n);return i.focus(),this}})})}(CMS.$);
