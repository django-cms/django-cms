...
!function(e){"use strict";var i={SHIFT:16,TAB:9,UP:38,DOWN:40,ENTER:13,ESC:27};e(function(){var s=e(document);s.on("pointerup.cms",function(){CMS.Plugin._hideSubnav()}).on("keydown.cms",function(e){e.keyCode===i.SHIFT&&s.data("expandmode",!0)}).on("keyup.cms",function(e){e.keyCode===i.SHIFT&&s.data("expandmode",!1)}),/*!
         * Plugins
         * for created plugins or generics (static content)
         */
CMS.Plugin=new CMS.Class({implement:[CMS.API.Helpers],options:{type:"",placeholder_id:null,plugin_type:"",plugin_id:null,plugin_language:"",plugin_parent:null,plugin_order:null,plugin_breadcrumb:[],plugin_restriction:[],urls:{add_plugin:"",edit_plugin:"",move_plugin:"",copy_plugin:"",delete_plugin:""}},initialize:function(i,s){switch(this.options=e.extend(!0,{},this.options,s),this._setupUI(i),this.csrf=CMS.config.csrf,this.timer=function(){},this.timeout=250,this.click="pointerup.cms",this.ui.container.data("settings",this.options),this.options.type){case"placeholder":this._setPlaceholder(),this._collapsables();break;case"plugin":this._setPlugin(),this._collapsables();break;default:this._setGeneric()}},_setupUI:function(i){i=e("."+i),this.ui={container:i,publish:e(".cms-btn-publish"),window:e(window),revert:e(".cms-toolbar-revert"),dragbar:null,draggable:null,submenu:null,dropdown:null}},_setPlaceholder:function(){var i=this;this.ui.dragbar=e(".cms-dragbar-"+this.options.placeholder_id),this.ui.submenu=this.ui.dragbar.find(".cms-submenu");var s=this.ui.dragbar.find(".cms-dragbar-title"),t=this.ui.dragbar.find(".cms-dragbar-toggler a"),n="cms-dragbar-title-expanded";this._setSubnav(this.ui.submenu),CMS.settings.dragbars=CMS.settings.dragbars||[],t.on("click",function(e){e.preventDefault(),s.hasClass(n)?i._collapseAll(s):i._expandAll(s)}),-1!==e.inArray(this.options.placeholder_id,CMS.settings.dragbars)&&s.addClass(n)},_setPlugin:function(){var i=this;this.ui.container.on("dblclick",function(e){e.preventDefault(),e.stopPropagation(),i.editPlugin(i.options.urls.edit_plugin,i.options.plugin_name,i.options.plugin_breadcrumb)}),this.ui.container.on("pointerover.cms pointerout.cms",function(e){e.stopPropagation();var s=i.options.plugin_name,t=i.options.plugin_id;"pointerover"===e.type?i.showTooltip(s,t):i.hideTooltip()}),this.ui.container.on("cms.plugins.update",function(e){e.stopPropagation(),i.movePlugin()}),this.ui.container.on("cms.plugin.update",function(s){s.stopPropagation();var t=e(s.delegateTarget),n=e(".cms-draggable-"+t.data("settings").plugin_id),a=i._getId(n.parents(".cms-draggables").last().prevAll(".cms-dragbar").first());if(!a)return!1;var o=t.data("settings");o.target=a,o.parent=i._getId(n.parent().closest(".cms-draggable")),i.copyPlugin(o)}),this.ui.draggable=e(".cms-draggable-"+this.options.plugin_id),this.ui.dragitem=this.ui.draggable.find("> .cms-dragitem"),this.ui.submenu=this.ui.dragitem.find(".cms-submenu"),this._setSubnav(this.ui.submenu),this.ui.dragitem.on("dblclick",function(e){e.preventDefault(),e.stopPropagation(),i.editPlugin(i.options.urls.edit_plugin,i.options.plugin_name,i.options.plugin_breadcrumb)})},_setGeneric:function(){var e=this;this.ui.container.on("dblclick",function(i){i.preventDefault(),i.stopPropagation(),e.editPlugin(e.options.urls.edit_plugin,e.options.plugin_name,[])}),this.ui.container.on("pointerover.cms pointerout.cms",function(i){i.stopPropagation();var s=e.options.plugin_name,t=e.options.plugin_id;"pointerover"===i.type?e.showTooltip(s,t):e.hideTooltip()})},addPlugin:function(i,s,t){if(CMS.API.locked)return!1;CMS.API.locked=!0;var n=this,a={placeholder_id:this.options.placeholder_id,plugin_type:i,plugin_parent:t||"",plugin_language:this.options.plugin_language,csrfmiddlewaretoken:this.csrf};e.ajax({type:"POST",url:this.options.urls.add_plugin,data:a,success:function(e){CMS.API.locked=!1,n.newPlugin=e,n.editPlugin(e.url,s,e.breadcrumb)},error:function(e){CMS.API.locked=!1;var i=CMS.config.lang.error;n._showError(i+e.responseText||e.status+" "+e.statusText)}})},editPlugin:function(e,i,s){var t=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});t.open(e,i,s)},copyPlugin:function(i,s){if(CMS.API.locked)return!1;CMS.API.locked=!0;var t=this,n=i||s?!0:!1;i=i||this.options,s?(i.target=i.placeholder_id,i.plugin_id="",i.parent=""):s=i.plugin_language;var a={source_placeholder_id:i.placeholder_id,source_plugin_id:i.plugin_id||"",source_language:s,target_plugin_id:i.parent||"",target_placeholder_id:i.target||CMS.config.clipboard.id,target_language:i.page_language||s,csrfmiddlewaretoken:this.csrf},o={type:"POST",url:i.urls.copy_plugin,data:a,success:function(){CMS.API.Toolbar.openMessage(CMS.config.lang.success),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var i=CMS.config.lang.error;t._showError(i+e.responseText||e.status+" "+e.statusText)}};n?e.ajax(o):CMS.API.Clipboard.clear(function(){e.ajax(o)})},cutPlugin:function(){if(CMS.API.locked)return!1;CMS.API.locked=!0;var i=this,s={placeholder_id:CMS.config.clipboard.id,plugin_id:this.options.plugin_id,plugin_parent:"",plugin_language:this.options.page_language,plugin_order:[this.options.plugin_id],csrfmiddlewaretoken:this.csrf};CMS.API.Clipboard.clear(function(){return CMS.API.locked?!1:(CMS.API.locked=!0,void e.ajax({type:"POST",url:i.options.urls.move_plugin,data:s,success:function(){CMS.API.Toolbar.openMessage(CMS.config.lang.success),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var s=CMS.config.lang.error;i._showError(s+e.responseText||e.status+" "+e.statusText)}}))})},movePlugin:function(i){if(CMS.API.locked)return!1;CMS.API.locked=!0;var s=this;i=i||this.options;var t=e(".cms-plugin-"+i.plugin_id),n=e(".cms-draggable-"+i.plugin_id);this._setPosition(i.plugin_id,t,n);var a=this._getId(n.parents(".cms-draggables").last().prevAll(".cms-dragbar").first()),o=this._getId(n.parent().closest(".cms-draggable")),r=this._getIds(n.siblings(".cms-draggable").andSelf());if(a===!1)return!1;var l={placeholder_id:a,plugin_id:i.plugin_id,plugin_parent:o||"",plugin_language:i.page_language,plugin_order:r,csrfmiddlewaretoken:this.csrf};e.ajax({type:"POST",url:i.urls.move_plugin,data:l,success:function(e){e.reload&&CMS.API.Helpers.reloadBrowser(),CMS.API.locked=!1,s._showSuccess(n)},error:function(e){CMS.API.locked=!1;var i=CMS.config.lang.error;s._showError(i+e.responseText||e.status+" "+e.statusText)}}),this.ui.publish.addClass("cms-btn-publish-active").removeClass("cms-btn-disabled").parent().show(),this.ui.revert.removeClass("cms-toolbar-item-navigation-disabled")},deletePlugin:function(e,i,s){var t=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});t.open(e,i,s)},_setPosition:function(i,s,t){var n=t.prev(".cms-draggable"),a=t.next(".cms-draggable"),o=t.parent().closest(".cms-draggable"),r=e(".cms-plugin-"+this._getId(o)),l=t.closest(".cms-dragarea");if(n.length)s.insertAfter(e(".cms-plugin-"+this._getId(n)));else if(a.length)s.insertBefore(e(".cms-plugin-"+this._getId(a)));else if(o.length){for(;r.children().length;)r=r.children();r.append(s)}else l.length?s.insertAfter(e(".cms-placeholder-"+this._getId(l))):CMS.API.Helpers.reloadBrowser()},editPluginPostAjax:function(e,i,s){return"undefined"==typeof i||"undefined"==typeof s?function(i,s){var t=e;t.editPlugin(s.url,t.options.plugin_name,s.breadcrumb)}:void this.editPlugin(s.url,this.options.plugin_name,s.breadcrumb)},_setSubnav:function(i){var s=this;this.ui.dropdown=i.siblings(".cms-submenu-dropdown");var t=this.ui.dropdown;t.data("top",t.css("top")),i.on(this.click,function(i){i.preventDefault(),i.stopPropagation();var t=e(this);t.hasClass("cms-btn-active")?CMS.Plugin._hideSubnav(t):(CMS.Plugin._hideSubnav(),s._showSubnav(t))}),t.on("mousedown mousemove mouseup",function(e){e.stopPropagation()}).on("touchstart",function(e){e.stopPropagation()}),t.find("a").on("click.cms",function(t){t.preventDefault(),t.stopPropagation(),CMS.API.Toolbar._loader(!0);var n=e(this);switch(CMS.Plugin._hideSubnav(i),n.attr("data-rel")){case"add":s.addPlugin(n.attr("href").replace("#",""),n.text(),s._getId(n.closest(".cms-draggable")));break;case"ajax_add":CMS.API.Toolbar.openAjax(n.attr("href"),JSON.stringify(n.data("post")),n.data("text"),s.editPluginPostAjax(s),n.data("on-success"));break;case"edit":s.editPlugin(s.options.urls.edit_plugin,s.options.plugin_name,s.options.plugin_breadcrumb);break;case"copy-lang":s.copyPlugin(this.options,n.attr("data-language"));break;case"copy":s.copyPlugin();break;case"cut":s.cutPlugin();break;case"delete":s.deletePlugin(s.options.urls.delete_plugin,s.options.plugin_name,s.options.plugin_breadcrumb);break;default:CMS.API.Toolbar._loader(!1),CMS.API.Toolbar._delegate(n)}}),i.siblings(".cms-submenu-quicksearch").find("input").on("keyup.cms",function(t){clearTimeout(s.timer),s.timer=setTimeout(function(){s._searchSubnav(i,e(t.currentTarget).val())},100)}),i.on(this.click+" dblclick",function(e){e.stopPropagation()}),i.siblings(".cms-submenu-quicksearch, .cms-submenu-dropdown").on(this.click,function(e){e.stopPropagation()})},_showSubnav:function(t){var n=this.ui.dropdown,a=parseInt(n.data("top"),10);t.addClass("cms-btn-active");var o=e(".cms-submenu").parentsUntil(".cms-dragarea"),r=n.find(".cms-submenu-scroll-hint");o.css("z-index",0);var l=t.parentsUntil(".cms-dragarea");l.css("z-index",999),t.siblings(".cms-submenu-quicksearch").show().find("input"),n.show().on("scroll.cms",function(){r.fadeOut(100),n.off("scroll.cms")}),n[0].scrollHeight>n.height()&&r.show(),s.off("keydown.cms.traverse"),s.on("keydown.cms.traverse",function(e){var s=n.find(".cms-submenu-item:visible a"),a=s.index(s.filter(":focus"));(e.keyCode===i.DOWN||e.keyCode===i.TAB)&&(e.preventDefault(),a>=0&&a<s.length-1?s.eq(a+1).focus():s.eq(0).focus()),(e.keyCode===i.UP||e.keyCode===i.TAB&&e.shiftKey)&&(e.preventDefault(),s.is(":focus")?s.eq(a-1).focus():s.eq(s.length).focus()),(e.keyCode===i.ENTER||e.keyCode===i.ESC)&&(t.siblings(".cms-submenu-quicksearch").find("input").blur(),CMS.Plugin._hideSubnav(t))}),n.css(this.ui.window.height()+this.ui.window.scrollTop()-t.offset().top-n.height()<=10&&t.offset().top-n.height()>=0?{top:"auto",bottom:a}:{top:a,bottom:"auto"})},_searchSubnav:function(i,s){var t=i.siblings(".cms-submenu-dropdown").find(".cms-submenu-item"),n=i.siblings(".cms-submenu-dropdown").find(".cms-submenu-item-title");return""===s?(t.add(n).show(),!1):(t.find("a, span").each(function(i,t){t=e(t);var n=t.text().toLowerCase(),a=s.toLowerCase();n.indexOf(a)>=0?t.parent().show():t.parent().hide()}),n.filter(":visible").each(function(i,s){n.hide(),e(s).nextUntil(".cms-submenu-item-title").show()}),t.filter(":visible").each(function(i,s){s=e(s),s.prev().hasClass("cms-submenu-item-title")?s.prev().show():s.prevUntil(".cms-submenu-item-title").last().prev().show()}),i.siblings(".cms-submenu-dropdown").show(),t.add(n).filter(":visible").length<=0&&i.siblings(".cms-submenu-dropdown").hide(),void i.siblings(".cms-submenu-dropdown").find(".cms-submenu-scroll-hint").hide())},_toggleCollapsable:function(i){var t,n=this,a=n._getId(i.parent()),o=this.ui.draggable,r=CMS.settings;if(r.states=r.states||[],i.hasClass("cms-dragitem-expanded")){if(r.states.splice(e.inArray(a,r.states),1),i.removeClass("cms-dragitem-expanded").parent().find("> .cms-draggables").hide(),s.data("expandmode")){if(t=o.find(".cms-draggable").find(".cms-dragitem-collapsable"),!t.length)return!1;t.each(function(){var i=e(this);i.hasClass("cms-dragitem-expanded")&&n._toggleCollapsable(i)})}}else if(r.states.push(a),i.addClass("cms-dragitem-expanded").parent().find("> .cms-draggables").show(),s.data("expandmode")){if(t=o.find(".cms-draggable").find(".cms-dragitem-collapsable"),!t.length)return!1;t.each(function(){var i=e(this);i.hasClass("cms-dragitem-expanded")||n._toggleCollapsable(i)})}this.ui.window.trigger("resize.sideframe"),CMS.API.Toolbar.setSettings(r)},_collapsables:function(){var i=this;if(this.ui.draggable=e(".cms-draggable-"+this.options.plugin_id),this.ui.container.each(function(i,s){var t=e(s).find(".cms-dragitem-collapsable"),n=t.filter(".cms-dragitem-expanded");t.length===n.length&&t.length+n.length!==0&&e(s).find(".cms-dragbar-title").addClass("cms-dragbar-title-expanded")}),!this.ui.draggable.length)return!1;if(this.ui.draggable.find("> .cms-dragitem-collapsable").on(this.click,function(){var s=e(this);i._toggleCollapsable(s)}),this.ui.draggable.on("dblclick",function(s){s.stopPropagation(),e(".cms-plugin-"+i._getId(e(this))).trigger("dblclick")}),CMS.Toolbar.ready)return!1;for(var s=CMS.settings.states.sort(),t=[],n=0;n<s.length;n++)s[n]!==s[n+1]&&t.push(s[n]);CMS.settings.states=t,e.each(CMS.settings.states,function(i,s){var t=e(".cms-draggable-"+s);t.find(".cms-draggables").length&&(t.find("> .cms-draggables").show(),t.find("> .cms-dragitem").addClass("cms-dragitem-expanded"))}),CMS.Toolbar.ready=!0},_expandAll:function(i){var s=this,t=i.closest(".cms-dragarea").find(".cms-dragitem-collapsable");if(!t.length)return!1;t.each(function(){var i=e(this);i.hasClass("cms-dragitem-expanded")||s._toggleCollapsable(i)}),i.addClass("cms-dragbar-title-expanded");var n=CMS.settings;n.dragbars=n.dragbars||[],n.dragbars.push(this.options.placeholder_id),CMS.API.Toolbar.setSettings(n)},_collapseAll:function(i){var s=this,t=i.closest(".cms-dragarea").find(".cms-dragitem-collapsable");t.each(function(){var i=e(this);i.hasClass("cms-dragitem-expanded")&&s._toggleCollapsable(i)}),i.removeClass("cms-dragbar-title-expanded");var n=CMS.settings;n.dragbars=n.dragbars||[],n.dragbars.splice(e.inArray(this.options.placeholder_id,n.states),1),CMS.API.Toolbar.setSettings(n)},_getId:function(e){return CMS.API.StructureBoard.getId(e)},_getIds:function(e){return CMS.API.StructureBoard.getIds(e)},_showError:function(e){return CMS.API.Toolbar.showError(e,!0)},_showSuccess:function(i){var s=e('<div class="cms-dragitem-success"></div>');i.append(s),s.fadeOut(function(){e(this).remove()}),this.ui.window.trigger("resize.sideframe")}}),CMS.Plugin._hideSubnav=function(i){i=i||e(".cms-submenu.cms-btn-active"),i.length&&(i.removeClass("cms-btn-active"),i.closest(".cms-draggable").data("active",!1),i.siblings(".cms-submenu-dropdown").hide(),i.siblings(".cms-submenu-quicksearch").hide(),i.siblings(".cms-submenu-quicksearch").find("input").val("").blur(),e(".cms-dragbar").css("position",""))}})}(CMS.$);
!function(e){"use strict";var t={SPACE:32,SHIFT:16,ESC:27};e(function(){function s(){i.each(function(){var t=e(this);t.find("> .cms-draggables").children().not(".cms-is-dragging").length?t.removeClass("cms-dragarea-empty"):t.addClass("cms-dragarea-empty")})}var i=e(".cms-dragarea:not(.cms-clipboard-containers)");/*!
         * StructureBoard
         * handles drag & drop, mode switching and
         */
CMS.StructureBoard=new CMS.Class({implement:[CMS.API.Helpers],options:{speed:300},initialize:function(t){this.options=e.extend(!0,{},this.options,t),this.config=CMS.config,this.settings=CMS.settings,this._setupUI(),this.click="click.cms",this.state=!1,this.dragging=!1,this._setup(),this._events(),s()},_setupUI:function(){var t=e(".cms-structure"),s=e("#cms-toolbar");this.ui={container:t,content:e(".cms-structure-content"),doc:e(document),window:e(window),toolbar:s,sortables:e(".cms-draggables"),plugins:e(".cms-plugin"),render_model:e(".cms-render-model"),placeholders:e(".cms-placeholder"),dragitems:e(".cms-draggable"),dragareas:e(".cms-dragarea"),dropareas:e(".cms-droppable"),dimmer:t.find(".cms-structure-dimmer"),clipboard:e(".cms-clipboard"),toolbarModeSwitcher:s.find(".cms-toolbar-item-cms-mode-switcher"),toolbarModeLinks:s.find(".cms-toolbar-item-cms-mode-switcher a")}},_setup:function(){var e=this;return this.ui.dragareas.length&&this.ui.toolbarModeSwitcher.length?(setTimeout(function(){"structure"===e.settings.mode?e.show(!0):e.hide(!0)},0),this.ui.placeholders.length&&this.ui.toolbarModeSwitcher.show(),void this._drag()):!1},_events:function(){var e=this,s=e.ui.toolbarModeLinks;s.eq(1).on(e.click,function(t){return t.preventDefault(),"edit"===e.settings.mode?!1:void e.hide()}),s.eq(0).on(e.click,function(t){return t.preventDefault(),"structure"===e.settings.mode?!1:void e.show()}),e.ui.toolbarModeSwitcher.length&&e.ui.doc.on("keydown",function(s){var i=document.activeElement!==document.body;s.keyCode!==t.SPACE||i||(s.preventDefault(),"structure"===e.settings.mode?e.hide():"edit"===e.settings.mode&&e.show())})},show:function(e){if("live"===CMS.config.mode)return!1;var t=this.ui.toolbarModeLinks;t.removeClass("cms-btn-active").eq(0).addClass("cms-btn-active"),this.ui.clipboard.fadeIn(this.options.speed),this.settings.mode="structure",e||(this.settings=this.setSettings(this.settings)),this.ui.dragareas.show(),this._showBoard()},hide:function(e){if("live"===CMS.config.mode)return!1;var t=this.ui.toolbarModeLinks;t.removeClass("cms-btn-active").eq(1).addClass("cms-btn-active"),this.ui.container.find(".cms-clipboard").hide(),this.ui.clipboard.hide(),this.settings.mode="edit",e||(this.settings=this.setSettings(this.settings)),this._hideBoard()},getId:function(e){if(void 0===e||null===e||e.length<=0)return!1;var t=null,s=e.attr("class").split(" ")[1];return e.hasClass("cms-plugin")?t=s.replace("cms-plugin-",""):e.hasClass("cms-draggable")?t=s.replace("cms-draggable-",""):e.hasClass("cms-placeholder")?t=s.replace("cms-placeholder-",""):e.hasClass("cms-dragbar")?t=s.replace("cms-dragbar-",""):e.hasClass("cms-dragarea")&&(t=s.replace("cms-dragarea-","")),t},getIds:function(t){var s=this,i=[];return t.each(function(){i.push(s.getId(e(this)))}),i},_showBoard:function(){var t=this;if(this.ui.container.show(),this.ui.dimmer.show(),this.ui.dragareas.css("opacity",1),this.ui.plugins.not(this.ui.render_model).hide(),this.ui.placeholders.show(),CMS.config.simpleStructureBoard){var s=this.ui.content,i=s.find(".cms-dragarea");s.addClass("cms-structure-content-simple"),i.addClass("cms-dragarea-simple"),i.each(function(t,i){e(i).hasClass("cms-dragarea-static")&&s.append(i)}),i.filter(".cms-dragarea-static").eq(0).css("margin-top","50px")}else this.ui.container.addClass("cms-structure-dynamic"),this.ui.window.on("resize.sideframe",function(){t._resizeBoard()}).trigger("resize.sideframe")},_hideBoard:function(){this.ui.container.hide(),this.ui.plugins.show(),this.ui.placeholders.hide(),this.ui.dimmer.hide(),this.ui.window.off("resize.sideframe"),this.ui.window.trigger("structureboard_hidden.sideframe"),CMS.config.simpleStructureBoard||this.ui.container.height(this.ui.doc.outerHeight())},_resizeBoard:function(){var t=null,s=null,i=null,a=null,r=this;setTimeout(function(){r.ui.container.height(r.ui.doc.outerHeight())},0),this.ui.placeholders.each(function(r,n){n=e(n),t=n.data("settings").placeholder_id,s=e(".cms-dragarea-"+t),n.height(s.outerHeight(!0)),i=n.width()?0:150,a=e(s).offsetParent().offset(),s.css({top:n.offset().top-a.top-5,left:n.offset().left-a.left-i,width:n.width()+i})})},_drag:function(){var i=this,a=!1,r=null,n=null;this.ui.sortables.nestedSortable({items:".cms-draggable:not(.cms-draggable-disabled .cms-draggable)",handle:".cms-dragitem",placeholder:"cms-droppable",connectWith:this.ui.sortables,tolerance:"pointer",toleranceElement:"> div",dropOnEmpty:!0,helper:"clone",appendTo:".cms-structure-content",cursor:"move",opacity:.4,zIndex:9999999,delay:100,refreshPositions:!0,listType:"div.cms-draggables",doNotClear:!0,disableNestingClass:"cms-draggable-disabled",errorClass:"cms-draggable-disallowed",over:function(){s()},start:function(t,a){i.dragging=!0,s(),CMS.Plugin._hideSubnav(),e(".cms-dragbar-empty").removeClass("cms-draggable-disallowed"),i.ui.sortables.each(function(){var t=e(this);0===t.children().length&&t.show()}),a.item.addClass("cms-is-dragging"),a.placeholder.css("height",a.helper.css("height")),i.ui.content.css({"overflow-x":"hidden"})},stop:function(t,n){if(i.dragging=!1,n.item.removeClass("cms-is-dragging"),!i.state)return!1;a&&(r.prepend(n.item),a=!1);var o=i.getId(n.item),d=e(".cms-plugin-"+o);d.trigger(d.closest(".cms-clipboard").length?"cms.plugin.update":"cms.plugins.update"),i.ui.sortables.each(function(){var t=e(this);0===t.children().length&&t.hide()}),i.ui.content.css({overflow:""}),s()},isAllowed:function(t,s,a){if(CMS.API.locked)return!1;var r=[],o=e(".cms-plugin-"+i.getId(a));if(0===o.length||null===o.data("settings"))return!1;var d=o.data("settings").plugin_type,c=i.getId(t.closest(".cms-dragarea")),l=e(".cms-placeholder-"+c),g=e(".cms-plugin-"+i.getId(t.closest(".cms-draggable")));return l.length&&(r=l.data("settings").plugin_restriction),g.length&&(r=g.data("settings").plugin_restriction),n&&(r=n.data("settings").plugin_restriction),t.parent().hasClass("cms-draggable-disabled")?!1:(i.state=r.length<=0||-1!==e.inArray(d,r)?!0:!1,i.state)}}),this.ui.doc.on("keyup.cms",function(e,s){(e.keyCode===t.ESC||s)&&(i.state=!1,i.ui.sortables.sortable("cancel"))}),this.ui.dropareas.droppable({greedy:!0,accept:".cms-draggable",tolerance:"pointer",activeClass:"cms-draggable-allowed",hoverClass:"cms-draggable-hover-allowed",over:function(t){n=e(".cms-placeholder-"+i.getId(e(t.target).parent().prev())),e(".cms-dragbar-empty").removeClass("cms-draggable-disallowed"),i.state?e(t.target).removeClass("cms-draggable-disallowed"):e(t.target).addClass("cms-draggable-disallowed")},out:function(t){n=null,e(t.target).removeClass("cms-draggable-disallowed")},drop:function(t){a=!0,r=e(t.target).parent().nextAll(".cms-draggables").first()}})}})})}(CMS.$);
