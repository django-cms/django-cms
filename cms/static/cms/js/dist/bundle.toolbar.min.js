 ...
 */
window.django=window.django||void 0,window.jQuery=window.django&&window.django.jQuery?window.django.jQuery:window.jQuery||void 0,window.Class=window.Class||void 0;var CMS={$:"function"==typeof window.jQuery?window.jQuery:void 0,Class:"function"==typeof window.Class?window.Class:void 0,API:{},KEYS:{SHIFT:16,TAB:9,UP:38,DOWN:40,ENTER:13,SPACE:32,ESC:27}};!function(o){"use strict";o(document).ready(function(){CMS.API.Helpers={reloadBrowser:function(e,t,n){var i=this,s=window.parent?window.parent:window;return n?(s.CMS.API.locked=!0,o.ajax({async:!1,type:"GET",url:s.CMS.config.request.url,data:{model:s.CMS.config.request.model,pk:s.CMS.config.request.pk},success:function(o){return s.CMS.API.locked=!1,""!==o||e?void(s.location.pathname!==o&&""!==o?i.reloadBrowser(o):"REFRESH_PAGE"===e?i.reloadBrowser():e&&i.reloadBrowser(e)):!1}}),!1):void s.setTimeout(function(){e&&e!==s.location.href?s.location.href=e:s.location.reload()},t||0)},preventSubmit:function(){var e=o("#cms-toolbar").find("form");e.submit(function(){CMS.API.Toolbar.showLoader(),o('input[type="submit"]').bind("click",function(o){o.preventDefault()}).css("opacity",.5)})},csrf:function(e){o.ajaxSetup({beforeSend:function(o){o.setRequestHeader("X-CSRFToken",e)}})},showTooltip:function(e,t){var n=o(".cms-tooltip");n.css("visibility","visible").data("plugin_id",t||null).show().find("span").html(e),o("body").bind("mousemove.cms",function(e){var t=20,i=e.pageX-o(n).offsetParent().offset().left,s=e.pageY-o(n).offsetParent().offset().top,a=o(n).offsetParent().width(),r=i+n.outerWidth(!0)+t;n.css({left:r>=a?i-n.outerWidth(!0)-t:i+t,top:s-12})}),n.bind("touchstart.cms",function(){o(".cms-plugin-"+o(this).data("plugin_id")).trigger("dblclick")})},hideTooltip:function(){var e=o(".cms-tooltip");e.css("visibility","hidden").hide(),o("body").unbind("mousemove.cms"),e.unbind("touchstart.cms")},setSettings:function(e){return e=JSON.stringify(o.extend({},CMS.config.settings,e)),CMS.API.Toolbar&&CMS.API.Toolbar.showLoader(),window.localStorage?(localStorage.setItem("cms_cookie",e),CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()):(CMS.API.locked=!0,o.ajax({async:!1,type:"POST",url:CMS.config.urls.settings,data:{csrfmiddlewaretoken:this.config.csrf,settings:e},success:function(o){CMS.API.locked=!1,e=o?JSON.parse(o):CMS.config.settings,CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()},error:function(o){CMS.API.Messages.open({message:o.response+" | "+o.status+" "+o.statusText,error:!0})}})),CMS.settings=JSON.parse(e),CMS.settings},getSettings:function(){var e;return CMS.API.Toolbar&&CMS.API.Toolbar.showLoader(),window.localStorage?(e=JSON.parse(localStorage.getItem("cms_cookie")),CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()):(CMS.API.locked=!0,o.ajax({async:!1,type:"GET",url:CMS.config.urls.settings,success:function(o){CMS.API.locked=!1,e=o?JSON.parse(o):CMS.config.settings,CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()},error:function(o){CMS.API.Messages.open({message:o.response+" | "+o.status+" "+o.statusText,error:!0})}})),e||(e=this.setSettings(CMS.config.settings)),CMS.settings=e,CMS.settings},makeURL:function(e,t){var n=[],i=[],s=[],a="",r=[],l=[],u=e;return e.split("?").length<=1||void 0===window.JSON||(r=e.split("?"),l=r[1].split("&"),u=r[0]),o.each(l,function(o,e){n.push({param:e.split("=")[0],value:e.split("=")[1]})}),t&&t.length&&o.each(t,function(o,e){n.push({param:e.split("=")[0],value:e.split("=")[1]})}),o.each(n,function(e,t){var n=o.inArray(t.param,i);-1===n?(i.push(t.param),s.push(t.value)):s[n]=t.value}),o.each(i,function(o,e){a+="&"+e+"="+s[o]}),a=a.replace("&","?"),e=u+a,e=e.replace("&","&amp;")},debounce:function(o,e,t){var n;return function(){var i=this,s=arguments,a=function(){n=null,t&&t.immediate||o.apply(i,s)},r=t&&t.immediate&&!n;clearTimeout(n),n=setTimeout(a,e),r&&o.apply(i,s)}},throttle:function(e,t,n){var i,s,a,r=null,l=0;n||(n={});var u=function(){l=n.leading===!1?0:o.now(),r=null,a=e.apply(i,s),r||(i=s=null)};return function(){var c=o.now();l||n.leading!==!1||(l=c);var d=t-(c-l);return i=this,s=arguments,0>=d||d>t?(r&&(clearTimeout(r),r=null),l=c,a=e.apply(i,s),r||(i=s=null)):r||n.trailing===!1||(r=setTimeout(u,d)),a}}},CMS.API.Helpers.preventSubmit()})}(CMS.$);
/*!========================================================================
