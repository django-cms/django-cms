...
var CMS=window.CMS||{};!function(t){"use strict";t(function(){CMS.Toolbar=new CMS.Class({implement:[CMS.API.Helpers],options:{preventSwitch:!1,preventSwitchMessage:"Switching is disabled.",toolbarDuration:200},initialize:function(i){this.options=t.extend(!0,{},this.options,i),this.config=CMS.config,this.settings=CMS.settings,this._setupUI(),this.click="click.cms.toolbar",this.touchStart="touchstart.cms.toolbar",this.pointerUp="pointerup.cms.toolbar",this.pointerOverOut="pointerover.cms.toolbar pointerout.csm.toolbar",this.pointerLeave="pointerleave.csm.toolbar",this.mouseEnter="mouseenter.cms.toolbar",this.mouseLeave="mouseleave.cms.toolbar",this.resize="resize.cms.toolbar",this.timer=function(){},this.lockToolbar=!1,this.messages=new CMS.Message,this.ui.toolbar.data("ready")||this._events();var s=this;setTimeout(function(){s._initialStates()},200),this.ui.toolbar.data("ready",!0)},_setupUI:function(){var i=t("#cms-toolbar");this.ui={container:i,body:t("html"),document:t(document),toolbar:i.find(".cms-toolbar"),toolbarTrigger:i.find(".cms-toolbar-trigger"),navigations:i.find(".cms-toolbar-item-navigation"),buttons:i.find(".cms-toolbar-item-buttons"),switcher:i.find(".cms-toolbar-item-switch"),messages:i.find(".cms-messages"),screenBlock:i.find(".cms-screenblock")}},_events:function(){var i=this;this.ui.toolbarTrigger.on(this.pointerUp,function(t){t.preventDefault(),i.toggle()}),this.ui.navigations.each(function(){function s(){o.removeClass(a),o.find("ul ul").hide(),e.find("> li").off(i.mouseEnter),i.ui.document.off(i.click)}var e=t(this),o=e.find("li"),n="cms-toolbar-item-navigation",a="cms-toolbar-item-navigation-hover",r="cms-toolbar-item-navigation-disabled",c="cms-toolbar-item-navigation-children",l=!1;e.find("a").on(i.click,function(e){return e.preventDefault(),""===t(this).attr("href")||"#"===t(this).attr("href")||t(this).parent().hasClass(r)||t(this).parent().hasClass(r)?void 0:(i._delegate(t(this)),s(),!1)}).on(i.touchStart,function(){l=!0}),o.on(i.click,function(o){o.preventDefault(),o.stopPropagation();var h=t(this);return h.hasClass(c)||s(),h.parent().hasClass(n)&&h.hasClass(a)||h.hasClass(r)?!1:(h.addClass(a),l||e.find("> li").on(i.mouseEnter,function(){return t(this).hasClass(a)?!1:void t(this).trigger(i.click)}),l=!1,void i.ui.document.on(i.click,s))}),o.find("li").on(i.pointerOverOut,function(){var i=t(this),s=i.closest(".cms-toolbar-item-navigation-children").add(i.parents(".cms-toolbar-item-navigation-children")),e=i.hasClass(c)||s.length;return i.hasClass(r)||i.hasClass(a)?!0:(o.find("li").removeClass(a),i.addClass(a),e?(i.find("> ul").show(),s.addClass(a)):o.find("ul ul").hide(),void i.siblings().find("> ul").hide())}).on(i.click,function(t){t.preventDefault(),t.stopPropagation()}),o.find("> ul").on(i.pointerLeave,function(){o.find("li").removeClass(a)})}),this.ui.switcher.each(function(){t(this).on(i.click,function(s){s.preventDefault(),i._setSwitcher(t(s.currentTarget))})}),this.ui.buttons.each(function(){var s=t(this);s.find("a").attr("data-rel")&&s.on(i.click,function(s){s.preventDefault(),i._delegate(t(this).find("a"))}),s.find(".cms-publish-page").on(i.click,function(t){confirm(i.config.lang.publish)||t.preventDefault()}),s.find(".cms-btn-publish").on(i.click,function(i){i.preventDefault(),t.ajax({type:"post",url:t(this).prop("href"),data:{csrfmiddlewaretoken:CMS.config.csrf},success:function(){CMS.API.Helpers.reloadBrowser()},error:function(t){throw new Error(t)}})})})},_initialStates:function(){var i=t(".cms-btn-publish").parent(),s=new CMS.Sideframe;"expanded"===this.settings.toolbar?this.open({duration:0}):this.close(),i.hide(),t(".cms-btn-publish-active").length&&i.show(),CMS.config.debug&&this._debug(),CMS.config.messages&&this.messages.open({message:CMS.config.messages}),CMS.config.error&&this.messages.open({message:CMS.config.error,error:!0}),CMS.config.auth&&CMS.config.settings.version===this.settings.version||(this.open({duration:0}),this.settings=this.setSettings(CMS.config.settings)),CMS.config.publisher&&(this.messages.open({message:CMS.config.publisher,dir:"right"}),setInterval(function(){CMS.$(".cms-toolbar-item-switch").toggleClass("cms-toolbar-item-switch-highlight")},this.messages.messageDelay)),this.settings.sideframe.url&&s.open({url:this.settings.sideframe.url,animate:!1}),this.ui.screenBlock.length&&this._screenBlock(),this.ui.body.addClass("cms-ready"),this.ui.document.trigger("cms-ready")},toggle:function(){"collapsed"===this.settings.toolbar?this.open():this.close()},open:function(t){this._show(t),this.settings.toolbar="expanded",this.settings=this.setSettings(this.settings)},_show:function(i){var s=i&&void 0!==i.duration?i.duration:this.options.toolbarDuration,e=t(".cms-debug-bar").height()||0,o=t(".cms-toolbar").height()+10;this.ui.toolbar.css({transition:"margin-top "+s+"ms","margin-top":0}),this.ui.toolbarTrigger.addClass("cms-toolbar-trigger-expanded"),this.ui.body.addClass("cms-toolbar-expanded"),this.ui.body.animate({"margin-top":o+e},s,"linear"),this.ui.messages.css("top",o+1)},close:function(){this._hide(),this.settings.toolbar="collapsed",this.settings=this.setSettings(this.settings)},_hide:function(){var i=this.options.toolbarDuration,s=t(".cms-toolbar").height()+10;return this.ui.toolbar.css("transition","margin-top "+i+"ms"),this.lockToolbar?!1:(this.ui.toolbarTrigger.removeClass("cms-toolbar-trigger-expanded"),this.ui.toolbar.css("margin-top",-s),this.ui.body.removeClass("cms-toolbar-expanded"),this.ui.body.animate({"margin-top":this.config.debug?5:0},i),void this.ui.messages.css("top",0))},openAjax:function(i){var s=this,e=i.url,o=i.post||"{}",n=i.text||"",a=i.callback,r=i.onSuccess,c=n?confirm(n):!0;return c?(this.showLoader(),t.ajax({type:"POST",url:e,data:o?JSON.parse(o):{}}).done(function(t){CMS.API.locked=!1,a?(a(s,t),s.hideLoader()):r?CMS.API.Helpers.reloadBrowser(r,!1,!0):CMS.API.Helpers.reloadBrowser(!1,!1,!0)}).fail(function(t){CMS.API.locked=!1,s.messages.open({message:t.response+" | "+t.status+" "+t.statusText,error:!0})})):!1},showLoader:function(){this.ui.toolbarTrigger.addClass("cms-toolbar-loader")},hideLoader:function(){this.ui.toolbarTrigger.removeClass("cms-toolbar-loader")},_delegate:function(t){var i=t.data("rel");switch(i){case"modal":var s=new CMS.Modal({onClose:t.data("on-close")});s.open({url:t.attr("href"),title:t.data("name")});break;case"message":this.messages.open({message:t.data("text")});break;case"cms_frame":var e=window.open(t.attr("href"),"cms_frame");e.focus();break;case"sideframe":var o=new CMS.Sideframe({onClose:t.data("on-close")});o.open({url:t.attr("href"),animate:!0});break;case"ajax":this.openAjax({url:t.attr("href"),post:JSON.stringify(t.data("post")),text:t.data("text"),onSuccess:t.data("on-success")});break;default:window.location.href=t.attr("href")}},_setSwitcher:function(t){var i=t.hasClass("cms-toolbar-item-switch-active"),s=t.find("a"),e=t.find(".cms-toolbar-item-switch-knob"),o=300;return this.options.preventSwitch?(this.messages.open({message:this.options.preventSwitchMessage,dir:"right"}),!1):(i?(e.animate({right:s.outerWidth(!0)-(e.outerWidth(!0)+2)},o),s.css("z-index",1).animate({"padding-top":6,"padding-right":14,"padding-bottom":4,"padding-left":28},o)):(e.animate({left:s.outerWidth(!0)-(e.outerWidth(!0)+2)},o),s.css("z-index",1).animate({"padding-top":6,"padding-right":28,"padding-bottom":4,"padding-left":14},o)),void setTimeout(function(){window.location.href=s.attr("href")},o))},_lock:function(t){t?(this.lockToolbar=!0,this.ui.toolbarTrigger.css("opacity",.2)):(this.lockToolbar=!1,this.ui.toolbarTrigger.css("opacity",1))},_debug:function(){var t=this,i=1e3,s=function(){},e=this.ui.container.find(".cms-debug-bar");e.on(this.mouseEnter+" "+this.mouseLeave,function(e){clearTimeout(s),e.type===t.mouseEnter&&(s=setTimeout(function(){t.messages.open({message:t.config.lang.debug})},i))})},_screenBlock:function(){var i=this,s=20,e=this.ui.screenBlock,o=t(".cms-sideframe");t(window).on(this.resize,function(){e.css({width:t(this).width()-o.width(),height:t(window).height()})}).trigger("resize"),setInterval(function(){t(window).trigger(i.resize)},s)}})})}(CMS.$);