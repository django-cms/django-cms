...
!function(i){"use strict";i(document).ready(function(){/*!
         ...
         */
CMS.Modal=new CMS.Class({implement:[CMS.API.Helpers],options:{onClose:!1,minHeight:400,minWidth:800,modalDuration:300,newPlugin:!1,urls:{css_modal:"cms/css/cms.toolbar.modal.css"}},initialize:function(t){this.options=i.extend(!0,{},this.options,t),this.config=CMS.config,this.body=i("html"),this.modal=i(".cms-modal"),this.toolbar=i(".cms-toolbar"),this.click=null!==document.ontouchstart?"click.cms":"touchend.cms click.cms",this.maximized=!1,this.minimized=!1,this.triggerMaximized=!1,this.saved=!1,this.modal.data("ready")||this._events(),this.modal.data("ready",!0)},_events:function(){var t=this;this.modal.find(".cms-modal-collapse").bind(this.click,function(i){i.preventDefault(),t._minimize()}),this.modal.find(".cms-modal-title").bind("mousedown.cms",function(i){i.preventDefault(),t._startMove(i)}),this.modal.find(".cms-modal-title").bind("dblclick.cms",function(){t._maximize()}),this.modal.find(".cms-modal-resize").bind("mousedown.cms",function(i){i.preventDefault(),t._startResize(i)}),this.modal.find(".cms-modal-maximize").bind(this.click,function(i){i.preventDefault(),t._maximize()}),this.modal.find(".cms-modal-breadcrumb-items").on(this.click,"a",function(s){s.preventDefault(),t._changeContent(i(this))}),this.modal.find(".cms-modal-close, .cms-modal-cancel").bind(this.click,function(i){t.options.onClose=null,i.preventDefault(),t.close()}),i(document).bind("mouseup.cms",function(i){t._endMove(i),t._endResize(i)})},open:function(t,s,o){if(CMS.API.locked)return CMS.API.locked=!1,!1;CMS.API.locked=!0,this.modal.is(":visible")&&this.modal.find(".cms-modal-collapsed").length&&(this.minimized=!0,this._minimize()),CMS.API.Toolbar._loader(!0),this.hideTooltip(),this.modal.find(".cms-modal-breadcrumb").hide(),this.modal.find(".cms-modal-breadcrumb-items").html(""),this.modal.find(".cms-modal-buttons").html("");var e=this.modal.find(".cms-modal-body, .cms-modal-foot");e.show(),this._loadContent(t,s),this.modal.find(".cms-modal-collapsed").length&&this._minimize(),this.modal.css({left:"50%",top:"50%","mergin-left":0,"margin-right":0});var n=300,d=350,a=i(window).width(),m=i(window).height(),l=a>=this.options.minWidth+n?a-n:this.options.minWidth,c=m>=this.options.minHeight+d?m-d:this.options.minHeight;this.modal.find(".cms-modal-body").css({width:l,height:c}),this.modal.find(".cms-modal-body").removeClass("cms-loader"),this.modal.find(".cms-modal-maximize").removeClass("cms-modal-maximize-active"),this.maximized=!1,c>=m&&(this.triggerMaximized=!0),this._setBreadcrumb(o),this._show(this.options.modalDuration)},close:function(){var i=this;if(this.options.newPlugin){var t=this.options.newPlugin,s='{ "csrfmiddlewaretoken": "'+this.config.csrf+'" }',o=this.config.lang.confirm;CMS.API.Toolbar.openAjax(t["delete"],s,o,function(){i._hide(100)})}else this._hide(100);this.options.onClose&&this.reloadBrowser(this.options.onClose,!1,!0),setTimeout(function(){i.minimized&&i._minimize(),i.maximized&&i._maximize()},300)},_show:function(t){var s=this,o=this.modal.width(),e=this.modal.height();this.modal.show().css({width:0,height:0,"margin-left":0,"margin-top":0}).stop(!0,!0).animate({width:o,height:e,"margin-left":-(o/2),"margin-top":-(e/2)},t,function(){i(this).removeAttr("style"),s.modal.css({"margin-left":-(o/2),"margin-top":-(e/2)}),s.modal.show(),CMS.API.Toolbar._loader(!1),s.triggerMaximized&&s._maximize(),CMS.API.locked=!1}),i(document).bind("keydown.cms",function(i){27===i.keyCode&&s.close()}),this.modal.focus()},_hide:function(i){this.modal.fadeOut(i),this.modal.find(".cms-modal-frame iframe").remove(),this.modal.find(".cms-modal-body").removeClass("cms-loader")},_minimize:function(){var i=this.modal.find(".cms-modal-collapse"),t=this.modal.find(".cms-modal-maximize"),s=this.modal.find(".cms-modal-body, .cms-modal-foot"),o=this.modal.find(".cms-modal-title");return this.maximized?!1:void(this.minimized===!1?(CMS.API.Toolbar.toggleToolbar(!0),i.addClass("cms-modal-collapsed"),s.hide(),this.modal.data("css",{left:this.modal.css("left"),top:this.modal.css("top"),margin:this.modal.css("margin")}),this.modal.css({left:this.toolbar.find(".cms-toolbar-left").outerWidth(!0)+50,top:this.config.debug?6:1,margin:0}),this.body.css("overflow",""),t.hide(),o.css("cursor","default"),this.minimized=!0):(i.removeClass("cms-modal-collapsed"),s.show(),this.modal.css(this.modal.data("css")),this.body.css("overflow","hidden"),t.show(),o.css("cursor","move"),this.minimized=!1))},_maximize:function(){var t=this.config.debug?5:0,s=this.modal.find(".cms-modal-body"),o=this.modal.find(".cms-modal-collapse"),e=this.modal.find(".cms-modal-maximize"),n=this.modal.find(".cms-modal-title");return this.minimized?!1:void(this.maximized===!1?(this.maximized=!0,e.addClass("cms-modal-maximize-active"),this.modal.data("css",{left:this.modal.css("left"),top:this.modal.css("top"),"margin-left":this.modal.css("margin-left"),"margin-top":this.modal.css("margin-top")}),s.data("css",{width:s.width(),height:s.height()}),this.modal.css({left:0,top:t,margin:0}),i(window).bind("resize.cms.modal",function(){s.css({width:i(window).width(),height:i(window).height()-60-t})}),i(window).trigger("resize.cms.modal"),o.hide(),n.css("cursor","default")):(this.maximized=!1,e.removeClass("cms-modal-maximize-active"),i(window).unbind("resize.cms.modal"),this.modal.css(this.modal.data("css")),s.css(s.data("css")),o.show(),n.css("cursor","move")))},_startMove:function(t){if(this.maximized)return!1;if(this.minimized)return!1;var s=this,o=s.modal.position();this.modal.find(".cms-modal-shim").show(),i(document).bind("mousemove.cms",function(i){var e=o.left-(t.pageX-i.pageX),n=o.top-(t.pageY-i.pageY);s.modal.css({left:e,top:n})})},_endMove:function(){this.modal.find(".cms-modal-shim").hide(),i(document).unbind("mousemove.cms")},_startResize:function(t){if(this.maximized)return!1;var s=this,o=this.modal.find(".cms-modal-body"),e=o.width(),n=o.height(),d=this.modal.position().left,a=this.modal.position().top;this.modal.find(".cms-modal-shim").show(),i(document).bind("mousemove.cms",function(i){var m=t.pageX-i.pageX,l=t.pageY-i.pageY,c=e-2*m,h=n-2*l,r=680;return r>=c||100>=h?!1:(o.css({width:e-2*m,height:n-2*l}),void s.modal.css({left:d+m,top:a+l}))})},_endResize:function(){this.modal.find(".cms-modal-shim").hide(),i(document).unbind("mousemove.cms")},_setBreadcrumb:function(t){var s=this.modal.find(".cms-modal-breadcrumb"),o="";return!t||t.length<=0?!1:t[0].title?(i.each(t,function(i,s){var e=i>=t.length-1?"cms-modal-breadcrumb-last":"";o+='<a href="'+s.url+'" class="'+e+'"><span>'+s.title+"</span></a>"}),s.find(".cms-modal-breadcrumb-items").html(o),void s.show()):!1},_setButtons:function(t){var s,o=t.contents().find(".suit-columns").length>0,e=this;s=t.contents().find(o?".save-box:eq(0)":".submit-row:eq(0)"),t.contents().find(".submit-row").hide();var n=s.find("input, a, button"),d=i("<span />");n.length||(s=t.contents().find("body:not(.change-list) #content form:eq(0)"),n=s.find('input[type="submit"], button[type="submit"]'),n.addClass("deletelink").hide()),n.each(function(t,s){i(s).attr("data-rel","_"+t)}),n.each(function(t,s){if(s=i(s),"hidden"===s.attr("type"))return!1;var o=s.attr("value")||s.text(),n="cms-btn";s.hasClass("default")&&(n="cms-btn cms-btn-action"),s.hasClass("deletelink")&&(n="cms-btn cms-btn-caution");var a=i('<div class="'+n+" "+s.attr("class")+'">'+o+"</div>");a.bind(e.click,function(){(s.is("input")||s.is("button"))&&s[0].click(),s.is("a")&&e._loadContent(s.prop("href"),o),(s.hasClass("default")||s.hasClass("deletelink"))&&(e.options.newPlugin=null,s.hasClass("deletelink")&&(e.options.onClose=null),e.modal.find(".cms-modal-frame iframe").hide(),e.saved=!0)}),d.append(a)});var a=i('<div class="cms-btn">'+e.config.lang.cancel+"</div>");a.bind(e.click,function(){e.options.onClose=!1,e.close()}),d.append(a),this.modal.find(".cms-modal-buttons").html(d)},_loadContent:function(t,s){var o=this;t=t.replace("&","&amp;");var e=i('<iframe src="'+t+'" class="" frameborder="0" />');e.css("visibility","hidden");var n=this.modal.find(".cms-modal-frame"),d=this.modal.find(".cms-modal-title");d.html(s||"&nbsp;"),n.find("iframe").css("visibility","hidden"),e.bind("load",function(){try{e.contents()}catch(t){CMS.API.Toolbar.showError("<strong>"+t+"</strong>"),o.close()}var n=e.contents().find(".messagelist li");n.length&&CMS.API.Toolbar.openMessage(n.eq(0).text()),n.remove();var a=e.contents();if(n.length&&o.enforceReload&&o.reloadBrowser(),n.length&&o.enforceClose)return o.close(),!1;if(a.find("head").append(i('<link rel="stylesheet" type="text/css" href="'+o.config.urls["static"]+o.options.urls.css_modal+'" />')),a.find(".viewsitelink").attr("target","_top"),o._setButtons(i(this)),(e.contents().find(".errornote").length||e.contents().find(".errorlist").length)&&(o.saved=!1),o.saved&&!a.find(".delete-confirmation").length)o.reloadBrowser(window.location.href,!1,!0);else{e.show();var m=e.contents().find("#content h1:eq(0)");void 0===s&&d.html(m.text()),m.remove(),e.css("visibility","visible"),e.data("ready",!0),a.find("body").bind("keydown.cms",function(i){27===i.keyCode&&o.close()}),a.find("body").addClass("cms-modal-window"),a.find(".object-tools").length&&a.find("#content").css("padding-top",38)}}),setTimeout(function(){o.modal.find(".cms-modal-body").addClass("cms-loader"),n.html(e)},this.options.modalDuration)},_changeContent:function(i){if(i.hasClass("cms-modal-breadcrumb-last"))return!1;var t=i.parent().find("a");t.removeClass("cms-modal-breadcrumb-last"),i.addClass("cms-modal-breadcrumb-last"),this._loadContent(i.attr("href")),this.modal.find(".cms-modal-title").text(i.text())}})})}(CMS.$);
!function(i){"use strict";i(document).ready(function(){/*!
         * Sideframe
...
!function(e){"use strict";e(document).ready(function(){/*!
         ...
         */
CMS.Plugin=new CMS.Class({implement:[CMS.API.Helpers],options:{type:"",placeholder_id:null,plugin_type:"",plugin_id:null,plugin_language:"",plugin_parent:null,plugin_order:null,plugin_breadcrumb:[],plugin_restriction:[],urls:{add_plugin:"",edit_plugin:"",move_plugin:"",copy_plugin:"",delete_plugin:""}},initialize:function(t,i){switch(this.container=e("."+t),this.options=e.extend(!0,{},this.options,i),this.body=e(document),this.csrf=CMS.config.csrf,this.timer=function(){},this.timeout=250,this.focused=!1,this.click=null!==document.ontouchstart?"click.cms":"tap.cms click.cms",this.container.data("settings",this.options),this.options.type){case"placeholder":this._setPlaceholder(),this._collapsables();break;case"plugin":this._setPlugin(),this._collapsables();break;default:this._setGeneric()}},_setPlaceholder:function(){var t=this,i=".cms-dragbar-title",s="cms-dragbar-title-expanded",n=e(".cms-dragbar-"+this.options.placeholder_id);this._setSubnav(n.find(".cms-submenu"));var a=CMS.settings;a.dragbars=a.dragbars||[],n.find(i).bind(this.click,function(){e(this).hasClass(s)?t._collapseAll(e(this)):t._expandAll(e(this))}),-1!==e.inArray(this.options.placeholder_id,a.dragbars)&&n.find(i).addClass(s)},_setPlugin:function(){var t=this;this.container.bind("dblclick",function(e){e.preventDefault(),e.stopPropagation(),t.editPlugin(t.options.urls.edit_plugin,t.options.plugin_name,t.options.plugin_breadcrumb)}),this.container.bind("mouseover.cms mouseout.cms",function(e){e.stopPropagation();var i=t.options.plugin_name,s=t.options.plugin_id;"mouseover"===e.type?t.showTooltip(i,s):t.hideTooltip()}),this.container.bind("cms.plugins.update",function(e){e.stopPropagation(),t.movePlugin()}),this.container.bind("cms.plugin.update",function(i){i.stopPropagation();var s=e(i.delegateTarget),n=e(".cms-draggable-"+s.data("settings").plugin_id),a=t._getId(n.parents(".cms-draggables").last().prevAll(".cms-dragbar").first());if(!a)return!1;var o=s.data("settings");o.target=a,o.parent=t._getId(n.parent().closest(".cms-draggable")),t.copyPlugin(o)});var i=e(".cms-draggable-"+this.options.plugin_id),s=i.find("> .cms-dragitem"),n=i.find(".cms-submenu:eq(0)"),a=e(".cms-draggables").find(".cms-submenu");this._setSubnav(i.find("> .cms-dragitem .cms-submenu")),i.bind("mouseenter mouseleave mouseover",function(i){return i.preventDefault(),i.stopPropagation(),t.focused?!1:(("mouseenter"===i.type||"mouseover"===i.type)&&e(this).data("active",!0),"mouseleave"===i.type&&(e(this).data("active",!1),a.hide()),void setTimeout(function(){e(i.currentTarget).data("active")||e(i.currentTarget).find(".cms-submenu:eq(0)").hide()},100))}),s.bind("mouseenter",function(e){e.preventDefault(),e.stopPropagation(),a.hide(),n.show()}),s.bind("dblclick",function(e){e.preventDefault(),e.stopPropagation(),t.editPlugin(t.options.urls.edit_plugin,t.options.plugin_name,t.options.plugin_breadcrumb)})},_setGeneric:function(){var e=this;this.container.bind("dblclick",function(t){t.preventDefault(),t.stopPropagation(),e.editPlugin(e.options.urls.edit_plugin,e.options.plugin_name,[])}),this.container.bind("mouseover.cms mouseout.cms",function(t){t.stopPropagation();var i=e.options.plugin_name,s=e.options.plugin_id;"mouseover"===t.type?e.showTooltip(i,s):e.hideTooltip()})},addPlugin:function(t,i,s){if(CMS.API.locked)return!1;CMS.API.locked=!0;var n=this,a={placeholder_id:this.options.placeholder_id,plugin_type:t,plugin_parent:s||"",plugin_language:this.options.plugin_language,csrfmiddlewaretoken:this.csrf};e.ajax({type:"POST",url:this.options.urls.add_plugin,data:a,success:function(e){CMS.API.locked=!1,n.newPlugin=e,n.editPlugin(e.url,i,e.breadcrumb)},error:function(e){CMS.API.locked=!1;var t=CMS.config.lang.error;n._showError(t+e.responseText||e.status+" "+e.statusText)}})},editPlugin:function(e,t,i){var s=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});s.open(e,t,i)},copyPlugin:function(t,i){if(CMS.API.locked)return!1;CMS.API.locked=!0;var s=this,n=t||i?!0:!1;t=t||this.options,i?(t.target=t.placeholder_id,t.plugin_id="",t.parent=""):i=t.plugin_language;var a={source_placeholder_id:t.placeholder_id,source_plugin_id:t.plugin_id||"",source_language:i,target_plugin_id:t.parent||"",target_placeholder_id:t.target||CMS.config.clipboard.id,target_language:t.page_language||i,csrfmiddlewaretoken:this.csrf},o={type:"POST",url:t.urls.copy_plugin,data:a,success:function(){CMS.API.Toolbar.openMessage(CMS.config.lang.success),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var t=CMS.config.lang.error;s._showError(t+e.responseText||e.status+" "+e.statusText)}};n?e.ajax(o):CMS.API.Clipboard.clear(function(){e.ajax(o)})},cutPlugin:function(){if(CMS.API.locked)return!1;CMS.API.locked=!0;var t=this,i={placeholder_id:CMS.config.clipboard.id,plugin_id:this.options.plugin_id,plugin_parent:"",plugin_language:this.options.page_language,plugin_order:[this.options.plugin_id],csrfmiddlewaretoken:this.csrf};CMS.API.Clipboard.clear(function(){return CMS.API.locked?!1:(CMS.API.locked=!0,void e.ajax({type:"POST",url:t.options.urls.move_plugin,data:i,success:function(){CMS.API.Toolbar.openMessage(CMS.config.lang.success),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var i=CMS.config.lang.error;t._showError(i+e.responseText||e.status+" "+e.statusText)}}))})},movePlugin:function(t){if(CMS.API.locked)return!1;CMS.API.locked=!0;var i=this;t=t||this.options;var s=e(".cms-plugin-"+t.plugin_id),n=e(".cms-draggable-"+t.plugin_id);this._setPosition(t.plugin_id,s,n);var a=this._getId(n.parents(".cms-draggables").last().prevAll(".cms-dragbar").first()),o=this._getId(n.parent().closest(".cms-draggable")),r=this._getIds(n.siblings(".cms-draggable").andSelf());if(a===!1)return!1;var l={placeholder_id:a,plugin_id:t.plugin_id,plugin_parent:o||"",plugin_language:t.page_language,plugin_order:r,csrfmiddlewaretoken:this.csrf};e.ajax({type:"POST",url:t.urls.move_plugin,data:l,success:function(e){e.reload&&CMS.API.Helpers.reloadBrowser(),CMS.API.locked=!1,i._showSuccess(n)},error:function(e){CMS.API.locked=!1;var t=CMS.config.lang.error;i._showError(t+e.responseText||e.status+" "+e.statusText)}}),e(".cms-btn-publish").addClass("cms-btn-publish-active").parent().show(),e(".cms-toolbar-revert").removeClass("cms-toolbar-item-navigation-disabled")},deletePlugin:function(e,t,i){var s=new CMS.Modal({newPlugin:this.newPlugin||!1,onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});s.open(e,t,i)},_setPosition:function(t,i,s){var n=s.prev(".cms-draggable"),a=s.next(".cms-draggable"),o=s.parent().closest(".cms-draggable"),r=e(".cms-plugin-"+this._getId(o)),l=s.closest(".cms-dragarea");if(n.length)i.insertAfter(e(".cms-plugin-"+this._getId(n)));else if(a.length)i.insertBefore(e(".cms-plugin-"+this._getId(a)));else if(o.length){for(;r.children().length;)r=r.children();r.append(i)}else l.length?i.append(e(".cms-plugin-"+this._getId(l))):CMS.API.Helpers.reloadBrowser()},editPluginPostAjax:function(e,t,i){return"undefined"==typeof t||"undefined"==typeof i?function(t,i){var s=e;s.editPlugin(i.url,s.options.plugin_name,i.breadcrumb)}:void this.editPlugin(i.url,this.options.plugin_name,i.breadcrumb)},_setSubnav:function(t){var i=this;t.bind("mouseenter mouseleave tap.cms",function(t){t.preventDefault(),t.stopPropagation(),"mouseenter"===t.type?i._showSubnav(e(this)):i._hideSubnav(e(this))}),t.find("a").bind("click.cms tap.cms",function(t){t.preventDefault(),t.stopPropagation(),CMS.API.Toolbar._loader(!0);var s=e(this);switch(s.attr("data-rel")){case"add":i.addPlugin(s.attr("href").replace("#",""),s.text(),i._getId(s.closest(".cms-draggable")));break;case"ajax_add":CMS.API.Toolbar.openAjax(s.attr("href"),JSON.stringify(s.data("post")),s.data("text"),i.editPluginPostAjax(i),s.data("on-success"));break;case"edit":i.editPlugin(i.options.urls.edit_plugin,i.options.plugin_name,i.options.plugin_breadcrumb);break;case"copy-lang":i.copyPlugin(this.options,s.attr("data-language"));break;case"copy":i.copyPlugin();break;case"cut":i.cutPlugin();break;case"delete":i.deletePlugin(i.options.urls.delete_plugin,i.options.plugin_name,i.options.plugin_breadcrumb);break;default:CMS.API.Toolbar._loader(!1),CMS.API.Toolbar._delegate(s)}}),t.find("input").bind("keyup keydown focus blur click",function(s){"focus"===s.type&&(i.focused=!0),"blur"!==s.type||i.traverse||(i.focused=!1,i._hideSubnav(t)),"keyup"===s.type&&(clearTimeout(i.timer),i.timer=setTimeout(function(){i._searchSubnav(t,e(s.currentTarget).val())},100))}),t.find(".cms-submenu-dropdown").each(function(){e(this).data("top",e(this).css("top"))}),t.bind(this.click,function(e){e.stopPropagation()})},_showSubnav:function(t){var i=this,s=t.find(".cms-submenu-dropdown"),n=parseInt(s.data("top"));clearTimeout(this.timer),this.timer=setTimeout(function(){var i=e(".cms-submenu").parentsUntil(".cms-dragarea"),s=t.find(".cms-submenu-scroll-hint");i.css("z-index",0);var n=t.parentsUntil(".cms-dragarea");n.css("z-index",999),t.find(".cms-submenu-quicksearch").show(),t.find("> .cms-submenu-dropdown").show().on("scroll",function(){s.fadeOut(100),e(this).off("scroll")}),t[0].scrollHeight>245&&s.show()},100),e(document).unbind("keydown.cms"),e(document).bind("keydown.cms",function(e){var s=t.find(".cms-submenu-item:visible a"),n=s.index(s.filter(":focus"));(40===e.keyCode||9===e.keyCode)&&(i.traverse=!0,e.preventDefault(),n>=0&&n<s.length-1?s.eq(n+1).focus():s.eq(0).focus()),(38===e.keyCode||9===e.keyCode&&e.shiftKey)&&(e.preventDefault(),s.is(":focus")?s.eq(n-1).focus():s.eq(s.length).focus()),(13===e.keyCode||27===e.keyCode)&&(i.traverse=!1,t.find("input").blur(),i._hideSubnav(t))}),e(window).height()+e(window).scrollTop()-t.offset().top-s.height()<=10&&t.offset().top-s.height()>=0?(s.css("top","auto"),s.css("bottom",n),s.closest(".cms-draggable").length&&s.css("bottom",n-1)):(s.css("top",n),s.css("bottom","auto"))},_hideSubnav:function(t){clearTimeout(this.timer);var i=this;return this.focused?!1:(t.closest(".cms-draggable").data("active",!1),this.timer=setTimeout(function(){t.find("> .cms-submenu-dropdown").hide(),t.find(".cms-submenu-quicksearch").hide(),t.find("input").val(""),i._searchSubnav(t,"")},this.timeout),void e(".cms-dragbar").css("position",""))},_searchSubnav:function(t,i){var s=t.find(".cms-submenu-item"),n=t.find(".cms-submenu-item-title");return""===i?(s.add(n).show(),!1):(s.find("a, span").each(function(t,s){s=e(s);var n=s.text().toLowerCase(),a=i.toLowerCase();n.indexOf(a)>=0?s.parent().show():s.parent().hide()}),n.filter(":visible").each(function(t,i){n.hide(),e(i).nextUntil(".cms-submenu-item-title").show()}),s.filter(":visible").each(function(t,i){e(i).prev().hasClass("cms-submenu-item-title")?e(i).prev().show():e(i).prevUntil(".cms-submenu-item-title").last().prev().show()}),t.find(".cms-submenu-dropdown").show(),s.add(n).filter(":visible").length<=0&&t.find(".cms-submenu-dropdown").hide(),void t.find(".cms-submenu-scroll-hint").hide())},_collapsables:function(){var t=this,i=CMS.settings,s=e(".cms-draggable-"+this.options.plugin_id);if(this.container.each(function(t,i){var s=e(i).find(".cms-dragitem-collapsable"),n=s.filter(".cms-dragitem-expanded");s.length===n.length&&s.length+n.length!==0&&e(i).find(".cms-dragbar-title").addClass("cms-dragbar-title-expanded")}),!s.length)return!1;if(s.find("> .cms-dragitem-collapsable").bind(this.click,function(){var i,n=e(this),a=t._getId(e(this).parent()),o=CMS.settings;if(o.states=o.states||[],n.hasClass("cms-dragitem-expanded")){if(o.states.splice(e.inArray(a,o.states),1),n.removeClass("cms-dragitem-expanded").parent().find("> .cms-draggables").hide(),e(document).data("expandmode")){if(i=s.find(".cms-draggable").find(".cms-dragitem-collapsable"),!i.length)return!1;i.each(function(){e(this).hasClass("cms-dragitem-expanded")&&e(this).trigger("click.cms")})}}else if(o.states.push(a),n.addClass("cms-dragitem-expanded").parent().find("> .cms-draggables").show(),e(document).data("expandmode")){if(i=s.find(".cms-draggable").find(".cms-dragitem-collapsable"),!i.length)return!1;i.each(function(){e(this).hasClass("cms-dragitem-expanded")||e(this).trigger("click.cms")})}e(window).trigger("resize.sideframe"),CMS.API.Toolbar.setSettings(o)}),s.bind("dblclick",function(i){i.stopPropagation(),e(".cms-plugin-"+t._getId(e(this))).trigger("dblclick")}),CMS.Toolbar.ready)return!1;for(var n=i.states.sort(),a=[],o=0;o<n.length;o++)n[o]!==n[o+1]&&a.push(n[o]);i.states=a,e.each(CMS.settings.states,function(t,i){var s=e(".cms-draggable-"+i);s.find(".cms-draggables").length&&(s.find("> .cms-draggables").show(),s.find("> .cms-dragitem").addClass("cms-dragitem-expanded"))}),CMS.Toolbar.ready=!0},_expandAll:function(t){var i=t.closest(".cms-dragarea").find(".cms-dragitem-collapsable");if(!i.length)return!1;i.each(function(){e(this).hasClass("cms-dragitem-expanded")||e(this).trigger("click.cms")}),t.addClass("cms-dragbar-title-expanded");var s=CMS.settings;s.dragbars=s.dragbars||[],s.dragbars.push(this.options.placeholder_id),CMS.API.Toolbar.setSettings(s)},_collapseAll:function(t){var i=t.closest(".cms-dragarea").find(".cms-dragitem-collapsable");i.each(function(){e(this).hasClass("cms-dragitem-expanded")&&e(this).trigger("click.cms")}),t.removeClass("cms-dragbar-title-expanded");var s=CMS.settings;s.dragbars=s.dragbars||[],s.dragbars.splice(e.inArray(this.options.placeholder_id,s.states),1),CMS.API.Toolbar.setSettings(s)},_getId:function(e){return CMS.API.StructureBoard.getId(e)},_getIds:function(e){return CMS.API.StructureBoard.getIds(e)},_showError:function(e){return CMS.API.Toolbar.showError(e,!0)},_showSuccess:function(t){var i=e('<div class="cms-dragitem-success"></div>');t.append(i),i.fadeOut(function(){e(this).remove()}),e(window).trigger("resize.sideframe")}})})}(CMS.$);
!function(e){"use strict";e(document).ready(function(){/*!
         * StructureBoard
