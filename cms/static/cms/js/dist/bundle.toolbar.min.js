 ...
 */
window.django=window.django||void 0,window.jQuery=window.django&&window.django.jQuery?window.django.jQuery:window.jQuery||void 0,window.Class=window.Class||void 0;var CMS={$:"function"==typeof window.jQuery?window.jQuery:void 0,Class:"function"==typeof window.Class?window.Class:void 0,API:{},KEYS:{SHIFT:16,TAB:9,UP:38,DOWN:40,ENTER:13,SPACE:32,ESC:27,CMD_LEFT:91,CMD_RIGHT:93,CMD_FIREFOX:224,CTRL:17},BREAKPOINTS:{mobile:420}};!function(e){"use strict";e(function(){var t=e("#cms-top"),o=function(e){return e.split(/\s+/g).map(function(e){return"cms-"+e}).join(" ")};CMS.API.Helpers={reloadBrowser:function(t,o,n){var r=this,i=window.parent?window.parent:window;return n?(i.CMS.API.locked=!0,e.ajax({async:!1,type:"GET",url:i.CMS.config.request.url,data:{model:i.CMS.config.request.model,pk:i.CMS.config.request.pk},success:function(e){return i.CMS.API.locked=!1,""!==e||t?void(i.location.pathname!==e&&""!==e?r.reloadBrowser(e):"REFRESH_PAGE"===t?r.reloadBrowser():t&&r.reloadBrowser(t)):!1}}),!1):void i.setTimeout(function(){t&&t!==i.location.href?i.location.href=t:i.location.reload()},o||0)},preventSubmit:function(){var t=e(".cms-toolbar").find("form");t.submit(function(){CMS.API.Toolbar.showLoader(),e('input[type="submit"]').on("click",function(e){e.preventDefault()}).css("opacity",.5)})},csrf:function(t){e.ajaxSetup({beforeSend:function(e){e.setRequestHeader("X-CSRFToken",t)}})},setSettings:function(t){return t=JSON.stringify(e.extend({},CMS.config.settings,t)),CMS.API.Toolbar&&CMS.API.Toolbar.showLoader(),this._isStorageSupported?(localStorage.setItem("cms_cookie",t),CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()):(CMS.API.locked=!0,e.ajax({async:!1,type:"POST",url:CMS.config.urls.settings,data:{csrfmiddlewaretoken:CMS.config.csrf,settings:t},success:function(e){CMS.API.locked=!1,t=e?JSON.parse(e):CMS.config.settings,CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()},error:function(e){CMS.API.Messages.open({message:e.response+" | "+e.status+" "+e.statusText,error:!0})}})),CMS.settings="object"==typeof t?t:JSON.parse(t),CMS.settings},getSettings:function(){var t;return CMS.API.Toolbar&&CMS.API.Toolbar.showLoader(),this._isStorageSupported?(t=JSON.parse(localStorage.getItem("cms_cookie")),CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()):(CMS.API.locked=!0,e.ajax({async:!1,type:"GET",url:CMS.config.urls.settings,success:function(e){CMS.API.locked=!1,t=e?JSON.parse(e):CMS.config.settings,CMS.API.Toolbar&&CMS.API.Toolbar.hideLoader()},error:function(e){CMS.API.Messages.open({message:e.response+" | "+e.status+" "+e.statusText,error:!0})}})),t||(t=this.setSettings(CMS.config.settings)),CMS.settings=t,CMS.settings},makeURL:function(t,o){var n=[],r=[],i=[],a="",s=[],u=[],c=t;return t.split("?").length<=1||void 0===window.JSON||(s=t.split("?"),u=s[1].split("&"),c=s[0]),e.each(u,function(e,t){n.push({param:t.split("=")[0],value:t.split("=")[1]})}),o&&o.length&&e.each(o,function(e,t){n.push({param:t.split("=")[0],value:t.split("=")[1]})}),e.each(n,function(t,o){var n=e.inArray(o.param,r);-1===n?(r.push(o.param),i.push(o.value)):i[n]=o.value}),e.each(r,function(e,t){a+="&"+t+"="+i[e]}),a=a.replace("&","?"),t=c+a,t=t.replace("&","&amp;")},debounce:function(e,t,o){var n;return function(){var r=this,i=arguments,a=function(){n=null,o&&o.immediate||e.apply(r,i)},s=o&&o.immediate&&!n;clearTimeout(n),n=setTimeout(a,t),s&&e.apply(r,i)}},throttle:function(t,o,n){var r,i,a,s=null,u=0;n||(n={});var c=function(){u=n.leading===!1?0:e.now(),s=null,a=t.apply(r,i),s||(r=i=null)};return function(){var l=e.now();u||n.leading!==!1||(u=l);var d=o-(l-u);return r=this,i=arguments,0>=d||d>o?(s&&(clearTimeout(s),s=null),u=l,a=t.apply(r,i),s||(r=i=null)):s||n.trailing===!1||(s=setTimeout(c,d)),a}},secureConfirm:function(e){var t=Number(new Date),o=confirm(e),n=Number(new Date);return t+10>n||o===!0},_isStorageSupported:function(){var e="modernizr";try{return localStorage.setItem(e,e),localStorage.removeItem(e),!0}catch(t){return!1}}(),addEventListener:function(e,n){return t.on(o(e),n)},removeEventListener:function(e,n){return t.off(o(e),n)},dispatchEvent:function(e,n){return t.trigger(o(e),[n])},once:function(e){var t,o=!1;return function(){return o||(o=!0,t=e.apply(this,arguments)),o&&(e=void 0),t}}},CMS.API.Helpers.preventSubmit()})}(CMS.$);
/*!========================================================================
