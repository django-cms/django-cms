...
var CMS=window.CMS||{};!function(i){"use strict";i(function(){/*!
         ...
         * Handles copy & paste
         */
CMS.Clipboard=new CMS.Class({implement:[CMS.API.Helpers],options:{position:220,speed:100,id:null,url:""},initialize:function(t){this.clipboard=i(".cms-clipboard"),this.options=i.extend(!0,{},this.options,t),this.config=CMS.config,this.settings=CMS.settings,this.containers=this.clipboard.find(".cms-clipboard-containers > .cms-draggable"),this.triggers=i(".cms-clipboard-trigger a"),this.triggerRemove=i(".cms-clipboard-empty a"),this.click="click.cms.clipboard",this._setup(),this._events()},_setup:function(){var t=this,o=117,a=this.clipboard.find(".cms-clipboard-containers"),e=new CMS.Modal({minWidth:400,minHeight:o,minimizable:!1,maximizable:!1,resizable:!1});e.on("cms.modal.loaded cms.modal.closed",function(){i(".cms-add-plugin-placeholder").remove()}).on("cms.modal.closed cms.modal.load",function(){a.prependTo(t.clipboard)}).ui.modal.on("cms.modal.load",function(){a.prependTo(t.clipboard)}),this.triggers.on(this.click,function(s){return s.preventDefault(),i(this).parent().hasClass("cms-toolbar-item-navigation-disabled")?!1:void e.open({html:a,title:t.clipboard.data("title"),width:400,height:o})})},_events:function(){var t=this;this.triggerRemove.on(this.click,function(o){return o.preventDefault(),o.stopPropagation(),i(this).parent().hasClass("cms-toolbar-item-navigation-disabled")?!1:void t.clear(function(){t.clipboard.hide(),t.triggers.parent().addClass("cms-toolbar-item-navigation-disabled"),t.triggerRemove.parent().addClass("cms-toolbar-item-navigation-disabled")})})},clear:function(i){var t='{ "csrfmiddlewaretoken": "'+this.config.csrf+'" }';CMS.API.Toolbar.openAjax({url:this.config.clipboard.url,post:t,callback:i})}})})}(CMS.$);
