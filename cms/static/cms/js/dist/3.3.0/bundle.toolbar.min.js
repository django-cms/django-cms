...
touchmove:t.proxy(e,"_touchMove"),touchend:t.proxy(e,"_touchEnd")}),o.call(e)}}}(n)},,function(t,e,i){var n;!function(s,o,r){function a(t,e,i){return t.addEventListener?void t.addEventListener(e,i,!1):void t.attachEvent("on"+e,i)}function l(t){if("keypress"==t.type){var e=String.fromCharCode(t.which);return t.shiftKey||(e=e.toLowerCase()),e}return C[t.which]?C[t.which]:_[t.which]?_[t.which]:String.fromCharCode(t.which).toLowerCase()}function c(t,e){return t.sort().join(",")===e.sort().join(",")}function u(t){var e=[];return t.shiftKey&&e.push("shift"),t.altKey&&e.push("alt"),t.ctrlKey&&e.push("ctrl"),t.metaKey&&e.push("meta"),e}function d(t){return t.preventDefault?void t.preventDefault():void(t.returnValue=!1)}function h(t){return t.stopPropagation?void t.stopPropagation():void(t.cancelBubble=!0)}function p(t){return"shift"==t||"ctrl"==t||"alt"==t||"meta"==t}function f(){if(!w){w={};for(var t in C)t>95&&112>t||C.hasOwnProperty(t)&&(w[C[t]]=t)}return w}function m(t,e,i){return i||(i=f()[t]?"keydown":"keypress"),"keypress"==i&&e.length&&(i="keydown"),i}function g(t){return"+"===t?["+"]:(t=t.replace(/\+{2}/g,"+plus"),t.split("+"))}function v(t,e){var i,n,s,o=[];for(i=g(t),s=0;s<i.length;++s)n=i[s],T[n]&&(n=T[n]),e&&"keypress"!=e&&x[n]&&(n=x[n],o.push("shift")),p(n)&&o.push(n);return e=m(n,o,e),{key:n,modifiers:o,action:e}}function b(t,e){return null===t||t===o?!1:t===e?!0:b(t.parentNode,e)}function y(t){function e(t){t=t||{};var e,i=!1;for(e in w)t[e]?i=!0:w[e]=0;i||(x=!1)}function i(t,e,i,n,s,o){var r,a,l=[],u=i.type;if(!g._callbacks[t])return[];for("keyup"==u&&p(t)&&(e=[t]),r=0;r<g._callbacks[t].length;++r)if(a=g._callbacks[t][r],(n||!a.seq||w[a.seq]==a.level)&&u==a.action&&("keypress"==u&&!i.metaKey&&!i.ctrlKey||c(e,a.modifiers))){var d=!n&&a.combo==s,h=n&&a.seq==n&&a.level==o;(d||h)&&g._callbacks[t].splice(r,1),l.push(a)}return l}function n(t,e,i,n){g.stopCallback(e,e.target||e.srcElement,i,n)||t(e,i)===!1&&(d(e),h(e))}function s(t){"number"!=typeof t.which&&(t.which=t.keyCode);var e=l(t);if(e)return"keyup"==t.type&&C===e?void(C=!1):void g.handleKey(e,u(t),t)}function r(){clearTimeout(b),b=setTimeout(e,1e3)}function f(t,i,s,o){function a(e){return function(){x=e,++w[t],r()}}function c(i){n(s,i,t),"keyup"!==o&&(C=l(i)),setTimeout(e,10)}w[t]=0;for(var u=0;u<i.length;++u){var d=u+1===i.length,h=d?c:a(o||v(i[u+1]).action);m(i[u],h,o,t,u)}}function m(t,e,n,s,o){g._directMap[t+":"+n]=e,t=t.replace(/\s+/g," ");var r,a=t.split(" ");return a.length>1?void f(t,a,e,n):(r=v(t,n),g._callbacks[r.key]=g._callbacks[r.key]||[],i(r.key,r.modifiers,{type:r.action},s,t,o),void g._callbacks[r.key][s?"unshift":"push"]({callback:e,modifiers:r.modifiers,action:r.action,seq:s,level:o,combo:t}))}var g=this;if(t=t||o,!(g instanceof y))return new y(t);g.target=t,g._callbacks={},g._directMap={};var b,w={},C=!1,_=!1,x=!1;g._handleKey=function(t,s,o){var r,a=i(t,s,o),l={},c=0,u=!1;for(r=0;r<a.length;++r)a[r].seq&&(c=Math.max(c,a[r].level));for(r=0;r<a.length;++r)if(a[r].seq){if(a[r].level!=c)continue;u=!0,l[a[r].seq]=1,n(a[r].callback,o,a[r].combo,a[r].seq)}else u||n(a[r].callback,o,a[r].combo);var d="keypress"==o.type&&_;o.type!=x||p(t)||d||e(l),_=u&&"keydown"==o.type},g._bindMultiple=function(t,e,i){for(var n=0;n<t.length;++n)m(t[n],e,i)},a(t,"keypress",s),a(t,"keydown",s),a(t,"keyup",s)}if(s){for(var w,C={8:"backspace",9:"tab",13:"enter",16:"shift",17:"ctrl",18:"alt",20:"capslock",27:"esc",32:"space",33:"pageup",34:"pagedown",35:"end",36:"home",37:"left",38:"up",39:"right",40:"down",45:"ins",46:"del",91:"meta",93:"meta",224:"meta"},_={106:"*",107:"+",109:"-",110:".",111:"/",186:";",187:"=",188:",",189:"-",190:".",191:"/",192:"`",219:"[",220:"\\",221:"]",222:"'"},x={"~":"`","!":"1","@":"2","#":"3",$:"4","%":"5","^":"6","&":"7","*":"8","(":"9",")":"0",_:"-","+":"=",":":";",'"':"'","<":",",">":".","?":"/","|":"\\"},T={option:"alt",command:"meta","return":"enter",escape:"esc",plus:"+",mod:/Mac|iPod|iPhone|iPad/.test(navigator.platform)?"meta":"ctrl"},S=1;20>S;++S)C[111+S]="f"+S;for(S=0;9>=S;++S)C[S+96]=S;y.prototype.bind=function(t,e,i){var n=this;return t=t instanceof Array?t:[t],n._bindMultiple.call(n,t,e,i),n},y.prototype.unbind=function(t,e){var i=this;return i.bind.call(i,t,function(){},e)},y.prototype.trigger=function(t,e){var i=this;return i._directMap[t+":"+e]&&i._directMap[t+":"+e]({},t),i},y.prototype.reset=function(){var t=this;return t._callbacks={},t._directMap={},t},y.prototype.stopCallback=function(t,e){var i=this;return(" "+e.className+" ").indexOf(" mousetrap ")>-1?!1:b(e,i.target)?!1:"INPUT"==e.tagName||"SELECT"==e.tagName||"TEXTAREA"==e.tagName||e.isContentEditable},y.prototype.handleKey=function(){var t=this;return t._handleKey.apply(t,arguments)},y.addKeycodes=function(t){for(var e in t)t.hasOwnProperty(e)&&(C[e]=t[e]);w=null},y.init=function(){var t=y(o);for(var e in t)"_"!==e.charAt(0)&&(y[e]=function(e){return function(){return t[e].apply(t,arguments)}}(e))},y.init(),s.Mousetrap=y,"undefined"!=typeof t&&t.exports&&(t.exports=y),n=function(){return y}.call(e,i,e,t),!(n!==r&&(t.exports=n))}}("undefined"!=typeof window?window:null,"undefined"!=typeof window?document:null)}]);