...
var CMS=window.CMS||{};!function(o){"use strict";CMS.PageTreeDropdowns=new CMS.Class({options:{triggerSelector:".js-cms-pagetree-dropdown-trigger",menuSelector:".js-cms-pagetree-dropdown-menu",openCls:"cms-pagetree-dropdown-menu-open"},initialize:function(e){this.options=o.extend(!0,{},this.options,e),this.click="click.cms.pagetree.dropdown",this._setupUI(),this._events()},_setupUI:function(){this.ui={container:this.options.container,document:o(document)}},_events:function(){var e,t,n,i=this;this.ui.container.on(this.click,this.options.triggerSelector,function(s){return s.preventDefault(),s.stopImmediatePropagation(),e=o(i.options.triggerSelector),t=o(i.options.menuSelector),n=e.index(this),t.eq(n).is(":visible")?(t.removeClass(i.options.openCls),!1):(t.removeClass(i.options.openCls).eq(n).addClass(i.options.openCls),void i.ui.document.one(i.click,function(){t.removeClass(i.options.openCls)}))}),this.ui.container.on(this.click,i.options.menuSelector,function(o){o.stopImmediatePropagation()}),this.ui.container.on(this.click,i.options.menuSelector+" a",function(){i.closeAllDropdowns()})},closeAllDropdowns:function(){o(this.options.menuSelector).removeClass(this.options.openCls)}})}(CMS.$);
