...
var CMS=window.CMS||{};!function(o){"use strict";CMS.PageTreeDropdowns=new CMS.Class({options:{dropdownSelector:".js-cms-pagetree-dropdown",triggerSelector:".js-cms-pagetree-dropdown-trigger",menuSelector:".js-cms-pagetree-dropdown-menu",openCls:"cms-pagetree-dropdown-menu-open"},initialize:function(t){this.options=o.extend(!0,{},this.options,t),this.click="click.cms.pagetree.dropdown",this._setupUI(),this._events()},_setupUI:function(){this.ui={container:this.options.container,document:o(document)}},_events:function(){var o=this;this.ui.container.on(this.click,this.options.triggerSelector,function(t){t.preventDefault(),t.stopImmediatePropagation(),o._toggleDropdown(this)}),this.ui.container.on(this.click,o.options.menuSelector,function(o){o.stopImmediatePropagation()}),this.ui.container.on(this.click,o.options.menuSelector+" a",function(){o.closeAllDropdowns()}),this.ui.document.on(this.click,function(){o.closeAllDropdowns()})},_toggleDropdown:function(t){var e=o(this.options.triggerSelector),n=o(this.options.dropdownSelector),i=e.index(t);return n.eq(i).hasClass(this.options.openCls)?(n.removeClass(this.options.openCls),!1):void n.removeClass(this.options.openCls).eq(i).addClass(this.options.openCls)},closeAllDropdowns:function(){o(this.options.dropdownSelector).removeClass(this.options.openCls)}})}(CMS.$);
var CMS=window.CMS||{};!function(e){"use strict";CMS.PageTree=new CMS.Class({initialize:function(t){this.options=e(".js-cms-pagetree").data("json"),this.options=e.extend(!0,{},this.options,t),this.click="click.cms.pagetree",this.cache={id:null,target:null,type:""},this.successTimer=1e3,this._setupUI(),this._events(),e.isEmptyObject(this.options)||this._setup()},_setupUI:function(){var t=e(".cms-pagetree");this.ui={container:t,document:e(document),tree:t.find(".js-cms-pagetree"),dialog:e(".js-cms-tree-dialog"),siteForm:e(".js-cms-pagetree-site-form")}},_setup:function(){var t=this,s=[],i={language:this.options.lang.code,openNodes:[]},n=!1;CMS.API.Helpers.csrf(this.options.csrf),e.each(this.options.columns,function(e,t){""===t.key?s.push({header:t.title,width:t.width||"1%",wideCellClass:t.cls}):s.push({header:t.title,value:function(e){return e.data?e.data["col"+t.key.replace("-","")]:""},width:t.width||"1%",wideCellClass:t.cls})}),this.options.filtered||(n={url:this.options.urls.tree,data:function(e){return"#"!==e.id?i.pageId=t._storeNodeId(e.data.id):i.pageId=null,i.openNodes=t._getStoredNodeIds(),i.site=t.options.site,i}}),this.ui.tree.jstree({core:{animation:0,check_callback:function(s,i,n,o,r){return("move_node"===s||"copy_node"===s)&&r&&r.pos&&("i"===r.pos?e("#jstree-marker").addClass("jstree-marker-child"):e("#jstree-marker").removeClass("jstree-marker-child")),!t.options.filtered},data:n,strings:{"Loading ...":this.options.lang.loading,"New node":this.options.lang.newNode,nodes:this.options.lang.nodes},error:function(e){var s=JSON.parse(e.data);"check"===e.error&&s&&"move_node"===s.chk||t.showError(e.reason)},themes:{name:"django-cms"},multiple:!1},plugins:["dnd","search","grid"],dnd:{inside_pos:"last",drag_selection:!1,is_draggable:function(){return!t.options.filtered},copy:!1},grid:{width:"100%",columns:s}})},_events:function(){var t=this;this.ui.tree.on("after_close.jstree",function(e,s){t._removeNodeId(s.node.data.id)}),this.ui.tree.on("after_open.jstree",function(e,s){t._storeNodeId(s.node.data.id),t._checkHelpers()}),this.ui.document.on("keydown.pagetree.alt-mode",function(e){e.keyCode===CMS.KEYS.SHIFT&&t.ui.container.addClass("cms-pagetree-alt-mode")}),this.ui.document.on("keyup.pagetree.alt-mode",function(e){e.keyCode===CMS.KEYS.SHIFT&&t.ui.container.removeClass("cms-pagetree-alt-mode")}),this.ui.document.on("dnd_start.vakata",function(s,i){var n=e(i.element),o=n.parent();t._dropdowns.closeAllDropdowns(),o.addClass("jstree-is-dragging"),i.data.nodes.forEach(function(s){var i=t._getDescendantsIds(s);[s].concat(i).forEach(function(t){e(".jsgrid_"+t+"_col").addClass("jstree-is-dragging")})}),o.hasClass("jstree-leaf")||i.helper.addClass("is-stacked")}),this.ui.document.on("dnd_stop.vakata",function(s,i){var n=e(i.element),o=n.parent();o.removeClass("jstree-is-dragging"),i.data.nodes.forEach(function(s){var i=t._getDescendantsIds(s);[s].concat(i).forEach(function(t){e(".jsgrid_"+t+"_col").removeClass("jstree-is-dragging")})})}),this.ui.tree.on("move_node.jstree copy_node.jstree",function(e,s){t.cache.type&&"cut"!==t.cache.type?t._copyNode(s):t._moveNode(t._getNodePosition(s)).done(function(){var e=t.ui.tree.jstree(!0);e._hide_grid(e.get_node(s.parent)),"#"===s.parent?e.refresh():e.refresh_node(s.parent)}),t.ui.tree.jstree("open_node",s.parent)}),this.ui.container.on(this.click,".js-cms-tree-item-cut",function(s){s.preventDefault(),t._cutOrCopy({type:"cut",element:e(this)})}),this.ui.container.on(this.click,".js-cms-tree-item-copy",function(s){s.preventDefault(),t._cutOrCopy({type:"copy",element:e(this)})}),this.ui.container.on(this.click,".cms-tree-item-helpers a",function(e){e.preventDefault(),t._paste(e)}),this.ui.container.on(this.click,".js-cms-tree-advanced-settings",function(t){t.shiftKey&&(t.preventDefault(),window.location.href=e(this).data("url"))}),this.ui.document.on(this.click,".messagelist .cms-tree-reload",function(e){e.preventDefault(),t._reloadHelper()}),this.ui.container.find(".js-cms-pagetree-site-trigger").on(this.click,function(s){s.preventDefault();var i=e(this);return i.parent().hasClass("active")?!1:void t.ui.siteForm.find("select").val(i.data().id).end().submit()}),this._setupDropdowns(),this._setupSearch(),this._setAjaxPost(".js-cms-tree-item-menu a"),this._setAjaxPost(".js-cms-tree-lang-trigger"),this._setupPageView()},_cutOrCopy:function(e){if("copy"===e.type&&e.element.data().apphook)return this.showError(this.options.lang.apphook),!1;var t=this._getNodeId(e.element.closest(".jstree-grid-cell"));this.cache.type===e.type&&t===this.cache.id?(this.cache.type=null,this._hideHelpers()):(this.cache.target=e.element,this.cache.type=e.type,this.cache.id=t,this._showHelpers(),this._checkHelpers())},_paste:function(t){this._hideHelpers();var s=this._getNodeId(this.cache.target),i=this._getNodeId(e(t.currentTarget));i.indexOf("jstree-1")>-1&&(i="#"),"cut"===this.cache.type?this.ui.tree.jstree("cut",s):this.ui.tree.jstree("copy",s),this.ui.tree.jstree("paste",i,"last"),this.cache.type=null,this.cache.target=null},_getStoredNodeIds:function(){return CMS.settings.pagetree||[]},_storeNodeId:function(e){var t=e,s=this._getStoredNodeIds();return-1===s.indexOf(t)&&s.push(t),CMS.settings.pagetree=s,CMS.API.Helpers.setSettings(CMS.settings),t},_removeNodeId:function(e){var t=e,s=this._getStoredNodeIds(),i=s.indexOf(t);return-1!==i&&s.splice(i,1),CMS.settings.pagetree=s,CMS.API.Helpers.setSettings(CMS.settings),t},_moveNode:function(t){var s=this;return t.site=s.options.site,e.ajax({method:"post",url:s.options.urls.move.replace("{id}",t.id),data:t}).done(function(){s._showSuccess(t.id)}).fail(function(e){s.showError(e.statusText)})},_copyNode:function(t){var s=this,i=s._getNodePosition(t),n={site:this.options.site,id:t.original.data.id,position:i.position};i.target&&(n.target=i.target),s.options.permission?(e.ajax({method:"post",url:s.options.urls.copyPermission.replace("{id}",n.id),data:n}).done(function(e){s.ui.dialog.append(e)}).fail(function(e){s.showError(e.statusText)}),this.ui.dialog.off(this.click,".cancel").on(this.click,".cancel",function(i){i.preventDefault(),s.ui.tree.jstree("delete_node",t.node.id),e(".js-cms-dialog").remove(),e(".js-cms-dialog-dimmer").remove()}).off(this.click,".submit").on(this.click,".submit",function(t){t.preventDefault();for(var i=e(this).closest("form").serialize().split("&"),o=0;o<i.length;o++)n[i[o].split("=")[0]]=i[o].split("=")[1];s._saveCopiedNode(n)})):this._saveCopiedNode(n)},_saveCopiedNode:function(t){var s=this;return e.ajax({method:"post",url:s.options.urls.copy.replace("{id}",t.id),data:t}).done(function(){s._reloadHelper()}).fail(function(e){s.showError(e.statusText)})},_getNodeId:function(e){var t=e.closest(".jstree-grid-cell").attr("class");return t?t.replace(/.*jsgrid_(.+?)_col.*/,"$1"):!1},_getNodePosition:function(e){var t={},s=this.ui.tree.jstree("get_node",e.node.parent);return t.position=e.position,"#"!==e.parent&&(t.target=s.data.id),e.node&&e.node.data&&(t.id=e.node.data.id),t},_setupDropdowns:function(){this._dropdowns=new CMS.PageTreeDropdowns({container:this.ui.container})},_setupPageView:function(){var e=CMS.API.Helpers._getWindow(),t=e.parent?e.parent:e;this.ui.container.on(this.click,".js-cms-pagetree-page-view",function(){t.CMS.API.Helpers.setSettings({sideframe:{url:null,hidden:!0}})})},_setAjaxPost:function(t){var s=this;this.ui.container.on(this.click,t,function(t){t.preventDefault(),e.ajax({method:"post",url:e(this).attr("href")}).done(function(){if(window.self!==window.top){var e=window.parent?window.parent:window,t={model:"cms.page",pk:e.CMS.config.request.page_id};CMS.API.Helpers.reloadBrowser("REFRESH_PAGE",!1,!0,t)}else s._reloadHelper()}).fail(function(e){s.showError(e.statusText)})})},_setupSearch:function(){var e=this,t=this.click+".search",s=!1,i=this.ui.container.find(".js-cms-pagetree-header-filter-trigger"),n=this.ui.container.find(".js-cms-pagetree-header-filter-container"),o=n.find(".js-cms-pagetree-header-search-close"),r="cms-pagetree-header-filter-active",a=this.ui.container.find(".js-cms-pagetree-header-search"),c=this.ui.container.find(".js-cms-pagetree-header-search-copy form"),d=this.ui.container.find(".cms-pagetree-header-filter"),l=d.find("#field-searchbar"),h=200;l.on("focus",function(e){e.stopImmediatePropagation(),d.addClass(r)}),l.on("blur",function(i){i.stopImmediatePropagation(),setTimeout(function(){s||d.removeClass(r)},h),e.ui.document.off(t)}),i.add(o).on(t,function(o){o.preventDefault(),o.stopImmediatePropagation(),s?(n.hide(),d.removeClass(r),e.ui.document.off(t),s=!1):(n.show(),d.addClass(r),e.ui.document.on(t,function(){s=!0,i.trigger(t)}),s=!0)}),n.on("click",function(e){e.stopImmediatePropagation()}),a.append(c.find('input[type="hidden"]'))},_showHelpers:function(){e(".cms-tree-item-helpers").removeClass("cms-hidden")},_hideHelpers:function(){e(".cms-tree-item-helpers").addClass("cms-hidden"),this.cache.id=null},_checkHelpers:function(){if(this.cache.type&&this.cache.id&&this._showHelpers(this.cache.type),"cut"===this.cache.type&&this.cache.target){var t=this._getDescendantsIds(this.cache.id);[this.cache.id].concat(t).forEach(function(t){e(".jsgrid_"+t+"_col .cms-tree-item-helpers").addClass("cms-hidden")})}},_showSuccess:function(e){var t=this.ui.tree.find('li[data-id="'+e+'"]');t.addClass("cms-tree-node-success"),setTimeout(function(){t.removeClass("cms-tree-node-success")},this.successTimer),this._hideHelpers()},_reloadHelper:function(){window.self!==window.top?window.location.reload():CMS.API.Helpers.reloadBrowser()},showError:function(t){var s=e(".messagelist"),i=e(".breadcrumbs"),n=this.options.lang.reload,o='<ul class="messagelist">   <li class="error">       {msg}        <a href="#reload" class="cms-tree-reload"> '+n+" </a>   </li></ul>",r=o.replace("{msg}","<strong>"+this.options.lang.error+"</strong> "+t);s.length?s.replaceWith(r):i.after(r)},_getDescendantsIds:function(e){return this.ui.tree.jstree(!0).get_node(e).children_d}}),e(function(){CMS.config={settings:{toolbar:"expanded"},urls:{settings:e(".js-cms-pagetree").data("settings-url")}},CMS.settings=CMS.API.Helpers.getSettings(),new CMS.PageTree})}(CMS.$);
>>>>>>> develop
