...
var CMS=window.CMS||{};!function(e){"use strict";e.jstree.plugins.gridResize=function(t,s){function i(){var e=n.ui.container.outerWidth(!0),t=n.ui.inner.outerWidth(!0);if(!n.snapshot.length&&t>e&&(n.snapshot=o()),n.snapshot.length)for(var s=n.snapshot.length,i=1;i<n.snapshot.length;i++){for(var r,c,a=0,d=n.snapshot.length-i,h=1;i>h;h++)a=a+n.snapshot.array[n.snapshot.length-h]||0;r=e<n.snapshot.width-a,c=d+1>=s,r&&c?(n.ui.cols.eq(d).addClass("cms-hidden"),s=d):n.ui.cols.eq(d).removeClass("cms-hidden")}}function o(){var t=[];return n.ui.cols.each(function(){t.push(e(this).outerWidth(!0))}),{array:t,length:t.length,width:t.reduce(function(e,t){return e+t},0)}}var n=this;this.bind=function(){s.bind.call(this),this.element.on("ready.jstree",function(){n.ui={window:e(window),cols:e(".jstree-grid-column"),container:e(".jstree-grid-wrapper"),inner:e(".jstree-grid-midwrapper")},n.timeout=100,n.snapshot=[],n.ui.window.on("resize.jstree",CMS.API.Helpers.throttle(i,n.timeout)).trigger("resize.jstree")}),this.element.on("redraw.jstree after_open.jstree after_close.jstree dnd_stop.vakata",function(){n.snapshot=[]})}},CMS.PageTree=new CMS.Class({initialize:function(t){this.options=e(".js-cms-pagetree").data("json"),this.options=e.extend(!0,{},this.options,t),this.click="click.cms.pagetree",this.cacheTarget=null,this.cacheType="",this.cacheId="",this.successTimer=1e3,this._setupUI(),this._events(),e.isEmptyObject(this.options)||this._setup()},_setupUI:function(){var t=e(".cms-pagetree-container");this.ui={container:t,document:e(document),tree:t.find(".js-cms-pagetree"),dialog:e(".js-cms-tree-dialog")}},_setup:function(){var t=this,s=[],i={language:this.options.lang.code,openNodes:[]},o=!1;CMS.API.Helpers.csrf(this.options.csrf),e.each(this.options.columns,function(e,t){s.push(""===t.key?{header:t.title,width:t.width||"1%",wideCellClass:t.cls}:{header:t.title,value:function(e){return e.data?e.data["col"+t.key]:""},width:t.width||"1%",wideCellClass:t.cls})}),this.options.filtered||(o={url:this.options.urls.tree,data:function(e){return"#"!==e.id&&(i.pageId=t._storeNodeId(e.data.id)),i.openNodes=t._getStoredNodeIds(),i.site=t.options.site,i}}),this.ui.tree.jstree({core:{animation:0,check_callback:function(){return t.options.filtered?!1:!0},data:o,strings:{"Loading ...":this.options.lang.loading,"New node":this.options.lang.newNode,nodes:this.options.lang.nodes},error:function(e){t.showError(e.reason)},themes:{name:"django-cms"},multiple:!1},plugins:["dnd","search","grid","gridResize"],dnd:{inside_pos:"last",drag_selection:!1,copy:!1},grid:{width:"100%",columns:s}})},_events:function(){var t=this;this.ui.tree.on("after_close.jstree",function(e,s){t._removeNodeId(s.node.data.id)}),this.ui.tree.on("after_open.jstree",function(e,s){t._storeNodeId(s.node.data.id),t._checkHelpers()}),this.ui.tree.on("move_node.jstree copy_node.jstree",function(e,s){t.cacheType&&"cut"!==t.cacheType?t._copyNode(s):t._moveNode(t._getNodePosition(s)),t.ui.tree.jstree("open_node",s.parent)}),this.ui.container.on(this.click,".js-cms-tree-item-cut",function(s){s.preventDefault(),t._cutAndCopy({type:"cut",element:e(this)})}),this.ui.container.on(this.click,".js-cms-tree-item-copy",function(s){s.preventDefault(),t._cutAndCopy({type:"copy",element:e(this)})}),this.ui.container.on(this.click,".cms-tree-item-helpers a",function(e){e.preventDefault(),t._paste(e)}),this._setFilter(),this._setTooltips(),this._setAjaxPost(".js-cms-tree-item-menu a"),this._setAjaxPost(".js-cms-tree-lang-trigger")},_cutAndCopy:function(e){var t=this._getNodeId(e.element.closest(".jstree-grid-cell"));this.cacheType===e.type&&t===this.cacheId?(this.cacheType=null,this._hideHelpers()):(this.cacheTarget=e.element,this.cacheType=e.type,this.cacheId=t,this._showHelpers(),this._checkHelpers())},_paste:function(t){this._hideHelpers();var s=this._getNodeId(this.cacheTarget),i=this._getNodeId(e(t.currentTarget));i.indexOf("jstree-1")>-1&&(i="#"),"cut"===this.cacheType?this.ui.tree.jstree("cut",s):this.ui.tree.jstree("copy",s),this.ui.tree.jstree("paste",i,"last")},_getStoredNodeIds:function(){return CMS.settings.pagetree||[]},_storeNodeId:function(e){var t=e,s=this._getStoredNodeIds();return-1===s.indexOf(t)&&s.push(t),CMS.settings.pagetree=s,CMS.API.Helpers.setSettings(CMS.settings),t},_removeNodeId:function(e){var t=e,s=this._getStoredNodeIds(),i=s.indexOf(t);return-1!==i&&s.splice(i,1),CMS.settings.pagetree=s,CMS.API.Helpers.setSettings(CMS.settings),t},_moveNode:function(t){var s=this;t.site=s.options.site,e.ajax({method:"post",url:s.options.urls.move.replace("{id}",t.id),data:t}).done(function(){s._showSuccess(t.id)}).fail(function(e){s.showError(e.statusText)})},_copyNode:function(t){var s=this,i=s._getNodePosition(t),o={site:this.options.site,id:t.original.data.id,position:i.position};i.target&&(o.target=i.target),e.ajax({method:"post",url:s.options.urls.copyPermission.replace("{id}",o.id),data:o}).done(function(e){s.ui.dialog.append(e)}).fail(function(e){s.showError(e.statusText)}),this.ui.dialog.off(this.click,".cancel").on(this.click,".cancel",function(i){i.preventDefault(),s.ui.tree.jstree("delete_node",t.node.id),e(".js-cms-dialog").remove()}).off(this.click,".submit").on(this.click,".submit",function(t){t.preventDefault();for(var i=e(this).closest("form").serialize().split("&"),n=0;n<i.length;n++)o[i[n].split("=")[0]]=i[n].split("=")[1];e.ajax({method:"post",url:s.options.urls.copy.replace("{id}",o.id),data:o}).done(function(){CMS.API.Helpers.reloadBrowser()}).fail(function(e){s.showError(e.statusText)})})},_getNodeId:function(e){return e.closest(".jstree-grid-cell").attr("class").replace(/.*jsgrid_(.+?)_col.*/,"$1")},_getNodePosition:function(e){var t={},s=this.ui.tree.jstree("get_node",e.node.parent);return t.position=e.position,"#"!==e.parent&&(t.target=s.data.id),e.node&&e.node.data&&(t.id=e.node.data.id),t},_setFilter:function(){var t=this,s=e(".js-cms-tree-filter-trigger"),i=e(".js-cms-tree-filter-container");s.on(this.click,function(e){e.preventDefault(),e.stopImmediatePropagation(),i.toggleClass("hidden"),t.ui.document.one(t.click,function(){i.addClass("hidden")})}),i.on(t.click,function(e){e.stopImmediatePropagation()}),e(".js-cms-tree-search-site select").on("change",function(){e(this).closest("form").submit()})},_setTooltips:function(){var t,s,i=this,o=".js-cms-tree-tooltip-trigger",n=".js-cms-tree-tooltip-container";this.ui.container.on(this.click,o,function(r){r.preventDefault(),r.stopImmediatePropagation(),t=e(o),s=e(n),s.removeClass("cms-tree-tooltip-container-open").eq(t.index(this)).addClass("cms-tree-tooltip-container-open"),i.ui.document.one(i.click,function(){s.removeClass("cms-tree-tooltip-container-open")})}),this.ui.container.on(this.click,n,function(e){e.stopImmediatePropagation()})},_setAjaxPost:function(t){var s=this;this.ui.container.on(this.click,t,function(t){t.preventDefault(),e.ajax({method:"post",url:e(this).attr("href")}).done(function(){CMS.API.Helpers.reloadBrowser()}).fail(function(e){s.showError(e.statusText)})})},_showHelpers:function(){e(".cms-tree-item-helpers").removeClass("cms-hidden")},_hideHelpers:function(){e(".cms-tree-item-helpers").addClass("cms-hidden"),this.cacheId=null},_checkHelpers:function(){this.cacheType&&this._showHelpers(this.cacheType),"cut"===this.cacheType&&this.cacheTarget&&e(".jsgrid_"+this._getNodeId(this.cacheTarget.closest(".jstree-grid-cell"))+"_col .cms-tree-item-helpers").addClass("cms-hidden")},_showSuccess:function(e){var t=this.ui.tree.find('li[data-id="'+e+'"]');t.addClass("cms-tree-node-success"),setTimeout(function(){t.removeClass("cms-tree-node-success")},this.successTimer)},showError:function(t){var s=e(".messagelist"),i=e(".breadcrumbs"),o='<ul class="messagelist"><li class="error">{msg}</li></ul>',n=o.replace("{msg}",this.options.lang.error+" – "+t);s.length?s.replaceWith(n):i.after(n)}}),e(function(){CMS.config={},CMS.settings=CMS.API.Helpers.getSettings(),new CMS.PageTree})}(CMS.$);