...
var CMS=window.CMS||{};!function(e){"use strict";CMS.PageTreeStickyHeader=new CMS.Class({initialize:function(t){var i=this;i.options=e.extend(!0,{},i.options,t),i.resize="resize.cms.pagetree.header",i.scroll="scroll.cms.pagetree.header",i.areClonesInDOM=!1,i._setupUI(),i._saveSizes(),i._events()},_setupUI:function(){var t=this.options.container,i=t.find(".jstree-grid-header");this.ui={container:t,window:e(window),headers:i,columns:t.find(".jstree-grid-column").toArray().map(function(t){return e(t)}),clones:i.clone().toArray().map(function(t){return e(t)})}},_saveSizes:function(){if(this.headersTopOffset=this.ui.headers.offset().top,this.toolbarHeight=0,this._isInSideframe()){this.toolbarHeight=CMS.API.Helpers._getWindow().parent.CMS.$(".cms-toolbar").height();var t=CMS.API.Helpers._getWindow().parent.CMS.$(".cms-debug-bar");t.length&&(this.toolbarHeight+=t.outerHeight())}else this.toolbarHeight=e("#branding").height()},_isInSideframe:function(){var e=CMS.API.Helpers._getWindow();return!(!e||!e.parent||e.parent===e)},_events:function(){this.ui.window.on([this.resize,this.scroll].join(" "),this._handleResizeOrScroll.bind(this))},_handleResizeOrScroll:function(){var e=this,t=e.ui.window.scrollTop(),i=e.ui.window.scrollLeft();e._shouldStick(t)?e._stickHeader(t,i):e._unstickHeader()},_shouldStick:function(e){return e+this.toolbarHeight>=this.headersTopOffset},_stickHeader:function(t,i){var s=this;s._insertClones(),s.ui.headers.each(function(t){var n=e(this),r=s.ui.clones[t].css("width"),o=s.ui.clones[t].offset().left;n.css({width:r,left:o-i})}),s.ui.headers.addClass("jstree-grid-header-fixed").css({top:s.toolbarHeight})},_unstickHeader:function(){var e=this;e._detachClones(),e.ui.headers.removeClass("jstree-grid-header-fixed").css({top:0,width:"auto",left:"auto"})},_insertClones:function(){var e=this;e.areClonesInDOM||(e.ui.columns.forEach(function(t,i){t.prepend(e.ui.clones[i])}),e.areClonesInDOM=!0)},_detachClones:function(){var e=this;e.areClonesInDOM&&(e.ui.clones.forEach(function(e){e.detach()}),e.areClonesInDOM=!1)}})}(CMS.$);
var CMS=window.CMS||{};!function(e){"use strict";CMS.PageTree=new CMS.Class({options:{pasteSelector:".js-cms-tree-item-paste"},initialize:function(t){var i=e(".js-cms-pagetree").data("json");this.options=e.extend(!0,{},this.options,i,t),this.click="click.cms.pagetree",this.clipboard={id:null,origin:null,type:""},this.successTimer=1e3,this._setupUI(),this._events(),e.isEmptyObject(i)||this._setup()},_setupUI:function(){var t=e(".cms-pagetree");this.ui={container:t,document:e(document),tree:t.find(".js-cms-pagetree"),dialog:e(".js-cms-tree-dialog"),siteForm:e(".js-cms-pagetree-site-form")}},_setup:function(){var t=this,i=[],s={language:this.options.lang.code,openNodes:[]},o=!1;CMS.API.Helpers.csrf(this.options.csrf),e.each(this.options.columns,function(e,t){""===t.key?i.push({header:t.title,width:t.width||"1%",wideCellClass:t.cls}):i.push({header:t.title,value:function(e){return e.data?e.data["col"+t.key.replace("-","")]:""},width:t.width||"1%",wideCellClass:t.cls})}),this.options.filtered||(o={url:this.options.urls.tree,cache:!1,data:function(e){return"#"===e.id?s.pageId=null:s.pageId=t._storeNodeId(e.data.id),s.openNodes=t._getStoredNodeIds(),s.site=t.options.site,s}}),this.ui.tree.jstree({core:{animation:0,check_callback:function(i,s,o,n,r){return("move_node"===i||"copy_node"===i)&&r&&r.pos&&("i"===r.pos?e("#jstree-marker").addClass("jstree-marker-child"):e("#jstree-marker").removeClass("jstree-marker-child")),!t.options.filtered},data:o,strings:{"Loading ...":this.options.lang.loading,"New node":this.options.lang.newNode,nodes:this.options.lang.nodes},error:function(e){var i=JSON.parse(e.data);"check"===e.error&&i&&"move_node"===i.chk||t.showError(e.reason)},themes:{name:"django-cms"},multiple:!1},plugins:["dnd","search","grid"],dnd:{inside_pos:"last",drag_selection:!1,is_draggable:function(){return!t.options.filtered},copy:!1},grid:{width:"100%",columns:i}})},_events:function(){var t=this;this.ui.tree.on("after_close.jstree",function(e,i){t._removeNodeId(i.node.data.id)}),this.ui.tree.on("after_open.jstree",function(e,i){t._storeNodeId(i.node.data.id),this.clipboard&&!this.clipboard.isPasting&&t._updatePasteHelpersState()}),this.ui.document.on("keydown.pagetree.alt-mode",function(e){e.keyCode===CMS.KEYS.SHIFT&&t.ui.container.addClass("cms-pagetree-alt-mode")}),this.ui.document.on("keyup.pagetree.alt-mode",function(e){e.keyCode===CMS.KEYS.SHIFT&&t.ui.container.removeClass("cms-pagetree-alt-mode")}),this.ui.document.on("dnd_start.vakata",function(i,s){var o=e(s.element),n=o.parent();t._dropdowns.closeAllDropdowns(),n.addClass("jstree-is-dragging"),s.data.nodes.forEach(function(i){var s=t._getDescendantsIds(i);[i].concat(s).forEach(function(t){e(".jsgrid_"+t+"_col").addClass("jstree-is-dragging")})}),n.hasClass("jstree-leaf")||s.helper.addClass("is-stacked")}),this.ui.document.on("dnd_stop.vakata",function(i,s){var o=e(s.element),n=o.parent();n.removeClass("jstree-is-dragging"),s.data.nodes.forEach(function(i){var s=t._getDescendantsIds(i);[i].concat(s).forEach(function(t){e(".jsgrid_"+t+"_col").removeClass("jstree-is-dragging")})})}),this.ui.tree.on("move_node.jstree copy_node.jstree",function(e,i){t.clipboard.type&&"cut"!==t.clipboard.type?t._copyNode(i):t._moveNode(t._getNodePosition(i)).done(function(){var e=t.ui.tree.jstree(!0);e._hide_grid(e.get_node(i.parent)),"#"===i.parent?e.refresh():e.refresh_node(i.parent)}),t.ui.tree.jstree("open_node",i.parent)}),this.ui.container.on(this.click,".js-cms-tree-item-cut",function(i){i.preventDefault(),t._cutOrCopy({type:"cut",element:e(this)})}),this.ui.container.on(this.click,".js-cms-tree-item-copy",function(i){i.preventDefault(),t._cutOrCopy({type:"copy",element:e(this)})}),this.ui.container.on(this.click,this.options.pasteSelector,function(i){i.preventDefault(),e(this).hasClass("cms-pagetree-dropdown-item-disabled")||t._paste(i)}),this.ui.container.on(this.click,".js-cms-tree-advanced-settings",function(t){t.shiftKey&&(t.preventDefault(),window.location.href=e(this).data("url"))}),this.ui.document.on(this.click,".messagelist .cms-tree-reload",function(e){e.preventDefault(),t._reloadHelper()}),this.ui.container.find(".js-cms-pagetree-site-trigger").on(this.click,function(i){i.preventDefault();var s=e(this);return s.parent().hasClass("active")?!1:void t.ui.siteForm.find("select").val(s.data().id).end().submit()}),this._setupDropdowns(),this._setupSearch(),this._setAjaxPost(".js-cms-tree-item-menu a"),this._setAjaxPost(".js-cms-tree-lang-trigger"),this._setupPageView(),t._setupStickyHeader()},_cutOrCopy:function(e){if("copy"===e.type&&e.element.data().apphook)return this.showError(this.options.lang.apphook),!1;var t=this._getNodeId(e.element.closest(".jstree-grid-cell"));this.clipboard.type===e.type&&t===this.clipboard.id?(this.clipboard.type=null,this.clipboard.id=null,this.clipboard.origin=null,this._disablePaste()):(this.clipboard.origin=e.element,this.clipboard.type=e.type,this.clipboard.id=t,this._updatePasteHelpersState())},_paste:function(t){this._disablePaste();var i=this._getNodeId(this.clipboard.origin),s=this._getNodeId(e(t.currentTarget));"cut"===this.clipboard.type?this.ui.tree.jstree("cut",i):this.ui.tree.jstree("copy",i),this.clipboard.isPasting=!0,this.ui.tree.jstree("paste",s,"last"),this.clipboard.id=null,this.clipboard.type=null,this.clipboard.origin=null,this.clipboard.isPasting=!1},_getStoredNodeIds:function(){return CMS.settings.pagetree||[]},_storeNodeId:function(e){var t=e,i=this._getStoredNodeIds();return-1===i.indexOf(t)&&i.push(t),CMS.settings.pagetree=i,CMS.API.Helpers.setSettings(CMS.settings),t},_removeNodeId:function(e){var t=e,i=this._getStoredNodeIds(),s=i.indexOf(t);return-1!==s&&i.splice(s,1),CMS.settings.pagetree=i,CMS.API.Helpers.setSettings(CMS.settings),t},_moveNode:function(t){var i=this;return t.site=i.options.site,e.ajax({method:"post",url:i.options.urls.move.replace("{id}",t.id),data:t}).done(function(){i._showSuccess(t.id)}).fail(function(e){i.showError(e.statusText)})},_copyNode:function(t){var i=this,s=i._getNodePosition(t),o={site:this.options.site,id:t.original.data.id,position:s.position};s.target&&(o.target=s.target),i.options.permission?(e.ajax({method:"post",url:i.options.urls.copyPermission.replace("{id}",o.id),data:o}).done(function(e){i.ui.dialog.append(e)}).fail(function(e){i.showError(e.statusText)}),this.ui.dialog.off(this.click,".cancel").on(this.click,".cancel",function(s){s.preventDefault(),i.ui.tree.jstree("delete_node",t.node.id),e(".js-cms-dialog").remove(),e(".js-cms-dialog-dimmer").remove()}).off(this.click,".submit").on(this.click,".submit",function(t){t.preventDefault();for(var s=e(this).closest("form").serialize().split("&"),n=0;n<s.length;n++)o[s[n].split("=")[0]]=s[n].split("=")[1];i._saveCopiedNode(o)})):this._saveCopiedNode(o)},_saveCopiedNode:function(t){var i=this;return e.ajax({method:"post",url:i.options.urls.copy.replace("{id}",t.id),data:t}).done(function(){i._reloadHelper()}).fail(function(e){i.showError(e.statusText)})},_getNodeId:function(e){var t=e.closest(".jstree-grid-cell").attr("class");return t?t.replace(/.*jsgrid_(.+?)_col.*/,"$1"):"#"},_getNodePosition:function(e){var t={},i=this.ui.tree.jstree("get_node",e.node.parent);return t.position=e.position,"#"!==e.parent&&(t.target=i.data.id),e.node&&e.node.data&&(t.id=e.node.data.id),t},_setupDropdowns:function(){this._dropdowns=new CMS.PageTreeDropdowns({container:this.ui.container})},_setupPageView:function(){var t=CMS.API.Helpers._getWindow(),i=t.parent?t.parent:t;this.ui.container.on(this.click,".js-cms-pagetree-page-view",function(){i.CMS.API.Helpers.setSettings(e.extend(!0,{},CMS.settings,{sideframe:{url:null,hidden:!0}}))})},_setupStickyHeader:function(){var e=this;e.ui.tree.on("ready.jstree",function(){e.header=new CMS.PageTreeStickyHeader({container:e.ui.container})})},_setAjaxPost:function(t){var i=this;this.ui.container.on(this.click,t,function(t){t.preventDefault(),e.ajax({method:"post",url:e(this).attr("href")}).done(function(){if(window.self===window.top)i._reloadHelper();else{var e=window.parent?window.parent:window,t={model:"cms.page",pk:e.CMS.config.request.page_id};CMS.API.Helpers.reloadBrowser("REFRESH_PAGE",!1,!0,t)}}).fail(function(e){i.showError(e.statusText)})})},_setupSearch:function(){var t=this,i=this.click+".search",s=!1,o=this.ui.container.find(".js-cms-pagetree-header-filter-trigger"),n=this.ui.container.find(".js-cms-pagetree-header-filter-container"),r=n.find(".js-cms-pagetree-header-search-close"),a="cms-pagetree-header-filter-active",d=e(".cms-pagetree-header"),c=this.ui.container.find(".js-cms-pagetree-header-search"),l=this.ui.container.find(".js-cms-pagetree-header-search-copy form"),p=this.ui.container.find(".cms-pagetree-header-filter"),u=p.find("#field-searchbar"),h=200;u.on("focus",function(e){e.stopImmediatePropagation(),d.addClass(a)}),u.on("blur",function(e){e.stopImmediatePropagation(),setTimeout(function(){s||d.removeClass(a)},h),t.ui.document.off(i)}),o.add(r).on(i,function(e){e.preventDefault(),e.stopImmediatePropagation(),s?(n.hide(),d.removeClass(a),t.ui.document.off(i),s=!1):(n.show(),d.addClass(a),t.ui.document.on(i,function(){s=!0,o.trigger(i)}),s=!0)}),n.on("click",function(e){e.stopImmediatePropagation()}),c.append(l.find('input[type="hidden"]'))},_enablePaste:function(t){var i="undefined"==typeof t?this.options.pasteSelector:t;e(i).removeClass("cms-pagetree-dropdown-item-disabled")},_disablePaste:function(t){var i="undefined"==typeof t?this.options.pasteSelector:t;e(i).addClass("cms-pagetree-dropdown-item-disabled")},_updatePasteHelpersState:function(){var e=this;if(this.clipboard.type&&this.clipboard.id&&this._enablePaste(),"cut"===this.clipboard.type&&this.clipboard.origin){var t=this._getDescendantsIds(this.clipboard.id),i=[this.clipboard.id];t&&t.length&&(i=i.concat(t)),i.forEach(function(t){e._disablePaste(".jsgrid_"+t+"_col "+e.options.pasteSelector)})}},_showSuccess:function(e){var t=this.ui.tree.find('li[data-id="'+e+'"]');t.addClass("cms-tree-node-success"),setTimeout(function(){t.removeClass("cms-tree-node-success")},this.successTimer),this._disablePaste(),this.clipboard.id=null},_reloadHelper:function(){window.self===window.top?CMS.API.Helpers.reloadBrowser():window.location.reload()},showError:function(t){var i=e(".messagelist"),s=e(".breadcrumbs"),o=this.options.lang.reload,n='<ul class="messagelist">   <li class="error">       {msg}        <a href="#reload" class="cms-tree-reload"> '+o+" </a>   </li></ul>",r=n.replace("{msg}","<strong>"+this.options.lang.error+"</strong> "+t);i.length?i.replaceWith(r):s.after(r)},_getDescendantsIds:function(e){return this.ui.tree.jstree(!0).get_node(e).children_d}}),e(function(){CMS.config={settings:{toolbar:"expanded"},urls:{settings:e(".js-cms-pagetree").data("settings-url")}},CMS.settings=CMS.API.Helpers.getSettings(),new CMS.PageTree})}(CMS.$);