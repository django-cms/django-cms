...
var CMS=window.CMS||{};!function(e){"use strict";CMS.PageTreeStickyHeader=new CMS.Class({initialize:function(i){var t=this;t.options=e.extend(!0,{},t.options,i),t.resize="resize.cms.pagetree.header",t.scroll="scroll.cms.pagetree.header",t.areClonesInDOM=!1,t._setupUI(),t._saveSizes(),t._events()},_setupUI:function(){var i=this.options.container,t=i.find(".jstree-grid-header");this.ui={container:i,window:e(window),headers:t,columns:i.find(".jstree-grid-column").toArray().map(function(i){return e(i)}),clones:t.clone().toArray().map(function(i){return e(i)})}},_saveSizes:function(){this.headersTopOffset=this.ui.headers.offset().top,this.toolbarHeight=0,this._isInSideframe()?this.toolbarHeight=CMS.API.Helpers._getWindow().parent.CMS.$(".cms-toolbar").height():this.toolbarHeight=e("#branding").height()},_isInSideframe:function(){var e=CMS.API.Helpers._getWindow();return!(!e||!e.parent||e.parent===e)},_events:function(){this.ui.window.on([this.resize,this.scroll].join(" "),this._handleResizeOrScroll.bind(this))},_handleResizeOrScroll:function(){var e=this,i=e.ui.window.scrollTop(),t=e.ui.window.scrollLeft();e._shouldStick(i)?e._stickHeader(i,t):e._unstickHeader()},_shouldStick:function(e){return e+this.toolbarHeight>=this.headersTopOffset},_stickHeader:function(i,t){var s=this;s._insertClones(),s.ui.headers.each(function(i){var n=e(this),r=s.ui.clones[i].css("width"),o=s.ui.clones[i].offset().left;n.css({width:r,left:o-t})}),s.ui.headers.addClass("jstree-grid-header-fixed").css({top:s.toolbarHeight})},_unstickHeader:function(){var e=this;e._detachClones(),e.ui.headers.removeClass("jstree-grid-header-fixed").css({top:0,width:"auto",left:"auto"})},_insertClones:function(){var e=this;e.areClonesInDOM||(e.ui.columns.forEach(function(i,t){i.prepend(e.ui.clones[t])}),e.areClonesInDOM=!0)},_detachClones:function(){var e=this;e.areClonesInDOM&&(e.ui.clones.forEach(function(e){e.detach()}),e.areClonesInDOM=!1)}})}(CMS.$);
