...
var CMS=window.CMS||{};!function(e){"use strict";CMS.PageTreeStickyHeader=new CMS.Class({initialize:function(t){var i=this;i.options=e.extend(!0,{},i.options,t),i.resize="resize.cms.pagetree.header",i.scroll="scroll.cms.pagetree.header",i.areClonesInDOM=!1,i._setupUI(),i._saveSizes(),i._events()},_setupUI:function(){var t=this.options.container,i=t.find(".jstree-grid-header");this.ui={container:t,window:e(window),headers:i,columns:t.find(".jstree-grid-column").toArray().map(function(t){return e(t)}),clones:i.clone().toArray().map(function(t){return e(t)})}},_saveSizes:function(){this.headersTopOffset=this.ui.headers.offset().top,this.toolbarHeight=0,this._isInSideframe()?this.toolbarHeight=CMS.API.Helpers._getWindow().parent.CMS.$(".cms-toolbar").height():this.toolbarHeight=e("#branding").height()},_isInSideframe:function(){var e=CMS.API.Helpers._getWindow();return!(!e||e.parent===e)},_events:function(){var e=this;e.ui.window.on([e.resize,e.scroll].join(" "),function(){var t=e.ui.window.scrollTop(),i=e.ui.window.scrollLeft();e._shouldStick(t)?e._stickHeader(t,i):e._unstickHeader()})},_shouldStick:function(e){return e+this.toolbarHeight>=this.headersTopOffset},_stickHeader:function(t,i){var s=this;s._insertClones(),s.ui.headers.each(function(t){var n=e(this),o=s.ui.clones[t].css("width"),r=s.ui.clones[t].offset().left;n.css({width:o,left:r-i})}),s.ui.headers.addClass("jstree-grid-header-fixed").css({top:s.toolbarHeight})},_unstickHeader:function(){var e=this;e._detachClones(),e.ui.headers.removeClass("jstree-grid-header-fixed").css({top:0,width:"auto",left:"auto"})},_insertClones:function(){var e=this;e.areClonesInDOM||(e.ui.columns.forEach(function(t,i){t.prepend(e.ui.clones[i])}),e.areClonesInDOM=!0)},_detachClones:function(){var e=this;e.areClonesInDOM&&(e.ui.clones.forEach(function(e){e.detach()}),e.areClonesInDOM=!1)}})}(CMS.$);
