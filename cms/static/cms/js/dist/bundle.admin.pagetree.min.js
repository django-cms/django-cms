...
var CMS=window.CMS||{};!function(o){"use strict";CMS.PageTreeDropdowns=new CMS.Class({options:{triggerSelector:".js-cms-pagetree-dropdown-trigger",menuSelector:".js-cms-pagetree-dropdown-menu",openCls:"cms-pagetree-dropdown-menu-open"},initialize:function(t){this.options=o.extend(!0,{},this.options,t),this.click="click.cms.pagetree.dropdown",this._setupUI(),this._events()},_setupUI:function(){this.ui={container:this.options.container,document:o(document)}},_events:function(){var o=this;this.ui.container.on(this.click,this.options.triggerSelector,function(t){t.preventDefault(),t.stopImmediatePropagation(),o._toggleDropdown(this)}),this.ui.container.on(this.click,o.options.menuSelector,function(o){o.stopImmediatePropagation()}),this.ui.container.on(this.click,o.options.menuSelector+" a",function(){o.closeAllDropdowns()}),this.ui.document.on(this.click,function(){o.closeAllDropdowns()})},_toggleDropdown:function(t){var e=o(this.options.triggerSelector),n=o(this.options.menuSelector),i=e.index(t);return n.eq(i).is(":visible")?(n.removeClass(this.options.openCls),!1):void n.removeClass(this.options.openCls).eq(i).addClass(this.options.openCls)},closeAllDropdowns:function(){o(this.options.menuSelector).removeClass(this.options.openCls)}})}(CMS.$);
