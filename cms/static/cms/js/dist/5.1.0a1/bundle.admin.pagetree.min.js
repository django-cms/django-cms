(window["webpackChunkdjango_cms"] = window["webpackChunkdjango_cms"] || []).push([["admin.pagetree"],{
...
(function (factory) {
    if (true) {
        ...
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ "./cms/static/cms/js/libs/jquery.min.js"), __webpack_require__(/*! jstree */ "./cms/static/cms/js/libs/jstree/jstree.min.js")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
...
!function(a){"use strict"; true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ "./cms/static/cms/js/libs/jquery.min.js")], __WEBPACK_AMD_DEFINE_FACTORY__ = (a),
		__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
		(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
...
/* harmony import */ var _modules_cms_pagetree__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/cms.pagetree */ "./cms/static/cms/js/modules/cms.pagetree.js");


window.CMS.PageTree = _modules_cms_pagetree__WEBPACK_IMPORTED_MODULE_0__["default"];
...
class PageTreeDropdowns {
  ...
  _toggleDropdown(trigger) {
    var dropdowns = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.options.dropdownSelector);
    var dropdown = jquery__WEBPACK_IMPORTED_MODULE_0___default()(trigger).closest(this.options.dropdownSelector);
   ...
   */
  closeAllDropdowns() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.options.dropdownSelector).removeClass(this.options.openCls);
  }
}
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PageTreeDropdowns);
...
/* harmony import */ var _cms_pagetree_dropdown__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cms.pagetree.dropdown */ "./cms/static/cms/js/modules/cms.pagetree.dropdown.js");
/* harmony import */ var _cms_pagetree_stickyheader__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./cms.pagetree.stickyheader */ "./cms/static/cms/js/modules/cms.pagetree.stickyheader.js");
...
/* harmony import */ var lodash_es_without_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! lodash-es/without.js */ "./node_modules/lodash-es/without.js");
/* harmony import */ var jstree__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! jstree */ "./cms/static/cms/js/libs/jstree/jstree.min.js");
/* harmony import */ var jstree__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(jstree__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _libs_jstree_jstree_grid_min__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../libs/jstree/jstree.grid.min */ "./cms/static/cms/js/libs/jstree/jstree.grid.min.js");
/* harmony import */ var _libs_jstree_jstree_grid_min__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_libs_jstree_jstree_grid_min__WEBPACK_IMPORTED_MODULE_7__);
/*
...
class PageTree {
  constructor(options) {
    ...
    var opts = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-cms-pagetree').data('json');
    ...
    _cms_base__WEBPACK_IMPORTED_MODULE_1__.Helpers.csrf(this.options.csrf);

    this._setupLanguages();

    // cancel if pagetree is not available
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default().isEmptyObject(opts) || opts.empty) {
      this._getClipboard();
      ...
      this.ui.container.on(this.click, this.options.pasteSelector, function (e) {
        e.preventDefault();
        if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).hasClass('cms-pagetree-dropdown-item-disabled')) {
          return;
        }
        that._paste(e);
      });
   ...
   */
  _setupUI() {
    var pagetree = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-pagetree');

    this.ui = {
      container: pagetree,
      document: jquery__WEBPACK_IMPORTED_MODULE_0___default()(document),
      tree: pagetree.find('.js-cms-pagetree'),
      dialog: jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-cms-tree-dialog'),
      siteForm: jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-cms-pagetree-site-form'),
      languagesSelect: jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-cms-pagetree-languages')
    };
  }
  ...
  _setup() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().each(this.options.columns, function (index, obj) {
      if (obj.key === '') {
      ...
      core: {
        ...
        check_callback: function (operation, node, node_parent, node_position, more) {
          if ((operation === 'move_node' || operation === 'copy_node') && more && more.pos) {
            if (more.pos === 'i') {
              jquery__WEBPACK_IMPORTED_MODULE_0___default()('#jstree-marker').addClass('jstree-marker-child');
            } else {
              jquery__WEBPACK_IMPORTED_MODULE_0___default()('#jstree-marker').removeClass('jstree-marker-child');
            }
          }
  ...
  _events() {
    ...
    this.ui.document.on('keydown.pagetree.alt-mode', function (e) {
      if (e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_1__.KEYS.SHIFT) {
    ...
    this.ui.document.on('dnd_start.vakata', function (e, data) {
      var element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(data.element);
      ...
      data.data.nodes.forEach(function (nodeId) {
        ...
        [nodeId].concat(descendantIds).forEach(function (id) {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('.jsgrid_' + id + '_col').addClass('jstree-is-dragging');
        });
      });
    ...
    this.ui.document.on('dnd_move.vakata', function (e, data) {
      ...
      if (isMovingCopy) {
        if (!isCopyClassAdded) {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('.jstree-is-dragging').addClass('jstree-is-dragging-copy');
          isCopyClassAdded = true;
        }
      } else if (isCopyClassAdded) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.jstree-is-dragging').removeClass('jstree-is-dragging-copy');
      ...
      var ins = jquery__WEBPACK_IMPORTED_MODULE_0___default().jstree.reference(data.event.target);

      // make sure we're hovering over a tree node
      if (ins) {
        var marker = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#jstree-marker');
        var root = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#changelist');
        var column = jquery__WEBPACK_IMPORTED_MODULE_0___default()(data.data.origin.element);

        var hover = ins.settings.dnd.large_drop_target ?
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(data.event.target).
        closest('.jstree-node') :
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(data.event.target).
        ...
        marker.css({
          left: "".concat(root.offset().left, "px"),
    ...
    this.ui.document.on('dnd_stop.vakata', function (e, data) {
      ...
      data.data.nodes.forEach(function (nodeId) {
        ...
        [nodeId].concat(descendantIds).forEach(function (id) {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('.jsgrid_' + id + '_col').removeClass('jstree-is-dragging jstree-is-dragging-copy');
        });
      });
    });
    ...
    this.ui.container.on(this.click, '.js-cms-tree-item-cut', function (e) {
      e.preventDefault();
      that._cutOrCopy({ type: 'cut', element: jquery__WEBPACK_IMPORTED_MODULE_0___default()(this) });
    });

    // set event for cut and paste
    this.ui.container.on(this.click, '.js-cms-tree-item-copy', function (e) {
      e.preventDefault();
      that._cutOrCopy({ type: 'copy', element: jquery__WEBPACK_IMPORTED_MODULE_0___default()(this) });
    });
    ...
    this.ui.container.on(this.click, '.js-cms-pagetree-add-page', (e) => {
      const treeId = this._getNodeId(jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target));
  ...
  _cutOrCopy(obj) {
    ...
    if (this.clipboard.type === 'copy' || !this.clipboard.type) {
      ...
      _cms_base__WEBPACK_IMPORTED_MODULE_1__.Helpers.setSettings(CMS.settings);
    }
  }
  ...
  _paste(event) {
    ...
    var copyFromId = this._getNodeId(
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".js-cms-pagetree-options[data-id=\"".concat(this.clipboard.origin, "\"]")).closest('.jstree-grid-cell')
    );
    var copyToId = this._getNodeId(jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.currentTarget));
  ...
  _removeNodeId(id) {
    ...
    const childrenIds = instance.get_node({
      id: CMS.$("[data-node-id=".concat(id, "]")).attr('id')
    }).children_d;
    ...
    const storage = (0,lodash_es_without_js__WEBPACK_IMPORTED_MODULE_5__["default"])(this._getStoredNodeIds(), ...idsToRemove);
  ...
  _copyNode(obj) {
    ...
    if (that.options.permission) {
      ...
      on(this.click, '.cancel', function (e) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-cms-dialog').remove();
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-cms-dialog-dimmer').remove();
      }).
      off(this.click, '.submit').
      on(this.click, '.submit', function (e) {
        e.preventDefault();
        var submitButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
   ...
   */
  _setupDropdowns() {
    this._dropdowns = new _cms_pagetree_dropdown__WEBPACK_IMPORTED_MODULE_2__["default"]({
   ...
   */
  _setupPageView() {
    var win = _cms_base__WEBPACK_IMPORTED_MODULE_1__.Helpers._getWindow();
    ...
    this.ui.container.on(this.click, '.js-cms-pagetree-page-view', function () {
      parent.CMS.API.Helpers.setSettings(
        jquery__WEBPACK_IMPORTED_MODULE_0___default().extend(true, {}, CMS.settings, {
          sideframe: {
            url: null,
            hidden: true
          }
  ...
  _setupStickyHeader() {
    ...
    that.ui.tree.on('ready.jstree', function () {
      that.header = new _cms_pagetree_stickyheader__WEBPACK_IMPORTED_MODULE_3__["default"]({
  ...
  _setAjaxPost(trigger) {
    ...
    this.ui.container.on(this.click, trigger, function (e) {
      ...
      if (element.attr('target') === '_top') {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('<form method="post" action="' + element.attr('href') + '">' +
        csrfToken + '</form>').
        appendTo(jquery__WEBPACK_IMPORTED_MODULE_0___default()(parent.document.body)).
        submit();
        return;
      }
      try {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
        ...
        if (window.self === window.top) {
          ...
          _cms_base__WEBPACK_IMPORTED_MODULE_1__.Helpers.reloadBrowser('REFRESH_PAGE');
        }
      }).
      fail(function (error) {
        try {
  ...
  _setupSearch() {
    ...
    var pageTreeHeader = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-pagetree-header');
  ...
  _enablePaste(selector) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(sel).removeClass('cms-pagetree-dropdown-item-disabled');
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(dropdownSel).data('lazyUrlData', data);
  }
  ...
  _disablePaste(selector) {
    ...
    // helpers are generated on the fly, so we need to reference
    // them every single time
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(sel).addClass('cms-pagetree-dropdown-item-disabled');

    // not loaded actions dropdown have to be updated as well
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(dropdownSel).removeData('lazyUrlData');
  }
  ...
  _reloadHelper() {
    if (window.self === window.top) {
      _cms_base__WEBPACK_IMPORTED_MODULE_1__.Helpers.reloadBrowser();
    } else {
   ...
   */
  showError(message) {
    var messages = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.messagelist');
    var breadcrumb = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.breadcrumbs');
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  ...
  window.CMS.config = {
    ...
    urls: {
      settings: jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-cms-pagetree').data('settings-url')
    }
  };
  window.CMS.settings = _cms_base__WEBPACK_IMPORTED_MODULE_1__.Helpers.getSettings();
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PageTree);
...
class PageTreeStickyHeader {
  ...
  _saveSizes() {
    ...
    if (this._isInSideframe()) {
      ...
      this.toolbarHeight = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.djangocms-admin-style #branding').height() || 0;
    }
  }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PageTreeStickyHeader);
 ...
 * // => [3]
 */
var without = (0,_baseRest_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function(array, values) {
  return (0,_isArrayLikeObject_js__WEBPACK_IMPORTED_MODULE_2__["default"])(array)
    ? (0,_baseDifference_js__WEBPACK_IMPORTED_MODULE_0__["default"])(array, values)
    : [];
});
...
/******/ var __webpack_exports__ = (__webpack_exec__("./cms/static/cms/js/admin.pagetree.js"));
/******/ }
]);
//# sourceMappingURL=bundle.admin.pagetree.min.js.map