...
/* harmony export */   currentVersionMatches: () => (/* binding */ currentVersionMatches),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   uid: () => (/* binding */ uid)
/* harmony export */ });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./cms/static/cms/js/libs/jquery.min.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var lodash_es_once_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash-es/once.js */ "./node_modules/lodash-es/once.js");
/* harmony import */ var lodash_es_debounce_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lodash-es/debounce.js */ "./node_modules/lodash-es/debounce.js");
/* harmony import */ var lodash_es_throttle_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! lodash-es/throttle.js */ "./node_modules/lodash-es/throttle.js");
/* harmony import */ var _loader__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./loader */ "./cms/static/cms/js/modules/loader.js");
/**
 * CMS.API.Helpers
 ...
 * @returns {Boolean}
 */
const currentVersionMatches = (_ref) => {let { version } = _ref;
  return version === "5.1.0a1";
};
...
const Helpers = {
  ...
  once: lodash_es_once_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  debounce: lodash_es_debounce_js__WEBPACK_IMPORTED_MODULE_2__["default"],
  throttle: lodash_es_throttle_js__WEBPACK_IMPORTED_MODULE_3__["default"],
  ...
  preventSubmit: function () {
    var forms = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-toolbar').find('form');
    var SUBMITTED_OPACITY = 0.5;

    forms.submit(function () {
      // show loader
      (0,_loader__WEBPACK_IMPORTED_MODULE_4__.showLoader)();
      // we cannot use disabled as the name action will be ignored
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('input[type="submit"]').
      on('click', function (e) {
        e.preventDefault();
      }).
  ...
  setSettings: function (newSettings) {
    // merge settings
    var settings = JSON.stringify(jquery__WEBPACK_IMPORTED_MODULE_0___default().extend({}, window.CMS.config.settings, newSettings));
    ...
    if (this._isStorageSupported) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
        ...
        success: function (data) {
          ...
          (0,_loader__WEBPACK_IMPORTED_MODULE_4__.hideLoader)();
        },
  ...
  dispatchEvent: function dispatchEvent(eventName, payload) {
    var event = new (jquery__WEBPACK_IMPORTED_MODULE_0___default().Event)(_ns(eventName));
  ...
  getColorScheme: function () {
    let state = jquery__WEBPACK_IMPORTED_MODULE_0___default()('html').attr('data-theme');
  ...
  setColorScheme: function (mode) {
    let body = jquery__WEBPACK_IMPORTED_MODULE_0___default()('html');
    ...
    body.find('div.cms iframe').each(function setFrameColorScheme(i, e) {
      if (e.contentDocument) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.contentDocument).find('iframe').each(setFrameColorScheme);
      }
    });
  },
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  CMS._eventRoot = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#cms-top');
  // autoinits
  Helpers.preventSubmit();
});

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_CMS);
...
class ChangeTracker {
  ...
  _trackChange(e) {
    if (this.state.fields.has(e.target)) {
      ...
      this.state.fields.set(
        e.target,
        jquery__WEBPACK_IMPORTED_MODULE_0___default().extend(current, {
   ...
   */
  _getValue(target) {
    var el = jquery__WEBPACK_IMPORTED_MODULE_0___default()(target);
      ...
      if (el.is('[multiple]')) {
        ...
        options.each(function () {
          if (this.defaultSelected) {
            value.push(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val());
          }
        });
      } else {
        options.each(function () {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ChangeTracker);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _cms_modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cms.modal */ "./cms/static/cms/js/modules/cms.modal.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! jquery */ "./cms/static/cms/js/libs/jquery.min.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _cms_base__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cms.base */ "./cms/static/cms/js/modules/cms.base.js");
/* harmony import */ var _cms_plugins__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./cms.plugins */ "./cms/static/cms/js/modules/cms.plugins.js");
...
class Clipboard {
   ...
   */
  _setupUI() {
    var clipboard = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.cms-clipboard');

    this.ui = {
      clipboard: clipboard,
      triggers: jquery__WEBPACK_IMPORTED_MODULE_1___default()('.cms-clipboard-trigger a'),
      triggerRemove: jquery__WEBPACK_IMPORTED_MODULE_1___default()('.cms-clipboard-empty a'),
  ...
  _events() {
    ...
    that.modal = new _cms_modal__WEBPACK_IMPORTED_MODULE_0__["default"]({
      minWidth: MIN_WIDTH,
    ...
    _cms_base__WEBPACK_IMPORTED_MODULE_2__.Helpers.removeEventListener(
      'modal-loaded.clipboard modal-closed.clipboard modal-close.clipboard modal-load.clipboard'
    );

    _cms_base__WEBPACK_IMPORTED_MODULE_2__.Helpers.addEventListener('modal-loaded.clipboard modal-closed.clipboard', (e, _ref) => {let { instance } = _ref;
      if (instance === this.modal) {
        _cms_plugins__WEBPACK_IMPORTED_MODULE_3__["default"]._removeAddPluginPlaceholder();
      }
    });

    _cms_base__WEBPACK_IMPORTED_MODULE_2__.Helpers.addEventListener('modal-close.clipboard', (e, _ref2) => {let { instance } = _ref2;
      if (instance === this.modal) {
        this.ui.pluginsList.prependTo(that.ui.clipboard);
        _cms_plugins__WEBPACK_IMPORTED_MODULE_3__["default"]._updateClipboard();
      }
    });
    _cms_base__WEBPACK_IMPORTED_MODULE_2__.Helpers.addEventListener('modal-load.clipboard', (e, _ref3) => {let { instance } = _ref3;
      if (instance === this.modal) {
        this.ui.pluginsList.prependTo(that.ui.clipboard);
      } else {
        this.ui.pluginsList.prependTo(that.ui.clipboard);
    ...
    try {
      local_storage__WEBPACK_IMPORTED_MODULE_4___default().off(storageKey);
    } catch (_unused) {}
    local_storage__WEBPACK_IMPORTED_MODULE_4___default().on(storageKey, (value) => this._handleExternalUpdate(value));
  ...
  _toolbarEvents() {
    ...
    that.ui.triggers.off(Clipboard.click).on(Clipboard.click, function (e) {
      e.preventDefault();
      e.stopPropagation();
      if (jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).parent().hasClass('cms-toolbar-item-navigation-disabled')) {
        return false;
      }
  ...
  _handleExternalUpdate(value) {
    ...
    _cms_plugins__WEBPACK_IMPORTED_MODULE_3__["default"]._updateClipboard();
    CMS._instances.push(new _cms_plugins__WEBPACK_IMPORTED_MODULE_3__["default"]("cms-plugin-".concat(clipboardData.data.plugin_id), clipboardData.data));
  ...
  _cleanupDOM() {
    var that = this;
    var pasteItems = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.cms-submenu-item [data-rel=paste]').
    attr('tabindex', '-1').
    parent().
  ...
  clear(callback) {
    ...
    CMS.API.Toolbar.openAjax({
      url: _cms_base__WEBPACK_IMPORTED_MODULE_2__.Helpers.updateUrlWithPath(CMS.config.clipboard.url),
      post: post,
      callback: function () {
  ...
  populate(html, pluginData) {
    ...
    local_storage__WEBPACK_IMPORTED_MODULE_4___default().set(storageKey, JSON.stringify(this.currentClipboardData));
  }
}
...
class Messages {
   ...
   */
  _setupUI() {
    var container = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms');

    this.ui = {
      container: container,
      body: jquery__WEBPACK_IMPORTED_MODULE_0___default()('html'),
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _cms_changetracker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cms.changetracker */ "./cms/static/cms/js/modules/cms.changetracker.js");
/* harmony import */ var _keyboard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./keyboard */ "./cms/static/cms/js/modules/keyboard.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! jquery */ "./cms/static/cms/js/libs/jquery.min.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _jquery_transition__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./jquery.transition */ "./cms/static/cms/js/modules/jquery.transition.js");
/* harmony import */ var _trap__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./trap */ "./cms/static/cms/js/modules/trap.js");
/* harmony import */ var _cms_base__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./cms.base */ "./cms/static/cms/js/modules/cms.base.js");
/* harmony import */ var _loader__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./loader */ "./cms/static/cms/js/modules/loader.js");
/*
 * Copyright https://github.com/divio/django-cms
 */
...
class Modal {
  constructor(options) {
    this.options = jquery__WEBPACK_IMPORTED_MODULE_2___default().extend(true, {}, Modal.options, options);
   ...
   */
  _setupUI() {
    var modal = jquery__WEBPACK_IMPORTED_MODULE_2___default()('.cms-modal');

    this.ui = {
      modal: modal,
      body: jquery__WEBPACK_IMPORTED_MODULE_2___default()('html'),
      window: jquery__WEBPACK_IMPORTED_MODULE_2___default()(window),
      toolbarLeftPart: jquery__WEBPACK_IMPORTED_MODULE_2___default()('.cms-toolbar-left'),
  ...
  _events() {
    ...
    on(this.click + ' ' + this.touchEnd + ' ' + this.keyUp, function (e) {
      if (e.type !== 'keyup' || e.type === 'keyup' && e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_5__.KEYS.ENTER) {
        e.preventDefault();
        that.minimize();
      }
    });
    ...
    this.ui.breadcrumb.off(this.click, 'a').on(this.click, 'a', function (e) {
      e.preventDefault();
      that._changeIframe(jquery__WEBPACK_IMPORTED_MODULE_2___default()(this));
    });
  }
  ...
  open(opts) {
    ...
    _cms_base__WEBPACK_IMPORTED_MODULE_5__.Helpers.dispatchEvent('modal-load', { instance: this });
    ...
    _cms_base__WEBPACK_IMPORTED_MODULE_5__.Helpers.dispatchEvent('modal-loaded', { instance: this });

    var currentContext = _keyboard__WEBPACK_IMPORTED_MODULE_1__["default"].getContext();

    if (currentContext !== 'modal') {
      previousKeyboardContext = _keyboard__WEBPACK_IMPORTED_MODULE_1__["default"].getContext();
      previouslyFocusedElement = jquery__WEBPACK_IMPORTED_MODULE_2___default()(document.activeElement);
    }
    ...
    _keyboard__WEBPACK_IMPORTED_MODULE_1__["default"].setContext('modal');
    return this;
  }
  ...
  _show(opts) {
    ...
    one('cmsTransitionEnd', function () {
      ...
      CMS.API.locked = false;
      _cms_base__WEBPACK_IMPORTED_MODULE_5__.Helpers.dispatchEvent('modal-shown', { instance: that });
    }).
    emulateTransitionEnd(speed);

    // add esc close event
    this.ui.body.off('keydown.cms.close').on('keydown.cms.close', function (e) {
      if (e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_5__.KEYS.ESC && that.options.closeOnEsc) {
        e.stopPropagation();
   ...
   */
  close() {
    var event = _cms_base__WEBPACK_IMPORTED_MODULE_5__.Helpers.dispatchEvent('modal-close', { instance: this });

    if (event.isDefaultPrevented()) {
      return false;
    }

    _cms_base__WEBPACK_IMPORTED_MODULE_5__.Helpers._getWindow().removeEventListener('beforeunload', this._beforeUnloadHandler);

    // handle refresh option
    if (this.options.onClose) {
      _cms_base__WEBPACK_IMPORTED_MODULE_5__.Helpers.reloadBrowser(this.options.onClose, false);
    }
    (0,_trap__WEBPACK_IMPORTED_MODULE_4__.untrap)(this.ui.body[0]);
    _keyboard__WEBPACK_IMPORTED_MODULE_1__["default"].setContext(previousKeyboardContext);
    try {
  ...
  _hide(opts) {
    ...
    setTimeout(function () {
      ...
      (0,_loader__WEBPACK_IMPORTED_MODULE_6__.hideLoader)();
      _cms_base__WEBPACK_IMPORTED_MODULE_5__.Helpers.dispatchEvent('modal-closed', { instance: that });
  ...
  maximize() {
    ...
    if (this.maximized === false) {
      ...
      this.maximized = true;
      _cms_base__WEBPACK_IMPORTED_MODULE_5__.Helpers.dispatchEvent('modal-maximized', { instance: this });
    } else {
      // minimize
      ...
      this.maximized = false;
      _cms_base__WEBPACK_IMPORTED_MODULE_5__.Helpers.dispatchEvent('modal-restored', { instance: this });
    }
  }
  ...
  _setBreadcrumb(breadcrumbs) {
    ...
    // load breadcrumbs
    jquery__WEBPACK_IMPORTED_MODULE_2___default().each(breadcrumbs, function (index, item) {
  ...
  _setButtons(iframe) {
    ...
    var that = this;
    var group = jquery__WEBPACK_IMPORTED_MODULE_2___default()('<div class="cms-modal-item-buttons"></div>');
    var render = jquery__WEBPACK_IMPORTED_MODULE_2___default()('<div class="cms-modal-buttons-inner"></div>');
    var cancel = jquery__WEBPACK_IMPORTED_MODULE_2___default()('<a href="#" class="cms-btn">' + CMS.config.lang.cancel + '</a>');
    var row;
    var tmp;
    ...
    buttons.on('click', function () {
      if (jquery__WEBPACK_IMPORTED_MODULE_2___default()(this).hasClass('default')) {
        that.hideFrame = true;
      }
    });
    ...
    buttons.each(function (index, btn) {
      var item = jquery__WEBPACK_IMPORTED_MODULE_2___default()(btn);
      ...
      var el = jquery__WEBPACK_IMPORTED_MODULE_2___default()('<a href="#" class="' + cls + ' ' + item.attr('class') + '">' + title + '</a>');
      ...
      el.on(that.click + ' ' + that.touchEnd, function (e) {
        ...
        if (item.is('a')) {
          that._loadIframe({
            url: _cms_base__WEBPACK_IMPORTED_MODULE_5__.Helpers.updateUrlWithPath(item.prop('href')),
            name: title
          });
        }
  ...
  _loadIframe(opts) {
    ...
    opts.url = _cms_base__WEBPACK_IMPORTED_MODULE_5__.Helpers.makeURL(opts.url);
    opts.title = opts.title || '';
    opts.breadcrumbs = opts.breadcrumbs || '';

    (0,_loader__WEBPACK_IMPORTED_MODULE_6__.showLoader)();
    ...
    var iframe = jquery__WEBPACK_IMPORTED_MODULE_2___default()('<iframe tabindex="0" src="' + opts.url + '" class="" frameborder="0" />');
    ...
    iframe.on('load', function () {
      ...
      (0,_trap__WEBPACK_IMPORTED_MODULE_4__.trap)(body[0]);
      ...
      if (redirect) {
        _cms_base__WEBPACK_IMPORTED_MODULE_5__.Helpers.reloadBrowser(redirect, false);
        return true;
      }
      ...
      if (iframe[0].contentWindow && iframe[0].contentWindow.CMS && iframe[0].contentWindow.CMS.CKEditor) {
        jquery__WEBPACK_IMPORTED_MODULE_2___default()(iframe[0].contentWindow.document).ready(function () {
            ...
            if (editor) {
              editor.on('instanceReady', function (e) {
                Modal._setupCtrlEnterSave(
                  jquery__WEBPACK_IMPORTED_MODULE_2___default()(e.editor.container.$).find('iframe')[0].contentWindow.document
                );
              });
            }
      ...
      if (messages.length && that.enforceReload) {
        that.ui.modalBody.addClass('cms-loader');
        (0,_loader__WEBPACK_IMPORTED_MODULE_6__.showLoader)();
        _cms_base__WEBPACK_IMPORTED_MODULE_5__.Helpers.reloadBrowser();
      }
      ...
      // set modal buttons
      that._setButtons(jquery__WEBPACK_IMPORTED_MODULE_2___default()(this));
      ...
      if (that.saved && saveSuccess && !contents.find('.delete-confirmation').length) {
        ...
        if (that.options.onClose) {
          ...
          // hello ckeditor
          _cms_base__WEBPACK_IMPORTED_MODULE_5__.Helpers.removeEventListener('modal-close.text-plugin');
          that.close();
        ...
        setTimeout(() => {
          ...
          if (jquery__WEBPACK_IMPORTED_MODULE_2___default()(iframe[0].contentDocument.documentElement).find(':focus').length) {
            return;
          }
  ...
  _attachContentPreservingHandlers(iframe) {
    ...
    that.tracker = new _cms_changetracker__WEBPACK_IMPORTED_MODULE_0__["default"](iframe);

    _cms_base__WEBPACK_IMPORTED_MODULE_5__.Helpers._getWindow().addEventListener('beforeunload', this._beforeUnloadHandler);
  }
  ...
  _confirmDirtyEscCancel() {
    if (this.tracker && this.tracker.isFormChanged()) {
      return _cms_base__WEBPACK_IMPORTED_MODULE_5__.Helpers.secureConfirm(CMS.config.lang.confirmDirty + '\n\n' + CMS.config.lang.confirmDirtyESC);
    }
    return true;
  }
  ...
  _loadMarkup(opts) {
    ...
    (0,_trap__WEBPACK_IMPORTED_MODULE_4__.trap)(this.ui.frame[0]);
  }
  ...
  static _setupCtrlEnterSave(doc) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_2___default()(doc).
    on('keydown.cms.submit', function (e) {
      if (e.ctrlKey && e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_5__.KEYS.ENTER && !mac) {
        jquery__WEBPACK_IMPORTED_MODULE_2___default()('.cms-modal-buttons .cms-btn-action:first').trigger('click');
      }

      if (mac) {
        if (e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_5__.KEYS.CMD_LEFT || e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_5__.KEYS.CMD_RIGHT || e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_5__.KEYS.CMD_FIREFOX) {
          cmdPressed = true;
        }

        if (e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_5__.KEYS.ENTER && cmdPressed) {
          jquery__WEBPACK_IMPORTED_MODULE_2___default()('.cms-modal-buttons .cms-btn-action:first').trigger('click');
        }
      }
    }).
...
class Navigation {
  ...
  _events() {
    ...
    on(
      ...
      (0,lodash_es_throttle_js__WEBPACK_IMPORTED_MODULE_1__["default"])(this._handleResize.bind(this), THROTTLE_TIMEOUT)
    );
  }
  ...
  _getWidths() {
    ...
    var getSize = function getSize(el, store) {
      ...
      var width = jquery__WEBPACK_IMPORTED_MODULE_0___default()(el).outerWidth(true);
...
/* harmony export */ });
/* harmony import */ var _cms_modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cms.modal */ "./cms/static/cms/js/modules/cms.modal.js");
/* harmony import */ var _cms_structureboard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cms.structureboard */ "./cms/static/cms/js/modules/cms.structureboard.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! jquery */ "./cms/static/cms/js/libs/jquery.min.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _nextuntil__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./nextuntil */ "./cms/static/cms/js/modules/nextuntil.js");
/* harmony import */ var lodash_es_debounce_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! lodash-es/debounce.js */ "./node_modules/lodash-es/debounce.js");
/* harmony import */ var lodash_es_uniqWith_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! lodash-es/uniqWith.js */ "./node_modules/lodash-es/uniqWith.js");
/* harmony import */ var lodash_es_once_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! lodash-es/once.js */ "./node_modules/lodash-es/once.js");
/* harmony import */ var lodash_es_difference_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! lodash-es/difference.js */ "./node_modules/lodash-es/difference.js");
/* harmony import */ var lodash_es_isEqual_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! lodash-es/isEqual.js */ "./node_modules/lodash-es/isEqual.js");
/* harmony import */ var _cms_base__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./cms.base */ "./cms/static/cms/js/modules/cms.base.js");
/* harmony import */ var _loader__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./loader */ "./cms/static/cms/js/modules/loader.js");
/*
 * Copyright https://github.com/divio/django-cms
 */
...
var pluginUsageMap = _cms_base__WEBPACK_IMPORTED_MODULE_9__.Helpers._isStorageSupported ? JSON.parse(localStorage.getItem('cms-plugin-usage') || '{}') : {};
...
class Plugin {
  constructor(container, options) {
    ...
    Object.assign(this, _cms_base__WEBPACK_IMPORTED_MODULE_9__.Helpers);

    this.options = jquery__WEBPACK_IMPORTED_MODULE_2___default().extend(true, {}, {
    ...
    this.uid = (0,_cms_base__WEBPACK_IMPORTED_MODULE_9__.uid)();
   ...
   */
  _setupUI(container) {
    const wrapper = jquery__WEBPACK_IMPORTED_MODULE_2___default()(".".concat(container));
    let contents;
    ...
    if (wrapper.length > 1 && container.match(/cms-plugin/)) {
      ...
      if (contentWrappers[0][0].tagName === 'TEMPLATE') {
        ...
        if (contents.length) {
          ...
          contents = contents.reduce((collection, items) => collection.add(items), jquery__WEBPACK_IMPORTED_MODULE_2___default()());
        }
      } else {
        contents = wrapper;
      }
    ...
    if (!contents.length) {
      contents = jquery__WEBPACK_IMPORTED_MODULE_2___default()('<div></div>');
    }
  ...
  _processTemplateGroup(items, container) {
    const templateStart = jquery__WEBPACK_IMPORTED_MODULE_2___default()(items[0]);
    const className = templateStart.attr('class').replace('cms-plugin-start', '');
    let itemContents = jquery__WEBPACK_IMPORTED_MODULE_2___default()((0,_nextuntil__WEBPACK_IMPORTED_MODULE_3__["default"])(templateStart[0], container));

    itemContents.each((index, el) => {
      if (el.nodeType === Node.TEXT_NODE && !el.textContent.match(/^\s*$/)) {
        const element = jquery__WEBPACK_IMPORTED_MODULE_2___default()(el);
    ...
    itemContents.addClass("cms-plugin ".concat(className));
  ...
  _setPlaceholder() {
    ...
    this.ui.dragbar = jquery__WEBPACK_IMPORTED_MODULE_2___default()('.cms-dragbar-' + this.options.placeholder_id);
    ...
    if (jquery__WEBPACK_IMPORTED_MODULE_2___default().inArray(this.options.placeholder_id, CMS.settings.dragbars) !== -1) {
  ...
  _setPluginStructureEvents() {
    ...
    this.ui.draggable = jquery__WEBPACK_IMPORTED_MODULE_2___default()('.cms-draggable-' + this.options.plugin_id);
    ...
    this.ui.draggable.off('cms-paste-plugin-update').on('cms-paste-plugin-update', function (e, eventData) {
      ...
      var dragitem = jquery__WEBPACK_IMPORTED_MODULE_2___default()(".cms-draggable-".concat(eventData.id, ":last"));
      ...
      _cms_base__WEBPACK_IMPORTED_MODULE_9__.Helpers.setSettings(CMS.settings);
    ...
    setTimeout(() => {
      ...
      on('mouseenter', (e) => {
        e.stopPropagation();
        if (!_cms_base__WEBPACK_IMPORTED_MODULE_9__.$document.data('expandmode')) {
          return;
        }
  ...
  _dblClickToEditHandler(e) {
    var that = this;
    var disabled = jquery__WEBPACK_IMPORTED_MODULE_2___default()(e.currentTarget).closest('.cms-drag-disabled');
    ...
    if (!disabled.length) {
      that.editPlugin(
        _cms_base__WEBPACK_IMPORTED_MODULE_9__.Helpers.updateUrlWithPath(that.options.urls.edit_plugin),
  ...
  _setPluginContentEvents() {
    ...
    on('mouseover.cms.plugins', (e) => {
      ...
      e.stopPropagation();
      jquery__WEBPACK_IMPORTED_MODULE_2___default()('.cms-dragitem-success').remove();
      jquery__WEBPACK_IMPORTED_MODULE_2___default()('.cms-draggable-success').removeClass('cms-draggable-success');
    ...
    if (!Plugin._isContainingMultiplePlugins(this.ui.container)) {
      _cms_base__WEBPACK_IMPORTED_MODULE_9__.$document.
      off(pluginDoubleClickEvent, ".cms-plugin-".concat(this.options.plugin_id)).
      on(
        pluginDoubleClickEvent, ".cms-plugin-".concat(
  ...
  _setGeneric() {
    ...
    this.ui.container.off(Plugin.doubleClick).on(Plugin.doubleClick, function (e) {
      e.preventDefault();
      e.stopPropagation();
      that.editPlugin(_cms_base__WEBPACK_IMPORTED_MODULE_9__.Helpers.updateUrlWithPath(that.options.urls.edit_plugin), that.options.plugin_name, []);
    });
  ...
  _checkIfPasteAllowed() {
    ...
    if (clipboardDraggable.data('cms')) {
      ...
      var parent_bounds = jquery__WEBPACK_IMPORTED_MODULE_2___default().grep(clipboardPluginData.plugin_parent_restriction, function (restriction) {
      ...
      if (
      bounds.length && jquery__WEBPACK_IMPORTED_MODULE_2___default().inArray(type, bounds) === -1 ||
      parent_bounds.length && jquery__WEBPACK_IMPORTED_MODULE_2___default().inArray(currentPluginType, parent_bounds) === -1)
      {
        pasteItem.addClass('cms-submenu-item-disabled');
        pasteItem.find('a').attr('tabindex', '-1').attr('aria-disabled', 'true');
  ...
  addPlugin(type, name, parent) {let showAddForm = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;let position = arguments.length > 4 ? arguments[4] : undefined;
    var params = {
    ...
    var url = this.options.urls.add_plugin + '?' + jquery__WEBPACK_IMPORTED_MODULE_2___default().param(params);

    const modal = new _cms_modal__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    if (showAddForm) {
      ...
      body.append("<form method=\"post\" action=\"".concat(url, "\" style=\"display: none;\">\n                <input type=\"hidden\" name=\"csrfmiddlewaretoken\" value=\"").concat(
        CMS.config.csrf, "\"></form>"));
      body.find('form').submit();
    }
    this.modal = modal;

    _cms_base__WEBPACK_IMPORTED_MODULE_9__.Helpers.removeEventListener('modal-closed.add-plugin');
    _cms_base__WEBPACK_IMPORTED_MODULE_9__.Helpers.addEventListener('modal-closed.add-plugin', (e, _ref) => {let { instance } = _ref;
      if (instance !== modal) {
        return;
      }
  ...
  _getPluginAddPosition() {
    if (this.options.type === 'placeholder') {
      return jquery__WEBPACK_IMPORTED_MODULE_2___default()(".cms-dragarea-".concat(this.options.placeholder_id, " .cms-draggable")).length + 1;
    }
  ...
  editPlugin(url, name, breadcrumb) {
    ...
    var modal = new _cms_modal__WEBPACK_IMPORTED_MODULE_0__["default"]({
      onClose: this.options.onClose || false,
      redirectOnClose: this.options.redirectOnClose || false
    });
    ...
    _cms_base__WEBPACK_IMPORTED_MODULE_9__.Helpers.removeEventListener('modal-closed.edit-plugin modal-loaded.edit-plugin');
    _cms_base__WEBPACK_IMPORTED_MODULE_9__.Helpers.addEventListener('modal-closed.edit-plugin modal-loaded.edit-plugin', (e, _ref2) => {let { instance } = _ref2;
      if (instance === modal) {
        // cannot be cached
        Plugin._removeAddPluginPlaceholder();
      }
  ...
  copyPlugin(opts, source_language) {
    ...
    var options = jquery__WEBPACK_IMPORTED_MODULE_2___default().extend({}, opts || this.options);
    ...
    var request = {
      type: 'POST',
      url: _cms_base__WEBPACK_IMPORTED_MODULE_9__.Helpers.updateUrlWithPath(options.urls.copy_plugin),
      data: data,
      success(response) {
        CMS.API.Messages.open({
        ...
        if (copyingFromLanguage) {
          CMS.API.StructureBoard.invalidateState('PASTE', jquery__WEBPACK_IMPORTED_MODULE_2___default().extend({}, data, response));
        } else {
          CMS.API.StructureBoard.invalidateState('COPY', response);
        }
        CMS.API.locked = false;
        (0,_loader__WEBPACK_IMPORTED_MODULE_10__.hideLoader)();
      },
      error(jqXHR) {
        CMS.API.locked = false;
    ...
    jquery__WEBPACK_IMPORTED_MODULE_2___default().ajax(request);
  }
  ...
  cutPlugin() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_2___default().ajax({
      type: 'POST',
      url: _cms_base__WEBPACK_IMPORTED_MODULE_9__.Helpers.updateUrlWithPath(that.options.urls.move_plugin),
      data: data,
      success(response) {
        CMS.API.locked = false;
        CMS.API.Messages.open({
        ...
        CMS.API.StructureBoard.invalidateState('CUT', jquery__WEBPACK_IMPORTED_MODULE_2___default().extend({}, data, response));
        (0,_loader__WEBPACK_IMPORTED_MODULE_10__.hideLoader)();
      },
      error(jqXHR) {
        CMS.API.locked = false;
  ...
  pastePlugin() {
    ...
    if (this.options.plugin_id) {
      _cms_structureboard__WEBPACK_IMPORTED_MODULE_1__["default"].actualizePluginCollapseStatus(this.options.plugin_id);
    }
  ...
  movePlugin(opts) {
    ...
    const dragitem = jquery__WEBPACK_IMPORTED_MODULE_2___default()(".cms-draggable-".concat(options.plugin_id, ":last"));
    ...
    (0,_loader__WEBPACK_IMPORTED_MODULE_10__.showLoader)();

    jquery__WEBPACK_IMPORTED_MODULE_2___default().ajax({
      type: 'POST',
      url: _cms_base__WEBPACK_IMPORTED_MODULE_9__.Helpers.updateUrlWithPath(options.urls.move_plugin),
      data: data,
      success: (response) => {
        CMS.API.StructureBoard.invalidateState(
          data.move_a_copy ? 'PASTE' : 'MOVE',
          jquery__WEBPACK_IMPORTED_MODULE_2___default().extend({}, data, { placeholder_id: placeholder_id }, response)
        );
  ...
  _setSettings(oldSettings, newSettings) {
    var settings = jquery__WEBPACK_IMPORTED_MODULE_2___default().extend(true, {}, oldSettings, newSettings);
    var plugin = jquery__WEBPACK_IMPORTED_MODULE_2___default()('.cms-plugin-' + settings.plugin_id);
    var draggable = jquery__WEBPACK_IMPORTED_MODULE_2___default()('.cms-draggable-' + settings.plugin_id);
    ...
    if (plugin.length) {
      ...
      plugin.each(function () {
        jquery__WEBPACK_IMPORTED_MODULE_2___default()(this).data('cms')[index] = settings;
      });
    }
    if (draggable.length) {
  ...
  deletePlugin(url, name, breadcrumb) {
    ...
    _cms_base__WEBPACK_IMPORTED_MODULE_9__.Helpers.removeEventListener('modal-loaded.delete-plugin');
    _cms_base__WEBPACK_IMPORTED_MODULE_9__.Helpers.addEventListener('modal-loaded.delete-plugin', (e, _ref3) => {let { instance } = _ref3;
      if (instance === modal) {
        Plugin._removeAddPluginPlaceholder();
      }
    });
   ...
   * @returns {void}
   */
  destroy() {let options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    ...
    _cms_base__WEBPACK_IMPORTED_MODULE_9__.$document.off(".".concat(this.uid));
    _cms_base__WEBPACK_IMPORTED_MODULE_9__.$window.off(".".concat(this.uid));
  }
  ...
  editPluginPostAjax(toolbar, response) {
    this.editPlugin(_cms_base__WEBPACK_IMPORTED_MODULE_9__.Helpers.updateUrlWithPath(response.url), this.options.plugin_name, response.breadcrumb);
  }
  ...
  _scrollToElement(el, opts) {
    ...
    var scrollHeight = _cms_base__WEBPACK_IMPORTED_MODULE_9__.$window.height();
  ...
  _setAddPluginModal(nav) {
    ...
    var initModal = (0,lodash_es_once_js__WEBPACK_IMPORTED_MODULE_6__["default"])(function initModal() {
      var placeholder = jquery__WEBPACK_IMPORTED_MODULE_2___default()(
      ...
      modal = new _cms_modal__WEBPACK_IMPORTED_MODULE_0__["default"]({
        minWidth: 400,
        minHeight: 400
      });
      ...
      _cms_base__WEBPACK_IMPORTED_MODULE_9__.Helpers.addEventListener('modal-loaded', (e, _ref4) => {let { instance } = _ref4;
        if (instance !== modal) {
          return;
        }
      ...
      _cms_base__WEBPACK_IMPORTED_MODULE_9__.Helpers.addEventListener('modal-closed', (e, _ref5) => {let { instance } = _ref5;
        if (instance !== modal) {
          return;
        }
        Plugin._removeAddPluginPlaceholder();
      ...
      _cms_base__WEBPACK_IMPORTED_MODULE_9__.Helpers.addEventListener('modal-shown', (e, _ref6) => {let { instance } = _ref6;
        if (modal !== instance) {
          return;
        }
        var dropdown = jquery__WEBPACK_IMPORTED_MODULE_2___default()('.cms-modal-markup .cms-plugin-picker');
  ...
  _updateWithMostUsedPlugins(plugins) {
    ...
    const mostUsedPlugins = Object.entries(pluginUsageMap).sort((_ref7, _ref8) => {let [x, a] = _ref7;let [y, b] = _ref8;return a - b;}).reverse();
    ...
    mostUsedPlugins.forEach((_ref9) => {let [name] = _ref9;
      if (count === MAX_MOST_USED_PLUGINS) {
        return;
      }
      const item = items.find("[href=".concat(name, "]"));
    ...
    if (count) {
      plugins.find('.cms-quicksearch').after(
        jquery__WEBPACK_IMPORTED_MODULE_2___default()("<div class=\"cms-submenu-item cms-submenu-item-title\" data-cms-most-used>\n                    <span>".concat(
   ...
   */
  _getNamepacedEvent(base) {let additionalNS = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
    return "".concat(base).concat(additionalNS ? '.'.concat(additionalNS) : '', ".").concat(this.uid);
  }
  ...
  _getPossibleChildClasses() {
    ...
    var resultElements = jquery__WEBPACK_IMPORTED_MODULE_2___default()(jquery__WEBPACK_IMPORTED_MODULE_2___default()('#cms-plugin-child-classes-' + placeholderId).html());
  ...
  _setupQuickSearch(plugins) {
    ...
    var handler = (0,lodash_es_debounce_js__WEBPACK_IMPORTED_MODULE_4__["default"])(function () {
      var input = jquery__WEBPACK_IMPORTED_MODULE_2___default()(this);
    ...
    plugins.find('> .cms-quicksearch').find('input').on(Plugin.keyUp, handler).on(
      Plugin.keyUp,
      (0,lodash_es_debounce_js__WEBPACK_IMPORTED_MODULE_4__["default"])(function (e) {
        var input;
        var pluginsPicker;

        if (e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_9__.KEYS.ENTER) {
          input = jquery__WEBPACK_IMPORTED_MODULE_2___default()(this);
  ...
  _delegate(e) {
    ...
    var items = '.cms-submenu-edit, .cms-submenu-item a';
    var el = jquery__WEBPACK_IMPORTED_MODULE_2___default()(e.target).closest(items);
    ...
    switch (el.attr('data-rel')) {
      ...
      case 'ajax_add':
        CMS.API.Toolbar.openAjax({
          ...
          text: el.data('text'),
          callback: jquery__WEBPACK_IMPORTED_MODULE_2___default().proxy(that.editPluginPostAjax, that),
      ...
      case 'delete':
        that.deletePlugin(
          _cms_base__WEBPACK_IMPORTED_MODULE_9__.Helpers.updateUrlWithPath(that.options.urls.delete_plugin),
          that.options.plugin_name,
          that._getPluginBreadcrumbs()
        );
        break;
      case 'highlight':
        ...
        window.location.hash = "cms-plugin-".concat(this.options.plugin_id);
  ...
  _setupKeyboardTraversing() {
    ...
    // add key events
    _cms_base__WEBPACK_IMPORTED_MODULE_9__.$document.off(keyDownTraverseEvent);
    // istanbul ignore next: not really possible to reproduce focus state in unit tests
    _cms_base__WEBPACK_IMPORTED_MODULE_9__.$document.on(keyDownTraverseEvent, function (e) {
      var anchors = dropdown.find('.cms-submenu-item:visible a');
      var index = anchors.index(anchors.filter(':focus'));

      // bind arrow down and tab keys
      if (e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_9__.KEYS.DOWN || e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_9__.KEYS.TAB && !e.shiftKey) {
        e.preventDefault();
      ...
      if (e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_9__.KEYS.UP || e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_9__.KEYS.TAB && e.shiftKey) {
        e.preventDefault();
        if (anchors.is(':focus')) {
          anchors.eq(index - 1).focus();
        } else {
  ...
  _showSettingsMenu(nav) {
    ...
    if (
    _cms_base__WEBPACK_IMPORTED_MODULE_9__.$window.height() + _cms_base__WEBPACK_IMPORTED_MODULE_9__.$window.scrollTop() - nav.offset().top - dropdown.height() <= MIN_SCREEN_MARGIN &&
  ...
  _filterPluginsList(list, input) {
    ...
    titles.filter(':visible').each(function (index, item) {
      titles.hide();
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(item).nextUntil('.cms-submenu-item-title').show();
    });

    // always display title of a category
    items.filter(':visible').each(function (index, titleItem) {
      var item = jquery__WEBPACK_IMPORTED_MODULE_2___default()(titleItem);
  ...
  _toggleCollapsable(el) {
    ...
    if (el.hasClass('cms-dragitem-expanded')) {
      settings.states.splice(jquery__WEBPACK_IMPORTED_MODULE_2___default().inArray(id, settings.states), 1);
      el.
    ...
    _cms_base__WEBPACK_IMPORTED_MODULE_9__.$document.trigger('resize.sideframe');

    // save settings
    _cms_base__WEBPACK_IMPORTED_MODULE_9__.Helpers.setSettings(settings);
  }
  ...
  _updatePlaceholderCollapseState() {
    ...
    filter((_ref0) => {let [, o] = _ref0;return o.placeholder_id === this.options.placeholder_id && o.type === 'plugin';}).
    map((_ref1) => {let [, o] = _ref1;return o.plugin_id;});

    const openedPlugins = CMS.settings.states;
    const closedPlugins = (0,lodash_es_difference_js__WEBPACK_IMPORTED_MODULE_7__["default"])(pluginsOfCurrentPlaceholder, openedPlugins);
    const areAllRemainingPluginsLeafs = closedPlugins.every((id) => {
      return !CMS._plugins.find(
        (_ref10) => {let [, o] = _ref10;return o.placeholder_id === this.options.placeholder_id && o.plugin_parent === id;}
      );
    });
    const el = jquery__WEBPACK_IMPORTED_MODULE_2___default()(".cms-dragarea-".concat(this.options.placeholder_id, " .cms-dragbar-title"));
    var settings = CMS.settings;
    ...
    if (areAllRemainingPluginsLeafs) {
      ...
      settings.dragbars = settings.dragbars || [];
      settings.dragbars.splice(jquery__WEBPACK_IMPORTED_MODULE_2___default().inArray(this.options.placeholder_id, settings.states), 1);
    }
  }
  ...
  _collapsables() {
    ...
    dragitem.find('> .cms-dragitem-text').on(
      ...
      (0,lodash_es_debounce_js__WEBPACK_IMPORTED_MODULE_4__["default"])(function () {
  ...
  _getPluginBreadcrumbs() {
    ...
    var findParentPlugin = function (id) {
      return jquery__WEBPACK_IMPORTED_MODULE_2___default().grep(CMS._plugins || [], function (pluginOptions) {
...
Plugin._updateRegistry = function _updateRegistry(plugins) {
  plugins.forEach((pluginData) => {
    const pluginContainer = "cms-plugin-".concat(pluginData.plugin_id);
    const pluginIndex = CMS._plugins.findIndex((_ref11) => {let [pluginStr] = _ref11;return pluginStr === pluginContainer;});
...
Plugin._hideSettingsMenu = function (navEl) {
  var nav = navEl || jquery__WEBPACK_IMPORTED_MODULE_2___default()('.cms-submenu-btn.cms-btn-active');
  ...
  jquery__WEBPACK_IMPORTED_MODULE_2___default()('.cms-z-index-9999').removeClass('cms-z-index-9999');
  ...
  // reset relativity
  jquery__WEBPACK_IMPORTED_MODULE_2___default()('.cms-dragbar').css('position', '');
};
...
Plugin._initializeGlobalHandlers = function _initializeGlobalHandlers() {
  ...
  setTimeout(function () {
    ...
    if (clipboardDraggable.length) {
      pluginData = CMS._plugins.find(
        (_ref12) => {let [desc] = _ref12;return desc === "cms-plugin-".concat(CMS.API.StructureBoard.getId(clipboardDraggable));}
      )[1];
  ...
  on(Plugin.keyDown, function (e) {
    if (e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_9__.KEYS.SHIFT) {
      _cms_base__WEBPACK_IMPORTED_MODULE_9__.$document.data('expandmode', true);
      try {
        jquery__WEBPACK_IMPORTED_MODULE_2___default()('.cms-plugin:hover').last().trigger('mouseenter');
        jquery__WEBPACK_IMPORTED_MODULE_2___default()('.cms-dragitem:hover').last().trigger('mouseenter');
      } catch (_unused) {}
    }
  }).
  on(Plugin.keyUp, function (e) {
    if (e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_9__.KEYS.SHIFT) {
      _cms_base__WEBPACK_IMPORTED_MODULE_9__.$document.data('expandmode', false);
      try {
        jquery__WEBPACK_IMPORTED_MODULE_2___default()(':hover').trigger('mouseleave');
      } catch (_unused2) {}
    }
  }).
  on(Plugin.click, '.cms-plugin a, a:has(.cms-plugin), a.cms-plugin', function (e) {
    ...
    if (++clickCounter === 1) {
      timer = setTimeout(function () {
        var anchor = jquery__WEBPACK_IMPORTED_MODULE_2___default()(e.target).closest('a');
  ...
  _cms_base__WEBPACK_IMPORTED_MODULE_9__.$document.on(Plugin.click, '.cms-plugin:not([class*=cms-render-model])', Plugin._clickToHighlightHandler);
  _cms_base__WEBPACK_IMPORTED_MODULE_9__.$document.on("".concat(Plugin.pointerOverAndOut, " ").concat(Plugin.touchStart), '.cms-plugin', function (e) {
    // required for both, click and touch
    // otherwise propagation won't work to the nested plugin

    e.stopPropagation();
    const pluginContainer = jquery__WEBPACK_IMPORTED_MODULE_2___default()(e.target).closest('.cms-plugin');
    ...
    var placeholderId = CMS.API.StructureBoard.getId(jquery__WEBPACK_IMPORTED_MODULE_2___default()(".cms-draggable-".concat(id)).closest('.cms-dragarea'));
    var placeholder = jquery__WEBPACK_IMPORTED_MODULE_2___default()('.cms-placeholder-' + placeholderId);
  ...
  _cms_base__WEBPACK_IMPORTED_MODULE_9__.$document.on(Plugin.click, '.cms-dragarea-static .cms-dragbar', (e) => {
    const placeholder = jquery__WEBPACK_IMPORTED_MODULE_2___default()(e.target).closest('.cms-dragarea');
  ...
  _cms_base__WEBPACK_IMPORTED_MODULE_9__.$window.on('blur.cms', () => {
    _cms_base__WEBPACK_IMPORTED_MODULE_9__.$document.data('expandmode', false);
  });
};
...
_ref13)
{let { successTimeout = 200, delay = 1500, seeThrough = false } = _ref13;
  const tpl = jquery__WEBPACK_IMPORTED_MODULE_2___default()("\n        <div class=\"cms-dragitem-success ".concat(
  ...
  jquery__WEBPACK_IMPORTED_MODULE_2___default()(_cms_base__WEBPACK_IMPORTED_MODULE_9__.Helpers._getWindow()).trigger('resize.sideframe');
};
...
{let { successTimeout = 200, seeThrough = false, delay = 1500, prominent = false } = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var coordinates = {};
  var positions = [];
  var OVERLAY_POSITION_TO_WINDOW_HEIGHT_RATIO = 0.2;

  jquery__WEBPACK_IMPORTED_MODULE_2___default()('.cms-plugin-' + pluginId).each(function () {
  ...
  var htmlMargin = html.css('position') === 'relative' ? parseInt(jquery__WEBPACK_IMPORTED_MODULE_2___default()('html').css('margin-top'), 10) : 0;
  ...
  _cms_base__WEBPACK_IMPORTED_MODULE_9__.$window.scrollTop(coordinates.top - _cms_base__WEBPACK_IMPORTED_MODULE_9__.$window.height() * OVERLAY_POSITION_TO_WINDOW_HEIGHT_RATIO);

  jquery__WEBPACK_IMPORTED_MODULE_2___default()("\n        <div class=\"\n            cms-plugin-overlay\n            cms-dragitem-success\n            cms-plugin-overlay-".concat(
  ...
  appendTo(jquery__WEBPACK_IMPORTED_MODULE_2___default()('body'));

  if (successTimeout) {
    setTimeout(() => {
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(".cms-plugin-overlay-".concat(pluginId)).fadeOut(successTimeout, function () {
        jquery__WEBPACK_IMPORTED_MODULE_2___default()(this).remove();
      });
    }, delay);
  }
...
Plugin._removeHighlightPluginContent = function (pluginId) {
  jquery__WEBPACK_IMPORTED_MODULE_2___default()(".cms-plugin-overlay-".concat(pluginId, "[data-success-timeout=0]")).remove();
};
...
Plugin._updateClipboard = function _updateClipboard() {
  clipboardDraggable = jquery__WEBPACK_IMPORTED_MODULE_2___default()('.cms-draggable-from-clipboard:first');
};
...
Plugin._updateUsageCount = function _updateUsageCount(pluginType) {
  ...
  if (_cms_base__WEBPACK_IMPORTED_MODULE_9__.Helpers._isStorageSupported) {
...
Plugin._removeAddPluginPlaceholder = function removeAddPluginPlaceholder() {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_2___default()('.cms-add-plugin-placeholder').remove();
};
...
Plugin._refreshPlugins = function refreshPlugins() {
  ...
  // Remove duplicates
  CMS._plugins = (0,lodash_es_uniqWith_js__WEBPACK_IMPORTED_MODULE_5__["default"])(CMS._plugins, lodash_es_isEqual_js__WEBPACK_IMPORTED_MODULE_8__["default"]);

  CMS._instances.forEach((instance) => {
    if (instance.options.type === 'placeholder') {
      instance._setupUI("cms-placeholder-".concat(instance.options.placeholder_id));
  ...
  CMS._instances.forEach((instance) => {
    if (instance.options.type === 'plugin') {
      instance._setupUI("cms-plugin-".concat(instance.options.plugin_id));
      instance._ensureData();
  ...
  CMS._plugins.forEach((_ref14) => {let [type, opts] = _ref14;
...
Plugin._getPluginById = function (id) {
  return CMS._instances.find((_ref15) => {let { options } = _ref15;return options.type === 'plugin' && Number(options.plugin_id) === Number(id);});
};
...
Plugin._updatePluginPositions = function (placeholder_id) {
  ...
  const plugins = jquery__WEBPACK_IMPORTED_MODULE_2___default()(".cms-dragarea-".concat(placeholder_id, " .cms-draggable")).toArray();

  plugins.forEach((element, index) => {
    const pluginId = CMS.API.StructureBoard.getId(jquery__WEBPACK_IMPORTED_MODULE_2___default()(element));
...
Plugin._recalculatePluginPositions = function (action, data) {
  if (action === 'MOVE') {
    ...
    CMS._instances.filter((_ref16) => {let { options } = _ref16;return options.type === 'placeholder';}).
    map((_ref17) => {let { options } = _ref17;return options.placeholder_id;}).
...
// shorthand for jQuery(document).ready();
jquery__WEBPACK_IMPORTED_MODULE_2___default()(Plugin._initializeGlobalHandlers);
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./cms/static/cms/js/libs/jquery.min.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _cms_base__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cms.base */ "./cms/static/cms/js/modules/cms.base.js");
/* harmony import */ var _loader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./loader */ "./cms/static/cms/js/modules/loader.js");
/*
 * Copyright https://github.com/divio/django-cms
 */
...
class Sideframe {
   ...
   */
  _setupUI() {
    var sideframe = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-sideframe');
  ...
  open(opts) {
    ...
    (0,_loader__WEBPACK_IMPORTED_MODULE_2__.showLoader)();

    url = _cms_base__WEBPACK_IMPORTED_MODULE_1__.Helpers.makeURL(url);
  ...
  _content(url) {
    var that = this;
    var iframe = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<iframe src="' + url + '" class="" frameborder="0" />');
    var holder = this.ui.frame;
    var contents;
    var body;
    ...
    iframe.hide().on('load', function () {
      ...
      contents.on(that.click, function () {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).trigger('click.cms');
      });

      // attach close event
      body.on('keydown.cms', function (e) {
        if (e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_1__.KEYS.ESC) {
          that.close();
        }
      });
      ...
      (0,_loader__WEBPACK_IMPORTED_MODULE_2__.hideLoader)();
    });
    ...
    CMS.settings = _cms_base__WEBPACK_IMPORTED_MODULE_1__.Helpers.setSettings(window.CMS.settings);
    ...
    this.pageLoadInterval = setInterval(() => {
      try {
        ...
        if (currentUrl !== iframeUrl && currentUrl !== 'about:blank') {
          ...
          window.CMS.settings = _cms_base__WEBPACK_IMPORTED_MODULE_1__.Helpers.setSettings(window.CMS.settings);
  ...
  _show(animate) {
    ...
    _cms_base__WEBPACK_IMPORTED_MODULE_1__.Helpers.preventTouchScrolling(jquery__WEBPACK_IMPORTED_MODULE_0___default()(document), 'sideframe');
  }
  ...
  close() {
    ...
    CMS.settings = _cms_base__WEBPACK_IMPORTED_MODULE_1__.Helpers.setSettings(CMS.settings);
  ...
  _hide(opts) {
    ...
    _cms_base__WEBPACK_IMPORTED_MODULE_1__.Helpers.allowTouchScrolling(jquery__WEBPACK_IMPORTED_MODULE_0___default()(document), 'sideframe');
  }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Sideframe);
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _keyboard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./keyboard */ "./cms/static/cms/js/modules/keyboard.js");
/* harmony import */ var _cms_plugins__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cms.plugins */ "./cms/static/cms/js/modules/cms.plugins.js");
/* harmony import */ var _cms_toolbar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./cms.toolbar */ "./cms/static/cms/js/modules/cms.toolbar.js");
/* harmony import */ var _cms_clipboard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./cms.clipboard */ "./cms/static/cms/js/modules/cms.clipboard.js");
/* harmony import */ var _dom_diff__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./dom-diff */ "./cms/static/cms/js/modules/dom-diff.js");
/* harmony import */ var lodash_es_once_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! lodash-es/once.js */ "./node_modules/lodash-es/once.js");
/* harmony import */ var lodash_es_remove_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! lodash-es/remove.js */ "./node_modules/lodash-es/remove.js");
/* harmony import */ var lodash_es_isEqual_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! lodash-es/isEqual.js */ "./node_modules/lodash-es/isEqual.js");
/* harmony import */ var lodash_es_zip_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! lodash-es/zip.js */ "./node_modules/lodash-es/zip.js");
...
/* harmony import */ var _jquery_ui_custom__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./jquery.ui.custom */ "./cms/static/cms/js/modules/jquery.ui.custom.js");
/* harmony import */ var _jquery_ui_touchpunch__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./jquery.ui.touchpunch */ "./cms/static/cms/js/modules/jquery.ui.touchpunch.js");
/* harmony import */ var _jquery_ui_nestedsortable__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./jquery.ui.nestedsortable */ "./cms/static/cms/js/modules/jquery.ui.nestedsortable.js");
/* harmony import */ var _scrollbar__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./scrollbar */ "./cms/static/cms/js/modules/scrollbar.js");
/* harmony import */ var _preload_images__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./preload-images */ "./cms/static/cms/js/modules/preload-images.js");
/* harmony import */ var _cms_base__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./cms.base */ "./cms/static/cms/js/modules/cms.base.js");
/* harmony import */ var _loader__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./loader */ "./cms/static/cms/js/modules/loader.js");
/*
 * Copyright https://github.com/divio/django-cms
 */
...
const arrayEquals = (a1, a2) => (0,lodash_es_zip_js__WEBPACK_IMPORTED_MODULE_9__["default"])(a1, a2).every((_ref) => {let [a, b] = _ref;return a === b;});
...
class StructureBoard {
  constructor() {
    ...
    local_storage__WEBPACK_IMPORTED_MODULE_10___default().remove(storageKey);

    dd = new _dom_diff__WEBPACK_IMPORTED_MODULE_5__.DiffDOM();
   ...
   */
  _setupUI() {
    const container = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-structure');
    const toolbar = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-toolbar');

    this.ui = {
      container: container,
      content: jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-structure-content'),
      doc: jquery__WEBPACK_IMPORTED_MODULE_0___default()(document),
      window: jquery__WEBPACK_IMPORTED_MODULE_0___default()(window),
      html: jquery__WEBPACK_IMPORTED_MODULE_0___default()('html'),
      toolbar: toolbar,
      sortables: jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-draggables'), // global scope to include clipboard
      plugins: jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-plugin'),
      render_model: jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-render-model'),
      placeholders: jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-placeholder'),
      dragitems: jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-draggable'),
      dragareas: jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-dragarea'),
  ...
  _setup() {
    ...
    // istanbul ignore next
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-draggable:not(.cms-drag-disabled)').one(
      'pointerover.cms.drag',
      (0,lodash_es_once_js__WEBPACK_IMPORTED_MODULE_6__["default"])(() => {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-draggable').off('pointerover.cms.drag');
        this._drag();
      })
    );
  }
  ...
  _preloadOppositeMode() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(_cms_base__WEBPACK_IMPORTED_MODULE_16__.Helpers._getWindow()).one('load', () => {
      setTimeout(() => {
  ...
  _setupModeSwitcher() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(_cms_base__WEBPACK_IMPORTED_MODULE_16__.Helpers._getWindow()).
    on(this.keyUpAndDown, (e) => {
      if (
      e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_16__.KEYS.CMD_LEFT ||
      e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_16__.KEYS.CMD_RIGHT ||
      e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_16__.KEYS.CMD_FIREFOX ||
      e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_16__.KEYS.SHIFT ||
      e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_16__.KEYS.CTRL)
      {
        cmdPressed = true;
      }
      if (e.type === 'keyup') {
    ...
    modes.on(this.click, (e) => {
      ...
      if (cmdPressed && e.type === 'click') {
        ...
        _cms_base__WEBPACK_IMPORTED_MODULE_16__.Helpers._getWindow().open(modes.attr('href'), '_blank');
        return;
      }
    ...
    {
      _keyboard__WEBPACK_IMPORTED_MODULE_1__["default"].setContext('cms');
      _keyboard__WEBPACK_IMPORTED_MODULE_1__["default"].bind('space', (e) => {
        e.preventDefault();
        this._toggleStructureBoard();
      });
      _keyboard__WEBPACK_IMPORTED_MODULE_1__["default"].bind('shift+space', (e) => {
        e.preventDefault();
   ...
   */
  _toggleStructureBoard() {let options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    const that = this;

    if (options.useHoveredPlugin && CMS.settings.mode !== 'structure') {
      that._showAndHighlightPlugin(options.successTimeout).then((jquery__WEBPACK_IMPORTED_MODULE_0___default().noop), (jquery__WEBPACK_IMPORTED_MODULE_0___default().noop));
   ...
   */
  // eslint-disable-next-line no-magic-numbers
  _showAndHighlightPlugin() {let successTimeout = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 200;let seeThrough = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    ...
    return this.show().then(function () {
      const draggable = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-draggable-' + pluginId);
      ...
      each((i, el) => jquery__WEBPACK_IMPORTED_MODULE_0___default()(el).triggerHandler(_cms_plugins__WEBPACK_IMPORTED_MODULE_2__["default"].click));
      ...
      setTimeout(function () {
        ...
        _cms_plugins__WEBPACK_IMPORTED_MODULE_2__["default"]._highlightPluginStructure(draggable.find('.cms-dragitem:first'), { successTimeout, seeThrough });
      }, HIGHLIGHT_TIMEOUT);
    });
  }
   ...
   * @returns {Promise}
   */
  show() {let { init = false } = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    // cancel show if live modus is active
    if (CMS.config.mode === 'live') {
      return Promise.resolve(false);
    }
    ...
    if (init) {
      ...
      if (!scrollBarWidth && init) {
        scrollBarWidth = (0,_scrollbar__WEBPACK_IMPORTED_MODULE_14__["default"])();
      }
    ...
    _cms_base__WEBPACK_IMPORTED_MODULE_16__.Helpers.setSettings(CMS.settings);
  ...
  _loadStructure() {
    ...
    (0,_loader__WEBPACK_IMPORTED_MODULE_17__.showLoader)();
    return this.
    _requestMode('structure').
    done((contentMarkup) => {
      this._requeststructure = null;
      (0,_loader__WEBPACK_IMPORTED_MODULE_17__.hideLoader)();

      CMS.settings.states = _cms_base__WEBPACK_IMPORTED_MODULE_16__.Helpers.getSettings().states;
      ...
      const structure = jquery__WEBPACK_IMPORTED_MODULE_0___default()(body.querySelector('.cms-structure-content'));
      const toolbar = jquery__WEBPACK_IMPORTED_MODULE_0___default()(body.querySelector('.cms-toolbar'));
      const scripts = jquery__WEBPACK_IMPORTED_MODULE_0___default()(body.querySelectorAll('[type="text/cms-template"]')); // cms scripts
      const pluginIds = this.getIds(jquery__WEBPACK_IMPORTED_MODULE_0___default()(body.querySelectorAll('.cms-draggable')));
      const pluginData = StructureBoard._getPluginDataFromMarkup(
        body,
        pluginIds
      );

      _cms_plugins__WEBPACK_IMPORTED_MODULE_2__["default"]._updateRegistry(pluginData);

      CMS.API.Toolbar._refreshMarkup(toolbar);

      jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').append(scripts);
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-structure-content').html(structure.html());
      triggerWindowResize();
      ...
      this.ui.sortables = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-draggables');
      this._drag();
      StructureBoard._initializeDragItemsStates();
  ...
  _requestMode(mode) {
    ...
    if (!this["_request".concat(mode)]) {
      this["_request".concat(mode)] = jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
        url: url.toString(),
        method: 'GET'
      }).then((markup) => {
        (0,_preload_images__WEBPACK_IMPORTED_MODULE_15__["default"])(markup);

        return markup;
      });
    }

    return this["_request".concat(mode)];
  }
  ...
  _loadContent() {
    ...
    _requestMode('content').
      ...
      let body = jquery__WEBPACK_IMPORTED_MODULE_0___default()(matches[2]);
      const head = jquery__WEBPACK_IMPORTED_MODULE_0___default()(headRegex.exec(contentMarkup)[1]);
      const htmlAttrs = htmlRegex.exec(contentMarkup)[1];
      const bodyAttributes = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div ' + bodyAttrs + '></div>')[0].attributes;
      const htmlAttributes = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div ' + htmlAttrs + '></div>')[0].attributes;
      const newToolbar = body.find('.cms-toolbar');
      const toolbar = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms').add('[data-cms]').detach();
      const title = head.filter('title');
      const bodyElement = jquery__WEBPACK_IMPORTED_MODULE_0___default()('body');
      ...
      body = body.filter(function () {
        const elem = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
      ...
      [].slice.call(htmlAttributes).forEach(function (attr) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('html').attr(attr.name, attr.value);
      });

      bodyElement.append(body);
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('head').append(head);
      ...
      _cms_plugins__WEBPACK_IMPORTED_MODULE_2__["default"]._refreshPlugins();

      const scripts = jquery__WEBPACK_IMPORTED_MODULE_0___default()('script');
      ...
      if (unhandledPlugins.length) {
        ...
        _cms_base__WEBPACK_IMPORTED_MODULE_16__.Helpers.reloadBrowser('REFRESH_PAGE');
      }
  ...
  hide() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('html').removeClass('cms-overflow');
  ...
  getIds(els) {
    ...
    els.each(function () {
      array.push(that.getId(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this)));
    });
    return array;
  }
  ...
  _makeFullWidth() {
    ...
    if (CMS.settings.mode === 'structure') {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('html.cms-structure-mode-structure').addClass('cms-overflow');
    }
   ...
   * @private
   */
  _drag() {let elem = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.ui.sortables;
    const that = this;
    ...
    nestedSortable({
      ...
      start: function (e, ui) {
        ...
        _cms_plugins__WEBPACK_IMPORTED_MODULE_2__["default"]._hideSettingsMenu();
        ...
        that.ui.doc.on('keyup.cms.interrupt', function (event, cancel) {
          if (event.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_16__.KEYS.ESC && that.dragging || cancel) {
            that.state = false;
            jquery__WEBPACK_IMPORTED_MODULE_0___default().ui.sortable.prototype._mouseStop();
      ...
      update: function (event, ui) {
        ...
        const plugin = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".cms-draggable-".concat(id));
        const eventData = {
          id: id
        };
        ...
        if (originalPluginContainer.hasClass('cms-clipboard-containers')) {
          ...
          _cms_plugins__WEBPACK_IMPORTED_MODULE_2__["default"]._updateClipboard();
      ...
      isAllowed: function (placeholder, placeholderParent, originalItem) {
        ...
        const original = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-draggable-' + originalItemId);
        ...
        const parent_bounds = jquery__WEBPACK_IMPORTED_MODULE_0___default().grep(originalItemData.plugin_parent_restriction, function (r) {
          // special case when PlaceholderPlugin has a parent restriction named "0"
          return r !== '0';
        });
        ...
        const holder = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-placeholder-' + holderId);
        let plugin;
        ...
        if (placeholderParent && placeholderParent.length) {
          ...
          plugin = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-draggable-' + that.getId(placeholderParent.closest('.cms-draggable')));
        } else {
          plugin = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-draggable-' + that.getId(placeholder.closest('.cms-draggable')));
        }
        ...
        that.state = !(bounds.length && jquery__WEBPACK_IMPORTED_MODULE_0___default().inArray(type, bounds) === -1);

        // check if we have a parent restriction
        if (parent_bounds.length) {
          that.state = jquery__WEBPACK_IMPORTED_MODULE_0___default().inArray(immediateParentType, parent_bounds) !== -1;
        }
   ...
   */
  // eslint-disable-next-line complexity
  invalidateState(action, data) {let { propagate = true } = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    ...
    _cms_plugins__WEBPACK_IMPORTED_MODULE_2__["default"]._recalculatePluginPositions(action, data);
    ...
    this._loadToolbar().
      ...
      CMS.API.Toolbar._refreshMarkup(jquery__WEBPACK_IMPORTED_MODULE_0___default()(newToolbar).find('.cms-toolbar'));
    }).
    fail(() => _cms_base__WEBPACK_IMPORTED_MODULE_16__.Helpers.reloadBrowser());
  }

  _propagateInvalidatedState(action, data) {
    this.latestAction = [action, data];

    local_storage__WEBPACK_IMPORTED_MODULE_10___default().set(storageKey, JSON.stringify([action, data, window.location.pathname]));
  }

  _listenToExternalUpdates() {
    if (!_cms_base__WEBPACK_IMPORTED_MODULE_16__.Helpers._isStorageSupported) {
      return;
    }

    local_storage__WEBPACK_IMPORTED_MODULE_10___default().on(storageKey, this._handleExternalUpdate.bind(this));
  }
  ...
  _handleExternalUpdate(value) {
    ...
    if ((0,lodash_es_isEqual_js__WEBPACK_IMPORTED_MODULE_8__["default"])([action, data], this.latestAction)) {
      return;
    }
  ...
  updateContent() {
    const loader = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div class="cms-content-reloading"></div>');

    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-structure').before(loader);
    ...
    fail(() => loader.remove() && _cms_base__WEBPACK_IMPORTED_MODULE_16__.Helpers.reloadBrowser());
  }
  ...
  _updateSingleContent(content) {
    ...
    let nextEl = jquery__WEBPACK_IMPORTED_MODULE_0___default()(":not(template).cms-plugin.cms-plugin-".concat(content.pluginIds[0], ".cms-plugin-start"));
    ...
    content.pluginIds.forEach((id) => {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(":not(template).cms-plugin.cms-plugin-".concat(id)).remove();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("script[data-cms-plugin]#cms-plugin-".concat(id)).remove();
    });
  ...
  _findNextElement(position, placeholder_id, excludedPlugins) {
    let nextEl = jquery__WEBPACK_IMPORTED_MODULE_0___default()("div.cms-placeholder.cms-placeholder-".concat(placeholder_id));
    ...
    if (nextPlugins.length > 0) {
      ...
      nextEl = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".cms-plugin.cms-plugin-".concat(nextPluginId, ".cms-plugin-start"));
    }
    return nextEl;
  }
  ...
  _updateSekizai(data, block) {
    ...
    const diff = dd.diff(newElements, "<div>".concat(data[block], "</div>"));
  ...
  _loadToolbar() {
    const placeholderIds = (0,_cms_toolbar__WEBPACK_IMPORTED_MODULE_3__.getPlaceholderIds)(CMS._plugins).map((id) => "placeholders[]=".concat(id)).join('&');

    return jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      url: _cms_base__WEBPACK_IMPORTED_MODULE_16__.Helpers.updateUrlWithPath(
        "".concat(CMS.config.request.toolbar, "?") +
        placeholderIds +
        '&' + "obj_id=".concat(
          CMS.config.request.pk, "&") + "obj_type=".concat(
          encodeURIComponent(CMS.config.request.model)) + "&language=".concat(
          encodeURIComponent(CMS.config.request.language))
      )
    });
  }
  ...
  handleMovePlugin(data) {
    if (data.plugin_parent) {
      if (data.plugin_id) {
        const draggable = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".cms-draggable-".concat(data.plugin_id, ":last"));

        if (
        !draggable.closest(".cms-draggable-".concat(data.plugin_parent)).length &&
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".cms-draggable-".concat(data.plugin_parent)).html('').replaceWith(data.html);
    } else {
      // the one in the clipboard is first, so we need to take the second one,
      // that is already visually moved into correct place
      let draggable = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".cms-draggable-".concat(data.plugin_id, ":last"));

      // external update, have to move the draggable to correct place first
      if (!draggable.closest('.cms-draggables').parent().is(".cms-dragarea-".concat(data.placeholder_id))) {
        ...
        const placeholderDraggables = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".cms-dragarea-".concat(data.placeholder_id, " > .cms-draggables"));
        ...
        if (index === 0) {
          ...
          placeholderDraggables.find(".cms-draggable-".concat(pluginOrder[index - 1])).after(draggable);
        }
      }
      ...
      if (draggable.length) {
        ...
        // copy from language
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(".cms-dragarea-".concat(data.target_placeholder_id, " > .cms-draggables")).append(data.html);
      }
    }

    StructureBoard.actualizePlaceholders();
    _cms_plugins__WEBPACK_IMPORTED_MODULE_2__["default"]._updateRegistry(data.plugins);
  ...
  handleCopyPlugin(data) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-clipboard-containers').html(data.html);
    const cloneClipboard = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-clipboard').clone();

    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-clipboard').replaceWith(cloneClipboard);

    const pluginData = ["cms-plugin-".concat(data.plugins[0].plugin_id), data.plugins[0]];

    _cms_plugins__WEBPACK_IMPORTED_MODULE_2__["default"].aliasPluginDuplicatesMap[pluginData[1].plugin_id] = false;
    CMS._plugins.push(pluginData);
    CMS._instances.push(new _cms_plugins__WEBPACK_IMPORTED_MODULE_2__["default"](pluginData[0], pluginData[1]));

    CMS.API.Clipboard = new _cms_clipboard__WEBPACK_IMPORTED_MODULE_4__["default"]();

    _cms_plugins__WEBPACK_IMPORTED_MODULE_2__["default"]._updateClipboard();

    const clipboardDraggable = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-clipboard .cms-draggable:first');
  ...
  _extractMessages(doc) {
    ...
    if (messages.length) {
      ...
      return messages.toArray().map((el) => {
        const msgEl = jquery__WEBPACK_IMPORTED_MODULE_0___default()(el);
        const message = jquery__WEBPACK_IMPORTED_MODULE_0___default()(el).text().trim();
  ...
  refreshContent(contentMarkup) {
    ...
    const structureScrollTop = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-structure-content').scrollTop();

    const toolbar = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#cms-top, [data-cms]').detach();
    const newToolbar = jquery__WEBPACK_IMPORTED_MODULE_0___default()(newDoc).find('.cms-toolbar').clone();

    jquery__WEBPACK_IMPORTED_MODULE_0___default()(newDoc).find('#cms-top, [data-cms]').remove();

    const messages = this._extractMessages(jquery__WEBPACK_IMPORTED_MODULE_0___default()(newDoc));
    ...
    const headDiff = dd.diff(document.head, (0,_dom_diff__WEBPACK_IMPORTED_MODULE_5__.nodeToObj)(newDoc.head));
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-structure-content').scrollTop(structureScrollTop);
  ...
  _contentChanged(messages) {
    ...
    if (messages) {
      ...
      if (messages.length) {
        CMS.API.Messages.open({
          message: messages.map((message) => "<p>".concat(message.message, "</p>")).join(''),
  ...
  handleAddPlugin(data) {
    if (data.plugin_parent) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".cms-draggable-".concat(data.plugin_parent)).replaceWith(data.structure.html);
    } else {
      // the one in the clipboard is first
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".cms-dragarea-".concat(data.placeholder_id, " > .cms-draggables")).append(data.structure.html);
    }

    StructureBoard.actualizePlaceholders();
    _cms_plugins__WEBPACK_IMPORTED_MODULE_2__["default"]._updateRegistry(data.structure.plugins);
  ...
  handleEditPlugin(data) {
    if (data.plugin_parent) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".cms-draggable-".concat(data.plugin_id)).replaceWith(data.structure.html);
    }
  ...
  handleDeletePlugin(data) {
    ...
    const draggable = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-draggable-' + data.plugin_id);
    ...
    deletedPluginIds.forEach(function (pluginId) {
      if (!contentData.content) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(".cms-plugin.cms-plugin-".concat(pluginId)).remove(); // Remove from content
      }
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("script[data-cms-plugin]#cms-plugin-".concat(pluginId)).remove(); // Remove script elements
      (0,lodash_es_remove_js__WEBPACK_IMPORTED_MODULE_7__["default"])(CMS._plugins, (settings) => settings[0] === "cms-plugin-".concat(pluginId));
      (0,lodash_es_remove_js__WEBPACK_IMPORTED_MODULE_7__["default"])(
        CMS._instances,
  ...
  handleClearPlaceholder(data) {
    ...
    deletedIds.forEach((id) => {
      (0,lodash_es_remove_js__WEBPACK_IMPORTED_MODULE_7__["default"])(CMS._plugins, (settings) => settings[0] === "cms-plugin-".concat(id));
      (0,lodash_es_remove_js__WEBPACK_IMPORTED_MODULE_7__["default"])(
        CMS._instances,
        (instance) => instance.options.plugin_id && Number(instance.options.plugin_id) === Number(id)
      );

      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".cms-draggable-".concat(id)).remove();
    });
  ...
  static _initializeGlobalHandlers() {
    placeholders = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-dragarea:not(.cms-clipboard-containers)');
  }
  ...
  static actualizePlaceholders() {
    placeholders.each(function () {
      const placeholder = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    ...
    const addPluginPlaceholder = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-dragarea .cms-add-plugin-placeholder');
  ...
  static actualizePluginCollapseStatus(pluginId) {
    const el = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".cms-draggable-".concat(pluginId));
  ...
  static actualizePluginsCollapsibleStatus(els) {
    els.each(function () {
      const childList = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
  ...
  static _triggerRefreshEvents() {
    setTimeout(() => {
      _cms_base__WEBPACK_IMPORTED_MODULE_16__.Helpers._getWindow().document.dispatchEvent(new Event('DOMContentLoaded'));
      _cms_base__WEBPACK_IMPORTED_MODULE_16__.Helpers._getWindow().dispatchEvent(new Event('load'));
      _cms_base__WEBPACK_IMPORTED_MODULE_16__.Helpers._getWindow().dispatchEvent(new Event('cms-content-refresh'));
    }, 0);
  }
  ...
  highlightPluginFromUrl() {
    ...
    if (this._loadedContent) {
      _cms_plugins__WEBPACK_IMPORTED_MODULE_2__["default"]._highlightPluginContent(pluginId, {
        seeThrough: true,
        prominent: true,
        delay: 3000
      });
  ...
  static _getPluginDataFromMarkup(body, pluginIds) {
    return pluginIds.map((pluginId) => {
      const pluginData = body.querySelector("#cms-plugin-".concat(pluginId));
      let settings;
...
StructureBoard._initializeDragItemsStates = function _initializeDragItemsStates() {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default().each(CMS.settings.states, function (index, id) {
    const el = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-draggable-' + id);
...
// shorthand for jQuery(document).ready();
jquery__WEBPACK_IMPORTED_MODULE_0___default()(StructureBoard._initializeGlobalHandlers);

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (StructureBoard);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   getPlaceholderIds: () => (/* binding */ getPlaceholderIds)
/* harmony export */ });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./cms/static/cms/js/libs/jquery.min.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _cms_navigation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cms.navigation */ "./cms/static/cms/js/modules/cms.navigation.js");
/* harmony import */ var _cms_sideframe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cms.sideframe */ "./cms/static/cms/js/modules/cms.sideframe.js");
/* harmony import */ var _cms_modal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./cms.modal */ "./cms/static/cms/js/modules/cms.modal.js");
/* harmony import */ var _cms_plugins__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./cms.plugins */ "./cms/static/cms/js/modules/cms.plugins.js");
/* harmony import */ var lodash_es_throttle_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! lodash-es/throttle.js */ "./node_modules/lodash-es/throttle.js");
/* harmony import */ var _loader__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./loader */ "./cms/static/cms/js/modules/loader.js");
/* harmony import */ var _cms_base__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./cms.base */ "./cms/static/cms/js/modules/cms.base.js");
/*
 * Copyright https://github.com/divio/django-cms
 */
...
class Toolbar {
  constructor(options) {
    // Copy Helpers methods to instance
    Object.assign(this, _cms_base__WEBPACK_IMPORTED_MODULE_7__.Helpers);
     ...
     */
    this.navigation = new _cms_navigation__WEBPACK_IMPORTED_MODULE_1__["default"]();
  ...
  _setupUI() {
    ...
    this.ui = {
      ...
      toolbarSwitcher: jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-toolbar-item-cms-mode-switcher'),
      revert: jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-toolbar-revert')
    };
  }
  ...
  _events() {
    ...
    this.ui.navigations.each(function () {
      var navigation = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
      ...
      .on(that.click + ' ' + that.key, function (e) {
        ...
        // ctrl/cmd is pressed:
        if (
        e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_7__.KEYS.CMD_LEFT ||
        e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_7__.KEYS.CMD_RIGHT ||
        e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_7__.KEYS.CMD_FIREFOX ||
        e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_7__.KEYS.SHIFT ||
        e.keyCode === _cms_base__WEBPACK_IMPORTED_MODULE_7__.KEYS.CTRL)
        {
          cmdPressed = true;
        }
        if (e.type === 'keyup') {
        ...
        if (el.attr('href') !== '' && el.attr('href') !== '#' && !el.parent().hasClass(disabled)) {
          if (cmdPressed && e.type === 'click') {
            // control the behaviour when ctrl/cmd is pressed
            _cms_base__WEBPACK_IMPORTED_MODULE_7__.Helpers._getWindow().open(el.attr('href'), '_blank');
          } else if (e.type === 'click') {
            // otherwise delegate as usual
            that._delegate(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this));
          } else {
            // tabbing through
            return;
          }
      ...
      lists.on(that.click, function (e) {
        ...
        if (!isTouchingTopLevelMenu) {
          ...
          navigation.find('> li').on(that.mouseEnter, function () {
            ...
            if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).hasClass(hover)) {
              return false;
            }
            open = false;
            jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).trigger(that.click);
          });
        }
        ...
        that.ui.window.on(that.resize + '.menu.reset', (0,lodash_es_throttle_js__WEBPACK_IMPORTED_MODULE_5__["default"])(reset, SECOND));
        // update states
        open = true;
      });
    ...
    this.ui.buttons.each(function () {
      ...
      links.each(function (i, el) {
        var link = jquery__WEBPACK_IMPORTED_MODULE_0___default()(el);
    ...
    on(
      ...
      (0,lodash_es_throttle_js__WEBPACK_IMPORTED_MODULE_5__["default"])(jquery__WEBPACK_IMPORTED_MODULE_0___default().proxy(this._handleLongMenus, this), LONG_MENUS_THROTTLE)
    );
  }
  ...
  // eslint-disable-next-line complexity
  _initialStates() {
    var publishBtn = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-btn-publish').parent();
    ...
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-btn-publish-active').length) {
    ...
    sideFrameEnabled)
    {
      var sideframe = CMS.API.Sideframe || new _cms_sideframe__WEBPACK_IMPORTED_MODULE_2__["default"]();
    ...
    // set color scheme
    _cms_base__WEBPACK_IMPORTED_MODULE_7__.Helpers.setColorScheme(
  ...
  _show(opts) {
    ...
    var toolbarHeight = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-toolbar').height() + TOOLBAR_OFFSCREEN_OFFSET;
  ...
  openAjax(opts) {
    ...
    var question = text ? _cms_base__WEBPACK_IMPORTED_MODULE_7__.Helpers.secureConfirm(text) : true;
    ...
    return jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      if (callback) {
        ...
        if (onSuccess === 'FOLLOW_REDIRECT') {
          _cms_base__WEBPACK_IMPORTED_MODULE_7__.Helpers.reloadBrowser(response.url);
        } else {
          _cms_base__WEBPACK_IMPORTED_MODULE_7__.Helpers.reloadBrowser(onSuccess);
        }
      } else {
        // reload
        _cms_base__WEBPACK_IMPORTED_MODULE_7__.Helpers.reloadBrowser();
      }
    }).
    fail(function (jqXHR) {
      CMS.API.locked = false;
  ...
  _delegate(el) {
    ...
    switch (target) {
      case 'modal':
        _cms_plugins__WEBPACK_IMPORTED_MODULE_4__["default"]._removeAddPluginPlaceholder();

        var modal = new _cms_modal__WEBPACK_IMPORTED_MODULE_3__["default"]({
          onClose: el.data('on-close')
        });

        modal.open({
          url: _cms_base__WEBPACK_IMPORTED_MODULE_7__.Helpers.updateUrlWithPath(el.attr('href')) + '&_popup=1',
          title: el.data('name')
        });
        break;
      case 'message':
      ...
      case 'ajax':
        ...
        break;
      case 'color-toggle':
        _cms_base__WEBPACK_IMPORTED_MODULE_7__.Helpers.toggleColorScheme();
        break;
      case 'sideframe':
      ...
      default:
        if (el.hasClass('cms-form-post-method')) {
          ...
          _cms_base__WEBPACK_IMPORTED_MODULE_7__.Helpers._getWindow().location.href = el.attr('href');
        }
    }
  }
  ...
  _sendPostRequest(el) {
    ...
    var fakeForm = jquery__WEBPACK_IMPORTED_MODULE_0___default()(
      '<form style="display: none" action="' + el.attr('href') + '" method="POST">' + csrfToken +
      '</form>'
    );

    fakeForm.appendTo(_cms_base__WEBPACK_IMPORTED_MODULE_7__.Helpers._getWindow().document.body).submit();
  }
   ...
   */
  _handleLongMenus() {
    var openMenus = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-toolbar-item-navigation-hover > ul');
    ...
    var positions = openMenus.toArray().map(function (item) {
      var el = jquery__WEBPACK_IMPORTED_MODULE_0___default()(item);

      return jquery__WEBPACK_IMPORTED_MODULE_0___default().extend({}, el.position(), { height: el.height() });
    });
  ...
  _refreshMarkup(newToolbar) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.ui.toolbar).html(newToolbar.children());

    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-toolbar-item-cms-mode-switcher').replaceWith(switcher);
    ...
    CMS.API.Clipboard.ui.triggers = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-clipboard-trigger a');
    CMS.API.Clipboard.ui.triggerRemove = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-clipboard-empty a');
...
class Tooltip {
  constructor() {
    ...
    this._forceTouchOnce = (0,lodash_es_once_js__WEBPACK_IMPORTED_MODULE_1__["default"])(this._forceTouch.bind(this));
    this._checkTouch();
  }
  ...
  _forceTouch() {
    ...
    this.domElem.on('touchstart.cms', function () {
      var id = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('plugin_id');
      var plugin = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-plugin-' + id);
      ...
      if (plugin.length) {
        ...
        var generic = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-plugin[class*="cms-plugin-cms-"][class*="-' + id + '"]');
   ...
   */
  _pick() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-tooltip-touch, .cms-tooltip').css('visibility', 'hidden').hide();
    return this.isTouch ? jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-tooltip-touch') : jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cms-tooltip');
  }
  ...
  position(e, tooltip) {
    ...
    var offset = 20;
    var arrowOffset = 12;
    var relX = e.pageX - jquery__WEBPACK_IMPORTED_MODULE_0___default()(tooltip).offsetParent().offset().left;
    var relY = e.pageY - jquery__WEBPACK_IMPORTED_MODULE_0___default()(tooltip).offsetParent().offset().top;
    var bound = jquery__WEBPACK_IMPORTED_MODULE_0___default()(tooltip).offsetParent().width();
...
class Dropdown {
  ...
  keydown(e) {
    ...
    if (!isActive && e.which !== 27 || isActive && e.which === 27) {
      if (e.which === 27) {var _parent$querySelector;
        (_parent$querySelector = parent.querySelector(TOGGLE_SELECTOR)) === null || _parent$querySelector === void 0 || _parent$querySelector.focus();
      }
...
function bind(key, callback) {let ctx = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
...
function unbind(key) {let ctx = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  if (Array.isArray(key)) {
...
function handleKeydown(event) {
  ...
  if (context) {
    if (context[key]) {
      ...
      const comboKey = "".concat(lastKey, " > ").concat(key);
...
/***/ "./cms/static/cms/js/modules/nextuntil.js"
/*!************************************************!*\
  !*** ./cms/static/cms/js/modules/nextuntil.js ***!
  \************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
 ...
 */
function nextUntil(element, until) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ preloadImagesFromMarkup)
/* harmony export */ });
// istanbul ignore next
/**
 * preload
...
/***/ "./cms/static/cms/js/modules/scrollbar.js"
/*!************************************************!*\
  !*** ./cms/static/cms/js/modules/scrollbar.js ***!
  \************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var lodash_es_memoize_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash-es/memoize.js */ "./node_modules/lodash-es/memoize.js");
 ...
 */
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,lodash_es_memoize_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function measure() {
...
/***/ "./cms/static/cms/js/modules/shortcuts/create-modal.js"
/*!*************************************************************!*\
  !*** ./cms/static/cms/js/modules/shortcuts/create-modal.js ***!
  \*************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */ });
/* harmony import */ var _keyboard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../keyboard */ "./cms/static/cms/js/modules/keyboard.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! jquery */ "./cms/static/cms/js/libs/jquery.min.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_1__);
...
function createModal() {
  ...
  _keyboard__WEBPACK_IMPORTED_MODULE_0__["default"].setContext('cms');

  _keyboard__WEBPACK_IMPORTED_MODULE_0__["default"].bind(data.shortcut, function () {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.cms-btn[href*="wizard"]').trigger('click');
  });
}

/***/ },

/***/ "./cms/static/cms/js/modules/shortcuts/help.js"
/*!*****************************************************!*\
  !*** ./cms/static/cms/js/modules/shortcuts/help.js ***!
  \*****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ initHelpShortcut)
/* harmony export */ });
/* harmony import */ var _cms_modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../cms.modal */ "./cms/static/cms/js/modules/cms.modal.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! jquery */ "./cms/static/cms/js/libs/jquery.min.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _keyboard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../keyboard */ "./cms/static/cms/js/modules/keyboard.js");
/* harmony import */ var _tmpl__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../tmpl */ "./cms/static/cms/js/modules/tmpl.js");





var template = __webpack_require__(/*! ./help.html */ "./cms/static/cms/js/modules/shortcuts/help.html");
...
function initHelpShortcut() {
  ...
  function openModal(e) {
    ...
    modal.open({
      ...
      width: 600,
      height: 660,
      html: (0,_tmpl__WEBPACK_IMPORTED_MODULE_3__["default"])(template, { shortcutAreas: shortcutAreas })
    });
  }

  _keyboard__WEBPACK_IMPORTED_MODULE_2__["default"].setContext('cms');
  _keyboard__WEBPACK_IMPORTED_MODULE_2__["default"].bind('?', openModal);
  jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).on('pointerup.cms', '.cms-show-shortcuts', openModal);
}

/***/ },

/***/ "./cms/static/cms/js/modules/shortcuts/index.js"
/*!******************************************************!*\
  !*** ./cms/static/cms/js/modules/shortcuts/index.js ***!
  \******************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */ });
/* harmony import */ var _help__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./help */ "./cms/static/cms/js/modules/shortcuts/help.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! jquery */ "./cms/static/cms/js/libs/jquery.min.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _placeholders__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./placeholders */ "./cms/static/cms/js/modules/shortcuts/placeholders.js");
/* harmony import */ var _create_modal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./create-modal */ "./cms/static/cms/js/modules/shortcuts/create-modal.js");
/* harmony import */ var _toolbar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./toolbar */ "./cms/static/cms/js/modules/shortcuts/toolbar.js");
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_1___default()(function () {
    (0,_help__WEBPACK_IMPORTED_MODULE_0__["default"])();
    (0,_placeholders__WEBPACK_IMPORTED_MODULE_2__["default"])();
    (0,_create_modal__WEBPACK_IMPORTED_MODULE_3__["default"])();
    (0,_toolbar__WEBPACK_IMPORTED_MODULE_4__["default"])();
  });
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ initPlaceholders)
/* harmony export */ });
/* harmony import */ var _trap_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../trap.js */ "./cms/static/cms/js/modules/trap.js");
/* harmony import */ var _keyboard_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../keyboard.js */ "./cms/static/cms/js/modules/keyboard.js");




const queryAll = function (selector) {let root = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : document;return Array.from(root.querySelectorAll(selector));};
const query = function (selector) {let root = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : document;return root === null || root === void 0 ? void 0 : root.querySelector(selector);};
...
var bindPlaceholderKeys = function () {
  _keyboard_js__WEBPACK_IMPORTED_MODULE_1__["default"].setContext('placeholders');
  _keyboard_js__WEBPACK_IMPORTED_MODULE_1__["default"].bind('escape', function () {
    queryAll('.cms-structure .cms-dragarea').forEach((el) => el.removeAttribute('tabindex'));
    (0,_trap_js__WEBPACK_IMPORTED_MODULE_0__.untrap)(query('.cms-structure-content'));
    focusElement(document.documentElement);
    _keyboard_js__WEBPACK_IMPORTED_MODULE_1__["default"].setContext('cms');
  });

  _keyboard_js__WEBPACK_IMPORTED_MODULE_1__["default"].bind('enter', function () {
    _keyboard_js__WEBPACK_IMPORTED_MODULE_1__["default"].setContext('plugins');
    ...
    (0,_trap_js__WEBPACK_IMPORTED_MODULE_0__.trap)(area);
    _keyboard_js__WEBPACK_IMPORTED_MODULE_1__["default"].setContext('plugins');
  });

  _keyboard_js__WEBPACK_IMPORTED_MODULE_1__["default"].bind(['+', 'a'], function () {
    const area = document.activeElement.closest('.cms-dragarea');
    if (!area) return;
  ...
  _keyboard_js__WEBPACK_IMPORTED_MODULE_1__["default"].bind('x', function () {
    const area = document.activeElement.closest('.cms-dragarea');
    if (!area) return;
  ...
  _keyboard_js__WEBPACK_IMPORTED_MODULE_1__["default"].bind(['!', 's'], function () {
    const area = document.activeElement.closest('.cms-dragarea');
    if (!area) return;
    const settingsBtn = query('.cms-submenu-settings', area);
    triggerPointerUp(settingsBtn);
    _keyboard_js__WEBPACK_IMPORTED_MODULE_1__["default"].setContext('placeholder-actions');
    const submenuItem = query('.cms-submenu-item a', area);
    focusElement(submenuItem);
    const dropdownInner = query('.cms-dropdown-inner', area);
    (0,_trap_js__WEBPACK_IMPORTED_MODULE_0__.trap)(dropdownInner);
  });
};
...
var bindPlaceholderActionKeys = function () {
  ...
  _keyboard_js__WEBPACK_IMPORTED_MODULE_1__["default"].bind('escape', function () {
    ...
    (0,_trap_js__WEBPACK_IMPORTED_MODULE_0__.untrap)(dropdown);
    focusElement(area);
    _keyboard_js__WEBPACK_IMPORTED_MODULE_1__["default"].setContext('placeholders');
  });
};
...
var bindPluginKeys = function () {
  ...
  _keyboard_js__WEBPACK_IMPORTED_MODULE_1__["default"].bind('escape', function () {
    ...
    (0,_trap_js__WEBPACK_IMPORTED_MODULE_0__.untrap)(area);
    focusElement(area);
    _keyboard_js__WEBPACK_IMPORTED_MODULE_1__["default"].setContext('placeholders');
  });

  _keyboard_js__WEBPACK_IMPORTED_MODULE_1__["default"].bind('e', function () {
    const plugin = document.activeElement.closest('.cms-dragitem');
    if (!plugin) return;
  ...
  _keyboard_js__WEBPACK_IMPORTED_MODULE_1__["default"].bind(['!', 's'], function () {
    ...
    triggerPointerUp(settingsBtn);
    _keyboard_js__WEBPACK_IMPORTED_MODULE_1__["default"].setContext('plugin-actions');
...
function initPlaceholders() {
  ...
  _keyboard_js__WEBPACK_IMPORTED_MODULE_1__["default"].bind(data.shortcut.split(' / '), function () {
    if (CMS.settings.mode !== 'structure') {
      return;
    }
    ...
    (0,_trap_js__WEBPACK_IMPORTED_MODULE_0__.trap)(query('.cms-structure-content'));
    _keyboard_js__WEBPACK_IMPORTED_MODULE_1__["default"].setContext('placeholders');
  });
}
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  ...
  _keyboard__WEBPACK_IMPORTED_MODULE_0__["default"].setContext('cms');
  _keyboard__WEBPACK_IMPORTED_MODULE_0__["default"].bind(data.shortcut.split(' / '), function () {
    if (CMS.settings.toolbar === 'expanded') {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.cms-toolbar-item-navigation:first a:first').focus();
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.cms-toolbar-trigger a').focus();
    }
  });
}
...
/***/ "./cms/static/cms/js/modules/tmpl.js"
/*!*******************************************!*\
  !*** ./cms/static/cms/js/modules/tmpl.js ***!
  \*******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ tmpl)
/* harmony export */ });
var cache = {};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   isTrapping: () => (/* binding */ isTrapping),
...
function basePullAt(array, indexes) {
  ...
  while (length--) {
    ...
    if (length == lastIndex || index !== previous) {
      var previous = index;
      if ((0,_isIndex_js__WEBPACK_IMPORTED_MODULE_1__["default"])(index)) {
        splice.call(array, index, 1);
      } else {
        (0,_baseUnset_js__WEBPACK_IMPORTED_MODULE_0__["default"])(array, index);
      }
    }
  }
  return array;
...
function baseUnset(object, path) {
  ...
  var obj = (0,_parent_js__WEBPACK_IMPORTED_MODULE_2__["default"])(object, path);
  return obj == null || delete obj[(0,_toKey_js__WEBPACK_IMPORTED_MODULE_3__["default"])((0,_last_js__WEBPACK_IMPORTED_MODULE_1__["default"])(path))];
}
...
function unzip(array) {
  ...
  array = (0,_arrayFilter_js__WEBPACK_IMPORTED_MODULE_0__["default"])(array, function(group) {
    if ((0,_isArrayLikeObject_js__WEBPACK_IMPORTED_MODULE_4__["default"])(group)) {
      length = nativeMax(group.length, length);
      return true;
    }
  });
  return (0,_baseTimes_js__WEBPACK_IMPORTED_MODULE_3__["default"])(length, function(index) {
    return (0,_arrayMap_js__WEBPACK_IMPORTED_MODULE_1__["default"])(array, (0,_baseProperty_js__WEBPACK_IMPORTED_MODULE_2__["default"])(index));
  });
}
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _modules_shortcuts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/shortcuts */ "./cms/static/cms/js/modules/shortcuts/index.js");
/* harmony import */ var _modules_dropdown__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/dropdown */ "./cms/static/cms/js/modules/dropdown.js");
...
/* harmony import */ var _modules_cms_base__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/cms.base */ "./cms/static/cms/js/modules/cms.base.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! jquery */ "./cms/static/cms/js/libs/jquery.min.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _modules_cms_messages__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/cms.messages */ "./cms/static/cms/js/modules/cms.messages.js");
/* harmony import */ var _modules_cms_changetracker__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/cms.changetracker */ "./cms/static/cms/js/modules/cms.changetracker.js");
/* harmony import */ var _modules_cms_modal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/cms.modal */ "./cms/static/cms/js/modules/cms.modal.js");
/* harmony import */ var _modules_cms_sideframe__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/cms.sideframe */ "./cms/static/cms/js/modules/cms.sideframe.js");
/* harmony import */ var _modules_cms_clipboard__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/cms.clipboard */ "./cms/static/cms/js/modules/cms.clipboard.js");
/* harmony import */ var _modules_cms_plugins__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/cms.plugins */ "./cms/static/cms/js/modules/cms.plugins.js");
/* harmony import */ var _modules_cms_structureboard__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/cms.structureboard */ "./cms/static/cms/js/modules/cms.structureboard.js");
/* harmony import */ var _modules_cms_toolbar__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/cms.toolbar */ "./cms/static/cms/js/modules/cms.toolbar.js");
/* harmony import */ var _modules_cms_tooltip__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/cms.tooltip */ "./cms/static/cms/js/modules/cms.tooltip.js");
// polyfills
...
CMS.Messages = _modules_cms_messages__WEBPACK_IMPORTED_MODULE_4__["default"];
CMS.ChangeTracker = _modules_cms_changetracker__WEBPACK_IMPORTED_MODULE_5__["default"];
CMS.Modal = _modules_cms_modal__WEBPACK_IMPORTED_MODULE_6__["default"];
CMS.Sideframe = _modules_cms_sideframe__WEBPACK_IMPORTED_MODULE_7__["default"];
CMS.Clipboard = _modules_cms_clipboard__WEBPACK_IMPORTED_MODULE_8__["default"];
CMS.Plugin = _modules_cms_plugins__WEBPACK_IMPORTED_MODULE_9__["default"];
CMS.StructureBoard = _modules_cms_structureboard__WEBPACK_IMPORTED_MODULE_10__["default"];
CMS.Toolbar = _modules_cms_toolbar__WEBPACK_IMPORTED_MODULE_11__["default"];
CMS.Tooltip = _modules_cms_tooltip__WEBPACK_IMPORTED_MODULE_12__["default"];

CMS.API = {
  Helpers: _modules_cms_base__WEBPACK_IMPORTED_MODULE_2__.Helpers
};
CMS.KEYS = _modules_cms_base__WEBPACK_IMPORTED_MODULE_2__.KEYS;
CMS.$ = (jquery__WEBPACK_IMPORTED_MODULE_3___default());
...
CMS.$(function () {
  ...
  (0,_modules_shortcuts__WEBPACK_IMPORTED_MODULE_0__["default"])();
...
window.CMS = __webpack_exports__["default"];
/******/ })()
;
//# sourceMappingURL=bundle.toolbar.min.js.map