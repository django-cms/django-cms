...
we have added experimental support for Python 3.3. Support for Python 2.5 has
been dropped.
...
Twitter disabled V1 of their API, thus we have removed the twitter plugin
...
``PlaceholderAdmin`` does not have language tabs any more and the plugin editor
