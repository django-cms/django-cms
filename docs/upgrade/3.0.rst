...
A plugin's translatable content can now be read and set through :meth:`~cms.models.CMSPlugin.get_translatable_content()`
and :meth:`~cms.models.CMSPlugin.set_translatable_content()`. See :ref:`Custom Plugins <custom-plugins>` for more info.
