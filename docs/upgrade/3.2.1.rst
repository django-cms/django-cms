...
- Fix a bug where page tree styles did not load from STATIC_URL that pointed to a different host.
- Fix an issue where the side-frame would not refresh under some circumstances.
