...
out of the box. The main reasons for the changes:
    ...
    - Too many "opinions" of how parts of the CMS should work
...
Do we comment on chnages that have already happened in previous v3 versions, such as Github actions etc??
