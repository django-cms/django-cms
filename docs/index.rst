...
-----------  ----------------------------   ------------------------------------
\            3.10 3.9 3.8 3.7 3.6 3.5 3.4   4.1 4.0 3.2 3.1 3.0 2.2 2.1 2.0 1.11
===========  ==== === === === === === ===   === === === === === === === === ====
4.1.x        ✓    ✓   ✓   ✓   ×   ×   ×     ✓   ✓   ✓   ✓   ✓   ✓   ×   ×   ×
3.11.x       ✓    ✓   ✓   ✓   ×   ×   ×     ✓   ✓   LTS ×   ×   ×   ×   ×   ×
3.11.0       ✓    ✓   ✓   ✓   ×   ×   ×     ×   ✓   LTS ×   ×   ×   ×   ×   ×
...
.. _Python: https://www.python.org (also see https://devguide.python.org/devcycle/#end-of-life-branches)
.. _Django: https://www.djangoproject.com (also see https://www.djangoproject.com/download/#supported-versions)
